  ...
  $.fn.TouchSpin = function (options) {
    ...
    return this.each(function () {
        ...
        if (value !== "") {
          ...
          elements.input.val(
            settings.callback_after_calculation(
              parseFloat(value).toFixed(settings.decimals)
            )
          );
        }
      }
        ...
        if (parseFloat(settings.step) !== 1) {
          ...
          if (remainder !== 0) {
            settings.min =
              ...
              (parseFloat(settings.step) - remainder);
          }
        }
      }
      ...
      function _buildHtml() {
        ...
        if (initval !== "") {
          ...
          initval = settings.callback_after_calculation(
            parseFloat(initval).toFixed(settings.decimals)
          );
        }
      ...
      function _buildInputGroup() {
        ...
        var inputGroupSize = "";
        if (
          originalinput.hasClass("input-sm") ||
          originalinput.hasClass("form-control-sm")
        ) {
          inputGroupSize = "input-group-sm";
        } else if (
          originalinput.hasClass("input-lg") ||
          originalinput.hasClass("form-control-lg")
        ) {
      ...
      function _checkValue() {
        ...
        if (
          parseFloat(parsedval).toString() !== parseFloat(returnval).toString()
        ) {
        ...
        originalinput.val(
          settings.callback_after_calculation(
            parseFloat(returnval).toFixed(settings.decimals)
          )
        );
      }
