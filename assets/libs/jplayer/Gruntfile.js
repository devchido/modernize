  ...
  grunt.initConfig({
      ...
      playlist: {
        files: {
          "dist/add-on/jplayer.playlist.js": [
            "src/javascript/add-on/jplayer.playlist.js",
          ],
        },
      },
      inspector: {
        files: {
          "dist/add-on/jquery.jplayer.inspector.js": [
            "src/javascript/add-on/jquery.jplayer.inspector.js",
          ],
        },
      },
      popcorn: {
    ...
    uglify: {
      ...
      jplayer: {
        options: {
          banner:
            '/*! jPlayer <%= pkg.version %> for jQuery ~ (c) 2009-<%= grunt.template.today("yyyy") %> <%= pkg.organization %> ~ <%= pkg.license %> License */\n',
        },
        files: {
      ...
      playlist: {
        options: {
          banner:
            '/*! jPlayerPlaylist for jPlayer <%= pkg.version %> ~ (c) 2009-<%= grunt.template.today("yyyy") %> <%= pkg.organization %> ~ <%= pkg.license %> License */\n',
        },
        files: {
      ...
      inspector: {
        options: {
          banner:
            '/*! jPlayerInspector for jPlayer <%= pkg.version %> ~ (c) 2009-<%= grunt.template.today("yyyy") %> <%= pkg.organization %> ~ <%= pkg.license %> License */\n',
        },
        files: {
      ...
      popcorn: {
        options: {
          banner:
            '/*! Popcorn Player for jPlayer <%= pkg.version %> ~ (c) 2009-<%= grunt.template.today("yyyy") %> <%= pkg.organization %> ~ <%= pkg.license %> License */\n',
        },
        files: {
    ...
    sass: {
      ...
      "blue.monday": {
        options: {
          banner:
            '/*! Blue Monday Skin for jPlayer <%= pkg.version %> ~ (c) 2009-<%= grunt.template.today("yyyy") %> <%= pkg.organization %> ~ <%= pkg.license %> License */\n',
        },
        files: {
          "dist/skin/blue.monday/css/jplayer.blue.monday.css":
            "src/skin/blue.monday/scss/jplayer.blue.monday.scss",
        },
      },
      "pink.flag": {
        options: {
          banner:
            '/*! Pink Flag Skin for jPlayer <%= pkg.version %> ~ (c) 2009-<%= grunt.template.today("yyyy") %> <%= pkg.organization %> ~ <%= pkg.license %> License */\n',
        },
        files: {
          "dist/skin/pink.flag/css/jplayer.pink.flag.css":
            "src/skin/pink.flag/scss/jplayer.pink.flag.scss",
        },
      },
    },
    ...
    copy: {
      skins: {
        files: [
          {
            expand: true,
            cwd: "src/skin/blue.monday/",
            src: ["image/**", "mustache/**"],
            dest: "dist/skin/blue.monday/",
          },
          {
            expand: true,
            cwd: "src/skin/pink.flag/",
            src: ["image/**", "mustache/**"],
            dest: "dist/skin/pink.flag/",
          },
        ],
      },
    },
