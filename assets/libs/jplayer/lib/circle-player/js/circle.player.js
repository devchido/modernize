...
CirclePlayer.prototype = {
  ...
  _initPlayer: function () {
    ...
    this.player.bind(
      $.jPlayer.event.ready + this.eventNamespace,
      function (event) {
    ...
    this.player.bind(
      $.jPlayer.event.play + this.eventNamespace,
      function (event) {
    ...
    this.player.bind(
      $.jPlayer.event.timeupdate + this.eventNamespace,
      function (event) {
        if (!self.dragging) {
    ...
    this.player.bind(
      $.jPlayer.event.progress + this.eventNamespace,
      function (event) {
        var percent = 0;
        if (
    ...
    this.player.bind(
      $.jPlayer.event.ended + this.eventNamespace,
      function (event) {
        self._resetSolution();
      }
    );
