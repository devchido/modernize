(function (global, document) {
  ...
  if (!document.addEventListener) {
    ...
    var methods = (
      "byId forEach extend effects error guid sizeOf isArray nop position disable enable destroy" +
    ...
    init: function (entity, options) {
      ...
      if (typeof entity === "function") {
        ...
        if (!readyBound) {
          ...
          var DOMContentLoaded = function () {
            ...
            for (
              var i = 0, readyStackLength = readyStack.length;
              i < readyStackLength;
              i++
            ) {
      ...
      if (typeof entity === "string") {
        try {
          ...
          throw new Error(
            "Popcorn.js Error: Invalid media element selector: " + entity
          );
        }
      }
      ...
      nodeName =
        (this.media.nodeName && this.media.nodeName.toLowerCase()) || "video";
      ...
      if (Popcorn.byId(this.id)) {
        throw new Error(
          "Popcorn.js Error: Cannot use duplicate ID (" + this.id + ")"
        );
      }
      ...
      var isReady = function () {
        ...
        videoDurationPlus =
          duration != duration ? Number.MAX_VALUE : duration + 1;
        ...
        if (!self.isDestroyed) {
          ...
          self.media.addEventListener(
            "durationchange",
            self.data.durationChange,
            false
          );
        }
  ...
  Popcorn.extend(Popcorn, {
    ...
    position: function (elem) {
      ...
      scrollLeft =
        (global.pageXOffset && docElem.scrollLeft) || body.scrollLeft;
    ...
    disable: function (instance, plugin) {
      ...
      if (plugin in Popcorn.registryByName && instance.data.running[plugin]) {
        for (
          var i = instance.data.running[plugin].length - 1, event;
          i >= 0;
          i--
        ) {
    ...
    destroy: function (instance) {
      ...
      if (!instance.isDestroyed) {
        instance.data.timeUpdate &&
          instance.media.removeEventListener(
            "timeupdate",
            instance.data.timeUpdate,
            false
          );
  ...
  Popcorn.extend(
    ...
    (function () {
      var methods =
          "load play pause currentTime playbackRate volume duration preload playbackRate " +
  ...
  Popcorn.extend(Popcorn.p, {
    ...
    exec: function (id, time, fn) {
      ...
      if (eventType === "cuechange") {
        ...
        options._id =
          options.id || options._id || Popcorn.guid(options._natives.type);
    ...
    toggle: function (plugin) {
      return Popcorn[this.data.disabled[plugin] ? "enable" : "disable"](
        this,
        plugin
      );
    },
  ...
  Popcorn.Events = {
    ...
    MouseEvents:
      "mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave click dblclick",
    Events:
      "loadstart progress suspend emptied stalled play pause error " +
      "loadedmetadata loadeddata waiting playing canplay canplaythrough " +
      "seeking seeked timeupdate ended ratechange durationchange volumechange",
  };

  Popcorn.Events.Natives =
    Popcorn.Events.UIEvents +
    " " +
  ...
  TrackEvent.start = function (instance, track) {
    if (
      track.end > instance.media.currentTime &&
  ...
  TrackEvents.prototype.add = function (track) {
    ...
    track.start = Popcorn.util.toSeconds(
      track.start,
      this.parent.options.framerate
    );
    track.end = Popcorn.util.toSeconds(
      track.end,
      this.parent.options.framerate
    );
    ...
    if (
      startIndex <= this.parent.data.trackEvents.startIndex &&
    ...
    if (
      endIndex <= this.parent.data.trackEvents.endIndex &&
  ...
  Popcorn.addTrackEvent = function (obj, track) {
    ...
    if (
      ...
      obj.options.defaults[track._natives.type]
    ) {
  ...
  Popcorn.timeUpdate = function (obj, event) {
    ...
    if (previousTime <= currentTime) {
      ...
      while (
        tracks.byStart[start] &&
        tracks.byStart[start].start <= currentTime
      ) {
  ...
  Popcorn.plugin = function (name, definition, manifest) {
    ...
    var pluginFn = function (setup, options) {
      ...
      if (!options.target) {
        ...
        options.target =
          manifestOpts && "target" in manifestOpts && manifestOpts.target;
      }
    ...
    Popcorn.p[name] = plugin[name] = function (id, options) {
          ...
          if (trackEvent._natives._update) {
            ...
            if (isfn) {
              ...
              trackEvent._id =
                trackEvent.id ||
                trackEvent._id ||
                Popcorn.guid(trackEvent._natives.type);
      ...
      pluginFn.call(
        this,
        isfn ? definition.call(this, mergedSetupOpts) : definition,
        mergedSetupOpts
      );
  ...
  Popcorn.removePlugin = function (obj, name) {
    ...
    for (idx = 0, sl = byStart.length; idx < sl; idx++) {
      if (
        byStart[idx] &&
        byStart[idx]._natives &&
        byStart[idx]._natives.type === name
      ) {
        byStart[idx]._natives._teardown &&
          byStart[idx]._natives._teardown.call(obj, byStart[idx]);
    ...
    for (idx = 0, sl = animating.length; idx < sl; idx++) {
      if (
        animating[idx] &&
        animating[idx]._natives &&
        animating[idx]._natives.type === name
      ) {
  ...
  Popcorn.xhr = function (options) {
    ...
    if (settings.ajax) {
      ...
      if (settings.type === "POST") {
        settings.ajax.setRequestHeader("Content-Type", settings.contentType);
      }
