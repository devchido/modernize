  ...
  return (function e(t, n, r) {
        ...
        function (_dereq_, module, exports) {
          ...
          Bitstream = (function () {
            ...
            Bitstream.prototype.readLSB = function (bits, signed) {
              ...
              if (mBits > 32) {
                a +=
                  this.stream.peekUInt8(4) * Math.pow(2, 32 - this.bitPosition);
              }
              if (mBits >= 32) {
                a %= Math.pow(2, bits);
              } else {
          ...
          M4ADemuxer = (function (_super) {
            ...
            M4ADemuxer.probe = function (buffer) {
              ...
              return (
                ...
                ((_ref = buffer.peekString(8, 4)),
                __indexOf.call(TYPES, _ref) >= 0)
              );
            };
            ...
            atom("moov.trak.mdia.minf.stbl.stsd", function () {
              ...
              format.floatingPoint =
                (_ref = format.formatID) === "fl32" || _ref === "fl64";
              format.littleEndian =
            ...
            M4ADemuxer.prototype.parseChapters = function () {
              ...
              if (
                !(
                  ((_ref = this.track.chapterTracks) != null
                    ? _ref.length
                    : void 0) > 0
                )
              ) {
        ...
        function (_dereq_, module, exports) {
          ...
          AudioDevice = (function (_super) {
            ...
            AudioDevice.prototype.updateTime = function () {
              ...
              this.currentTime +=
                (((time - this._lastTime) / this.device.sampleRate) * 1000) | 0;
              this._lastTime = time;
              return this.emit("timeUpdate", this.currentTime);
            };
	...
	if ((bufferLength % " +
          ...
          (function (global) {
            ...
            WebAudioDevice = (function (_super) {
              ...
              WebAudioDevice.prototype.refill = function (event) {
                ...
                for (
                  i = _j = 0, _ref = outputBuffer.length;
                  _j < _ref;
                  i = _j += 1
                ) {
              ...
              this.queue.once(
                ...
                (function (_this) {
                  return function () {
                    ...
                    if (_this.playing) {
                      return (_ref2 = _this.device) != null
                        ? _ref2.start()
                        : void 0;
                    }
                  };
      ...
      32: [
        ...
        { "../core/buffer": 7, "../core/bufferlist": 8, "../core/events": 9 },
      ],
    },
    {},
    [1]
