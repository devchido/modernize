(function (Popcorn) {
  ...
  Popcorn.player = function (name, player) {
    ...
    var playerFn = function (target, src, options) {
      ...
      var date = new Date() / 1000,
        ...
        container =
          typeof target === "string" ? Popcorn.dom.find(target) : target,
        basePlayer = {},
        timeout,
        popcorn;
      ...
      var timeupdate = function () {
        ...
        if (!basePlayer.paused) {
          basePlayer.currentTime =
            basePlayer.currentTime + (date - baselineTime);
      ...
      options &&
        options.events &&
        Popcorn.forEach(options.events, function (val, key) {
    ...
    playerFn.canPlayType = player._canPlayType =
      player._canPlayType || Popcorn.nop;
  ...
  Popcorn.player.defineProperty =
    Object.defineProperty ||
    function (object, description, options) {
  ...
  Popcorn.smart = function (target, src, options) {
    var node = typeof target === "string" ? Popcorn.dom.find(target) : target,
      ...
      wrappers =
        "HTMLYouTubeVideoElement HTMLVimeoVideoElement HTMLSoundCloudAudioElement HTMLNullVideoElement".split(
          " "
        );
