...
(function () {
  ...
  test("Options setup", function () {
    ...
    equal(
      ...
      "expandIcon default ok"
    );
    equal(
      options.collapseIcon,
      "glyphicon glyphicon-minus",
      "collapseIcon default ok"
    );
    ...
    equal(
      ...
      "checkedIcon default ok"
    );
    equal(
      options.uncheckedIcon,
      "glyphicon glyphicon-unchecked",
      "uncheckedIcon default ok"
    );
    ...
    equal(
      options.searchResultBackColor,
      undefined,
      "searchResultBackColor default ok"
    );
    equal(options.enableLinks, false, "enableLinks default ok");
    equal(options.highlightSelected, true, "highlightSelected default ok");
    equal(
      options.highlightSearchResults,
      true,
      "highlightSearchResults default ok"
    );
    ...
    equal(
      ...
      "glyphicon glyphicon-selected",
      "selectedIcon set ok"
    );
    equal(
      options.checkedIcon,
      "glyphicon glyphicon-checked-icon",
      "checkedIcon set ok"
    );
    equal(
      options.uncheckedIcon,
      "glyphicon glyphicon-unchecked-icon",
      "uncheckedIcon set ok"
    );
    ...
    equal(
      typeof options.onNodeUnselected,
      "function",
      "onNodeUnselected set ok"
    );
    equal(
      typeof options.onSearchComplete,
      "function",
      "onSearchComplete set ok"
    );
  ...
  test("Correct initial levels shown", function () {
    ...
    equal(
      ...
      5,
      "Correctly display 5 root nodes when levels set to 1"
    );
    ...
    equal(
      $(el.selector + " ul li").length,
      7,
      "Correctly display 5 root and 2 child nodes when levels set to 2"
    );
  ...
  test("Expanding a node", function () {
    ...
    el.trigger("click");
    ok(
      $(".list-group-item").length > nodeCount,
      "Number of nodes are increased, so node must have expanded"
    );
  ...
  test("Collapsing a node", function () {
    ...
    ok(
      $(".list-group-item").length < nodeCount,
      "Number of nodes has decreased, so node must have collapsed"
    );
  ...
  test("Selecting a node", function () {
    ...
    ok(
      !iconClass || $(".expand-icon:first").hasClass(iconClass),
      "Node icon is correct"
    );
  ...
  test("Unselecting a node", function () {
    ...
    // Has correct icon
    ok(
      !options.nodeIcon || $(".expand-icon:first").hasClass(options.nodeIcon),
      "Node icon is correct"
    );
  ...
  test("Selecting multiple nodes (multiSelect true)", function () {
    ...
    ok(
      $firstEl.hasClass("node-selected"),
      'First node is correctly selected : class "node-selected" added'
    );
    ok(
      $secondEl.hasClass("node-selected"),
      'Second node is correctly selected : class "node-selected" added'
    );
  ...
  test("Checking a node", function () {
    ...
    $el = $(".check-icon:first");
    ok(
      $el.attr("class").indexOf(options.checkedIcon) !== -1,
      "Node is checked : icon is correct"
    );
  ...
  test("Unchecking a node", function () {
    ...
    $el = $(".check-icon:first");
    ok(
      $el.attr("class").indexOf(options.uncheckedIcon) !== -1,
      "Node is unchecked : icon is correct"
    );
  ...
  test("getNode", function () {
    ...
    equal(
      nodeParent1.text,
      "Parent 1",
      'Correct node returned : requested "Parent 1", got "Parent 1"'
    );
  });
  ...
  test("getParent", function () {
    ...
    equal(
      parentNode.text,
      "Parent 1",
      'Correct node returned : requested parent of "Child 1", got "Parent 1"'
    );
  });
  ...
  test("getChecked", function () {
    var $tree = init({ data: data, showCheckbox: true }).treeview(
      "checkNode",
      0
    );
  ...
  test("disableAll / enableAll", function () {
    ...
    equal(
      ...
      5,
      "Disable all works, 9 nodes with node-disabled class"
    );
  ...
  test("disableNode / enableNode", function () {
    ...
    ok(
      $(".node-disabled").length === 1,
      "Disable node (by id) : There is only one disabled node"
    );
    ...
    ok(
      $(".node-checked").length === 0,
      "Enable node (by id) : There are no disabled nodes"
    );
    ...
    ok(
      $(".node-disabled").length === 1,
      "Disable node (by node) : There is only one disabled node"
    );
    ...
    ok(
      $(".node-checked").length === 0,
      "Enable node (by node) : There are no disabled nodes"
    );
  });
  ...
  test("toggleNodeDisabled", function () {
    ...
    ok(
      $(".list-group-item:first").hasClass("node-disabled"),
      "Toggle node (by id) : Node has class node-disabled"
    );
    ok(
      $(".node-disabled").length === 1,
      "Toggle node (by id) : There is only one disabled node"
    );
    ...
    ok(
      ...
      "Toggle node (by node) : There are no disabled nodes"
    );
  });
  ...
  test("checkAll / uncheckAll", function () {
    ...
    equal(
      $($tree.selector + " ul li.node-checked").length,
      9,
      "Check all works, 9 nodes with node-checked class"
    );
    equal(
    ...
    equal(
      $($tree.selector + " ul li.node-checked").length,
      0,
      "Check all works, 9 nodes non with node-checked class"
    );
    equal(
  ...
  test("checkNode / uncheckNode", function () {
    ...
    ok(
      ...
      "Check node (by id) : Node has class node-checked"
    );
    ok(
      $(".node-checked").length === 1,
      "Check node (by id) : There is only one checked node"
    );
    ok(
      $(".check-icon:first").hasClass(options.checkedIcon),
      "Check node (by id) : Node icon is correct"
    );
    ...
    ok(
      $(".node-checked").length === 0,
      "Uncheck node (by id) : There are no checked nodes"
    );
    ok(
      $(".check-icon:first").hasClass(options.uncheckedIcon),
      "Uncheck node (by id) : Node icon is correct"
    );
    ...
    ok(
      $(".list-group-item:first").hasClass("node-checked"),
      "Check node (by node) : Node has class node-checked"
    );
    ok(
      $(".node-checked").length === 1,
      "Check node (by node) : There is only one checked node"
    );
    ok(
      $(".check-icon:first").hasClass(options.checkedIcon),
      "Check node (by node) : Node icon is correct"
    );
    ...
    ok(
      $(".node-checked").length === 0,
      "Uncheck node (by node) : There are no checked nodes"
    );
    ok(
      $(".check-icon:first").hasClass(options.uncheckedIcon),
      "Uncheck node (by node) : Node icon is correct"
    );
  });
  ...
  test("toggleNodeChecked", function () {
    ...
    ok(
      $(".list-group-item:first").hasClass("node-checked"),
      "Toggle node (by id) : Node has class node-checked"
    );
    ok(
      $(".node-checked").length === 1,
      "Toggle node (by id) : There is only one checked node"
    );
    ok(
      $(".check-icon:first").hasClass(options.checkedIcon),
      "Toggle node (by id) : Node icon is correct"
    );
    ...
    ok(
      $(".node-checked").length === 0,
      "Toggle node (by node) : There are no checked nodes"
    );
    ok(
      $(".check-icon:first").hasClass(options.uncheckedIcon),
      "Toggle node (by node) : Node icon is correct"
    );
  });
  ...
  test("selectNode / unselectNode", function () {
    ...
    ok(
      $(".list-group-item:first").hasClass("node-selected"),
      "Select node (by id) : Node has class node-selected"
    );
    ok(
      $(".node-selected").length === 1,
      "Select node (by id) : There is only one selected node"
    );
    ...
    ok(
      ...
      "Unselect node (by id) : There are no selected nodes"
    );
    ...
    ok(
      $(".list-group-item:first").hasClass("node-selected"),
      "Select node (by node) : Node has class node-selected"
    );
    ok(
      $(".node-selected").length === 1,
      "Select node (by node) : There is only one selected node"
    );
    ...
    ok(
      $(".node-selected").length === 0,
      "Unselect node (by node) : There are no selected nodes"
    );
  });
  ...
  test("toggleNodeSelected", function () {
    ...
    ok(
      $(".list-group-item:first").hasClass("node-selected"),
      "Toggle node (by id) : Node has class node-selected"
    );
    ok(
      $(".node-selected").length === 1,
      "Toggle node (by id) : There is only one selected node"
    );
    ...
    ok(
      $(".node-selected").length === 0,
      "Toggle node (by node) : There are no selected nodes"
    );
  });
  ...
  test("expandAll / collapseAll", function () {
    ...
    equal(
      ...
      5,
      "Starts in collapsed state, 5 root nodes displayed"
    );
    ...
    equal(
      $($tree.selector + " ul li").length,
      9,
      "Expand all works, all 9 nodes displayed"
    );
    ...
    equal(
      $($tree.selector + " ul li").length,
      5,
      "Collapse all works, 5 original root nodes displayed"
    );
    ...
    equal(
      $($tree.selector + " ul li").length,
      7,
      "Expand all (levels = 1) works, correctly displayed 7 nodes"
    );
  });
  ...
  test("expandNode / collapseNode / toggleExpanded", function () {
    ...
    equal(
      $($tree.selector + " ul li").length,
      7,
      "Expand node (by id) works, 7 nodes displayed"
    );
    ...
    equal(
      $($tree.selector + " ul li").length,
      5,
      "Collapse node (by id) works, 5 original nodes displayed"
    );
    ...
    equal(
      $($tree.selector + " ul li").length,
      7,
      "Toggle node (by id) works, 7 nodes displayed"
    );
    ...
    equal(
      $($tree.selector + " ul li").length,
      5,
      "Toggle node (by id) works, 5 original nodes displayed"
    );
    ...
    equal(
      $($tree.selector + " ul li").length,
      9,
      "Expand node (levels = 2, by id) works, 9 nodes displayed"
    );
    ...
    equal(
      $($tree.selector + " ul li").length,
      5,
      "Reset to collapsed state, 5 root nodes displayed"
    );
    ...
    equal(
      $($tree.selector + " ul li").length,
      7,
      "Expand node (by node) works, 7 nodes displayed"
    );
    ...
    equal(
      $($tree.selector + " ul li").length,
      5,
      "Collapse node (by node) works, 5 original nodes displayed"
    );
    ...
    equal(
      $($tree.selector + " ul li").length,
      7,
      "Toggle node (by node) works, 7 nodes displayed"
    );
    ...
    equal(
      $($tree.selector + " ul li").length,
      5,
      "Toggle node (by node) works, 5 original nodes displayed"
    );
    ...
    equal(
      $($tree.selector + " ul li").length,
      9,
      "Expand node (levels = 2, by node) works, 9 nodes displayed"
    );
  });
  ...
  test("revealNode", function () {
    ...
    equal(
      $($tree.selector + " ul li").length,
      7,
      "Reveal node (by id) works, reveal Child 1 and 7 nodes displayed"
    );
  ...
  test("search", function () {
    ...
    var result = $tree.treeview("search", [
      "Parent 1",
      { ignoreCase: false, exactMatch: true },
    ]);
    equal(
      result.length,
      1,
      'Search "Parent 1" case sensitive, exact match - returns 1 result'
    );

    // Case sensitive, like
    result = $tree.treeview("search", [
      "Parent",
    ...
    equal(
      result.length,
      5,
      'Search "Parent" case sensitive, exact match - returns 5 results'
    );

    // Case insensitive, exact match
    result = $tree.treeview("search", [
      "parent 1",
      { ignoreCase: true, exactMatch: true },
    ]);
    equal(
      result.length,
      1,
      'Search "parent 1" case insensitive, exact match - returns 1 result'
    );
    ...
    equal(
      result.length,
      5,
      'Search "parent" case insensitive, exact match - returns 5 results'
    );
