...
import AsGradient from "../src/asGradient";
...
describe("AsGradient", () => {
  ...
  describe("getPrefixedStrings()", () => {
    it("should get prefixed strings correctly", () => {
      ...
      console.info(gradient.getPrefixedStrings());
  ...
  describe("fromString()", () => {
    it("should parse from string", () => {
      ...
      expect(gradient._prefix).to.be.equal("-webkit-"); // test webkit prefix
      expect(gradient._type).to.be.equal("LINEAR"); // test linear type
      ...
      expect(gradient._prefix).to.be.equal("-moz-"); // test moz prefix
      expect(gradient._type).to.be.equal("LINEAR"); // test linear type
      ...
      expect(gradient._prefix).to.be.equal(null); // test standare prefix
      expect(gradient._type).to.be.equal("LINEAR"); // test linear type
    ...
    it("should get angle correctly from gradient string", () => {
      ...
      gradient.fromString(
        "-webkit-linear-gradient(left top, #000000, #ffffff)"
      );
