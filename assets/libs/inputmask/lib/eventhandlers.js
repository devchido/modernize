...
var EventHandlers = {
  keyEvent: function (e, checkval, writeOut, strict, ndx) {
    ...
    var kdResult = opts.onKeyDown.call(
      this,
      e,
  ...
  clickEvent: function (e, tabbed) {
    ...
    if (
      ...
      var newCaretPosition = determineNewCaretPosition.call(
        inputmask,
        caret.call(inputmask, input),
        tabbed
      );
  ...
  submitEvent: function () {
    ...
    if (
      /*opts.clearMaskOnLostFocus && */ getLastValidPosition.call(inputmask) ===
        -1 &&
      inputmask._valueGet &&
