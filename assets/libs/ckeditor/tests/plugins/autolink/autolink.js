  ...
  bender.test({
      ...
      while ((pastedText = pastedTexts.pop())) {
        this.editors.classic.once(
          ...
          function (evt) {
            ...
            assert.areSame(
              -1,
              evt.data.dataValue.search(/<a /),
              "text was not auto linked: " + pastedText
            );
          },
          null,
          null,
    ...
    "test URL link with quotation marks": function () {
      var pastedText = 'https://foo.bar/?bam="bom"',
        expected =
          '<a href="https://foo.bar/?bam=%22bom%22">https://foo.bar/?bam="bom"</a>';

      assertPasteEvent(
        this.editors.classic,
        { dataValue: pastedText },
        { dataValue: expected, type: "html" }
      );
    },
    ...
    "test pasting multiple URL links": function () {
      var pastedText =
        "http://en.wikipedia.org/wiki/Weasel http://en.wikipedia.org/wiki/Weasel";
    ...
    "test content that is a link": function () {
      var pastedText =
        '<a href="http://en.wikipedia.org/wiki/Weasel">Weasel</a>';
    ...
    "test type is changed once a link is created": function () {
      ...
      assertPasteEvent(
        this.editors.classic,
        { dataValue: pastedText, type: "text" },
        { dataValue: expected, type: "html" }
      );
    },
    ...
    "test created protected mail link (function)": function () {
      var pastedText = "a@a",
        expected =
          "<a href=\"javascript:void(location.href='mailto:'+String.fromCharCode(97,64,97))\">a@a</a>";

      assertPasteEvent(
        this.editors.encodedDefault,
        { dataValue: pastedText, type: "text" },
        function (data) {
