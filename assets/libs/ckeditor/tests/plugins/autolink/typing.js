...
(function () {
  ...
  bender.test({
    ...
    "test link completion with custom commit keystrokes": function () {
      testTyping(
        this.editors.customCommitKeystrokes,
        37,
        url,
        expectedUrlLink,
        "ArrowLeft URL"
    ...
    "test created protected mail link (string) on typing": function () {
      testTyping(
        ...
        32,
        "a@a^",
        "<p><a href=\"javascript:mt('a','a','','')\">a@a</a></p>"
      ); // SPACE
    },
    ...
    "test created protected mail link (function) on typing": function () {
      testTyping(
        ...
        32,
        "a@a^",
        "<p><a href=\"javascript:void(location.href='mailto:'+String.fromCharCode(97,64,97))\">a@a</a></p>"
      ); // SPACE
    },
    ...
    "test typing after autolinked text": function () {
      ...
      assert.areEqual(
        '<p><a href="http://example.com">http://example.com</a>&nbsp;test</p>',
        editor.getData()
      );
    },
  });
