...
addTests(
  "test indent does nothing when items are not wrapped in paragraph and caret is in the first one",
  "indent",
...
addTests(
  "test indent does not remove second list item when items are not wrapped in paragraph and caret is in the second one",
  "indent",
  [
    [
...
addTests(
  "test indent does not make changes when items are wrapped in paragraph and caret is in the first one",
  "indent",
  [
    [
...
addTests(
  "test indent nests list when items are wrapped in paragraph and caret is in the second one",
  "indent",
  [
    [
