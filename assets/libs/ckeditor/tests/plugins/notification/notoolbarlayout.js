      ...
      editor.once("notificationShow", function (evt) {
        ...
        setTimeout(function () {
          resume(function () {
            ...
            bender.assert.isNumberInRange(
              parseInt(notificationRect.left, 10),
              parseInt(contentRect.left, 10),
              parseInt(contentRect.right, 10)
            );
            bender.assert.isNumberInRange(
              parseInt(notificationRect.right, 10),
              parseInt(contentRect.left, 10),
              parseInt(contentRect.right, 10)
            );
            bender.assert.isNumberInRange(
              parseInt(notificationRect.top, 10),
              parseInt(contentRect.top, 10),
              parseInt(contentRect.bottom, 10)
            );
            bender.assert.isNumberInRange(
              parseInt(notificationRect.bottom, 10),
              parseInt(contentRect.top, 10),
              parseInt(contentRect.bottom, 10)
            );
