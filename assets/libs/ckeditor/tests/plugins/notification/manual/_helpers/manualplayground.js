...
var manualPlayground = {
  ...
  emulateProgress: function () {
    var notification = editor.showNotification(
      ...
      scenario = [
        ...
        {
          type: "success",
          message: "File image.png uploaded.",
          important: true,
        },
      ];
  ...
  showWarning: function () {
    editor.showNotification(
      'Vitae risus eget ante <a href="http://test/">mau</a> convallis.',
      "warning"
    );
  },
  ...
  showInfo: function () {
    editor.showNotification(
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vitae risus eget ante mae convallis.",
      "info"
    );
  },
};
