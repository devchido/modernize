...
bender.test({
  ...
  "test remove": function () {
    var editor = this.editor,
      area = editor._.notificationArea,
      doc = new CKEDITOR.dom.document(document),
      notification1 = new CKEDITOR.plugins.notification(editor, {
        message: "Foo",
      }),
      notification2 = new CKEDITOR.plugins.notification(editor, {
        message: "Foo",
      }),
      notification3 = new CKEDITOR.plugins.notification(editor, {
        message: "Foo",
      });
  ...
  "test delete editor": function () {
    ...
    assert.isTrue(
      true,
      "Listeners should be removed so there should be no errors."
    );
  },
});
