  ...
  bender.test({
    ...
    "test exposes Aggregator type": function () {
      assert.isInstanceOf(
        ...
        "Aggregator type is not exposed"
      );
    },
    ...
    "test constructor": function () {
      ...
      assert.isInstanceOf(
        CKEDITOR.template,
        aggr._message,
        "_message property type"
      );
      assert.isInstanceOf(
        CKEDITOR.template,
        aggr._singularMessage,
        "_singularMessage property type"
      );
    ...
    "test instances does not share _tasks": function () {
      ...
      assert.areSame(
        0,
        instance2._tasks.length,
        "instance2 _tasks remains empty"
      );
    },
    ...
    "test createTask creates a notification": function () {
      ...
      assert.areSame(
        1,
        aggr._createNotification.callCount,
        "_createNotification call count"
      );
      ...
      assert.areSame(
        1,
        notification.show.callCount,
        "notification show call count"
      );
    ...
    "test createTask reuses a notification when have tasks": function () {
      ...
      assert.areSame(
        0,
        NotificationMock.callCount,
        "Notification constructor call count"
      );
      assert.areSame(1, aggr.update.callCount, "update call count");
    },
    ...
    "test update": function () {
      ...
      assert.areSame(
        1,
        instance._updateNotification.callCount,
        "_updateNotification call count"
      );
    ...
    "test _updateNotification": function () {
      ...
      sinon.assert.calledWithExactly(
        instance.notification.update,
        expectedParams
      );

      assert.areSame(
        1,
        instance.getPercentage.callCount,
        "instance.getPercentage call count"
      );
    },
    ...
    "test _updateNotification notification call": function () {
      ...
      assert.areSame(
        1,
        instance.notification.update.callCount,
        "notification.update call count"
      );
    },
    ...
    "test _removeTask": function () {
      ...
      assert.areSame(
        1,
        instance.update.callCount,
        "instance.update call count"
      );
    },
    ...
    "test _removeTask subtracts doneWeight": function () {
      ...
      assert.areSame(
        20,
        instance._doneWeights,
        "instance._doneWeights reduced"
      );
    },
    ...
    "test _getNotificationMessage plural message even if single message defined":
      function () {
    ...
    "test _createNotification": function () {
      ...
      assert.isTrue(
        NotificationMock.returned(ret),
        "ret was returned by NotificationMock"
      );
    },
