...
(function () {
  ...
  bender.test({
    ...
    "test constructor sets default weight (0 is treated as invalid)":
      function () {
        ...
        assert.areSame(
          1,
          instance._weight,
          "Default value assigned for weight"
        );
      },
    ...
    "test subsequent update": function () {
      ...
      assert.areSame(
        50,
        instance._doneWeight,
        "Invalid value in _doneWeight after first call"
      );
      ...
      assert.areSame(
        200,
        instance._doneWeight,
        "Invalid value in _doneWeight after second call"
      );

      assert.areSame(
        0,
        instance.done.callCount,
        "instance.done was not called"
      );
    },
    ...
    "test task cannot be finished twice": function () {
      ...
      assert.isTrue(
        doneEventSpy.calledOnce,
        "Done event should be fired once."
      );
    },
    ...
    "test task cannot be cancelled twice": function () {
      ...
      assert.isTrue(
        cancelEventSpy.calledOnce,
        "Cancel event should be fired once."
      );
    },
    ...
    "test task cannot be cancelled after being finished": function () {
      ...
      assert.isFalse(
        cancelEventSpy.called,
        "Cancel event should not be fired."
      );
    },
