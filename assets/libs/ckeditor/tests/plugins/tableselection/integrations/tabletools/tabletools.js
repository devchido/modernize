...
(function () {
  ...
  var tests = {
    ...
    "test insert row before": function (editor, bot) {
      doCommandTest(bot, "rowInsertBefore", {
        case: "add-row-before",
        cells: [0],
      });
      doCommandTest(bot, "rowInsertBefore", {
        case: "add-row-before-2",
        cells: [1],
      });
      doCommandTest(bot, "rowInsertBefore", {
        case: "add-row-before-3",
        cells: [0],
      });
      doCommandTest(bot, "rowInsertBefore", {
        case: "add-row-before-multi",
        cells: [0, 1],
      });
    },

    "test insert row after": function (editor, bot) {
      doCommandTest(bot, "rowInsertAfter", {
        case: "add-row-after",
        cells: [0],
      });
      doCommandTest(bot, "rowInsertAfter", {
        case: "add-row-after-2",
        cells: [1],
      });
      doCommandTest(bot, "rowInsertAfter", {
        case: "add-row-after-3",
        cells: [0],
      });
      doCommandTest(bot, "rowInsertAfter", {
        case: "add-row-after-multi",
        cells: [0, 1],
      });
    },

    "test insert col before": function (editor, bot) {
      doCommandTest(bot, "columnInsertBefore", {
        case: "add-col-before",
        cells: [0],
      });
      doCommandTest(bot, "columnInsertBefore", {
        case: "add-col-before-2",
        cells: [1],
      });
      doCommandTest(bot, "columnInsertBefore", {
        case: "add-col-before-3",
        cells: [0],
      });
      doCommandTest(bot, "columnInsertBefore", {
        case: "add-col-before-4",
        cells: [1],
      });
      doCommandTest(bot, "columnInsertBefore", {
        case: "add-col-before-multi",
        cells: [0, 1],
      });
      doCommandTest(bot, "columnInsertBefore", {
        case: "add-col-before-multi2",
        cells: [1],
      });

      // (#591)
      doCommandTest(bot, "columnInsertBefore", {
        case: "add-col-before-vertical-split",
        cells: [3],
      });
    },

    "test insert col after": function (editor, bot) {
      doCommandTest(bot, "columnInsertAfter", {
        case: "add-col-after",
        cells: [0],
      });
      doCommandTest(bot, "columnInsertAfter", {
        case: "add-col-after-2",
        cells: [1],
      });
      doCommandTest(bot, "columnInsertAfter", {
        case: "add-col-after-3",
        cells: [0],
      });
      doCommandTest(bot, "columnInsertAfter", {
        case: "add-col-after-4",
        cells: [1],
      });
      doCommandTest(bot, "columnInsertAfter", {
        case: "add-col-after-multi",
        cells: [0, 1],
      });
    },

    "test merge cells": function (editor, bot) {
      doCommandTest(bot, "cellMerge", {
        case: "merge-cells",
        cells: [0, 1, 2, 3, 4, 5],
      });
    ...
    "test split cells": function (editor, bot) {
      ...
      doCommandTest(bot, "cellVerticalSplit", {
        case: "split-cells-4",
        cells: [1],
        skipCheckingSelection: true,
      });
    ...
    "test merge one cell": function (editor, bot) {
      doCommandTest(bot, "cellMergeRight", {
        case: "merge-cell-right",
        cells: [0],
      });
      doCommandTest(bot, "cellMergeDown", {
        case: "merge-cell-down",
        cells: [0],
      });
      doCommandTest(bot, "cellMergeDown", {
        case: "merge-cell-down-2",
        cells: [1],
      });
    },
    ...
    "test remove trailing cell": function (editor, bot) {
      doCommandTest(bot, "cellDelete", {
        case: "delete-cell-trailing",
        cells: [3],
        skipCheckingSelection: true,
      });
    },

    "test getSelectedCells restricted to the given table": function (
      editor,
      bot
    ) {
      ...
      bot.setHtmlWithSelection(
        CKEDITOR.document.getById("getSelectedCells-nested").getValue()
      );
      ...
      selectedCells = CKEDITOR.plugins.tabletools.getSelectedCells(
        editor.getSelection(),
        table
      );
    ...
    // (#tp-2217)
    "test getSelectedCells for nested table header cell": function (
      editor,
      bot
    ) {
      var editable = editor.editable(),
      ...
      bot.setHtmlWithSelection(
        CKEDITOR.document.getById("getSelectedCells-nestedHeader").getValue()
      );
      ...
      assert.isTrue(
        expectedCell.equals(selectedCells[0]),
        "Correct table cell is selected."
      );
    },
    ...
    "test getSelectedCells API": function () {
      arrayAssert.itemsAreEqual(
        [],
        CKEDITOR.plugins.tabletools.getSelectedCells(null),
        "Return for null"
      );
      ...
      arrayAssert.itemsAreEqual(
        [],
        CKEDITOR.plugins.tabletools.getSelectedCells(emptySelectionMock),
        "Ret for empty range list"
      );
    },
  ...
  tests._should.ignore["test merge one cell (collapsed selection) (classic)"] =
    shouldIgnore;
  tests._should.ignore["test merge one cell (collapsed selection) (inline)"] =
    shouldIgnore;
