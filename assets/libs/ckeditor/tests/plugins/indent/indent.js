  ...
  function createIndentOutdentTester(editor, html) {
    ...
    function assertContents(expected, msg) {
      assert[typeof expected == "string" ? "areEqual" : "isMatching"](
        ...
        bender.tools.fixHtml(
          bender.tools.getHtmlWithSelection(editor),
          true,
          true
        ),
        [modeAbbr, " | ", msg].join("") || ""
    ...
    function keystroke(editor, expected, msg, outdent) {
      editor
        ...
        .fire(
          "keydown",
          new CKEDITOR.dom.event({ keyCode: 9, shiftKey: outdent })
        );
      assertContents(expected, msg);
    }

    return {
      i: function (expected, msg) {
        // indent
        command(editor, expected, msg);
      },
      o: function (expected, msg) {
        // outdent
      ...
      s: function (indent, outdent, msg) {
        assert.areSame(
          indent,
          iCmd.state,
          msg || "(" + stateCounter + ") Indent command state"
        );
        assert.areSame(
          outdent,
          oCmd.state,
          msg || "(" + stateCounter + ") Outdent command state"
        );
  ...
  bender.test({
    ...
    "test block (cross-sel between blocks)": function () {
      createEditor("enterP", function (bot) {
        ...
        t.s(2, 0);
        t.i(
          '<p style="margin-left:10px;">xx[x</p><p style="margin-left:10px;">yy]y</p>',
          "Indent it once."
        );
        t.s(2, 2);
        t.i(
          '<p style="margin-left:20px;">xx[x</p><p style="margin-left:20px;">yy]y</p>',
          "Indent it twice."
        );
        t.s(2, 2);
        t.o(
    ...
    "test list (first li element, indent full list)": function () {
      createEditor("enterP", function (bot) {
        var t = createIndentOutdentTester(
          bot.editor,
        ...
        t.s(2, 2);
        t.i(
          '<ul style="margin-left:10px;"><li>x^</li><li>y</li></ul>',
          "Indent it once."
        );
        t.s(2, 2);
        t.i(
          '<ul style="margin-left:20px;"><li>x^</li><li>y</li></ul>',
          "Indent it twice."
        );
        t.s(2, 2);
        t.o(
        ...
        t.o(
          "<p>x^</p><ul><li>y</li></ul>",
          "Extract paragraph from list element."
        );
        t.s(2, 0);
      });
    },
    ...
    "test list (next li element, nesting lists)": function () {
      createEditor("enterP", function (bot) {
        ...
        t.i(
          ...
          "First indent is nesting."
        );
        t.s(2, 2);
        t.i(
          '<ul><li>x<ul style="margin-left:10px;"><li>y^</li></ul></li></ul>',
          "Second indent is margin."
        );
        t.s(2, 2);
        t.i(
          '<ul><li>x<ul style="margin-left:20px;"><li>y^</li></ul></li></ul>',
          "Third indent is margin."
        );
        t.s(2, 2);
        t.o(
          '<ul><li>x<ul style="margin-left:10px;"><li>y^</li></ul></li></ul>',
    ...
    "test list (nesting multiple li elements)": function () {
      createEditor("enterP", function (bot) {
        var t = createIndentOutdentTester(
          bot.editor,
          "<ul><li>x</li><li>y[y</li><li>z]z</li></ul>"
        );

        t.s(2, 2);
        t.i(
          "<ul><li>x<ul><li>y[y</li><li>z]z</li></ul></li></ul>",
          "First indent is nesting two elements."
        );
        t.s(2, 2);
        t.i(
          '<ul><li>x<ul style="margin-left:10px;"><li>y[y</li><li>z]z</li></ul></li></ul>',
          "Second indent is margin to nested list."
        );
        t.s(2, 2);
        t.o(
          "<ul><li>x<ul><li>y[y</li><li>z]z</li></ul></li></ul>",
        ...
        t.o(
          "<ul><li>x</li><li>y[y</li><li>z]z</li></ul>",
          "Outdent nesting back."
        );
        t.s(2, 2);
        t.o(
          "<ul><li>x</li></ul><p>y[y</p><p>z]z</p>",
          "Extract paragraphs from selected elements."
        );
        t.s(2, 0);
      });
    },
    ...
    "test list (cross-sel, nesting nested li elements)": function () {
      createEditor("enterP", function (bot) {
        var t = createIndentOutdentTester(
          bot.editor,
          "<ul><li>x</li><li>x[x<ol><li>y]y</li></ol></li><li>x</li></ul>"
        );

        t.s(2, 2);
        t.i(
          "<ul><li>x<ul><li>x[x<ol><li>y]y</li></ol></li></ul></li><li>x</li></ul>",
          "First indent creates 2nd level nesting."
        );
        t.s(2, 2);
        t.i(
          '<ul><li>x<ul style="margin-left:10px;"><li>x[x<ol><li>y]y</li></ol></li></ul></li><li>x</li></ul>',
        ...
        t.s(2, 2);
        t.o(
          "<ul><li>x</li></ul><p>x[x</p><ol><li>y]y</li></ol><ul><li>x</li></ul>",
          "Extract paragraphs."
        );
        t.s(2, 0);
      });
    ...
    "test list (cross-sel, selection start hooked in first li)": function () {
      createEditor("enterP", function (bot) {
        var t = createIndentOutdentTester(
          bot.editor,
          "<ul><li>x[x</li><li>xx<ol><li>y]y</li></ol></li><li>x</li></ul>"
        );

        t.s(2, 2);
        t.i(
          '<ul style="margin-left:10px;"><li>x[x</li><li>xx<ol><li>y]y</li></ol></li><li>x</li></ul>',
          "First indent increases margin."
        );
        t.s(2, 2);
        t.i(
          '<ul style="margin-left:20px;"><li>x[x</li><li>xx<ol><li>y]y</li></ol></li><li>x</li></ul>',
        ...
        t.o(
          "<ul><li>x[x</li><li>xx<ol><li>y]y</li></ol></li><li>x</li></ul>",
          "Second outdent reduces margin."
        );
        t.s(2, 2);
        t.o(
          "<p>x[x</p><p>xx</p><ol><li>y]y</li></ol><ul><li>x</li></ul>",
          "Extract paragraphs."
        );
        t.s(2, 0);
      });
    ...
    "test list (cross-sel between two li elements)": function () {
      createEditor("enterP", function (bot) {
        ...
        t.s(2, 2);
        t.i(
          '<ul style="margin-left:10px;"><li>x[x</li><li>y]y</li></ul>',
          "Indent it once."
        );
        t.s(2, 2);
        t.i(
          '<ul style="margin-left:20px;"><li>x[x</li><li>y]y</li></ul>',
          "Indent it twice."
        );
        t.s(2, 2);
        t.o(
    ...
    "test list (outer-sel#2, sel hooked in sibling blocks)": function () {
      createEditor("enterP", function (bot) {
        var t = createIndentOutdentTester(
          bot.editor,
          "<p>[x</p><ul><li>x</li><li>y</li></ul><p>x]</p>"
        );

        t.s(2, 0);
        t.i(
          '<p style="margin-left:10px;">[x</p><ul><li><p style="margin-left:10px;">x</p></li><li><p style="margin-left:10px;">y</p></li></ul><p style="margin-left:10px;">x]</p>',
          "Indent it once."
        );
        t.s(2, 2);
        t.i(
          '<p style="margin-left:20px;">[x</p><ul><li><p style="margin-left:20px;">x</p></li><li><p style="margin-left:20px;">y</p></li></ul><p style="margin-left:20px;">x]</p>',
          "Indent it twice."
        );
        t.s(2, 2);
        t.o(
        ...
        t.s(2, 2);
        t.o(
          "<p>[x</p><ul><li><p>x</p></li><li><p>y</p></li></ul><p>x]</p>",
    ...
    "test list (outer-sel#3, mixed sel block->list)": function () {
      createEditor("enterP", function (bot) {
        var t = createIndentOutdentTester(
          bot.editor,
          "<p>x[x</p><ul><li>x]</li><li>y</li></ul>"
        );

        t.s(2, 0);
        t.i(
          '<p style="margin-left:10px;">x[x</p><ul><li><p style="margin-left:10px;">x]</p></li><li>y</li></ul>',
          "Indent it once."
        );
        t.s(2, 2);
        t.i(
          '<p style="margin-left:20px;">x[x</p><ul><li><p style="margin-left:20px;">x]</p></li><li>y</li></ul>',
          "Indent it twice."
        );
        t.s(2, 2);
        t.o(
        ...
        t.s(2, 2);
        t.o(
          "<p>x[x</p><ul><li><p>x]</p></li><li>y</li></ul>",
          "Outdent it back again."
        );
        t.s(2, 0);
      });
    ...
    "test list (outer-sel#3, mixed sel list->block)": function () {
      createEditor("enterP", function (bot) {
        var t = createIndentOutdentTester(
          bot.editor,
          "<ul><li>x</li><li>[y</li></ul><p>x]x</p>"
        );

        t.s(2, 2);
        t.i(
          "<ul><li>x<ul><li>[y</li></ul></li></ul><p>x]x</p>",
          "Indent it once."
        );
        t.s(2, 2);
        t.i(
          '<ul><li>x<ul style="margin-left:10px;"><li>[y</li></ul></li></ul><p>x]x</p>',
          "Indent it twice."
        );
        t.s(2, 2);
        t.o(
    ...
    "test list (first li in nested list)": function () {
      createEditor("enterP", function (bot) {
        var t = createIndentOutdentTester(
          bot.editor,
          "<ul><li><ol><li>x^</li></ol></li><li>y</li></ul>"
        );

        t.s(2, 2);
        t.i(
          '<ul><li><ol style="margin-left:10px;"><li>x^</li></ol></li><li>y</li></ul>',
          "Indent it once."
        );
        t.s(2, 2);
        t.i(
          '<ul><li><ol style="margin-left:20px;"><li>x^</li></ol></li><li>y</li></ul>',
          "Indent it twice."
        );
        t.s(2, 2);
        t.o(
        ...
        t.s(2, 2);
        t.o(
          "<ul><li>&nbsp;</li><li>x^</li><li>y</li></ul>",
          "Collapse the inner list."
        );
        t.s(2, 2);
      });
    },
    ...
    "test list (first li in nested list, same type)": function () {
      createEditor("enterP", function (bot) {
        var t = createIndentOutdentTester(
          bot.editor,
          "<ul><li><ul><li>x^</li></ul></li><li>y</li></ul>"
        );

        t.s(2, 2);
        t.i(
          '<ul><li><ul style="margin-left:10px;"><li>x^</li></ul></li><li>y</li></ul>',
          "Indent it once."
        );
        t.s(2, 2);
        t.i(
          '<ul><li><ul style="margin-left:20px;"><li>x^</li></ul></li><li>y</li></ul>',
          "Indent it twice."
        );
        t.s(2, 2);
        t.o(
    ...
    "test list (first li in nested list, cross-sel between lists)":
      function () {
        createEditor("enterP", function (bot) {
          var t = createIndentOutdentTester(
            bot.editor,
            "<ul><li><ol><li>x[x</li></ol></li><li>y]y</li></ul>"
          );

          t.s(2, 2);
          t.i(
            '<ul><li><ol style="margin-left:10px;"><li>x[x</li></ol></li><li>y]y</li></ul>',
            "Indent it once."
          );
          t.s(2, 2);
          t.i(
            '<ul><li><ol style="margin-left:20px;"><li>x[x</li></ol></li><li>y]y</li></ul>',
            "Indent it twice."
          );
          t.s(2, 2);
          t.o(
    ...
    "test table": function () {
      createEditor("enterP", function (bot) {
        var t = createIndentOutdentTester(
          bot.editor,
          "<table><tbody><tr><td>y^</td><td></td></tr></tbody></table>"
        );

        t.s(2, 0);
        t.i(
          '<table><tbody><tr><td><p style="margin-left:10px;">y^</p></td><td>&nbsp;</td></tr></tbody></table>',
          "Indent it once."
        );
        t.s(2, 2);
        t.i(
          '<table><tbody><tr><td><p style="margin-left:20px;">y^</p></td><td>&nbsp;</td></tr></tbody></table>',
          "Indent it twice."
        );
        t.s(2, 2);
        t.o(
        ...
        t.s(2, 2);
        t.o(
          "<table><tbody><tr><td><p>y^</p></td><td>&nbsp;</td></tr></tbody></table>",
          "Outdent it back again."
        );
        t.s(2, 0);
      });
    ...
    "test table (outer-sel between sibling blocks)": function () {
      createEditor("enterP", function (bot) {
        var t = createIndentOutdentTester(
          bot.editor,
          "<p>[x</p><table><tbody><tr><td>y</td><td></td></tr></tbody></table><p>z]</p>"
        );

        t.s(2, 0);
        t.i(
          '<p style="margin-left:10px;">[x</p><table><tbody><tr><td><p style="margin-left:10px;">y</p></td>' +
            '<td style="margin-left:10px;">&nbsp;</td></tr></tbody></table><p style="margin-left:10px;">z]</p>',
          "Indent it once."
        );
        t.s(2, 2);
        t.i(
          '<p style="margin-left:20px;">[x</p><table><tbody><tr><td><p style="margin-left:20px;">y</p></td>' +
        ...
        t.s(2, 2);
        t.o(
          "<p>[x</p><table><tbody><tr><td><p>y</p></td><td>&nbsp;</td></tr></tbody></table><p>z]</p>",
          "Outdent it back again."
        );
        t.s(2, 0);
      });
    ...
    "test div (indent nested div)": function () {
      createEditor("enterP", function (bot) {
        ...
        t.s(2, 0);
        t.i(
          '<div><div style="margin-left:10px;">x^</div></div>',
          "Indent it once."
        );
        t.s(2, 2);
        t.i(
          '<div><div style="margin-left:20px;">x^</div></div>',
          "Indent it twice."
        );
        t.s(2, 2);
        t.o(
    ...
    "test div (indent nested div, cross-sel between divs)": function () {
      createEditor("enterP", function (bot) {
        var t = createIndentOutdentTester(
          bot.editor,
          "<div>x[x<div>y]y</div></div>"
        );

        t.s(2, 0);
        t.i(
          '<div><p style="margin-left:10px;">x[x</p><div style="margin-left:10px;">y]y</div></div>',
          "Indent it once."
        );
        t.s(2, 2);
        t.i(
          '<div><p style="margin-left:20px;">x[x</p><div style="margin-left:20px;">y]y</div></div>',
          "Indent it twice."
        );
        t.s(2, 2);
        t.o(
        ...
        t.s(2, 0);
        t.o(
          "<div><p>x[x</p><div>y]y</div></div>",
          "Remaining at minimum indent level."
        );
        t.s(2, 0);
      });
    },
    ...
    "test deflist": function () {
      createEditor("enterP", function (bot) {
        ...
        t.s(2, 0);
        t.i(
          '<dl style="margin-left:10px;"><dt>x^</dt><dd>y</dd></dl>',
          "Indent it once."
        );
        t.s(2, 2);
        t.i(
          '<dl style="margin-left:20px;"><dt>x^</dt><dd>y</dd></dl>',
          "Indent it twice."
        );
        t.s(2, 2);
        t.o(
    ...
    "test deflist (cross-sel)": function () {
      createEditor("enterP", function (bot) {
        var t = createIndentOutdentTester(
          bot.editor,
          "<dl><dt>x[x</dt><dd>y]y</dd></dl>"
        );

        t.s(2, 0);
        t.i(
          '<dl style="margin-left:10px;"><dt>x[x</dt><dd>y]y</dd></dl>',
          "Indent it once."
        );
        t.s(2, 2);
        t.i(
          '<dl style="margin-left:20px;"><dt>x[x</dt><dd>y]y</dd></dl>',
          "Indent it twice."
        );
        t.s(2, 2);
        t.o(
    ...
    "test indent classes - list": function () {
      createEditor("indentClasses", function (bot) {
        ...
        t.s(2, 2);
        t.i(
          '<ul><li>x<ul class="1st"><li>y^</li></ul></li></ul>',
          "Indent it again."
        );
        t.s(2, 2);
        t.i(
          '<ul><li>x<ul class="2nd"><li>y^</li></ul></li></ul>',
          "Indent it again."
        );
        t.s(0, 2);
        t.i(
    ...
    "test indent lists-only: states, indent block": function () {
      createEditor("indentList", function (bot) {
        var t = createIndentOutdentTester(
          bot.editor,
          "<p>fo^o</p><ul><li>x</li><li>y</li></ul>"
        );

        t.s(0, 0);
        t.i(
          "<p>fo^o</p><ul><li>x</li><li>y</li></ul>",
          "Cannot indent blocks."
        );
        t.s(0, 0);
      });
    },
    ...
    "test indent lists-only: states, indent block (#2)": function () {
      createEditor("indentList", function (bot) {
        ...
        t.o(
          "<p>x^</p><ul><li>y</li></ul>",
          "Collapse the list into paragraph."
        );
        t.s(0, 0);
      });
    },
    ...
    "test indent lists-only: selections, start in list, cross": function () {
      createEditor("indentList", function (bot) {
        var t = createIndentOutdentTester(
          bot.editor,
          "<p>foo</p><ul><li>[x</li><li>y]</li></ul>"
        );

        t.s(0, 2);
        t.o(
          "<p>foo</p><p>[x</p><p>y]</p>",
          "Collapse list when cross-selection."
        );
        t.s(0, 0);
      });
    },
    ...
    "test indent lists-only: selections, start in list element": function () {
      createEditor("indentList", function (bot) {
        var t = createIndentOutdentTester(
          bot.editor,
          "<ul><li>x</li><li>[y</li></ul><p>fo]o</p>"
        );

        t.s(2, 2, "Can indent and outdent since path is in list.");
        t.i(
          "<ul><li>x<ul><li>[y</li></ul></li></ul><p>fo]o</p>",
          "Indent list once."
        );
        ...
        t.s(2, 2, "Can indent and outdent since path is in list.");
        t.o(
          "<ul><li>x</li></ul><p>[y</p><p>fo]o</p>",
          "Outdented and collapsed list element."
        );
        t.s(0, 0);
      });
    },
    ...
    "test indent lists-only: margins": function () {
      createEditor("indentList", function (bot) {
        ...
        t.s(2, 2);
        t.i(
          '<ul style="margin-left:10px;"><li>x<ul><li>^y</li></ul></li></ul>',
          "Indent list once. Don't touch list margin."
        );
        t.s(0, 2);
        t.o(
          '<ul style="margin-left:10px;"><li>x</li><li>^y</li></ul>',
          "Outdent nested list. Don't touch parents list margin."
        );
        t.s(2, 2);
        t.o(
          '<ul style="margin-left:10px;"><li>x</li></ul><p>^y</p>',
          "Collapse list despite of margin if not first element."
        );
        t.s(0, 0);
      });
    },
    ...
    "test indent block-only: paragraph": function () {
      createEditor("indentBlock", function (bot) {
        ...
        t.s(2, 0);
        t.i(
          '<p style="margin-left:10px;">fo[o</p><ul><li><p style="margin-left:10px;">x]</p></li><li>y</li></ul>',
          "Create indented paragraphs."
        );
        t.s(2, 2);
        t.o(
          "<p>fo[o</p><ul><li><p>x]</p></li><li>y</li></ul>",
          "Outdent paragraphs."
        );
        t.s(2, 0);
      });
    ...
    "test ENTER_BR": function () {
      createEditor("enterBR", function (bot) {
        ...
        t.s(2, 0);
        t.i(
          '<div style="margin-left:10px;">f^oo</div>',
          "Indent entire block."
        );
        t.s(2, 2);
        t.i(
          '<div style="margin-left:20px;">f^oo</div>',
          "Indent entire block twice."
        );
        t.s(2, 2);
        t.o(
          '<div style="margin-left:10px;">f^oo</div>',
          "Outdent entire block."
        );
        t.s(2, 2);
    ...
    "test undo manager": function () {
      createEditor("enterP", function (bot) {
        ...
        t.r(
          '<ul><li>x<ul style="margin-left:10px;"><li>y^</li></ul></li></ul>',
          "Redo - nothing more can be redone."
        );
      });
    },
    ...
    "test indent next to inline non-editable": function () {
      ...
      createEditor("enterP", function (bot) {
        var t1 = createIndentOutdentTester(
          bot.editor,
          '<p><span contenteditable="false">xxx</span>^</p>'
        );

        t1.s(2, 0);
        t1.i(
          '<p style="margin-left:10px;"><span contenteditable="false">xxx</span>^</p>',
          "Indent it once."
        );
        t1.s(2, 2);

        var t2 = createIndentOutdentTester(
          bot.editor,
          '<p>a<span contenteditable="false">bb</span>c^</p>'
        );

        t2.s(2, 0);
        t2.i(
          '<p style="margin-left:10px;">a<span contenteditable="false">bb</span>c^</p>',
          "Indent it once."
        );
        t2.s(2, 2);
