...
addTests("test outdent on list item with direction", "outdent", [
  ['<ul dir="rtl"><li><p>^foo</p></li></ul>', '<p dir="rtl">foo</p>'],
...
addTests(
  "test decrease nest list keeps inline style on list element",
  "outdent",
  [
    [
...
addTests(
  "test indent add margin to the whole list when items are not wrapped in paragraph and caret is in the first one",
  "indent",
  [
    [
...
addTests(
  "test indent nests list item when items are not wrapped in paragraph and caret is in the second one",
  "indent",
  [
    [
...
addTests(
  "test indent add margin to the whole list when items are wrapped in paragraph and caret is in the first one",
  "indent",
  [
    [
...
addTests(
  "test indent nest list item when items are wrapped in paragraph and caret is in the second one",
  "indent",
  [
    [
