...
(function () {
  ...
  bender.test({
    "test setdata with font tag with face": function () {
      ...
      bot.setData(
        '<p><font face="Courier New, Courier, monospace">foo bar baz</font></p>',
        function () {
    ...
    "test apply font tag with face": function () {
      ...
      richComboTools.assertCombo({
        ...
        bot: bot,
        resultHtml:
          '<p><font face="Courier New, Courier, monospace">foo</font>@</p>',
      });
    },
    ...
    "test change font tag with face": function () {
      ...
      bender.tools.selection.setWithHtml(
        editor,
        '<p><font face="Arial, Helvetica, sans-serif">[foo]</font></p>'
      );
      richComboTools.assertCombo({
        comboName: "Font",
        comboValue: "Courier New",
    ...
    "test apply font tag with face in nested html": function () {
      ...
      bender.tools.selection.setWithHtml(
        editor,
        "<p><strong>[fo<em>o] bar</em> baz</strong></p>"
      );
      richComboTools.assertCombo({
        comboName: "Font",
        comboValue: "Courier New",
    ...
    "test setdata with font tag with size": function () {
      ...
      bot.setData('<p><font size="7">foo bar baz</font></p>', function () {
        assert.beautified.html(
          '<p><font size="7">foo bar baz</font></p>',
          editor.getData()
        );
      });
    },
