  ...
  bender.test({
    ...
    "test apply font size (collapsed selection)": function () {
      ...
      bot.combo("FontSize", function (combo) {
        ...
        assert.isInnerHtmlMatching(
          '<p><span style="font-size:48px">foo</span>@</p>',
        ...
        this.wait(function () {
          ...
          bot.combo("FontSize", function (combo) {
            ...
            this.wait(function () {
              ...
              assert.isInnerHtmlMatching(
                '<p><span style="font-size:48px">foo</span>bar@</p>',
                editor.editable().getHtml(),
                htmlMatchingOpts
              );
            }, 0);
    ...
    "test apply font size over another font size (collapsed selection)":
      function () {
        var bot = this.editorBot;

        bender.tools.selection.setWithHtml(
          bot.editor,
          '<p>x<span style="font-size:48px">f{}oo</span>x</p>'
        );
        this.assertCombo(
          "FontSize",
          24,
    ...
    "test apply font size over another font size (collapsed selection in empty span)":
      function () {
        ...
        bender.tools.selection.setWithHtml(
          bot.editor,
          '<p>x<span style="font-size:48px"><em>[]</em></span>x</p>'
        );
        this.assertCombo(
          "FontSize",
          24,
          ...
          function (bot) {
            assert.areSame(
              1,
              bot.editor.editable().find("span").count(),
    ...
    "test apply font size over another font size (collapsed selection at the existing span boundary)":
      function () {
        var bot = this.editorBot;

        bender.tools.selection.setWithHtml(
          bot.editor,
          '<p>x<span style="font-size:48px">{}foo</span>x</p>'
        );
        this.assertCombo(
          "FontSize",
          24,
    ...
    "test apply font size over another font size (text selection)":
      function () {
        var bot = this.editorBot;

        bender.tools.selection.setWithHtml(
          bot.editor,
          '<p>x<span style="font-size:48px">f{o}o</span>x</p>'
        );
        this.assertCombo(
          "FontSize",
          24,
    ...
    "test apply font size over another font size (the existing span selection)":
      function () {
        var bot = this.editorBot;
    ...
    "test apply font size over another font size (selection containing other span)":
      function () {
        var bot = this.editorBot;

        bender.tools.selection.setWithHtml(
          bot.editor,
          '<p>x{f<span style="font-size:48px">o</span>o}x</p>'
        );
        this.assertCombo(
          "FontSize",
          24,
    ...
    "test apply font size over another font size (deeply nested text selection)":
      function () {
        var bot = this.editorBot;

        bender.tools.selection.setWithHtml(
          bot.editor,
          '<p>x<span style="font-size:48px"><em>f{o}o</em></span>x</p>'
        );
        this.assertCombo(
          "FontSize",
          24,
    ...
    "test apply font size over another font size (deeply nested collapsed selection)":
      function () {
        ...
        bender.tools.selection.setWithHtml(
          bot.editor,
          '<p>x<span style="font-size:48px"><em>f<u class="y">{}o</u>o</em></span>x</p>'
        );
        this.assertCombo(
          "FontSize",
          24,
    ...
    "test apply font size over font family (check possible false positive match)":
      function () {
        var bot = this.editorBot;

        bender.tools.selection.setWithHtml(
          bot.editor,
          '<p>x<span style="' + ffArial + '">f{o}o</span>x</p>'
        );
        this.assertCombo(
          "FontSize",
          24,
          ...
          '<p>x<span style="' +
            ffArial +
            '">f<span style="font-size:24px">o</span>o</span>x@</p>'
        );
      },

    "test apply font family over another font family (text selection)":
      function () {
        var bot = this.editorBot;
    ...
    "test reapply font family on the beginning (collapsed selection)":
      function () {
        if (CKEDITOR.env.safari) {
          assert.ignore();
        }
        ...
        bender.tools.selection.setWithHtml(
          bot.editor,
          '<p>x<span style="' + ffArial + '"><em>{}foo</em></span>x</p>'
        );
        this.assertCombo(
          "Font",
          "Comic Sans MS",
          ...
          '<p>x<em><span style="' +
            ffCS +
            '">bar</span></em><span style="' +
            ffArial +
            '"><em>foo</em></span>x@</p>'
        );
      },

    "test reapply font family in the middle (collapsed selection)":
      function () {
        var bot = this.editorBot;

        bender.tools.selection.setWithHtml(
          bot.editor,
          '<p>x<span style="' + ffArial + '"><em>fo{}o</em></span>x</p>'
        );
        this.assertCombo(
          "Font",
          "Comic Sans MS",
    ...
    "test reapply font size on the end (collapsed selection)": function () {
      ...
      bender.tools.selection.setWithHtml(
        bot.editor,
        '<p>x<span style="font-size:12px"><em>foo{}</em></span>x</p>'
      );
      this.assertCombo(
        "FontSize",
        24,
    ...
    "test remove font size from text": function () {
      ...
      bender.tools.selection.setWithHtml(
        bot.editor,
        '<p><span style="font-size:12px">[foo]</span></p>'
      );
    ...
    "test remove font family from text": function () {
      ...
      bender.tools.selection.setWithHtml(
        bot.editor,
        '<p><span style="' + ffArial + '">[foo]</span></p>'
      );
    ...
    "test remove font size partialy from text": function () {
      ...
      bender.tools.selection.setWithHtml(
        bot.editor,
        '<p><span style="font-size:24px">[foo ]bar</span></p>'
      );
      this.assertCombo(
        "FontSize",
        "cke-default",
        false,
        bot,
        '<p>foo <span style="font-size:24px">bar</span>@</p>'
      );
    },
    ...
    "test remove font family partially from text": function () {
      ...
      bender.tools.selection.setWithHtml(
        bot.editor,
        '<p><span style="' + ffArial + '">[foo ]bar</span></p>'
      );
      this.assertCombo(
        "Font",
        "cke-default",
        false,
        bot,
        '<p>foo <span style="' + ffArial + '">bar</span>@</p>'
      );
    },
    ...
    // (#1040)
    "test apply new style to entire selection if partially present":
      function () {
        var bot = this.editorBot;
        bender.tools.selection.setWithHtml(
          bot.editor,
          '<h1><span style="' + ffCourierNew + '">[Hello</span> world!]</h1>'
        );
    ...
    // (#1040)
    "test if styles are not changed if applied second time on the part of already styled element":
      function () {
        var bot = this.editorBot;
        bender.tools.selection.setWithHtml(
          bot.editor,
          '<h1><span style="' + ffCourierNew + '">[Hel]lo</span> world!</h1>'
        );
