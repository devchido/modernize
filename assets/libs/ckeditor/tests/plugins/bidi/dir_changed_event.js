  ...
  window.frameLoaded = function () {
    bender.test({
      ...
      test_dirChanged_event: function () {
        var target = this.doc.getById("p1"),
          changed;
      ...
      test_dirChanged_event_2: function () {
        var target = this.doc.getById("p2"),
          changed;
        this.doc.on("dirChanged", function () {
          changed = true;
        });
      ...
      test_dirChanged_event_3: function () {
        var target = this.doc.getById("p3"),
          changed;
        this.doc.on("dirChanged", function () {
          changed = true;
        });
      ...
      test_dirChanged_event_4: function () {
        var target = this.doc.getById("p4"),
          changed;
        this.doc.on("dirChanged", function () {
          changed = true;
        });
      ...
      test_dirChanged_event_5: function () {
        var target = this.doc.getById("p5"),
          changed;
        this.doc.on("dirChanged", function () {
          changed = true;
        });
      ...
      test_dirChanged_event_6: function () {
        var target = this.doc.getById("p6"),
          changed;
        this.doc.on("dirChanged", function () {
          changed = true;
        });
