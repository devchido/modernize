  ...
  bender.test({
    ...
    "test selectionChange with options.refresh": function () {
      ...
      this.editorBot.setHtmlWithSelection(
        "<p>Test^ <strong>Foo</strong><em>bar</em></p>"
      );
        ...
        function () {
          resume(function () {
            contextTools._assertToolbarVisible(
              false,
              context,
              "Toolbar visibility after blurring the editor"
            );
          });
        },
        this,
        ...
        resume(function () {
          ...
          try {
            contextTools._assertToolbarVisible(
              false,
              context,
              "Toolbar visibility after switching to source area"
            );
          } catch (e) {
    ...
    "test correct highlighted element after overriding refresh": function () {
      ...
      this.editorBot.setHtmlWithSelection(
        "<p><em>foo<strong>b^ar</strong>baz</em></p>"
      );
    ...
    "test correct highlighted with refresh after widget was matched":
      function () {
        this.editorBot.setHtmlWithSelection(
          "<p><em>foo<strong>b^ar</strong>baz</em</p>"
        );
        ...
        sinon
          .stub(widgetContext, "_matchWidget")
          .returns(this.editor.editable().findOne("em"));
