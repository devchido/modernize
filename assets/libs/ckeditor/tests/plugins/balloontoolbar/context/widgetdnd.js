...
(function () {
  ...
  bender.test({
    ...
    "test balloontoolbar visibility and command state after drop - inline widget":
      function () {
        var editor = this.editor,
          context = getContextStub(
            editor,
            ["testwidget"],
            "testcommandButton,buttonWithoutCommand"
          );

        assert.areSame(
          CKEDITOR.TRISTATE_DISABLED,
          editor.getCommand("testcommand").state,
          "command is disabled"
        );
    ...
    "test balloontoolbar visibility and command state after drop - block widget":
      function () {
        var editor = this.editor,
          context = getContextStub(
            editor,
          ...
          function () {
            ...
            try {
              ...
              editor.document.fire(
                "mouseup",
                new CKEDITOR.dom.event({ target: img })
              );
