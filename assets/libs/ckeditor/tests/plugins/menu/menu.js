  ...
  bender.test({
    "test menu item class names": function () {
      this.editorBot.menu("custom_menubutton", function (menu) {
        ...
        assert.isTrue(
          menuItemEl.hasClass("cke_menubutton"),
          "check ui type class name"
        );
        assert.isTrue(
          menuItemEl.hasClass("cke_menubutton__custom_menuitem"),
          "check named ui type class name"
        );
        assert.isTrue(
          menuItemEl.hasClass(customCls),
          "check ui item custom class name"
        );
      });
    },
  });
