    ...
    bender.editorBot.create(
      ...
      function (bot) {
        var btn = bot.editor.ui.get(btnName),
          ...
          btnCss = CKEDITOR.tools.parseCssText(
            btnEl.findOne(".cke_button_icon").getAttribute("style"),
            true
          );
        ...
        if (iconPath === undefined) {
          ...
          if (isDev) {
            ...
            iconPath = CKEDITOR.env.hidpi
              ? /plugins\/icons_hidpi\.png/gi
              : /plugins\/icons\.png/gi;
          }
        }
