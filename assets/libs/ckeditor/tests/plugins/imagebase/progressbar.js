  ...
  var ProgressBar,
    ...
    tests = {
      ...
      "test constructor creates proper elements": function () {
        ...
        assert.areSame(
          this.sandbox.findOne(".cke_loader"),
          ret.wrapper,
          "ret.wrapper"
        );
        ...
        assert.beautified.html(
          doc.getById("expected-create-from-element").getHtml(),
          this.sandbox.getHtml()
        );
      },
      ...
      "test update()": function () {
        ...
        CKEDITOR.tools.array.forEach(values, function (assertSet) {
          ...
          assert.areSame(
            assertSet[1],
            ret.bar.getStyle("width", assertSet[0]),
            "Width for " + assertSet[0]
          );
        });
      },
      ...
      "test bindLoader() abort event removes listeners": function () {
        ...
        assert.areSame(
          1,
          this.dummyProgress.aborted.callCount,
          "Aborted call count"
        );
      ...
      "test bindLoader() update event is throttled": function () {
        ...
        assert.areSame(
          1,
          this.dummyProgress.updated.callCount,
          "Updated call count"
        );
      },
      ...
      "test bindLoader() error event removes listeners": function () {
        ...
        assert.areSame(
          1,
          this.dummyProgress.failed.callCount,
          "Failed call count"
        );
      },
