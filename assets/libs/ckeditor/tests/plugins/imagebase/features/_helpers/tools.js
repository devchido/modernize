        ...
        function (evt) {
          ...
          setTimeout(function () {
            ...
            function wrappedCallback(uploadEvt) {
              ...
              // resume calls).
              if (listeners.length) {
                listeners = CKEDITOR.tools.array.filter(
                  listeners,
                  function (curListener) {
              ...
              resume(function () {
                callback(
                  bender.tools.objToArray(editor.widgets.instances),
                  evt,
                  uploadEvt
                );
              });
      ...
      getProgressCircleType: function (editor, ProgressReporter) {
        ...
        function ProgressCircle() {
          var svgSize = CIRCLE_PROGRESS_SIZE * 2 + CIRCLE_THICKNESS,
            ...
            htmlTemplate = new CKEDITOR.template(
              '<div class="cont" data-pct="0">' +
