...
(function () {
  ...
  bender.test({
    ...
    "test baseWidget functions remain called": function () {
      ...
      assert.areSame(
        1,
        inputDefinition.init.callCount,
        "inputDefinition.init call count"
      );
      assert.areSame(
        1,
        inputDefinition.data.callCount,
        "inputDefinition.data call count"
      );
      assert.areSame(
        1,
        dummyFeature.init.callCount,
        "dummyFeature.init call count"
      );
      assert.areSame(
        1,
        dummyFeature.data.callCount,
        "dummyFeature.data call count"
      );
    ...
    "test feature.setUp parameters": function () {
      ...
      assert.isTrue(
        spy.calledWithExactly(editor, widgetDefinition),
    ...
    "test widgetDefinition.features stacking": function () {
      ...
      var outputDefinition = plugin.addFeature(
        this.editor,
        "foo",
        inputDefinition
      );
