  ...
  bender.test({
      ...
      bot.dialog("testAdvTab", function (dialog) {
        ...
        assert.isTrue(
          style == "border-width:2px;width:300px;" ||
            style ==
              "border-bottom-width:2px;border-left-width:2px;border-right-width:2px;border-top-width:2px;width:300px;",
          style
        );
        ...
        assert.isTrue(
          style == "border:1px solid red;width:300px;" ||
            ...
            style ==
              "border-bottom:red 1px;border-left:red 1px;border-right:red 1px;border-top:red 1px;width:300px;" ||
            style ==
              "border-bottom:red 1px solid;border-left:red 1px solid;border-right:red 1px solid;border-top:red 1px solid;width:300px;" ||
            style ==
              "border-bottom-color:red;border-bottom-width:1px;border-left-color:red;border-left-width:1px;border-right-color:red;border-right-width:1px;" +
                "border-style:initial;border-top-color:red;border-top-width:1px;width:300px;" ||
            style ==
              "border-bottom-color:red;border-bottom-style:solid;border-bottom-width:1px;border-left-color:red;border-left-style:solid;" +
    ...
    "test adding two subsequent id changes": function () {
      ...
      bot.dialog("link", function (dialog) {
        ...
        assert.beautified.html(
          '<p><a href="http://a" id="aa">aaa</a> <strong>bbb</strong></p>',
          bot.getData(true)
        );

        editor
          .getSelection()
          .selectElement(editor.editable().findOne("strong"));
        ...
        bot.dialog("link", function (dialog) {
          ...
          assert.beautified.html(
            '<p><a href="http://a" id="aa">aaa</a> <a href="http://b" id="bb"><strong>bbb</strong></a></p>',
            bot.getData(true)
          );
        });
      });
    ...
    "test editing two subsequent id changes": function () {
      ...
      this.editorBot.setHtmlWithSelection(
        '<p>[<a href="a">aaa</a>] <a href="b">bbb</a></p>'
      );
      ...
      bot.dialog("link", function (dialog) {
        ...
        assert.beautified.html(
          '<p><a href="a" id="aa">aaa</a> <a href="b">bbb</a></p>',
          bot.getData(true)
        );

        editor
          .getSelection()
          .selectElement(editor.editable().findOne('a[href="b"]'));
        ...
        bot.dialog("link", function (dialog) {
          ...
          assert.beautified.html(
            '<p><a href="a" id="aa">aaa</a> <a href="b" id="bb">bbb</a></p>',
            bot.getData(true)
          );
        });
      });
