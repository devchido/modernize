...
(function () {
  ...
  bender.test({
    "test CKEDITOR.ui.dialog.radio wai-aria role=radiogroup": function () {
      ...
      new CKEDITOR.ui.dialog.radio(
        this.getDialogMockup(),
        this.getMockupRadioDefinition(),
        htmlList
      );
      ...
      assert.areSame(
        ...
        'Role "radiogroup" for set for the container'
      );
    },
    ...
    "test CKEDITOR.ui.dialog.labeledElement wai-aria role": function () {
      ...
      assert.areSame(
        "presentation",
        labeled.getAttribute("role"),
        'Role "presentation" set for labeled content'
      );
    },
