...
bender.editors = {
  editor1: {
    ...
    allowedForTests:
      "li{margin-right}[type]; ul[lang]; ol{font-size}; dl dt dd",
  },
  editor2: {
    config: {
      enterMode: CKEDITOR.ENTER_P,
...
bender.test({
  ...
  "test apply list ( with justify style)": function () {
    ...
    bot.setHtmlWithSelection(
      '<p>[foo</p><p style="text-align:center;">bar</p><p style="text-align:right;">baz]</p>'
    );
    bot.execCommand("numberedlist");
    assert.areSame(
      '<ol><li>foo</li><li style="text-align:center;">bar</li><li style="text-align:right;">baz</li></ol>',
      bot.getData(true)
    );
    bot.execCommand("bulletedlist");
    assert.areSame(
      '<ul><li>foo</li><li style="text-align:center;">bar</li><li style="text-align:right;">baz</li></ul>',
      bot.getData(true)
    );
    bot.execCommand("bulletedlist");
    assert.areSame(
  ...
  "test apply list (with text direction)": function () {
    ...
    bot.setHtmlWithSelection(
      '[<p dir="rtl">foo</p><p dir="rtl">bar</p><p dir="rtl">baz</p>]'
    );
    bot.execCommand("numberedlist");
    assert.areSame(
      '<ol dir="rtl"><li>foo</li><li>bar</li><li>baz</li></ol>',
      bot.getData(true)
    );
    bot.execCommand("bulletedlist");
    assert.areSame(
      '<ul dir="rtl"><li>foo</li><li>bar</li><li>baz</li></ul>',
      bot.getData(true)
    );
    bot.execCommand("bulletedlist");
    assert.areSame(
  ...
  "test apply list (with block styles)": function () {
    var bot = this.editorBots.editor1;
    bot.setHtmlWithSelection(
      '[<p dir="rtl">Item 1</p><p dir="rtl" style="margin-right: 40px;">Item 2</p><p dir="rtl" style="margin-right: 80px;">Item 3</p>]'
    );
    bot.execCommand("bulletedlist");
    assert.areSame(
      '<ul dir="rtl"><li>item 1</li><li style="margin-right:40px;">item 2</li><li style="margin-right:80px;">item 3</li></ul>',
      bot.getData(true)
    );
  },
  ...
  "test remove list (inside table)": function () {
    var bot = this.editorBots.editor1;
    bot.setHtmlWithSelection(
      "<table><tr><td><ol><li>[item 1</li><li>item 2]</li></ol></td></tr></table>"
    );
    bot.execCommand("numberedlist");
    assert.areSame(
      "<table><tbody><tr><td><p>item 1</p><p>item 2</p></td></tr></tbody></table>",
      bot.getData(false, true)
    );
  },
  ...
  "test create list with merge": function () {
    ...
    bot.execCommand("bulletedlist");
    assert.areSame(
      "<ul><li>bullet line 1</li><li>bullet line 2</li><li>second line</li></ul>",
      bot.getData(1)
    );
  },
  ...
  "test switch list type (with custom bullet)": function () {
    var bot = this.editorBots.editor2;
    bot.setHtmlWithSelection(
      '<ol><li type="square">[item1</li><li type="square">item2</li><li type="square">item3]</li></ol> '
    );
    bot.execCommand("bulletedlist");
    assert.areSame(
      '<ul><li type="square">item1</li><li type="square">item2</li><li type="square">item3</li></ul>',
      bot.getData(1)
    );
  },
  ...
  "test switch list type keeps text direction": function () {
    var bot = this.editorBots.editor2;
    bot.setHtmlWithSelection(
      '[<ol dir="rtl" lang="en"><li>line 1</li><li>line 2</li></ol>]'
    );
    bot.execCommand("bulletedlist");
    assert.areSame(
      '<ul dir="rtl" lang="en"><li>line 1</li><li>line 2</li></ul>',
      bot.getData(true)
    );
  },
  ...
  "test change list type keep styles on sub list": function () {
    ...
    bot.setHtmlWithSelection(
      '[<ul style="font-size:16px;"><li>foo<ul style="font-size:22px;"><li>bar</li></ul></li></ul>]'
    );
    bot.execCommand("numberedlist");
    assert.areSame(
      '<ol style="font-size:16px;"><li>foo<ol style="font-size:22px;"><li>bar</li></ol></li></ol>',
      bot.getData(true)
    );
  },
  ...
  "test create list with merge below (with direction)": function () {
    ...
    bot.execCommand("numberedlist");
    assert.areSame(
      '<ol dir="rtl"><li dir="ltr">ltr</li><li>rtl</li></ol>',
      bot.getData(false, true)
    );
    ...
    bot.execCommand("numberedlist");
    assert.areSame(
      '<ol><li dir="rtl">rtl</li><li>ltr</li></ol>',
      bot.getData(false, true)
    );
  },
  ...
  "test create list with merge above (with direction)": function () {
    ...
    bot.execCommand("numberedlist");
    assert.areSame(
      '<ol dir="rtl"><li>rtl</li><li dir="ltr">ltr</li></ol>',
      bot.getData(false, true)
    );
    ...
    // LTR
    bot.setHtmlWithSelection(
      '<ol dir="rtl"><li>rtl</li></ol><p dir="ltr">^ltr</p>'
    );
    bot.execCommand("numberedlist");
    assert.areSame(
      '<ol dir="rtl"><li>rtl</li><li dir="ltr">ltr</li></ol>',
  ...
  "test single list type active inside of nested list": function () {
    ...
    var nList = ed.getCommand("numberedlist"),
      bList = ed.getCommand("bulletedlist");
    assert.areSame(
      CKEDITOR.TRISTATE_OFF,
      nList.state,
      "check numbered list inactive"
    );
    assert.areSame(
      CKEDITOR.TRISTATE_ON,
      bList.state,
      "check bulleted list active"
    );
  },
  ...
  "test inactive when list is out of block limit": function () {
    var bot = this.editorBots.editor2,
      ed = bot.editor;
    bot.setHtmlWithSelection(
      "<ul><li><table><tr><td>^foo</td></tr></table></li></ul>"
    );
  ...
  "test sublist order after removing higher order sublist": function () {
    ...
    bot.setHtmlWithSelection(
      "<ol><li>test<ol><li>^<ol><li>a</li><li>b</li><li>c</li></ol></li></ol></li></ol>"
    );
    editor.fire("key", {
    ...
    assert.areSame(
      "<ol><li>test<ol><li>a</li><li>b</li><li>c</li></ol></li></ol>",
