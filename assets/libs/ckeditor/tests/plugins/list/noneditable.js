...
(function () {
  ...
  bender.test({
    "test applying list to selection containing non-editable inline elements":
      function () {
    ...
    "test removing list from a selection containing non-editable inline elements":
      function () {
        var editor = this.editor;
    ...
    "test applying list to a non-editable div": function () {
      ...
      bot.setData(
        '<p>x</p><div contenteditable="false" id="f"><div>foo</div></div><p>x</p>',
        function () {
          editor.getSelection().fake(editor.document.getById("f"));

          editor.execCommand("numberedlist");
          assert.areSame(
            '<p>x</p><ol><li><div contenteditable="false" id="f"><div>foo</div></div></li></ol><p>x</p>',
    ...
    "test applying list to a non-editable blocks, standard selection":
      function () {
        var editor = this.editor;
    ...
    "test removing list from a non-editable blocks, standard selection":
      function () {
        var editor = this.editor;
