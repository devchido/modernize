    ...
    bender.tools.testInputOut(
      ...
      function (source, expected) {
        ...
        assert.isInnerHtmlMatching(
          ...
          bender.tools.selection.getWithHtml(bot.editor),
          {
...
addTests(
  "test backspace join list items",
  "join_list15",
  BACKSPACE,
  undefined,
  assertNotNestedAnchors
);
addTests(
  "test backspace join list items",
  "join_list16",
...
addTests(
  "test backspace join list items - CTRL",
  "join_list1",
  BACKSPACE,
  CKEDITOR.CTRL
);
addTests(
  "test backspace outdent list item - SHIFT",
  "outdent_list",
  BACKSPACE,
  CKEDITOR.SHIFT
);
addTests(
  "test del join list items - CTRL",
  "join_list1_del",
  DEL,
  CKEDITOR.CTRL
);
addTests(
  "test del join with next list item - SHIFT",
  "merge_next_list",
  DEL,
  CKEDITOR.SHIFT
);
