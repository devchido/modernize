...
(function () {
  ...
  var originalGetClientRect = CKEDITOR.dom.element.prototype.getClientRect,
    widgetHtml =
      '<figure class="easyimage easyimage-full"><img src="../image2/_assets/foo.png" alt="foo"><figcaption>Test image</figcaption></figure>',
    tests = {
      setUp: function () {
        ...
        bot.setData(widgetHtml, function () {
          ...
          editor.once("dialogShow", function (evt) {
            resume(function () {
              ...
              assert.areSame(
                "bar",
                editor.editable().findOne("img").getAttribute("alt"),
      ...
      "test easyimageFull and easyimageSide commands": function (editor, bot) {
        bot.setData(widgetHtml, function () {
          ...
          assert.isFalse(
            ...
            "Image does not have side class"
          );
          assert.isTrue(
            widget.hasClass("easyimage"),
            "Widget wrapper has main class"
          );
          assert.isFalse(
            widget.hasClass("easyimage-side"),
