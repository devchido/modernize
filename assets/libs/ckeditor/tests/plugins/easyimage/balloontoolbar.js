...
(function () {
  ...
  function getExpectedYOffset(widget) {
    var editor = widget.editor,
      ...
      ret =
        wrapperPosition.y + wrapperRect.height + toolbar._view.triangleHeight;
  ...
  var testSuiteIframe = CKEDITOR.document.getWindow().getFrame(),
    ...
    tests = {
      ...
      "test balloontoolbar integration": function (editor, bot) {
        var widgetHtml =
          '<figure class="image easyimage"><img src="../image2/_assets/foo.png" alt="foo"><figcaption>Test image</figcaption></figure>';
      ...
      "test balloontoolbar positioning": function (editor, bot) {
        ...
        editor.container
          .getWindow()
          .$.scroll(0, editor.container.getDocumentPosition().y);

        var source =
          '<figure class="image easyimage"><img src="../image2/_assets/bar.png" alt="foo"><figcaption></figcaption></figure>';
            ...
            setTimeout(function () {
              ...
              setTimeout(function () {
                resume(function () {
                  ...
                  if (
                    (CKEDITOR.env.ie && CKEDITOR.env.ie <= 11) ||
                    CKEDITOR.env.iOS
                  ) {
