  ...
  var assertPasteFiles = imageBaseFeaturesTools.assertPasteFiles,
    tests = {
      init: function () {
        ...
        this.editor.widgets.registered.easyimage.loaderType =
          AsyncSuccessFileLoader;
        ...
        editor.once("afterPaste", function () {
          resume(function () {
            ...
            assert.areSame(
              ...
              widgets[0].parts.image.getAttribute("src"),
              "Image src attribute"
            );

            assert.beautified.html(
              CKEDITOR.document.getById("expected-image-base64").getHtml(),
              editor.getData(),
              "Editor data"
            );

            this.listeners.push(
              widgets[0].once("uploadDone", function () {
                resume(function () {
                  assert.areSame(
                    "%BASE_PATH%/_assets/logo.png",
                    widgets[0].parts.image.getAttribute("src"),
                    "Image src after load"
                  );
                });
              })
            );
        ...
        editor.once("afterPaste", function () {
          resume(function () {
            ...
            assert.areSame(
              bender.tools.pngBase64,
              widgets[0].parts.image.getAttribute("src"),
              "Image 0 src attribute"
            );

            assert.areSame("easyimage", widgets[1].name, "Widget 1 type");
            assert.areSame(
              bender.tools.pngBase64,
              widgets[1].parts.image.getAttribute("src"),
              "Image 1 src attribute"
            );
            assert.beautified.html(
              CKEDITOR.document
                .getById("expected-multiple-image-base64")
                .getHtml(),
              editor.getData(),
              "Editor data"
            );
      ...
      "test uploaded image has correct focus": function () {
              ...
              widget.once("uploadDone", function () {
                resume(function () {
                  assert.areSame(
                    ...
                    "Focus should remain on editor frame"
                  );
        ...
        pasteFiles(editor, [bender.tools.getTestPngFile()], null, {
          type: "auto",
          method: "paste",
        });
      ...
      "test pasting mixed HTML content": function () {
        ...
        editor.once("afterPaste", function () {
          resume(function () {
            ...
            assert.beautified.html(
              CKEDITOR.document.getById("expected-mixed-content").getHtml(),
              editor.getData(),
              "Editor data"
            );
          });
        ...
        pasteFiles(
          editor,
          [],
          '<p>first<img src="' + bender.tools.pngBase64 + '">last</p>',
          {
            type: "auto",
            method: "paste",
          }
      ...
      "test pasting mixed HTML content image inline": function () {
        ...
        editor.once("afterPaste", function () {
          resume(function () {
            ...
            assert.beautified.html(
              CKEDITOR.document
                .getById("expected-mixed-content-inline-img")
                .getHtml(),
              editor.getData(),
              "Editor data"
            );
        ...
        pasteFiles(
          editor,
          [],
          '<p>Imagine its a cool <img src="' +
            bender.tools.pngBase64 +
            '"> emoji!</p><p>It should work.</p>',
          { type: "auto", method: "paste" }
        );
        wait();
      },
      ...
      "test downcast does not include progress bar": function () {
        ...
        this.sandbox
          ...
          .returns("%BASE_PATH%_assets/logo.png");
        ...
        assertPasteFiles(editor, {
          ...
          callback: function () {
            assert.beautified.html(
              CKEDITOR.document
                .getById("expected-progress-bar-downcast")
                .getHtml(),
              editor.getData()
            );
          },
      ...
      "test nothing explodes when upload finishes in a different mode":
        function () {
            ...
            callback: function (widgets) {
              ...
              editor.setMode("source", function () {
                ...
                disposableListeners.push(
                  editor.uploadRepository.loaders[0].on(
                    "uploaded",
                    function () {
            ...
            callback: function () {
              ...
              assertPasteEvent(
                ...
                function () {
                  ...
                  assert.areSame(
                    "%BASE_PATH%/_assets/logo.png",
                    widgets[keys[0]].parts.image.getAttribute("src"),
                    "Widget#0 src"
                  );
                  assert.areSame(
                    "%BASE_PATH%/_assets/logo.png",
                    widgets[keys[1]].parts.image.getAttribute("src"),
                    "Widget#1 src"
                  );
                },
                null,
      ...
      "test required upload command": function () {
        assert.isNotUndefined(
          this.editor.getCommand("easyimageUpload"),
          "Upload command is present in editor"
        );
      },
    };
