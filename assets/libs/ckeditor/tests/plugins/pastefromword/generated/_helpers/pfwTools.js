...
(function () {
  ...
  window.pfwTools = {
    ...
    defaultConfig: {
      ...
      extraAllowedContent:
        "span{line-height,background,font-weight,font-style,text-decoration,text-underline,display," +
    ...
    imageDefaultConfig: {
      ...
      colorButton_normalizeBackground: false,
      extraAllowedContent:
        "span{line-height,background,font-weight,font-size,font-style,text-decoration,text-underline,display," +
        "page-break-before,height,tab-stops,layout-grid-mode,text-justify,-ms-layout-grid-mode,-ms-text-justify," +
          ...
          font: function sortStyles(element) {
            ...
            function needSorting(element) {
              ...
              if (elementAttrs[0] === parentAttrs[0]) {
                return (
                  element.attributes[elementAttrs[0]] <
                  parent.attributes[parentAttrs[0]]
                );
              }
    ...
    ignoreTestsOnMobiles: function (tests) {
      ...
      if (bender.tools.env.mobile) {
        CKEDITOR.tools.array.forEach(
          CKEDITOR.tools.object.keys(tests),
          function (tcName) {
