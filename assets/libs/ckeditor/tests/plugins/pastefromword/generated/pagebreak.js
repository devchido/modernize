...
(function () {
  ...
  bender.test(
    createTestSuite({
      browsers: ["chrome", "ie8", "safari", "edge"],
      ...
      testData: {
        _should: {
          ignore: {
            "test Page_break office365 chrome":
              CKEDITOR.env.ie && CKEDITOR.env.version < 11,
            "test Page_break office365 safari":
              CKEDITOR.env.ie && CKEDITOR.env.version < 11,
            "test Page_break office365 edge":
              CKEDITOR.env.ie && CKEDITOR.env.version < 11,
            "test Page_break word2013 ie8":
              !CKEDITOR.env.ie || CKEDITOR.env.version >= 11,
          },
        },
      },
