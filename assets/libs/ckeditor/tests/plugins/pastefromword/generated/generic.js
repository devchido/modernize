...
(function () {
  ...
  bender.test(
    createTestSuite({
      browsers: ["chrome", "firefox", "ie8", "ie11", "safari", "datatransfer"],
      wordVersions: ["word2007", "word2013"],
      tests: {
        Bold: true,
        Colors: true,
      ...
      testData: {
        _should: {
          ignore: {
            ...
            "test Unordered_list_special_char_bullet word2013 chrome":
              CKEDITOR.env.edge,
            "test Unordered_list_special_char_bullet word2013 firefox":
              CKEDITOR.env.edge,
          },
        },
      },
      customFilters: [pfwTools.filters.style, pfwTools.filters.span],
      ignoreAll:
