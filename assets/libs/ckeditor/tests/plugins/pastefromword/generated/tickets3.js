...
(function () {
  ...
  pfwTools.defaultConfig.disallowedContent =
    (pfwTools.defaultConfig.disallowedContent
      ? pfwTools.defaultConfig.disallowedContent + ";"
      : "") + "code";
  ...
  bender.test(
    createTestSuite({
      ...
      tests: {
        ...
        "Tickets/7593Numbere_&_Bullet_list_with_list_styles_applied": [
          "word2013",
        ],
      ...
      testData: {
        _should: {
          ignore: {
            ...
            "test Tickets/6658CKEditor_Word_tabs_between_list_items_Sample word2013 ie11":
              CKEDITOR.env.edge,
          },
        },
      },
      customFilters: [pfwTools.filters.span],
      ignoreAll:
        (CKEDITOR.env.ie && CKEDITOR.env.version <= 11) ||
        bender.tools.env.mobile,
    })
  );
})();
