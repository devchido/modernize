...
(function () {
  ...
  bender.test(
    createTestSuite({
      browsers: ["chrome", "firefox", "ie8", "safari"],
      wordVersions: ["office365", "word2013"],
      tests: {
      ...
      testData: {
        _should: {
          ignore: {
            "test Page_break_simple office365 chrome":
              CKEDITOR.env.ie && CKEDITOR.env.version < 11,
            "test Page_break_simple office365 firefox":
              CKEDITOR.env.ie && CKEDITOR.env.version < 11,
            "test Page_break_simple office365 safari":
              CKEDITOR.env.ie && CKEDITOR.env.version < 11,
            "test Page_break_simple word2013 ie8":
              !CKEDITOR.env.ie || CKEDITOR.env.version >= 11,
          },
        },
      },
