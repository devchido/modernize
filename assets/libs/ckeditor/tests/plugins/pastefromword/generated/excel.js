...
(function () {
  ...
  bender.test(
    createTestSuite({
      ...
      wordVersions: ["excel2013", "excel2016"],
      tests: {
      ...
      testData: {
        _should: {
          ignore: {
            ...
            "test Table_text_attributes/Mixed excel2016 ie11": !(
              CKEDITOR.env.ie && CKEDITOR.env.version == 11
            ),
            "test Table_text_attributes/Cell_text excel2016 ie11": !(
              CKEDITOR.env.ie && CKEDITOR.env.version == 11
            ),

            "test Table_text_attributes/Mixed excel2013 datatransfer":
              CKEDITOR.env.ie,
            "test Table_text_attributes/Cell_text excel2013 datatransfer":
              CKEDITOR.env.ie,
            "test Table_text_attributes/Mixed excel2016 datatransfer":
              CKEDITOR.env.ie,
            "test Table_text_attributes/Cell_text excel2016 datatransfer":
              CKEDITOR.env.ie,
