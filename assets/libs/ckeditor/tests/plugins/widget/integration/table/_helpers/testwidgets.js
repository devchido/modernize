CKEDITOR.plugins.add("inlineWidget", {
  ...
  init: function (editor) {
    editor.widgets.add("test1", {
      ...
      template:
        '<strong class="inline-widget" style="background-color:#C0392B;padding:5px;">Very strong text.</strong>',
...
CKEDITOR.plugins.add("blockWidget", {
  ...
  init: function (editor) {
    editor.widgets.add("test2", {
      ...
      template:
        '<div class="block-widget" style="background-color:#F4D03F;padding:5px;">Some text in div.</div>',
