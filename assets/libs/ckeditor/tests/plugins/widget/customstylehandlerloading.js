...
(function () {
  ...
  bender.test({
    "test widget styles customHandler is not added if plugin file added":
      function () {
        ...
        if (!CKEDITOR.plugins.registered.widget) {
          CKEDITOR.scriptLoader.load(
            CKEDITOR.getUrl("/plugins/widget/plugins.js"),
            function () {
              resume(function () {
    ...
    "test widget styles customHandler is added after plugin is loaded":
      function () {
