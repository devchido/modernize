...
(function () {
  ...
  bender.test({
      ...
      this.editorBot.setData(
        ...
        function () {
          ...
          editor
            ...
            .fire(
              "keydown",
              new CKEDITOR.dom.event({ keyCode: CKEDITOR.SHIFT + 121 })
            );
          ...
          editor
            ...
            .fire(
              ...
              new CKEDITOR.dom.event({
                keyCode: CKEDITOR.CTRL + CKEDITOR.SHIFT + 121,
              })
            );
    ...
    "test contextMenu passing a data": function () {
      ...
      this.editorBot.setData(
        '<p>foo</p><div data-widget="testdata" id="w1">foo</div>',
        function () {
          var w1 = getWidgetById(editor, "w1");
          ...
          assert.areSame(
            1,
            itemsExist,
            "there is one testData item in context menu"
          );
        }
      );
    },
