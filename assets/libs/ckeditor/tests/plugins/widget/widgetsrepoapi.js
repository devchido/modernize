...
(function () {
  ...
  var Widget,
    ...
    parserEmDataWidgetTest = new CKEDITOR.htmlParser.element("em", {
      "data-widget": "test",
    }),
    parserEmDataWidgetFalse = new CKEDITOR.htmlParser.element("em", {
      "data-widget": false,
    }),
    parserElDataWidgetWrapperFalse = new CKEDITOR.htmlParser.element("em", {
      "data-cke-widget-wrapper": "false",
    }),
    parserElDataWidgetWrapperTrue = new CKEDITOR.htmlParser.element("em", {
      "data-cke-widget-wrapper": "true",
    }),
    domEm = CKEDITOR.dom.element.createFromHtml("<em></em>"),
    domEmDataWidgetTest = CKEDITOR.dom.element.createFromHtml(
      '<em data-widget="test" >foo</em>'
    ),
    domEmDataWidgetFalse = CKEDITOR.dom.element.createFromHtml(
      '<em data-widget="false" ></em>'
    ),
    domEmDataWidgetWrapperFalse = CKEDITOR.dom.element.createFromHtml(
      '<em data-cke-widget-wrapper="false" ></em>'
    ),
    domEmDataWidgetWrapperTrue = CKEDITOR.dom.element.createFromHtml(
      '<em data-cke-widget-wrapper="true" ></em>'
    ),
    domEmWidgetEditable = CKEDITOR.dom.element.createFromHtml(
      "<em data-cke-widget-editable ></em>"
    ),
    domEmWidgetDragHandler = CKEDITOR.dom.element.createFromHtml(
      "<em data-cke-widget-drag-handler></em>"
    ),
    domEmWidgetDragHandlerContainer = CKEDITOR.dom.element.createFromHtml(
      '<em class="cke_widget_drag_handler_container"></em>'
    );
  ...
  var fixHtml = widgetTestsTools.fixHtml,
    ...
    widgetInitedWrapperAttributes =
      widgetTestsTools.widgetInitedWrapperAttributes;
  ...
  bender.test({
    "test initial state": function () {
      ...
      assert.areEqual(
        0,
        keysLength(widgets.instances),
        "widgets.instances is empty"
      );
      assert.areEqual(
        4,
        keysLength(widgets.registered),
        "widgets.registered contains 4 widgets"
      );
    ...
    "test widgets.add and widgets.initOn": function () {
      ...
      var el = CKEDITOR.dom.element.createFromHtml(
        '<span data-widget="test1">foo</span>',
        editor.document
      );
      ...
      widgets.once("instanceCreated", function (evt) {
        ...
        assert.areSame(
          editor,
          evt.data.editor,
          "evt.data.editor - event was fired after basic properties were set"
        );
        fired++;
      });
      ...
      assert.isInstanceOf(
        ...
        widget,
        "widget is instance of widget class"
      );
      assert.areSame(
        widget,
        widgets.instances[widget.id],
        "instances contains widget"
      );
      ...
      assert.areSame(
        "1",
        wrapper.data("cke-widget-wrapper"),
        "Wrapper has widget-wrapper attribute"
      );
      assert.areSame(
        widget.id,
        +wrapper.data("cke-widget-id"),
        "Wrapper has widget-id attribute"
      );
      assert.areSame(wrapper, widget.wrapper, "Widget.wrapper");
      assert.isFalse(
        wrapper.hasClass("cke_widget_new"),
        "Wrapper does not have cke_widget_new class any more"
      );

      assert.areSame(widget, widgets.getByElement(el), "getByElement el");
      assert.areSame(
        widget,
        widgets.getByElement(wrapper),
        "getByElement wrapper"
      );
      assert.isNull(
        widgets.getByElement(wrapper.getParent()),
        "getByElement wrapper's parrent"
      );

      assert.areSame(
        widget,
        widgets.initOn(el),
        "Once initialized returns the same widget instance"
      );

      // Try to initialize widget on non-widget element.

      el = CKEDITOR.dom.element.createFromHtml(
        "<span>bar</span>",
        editor.document
      );
      editor.insertElement(el);
      ...
      el = CKEDITOR.dom.element.createFromHtml(
        '<span data-widget="noSuchWidget">bar</span>',
        editor.document
      );
      editor.insertElement(el);
    ...
    "test widgets.initOn - startup data": function () {
      ...
      this.editorBot.setData("<p>X<b>bar</b>X</p>", function () {
        var widget = editor.widgets.initOn(
          editor.editable().findOne("b"),
          "testiniton1",
          {
            foo: 1,
          }
    ...
    "test widgets.wrapElement - inline": function () {
      ...
      assert.isTrue(
        wrapper.hasClass("cke_widget_test"),
        "wrapper has css class based on widget name"
      );
      assert.isMatching(
        new RegExp(
          "^<p>foo<span " +
            widgetWrapperAttributes +
            '><em data-cke-widget-keep-attr="1" data-widget="test">foo</em></span>bar(<br />)?</p>$'
        ),
        fixHtml(editor.editable().getHtml())
      );
      assert.isTrue(
        wrapper.hasClass("cke_widget_inline"),
        "has cke_widget_inline class"
      );
    },
    ...
    "test widgets.wrapElement - block": function () {
      ...
      assert.isMatching(
        new RegExp(
          "^<p>foo(<br />)?</p><div " +
            widgetWrapperAttributes +
            '><div data-cke-widget-keep-attr="1" data-widget="test">foo</div></div><p>bar(<br />)?</p>$'
        ),
        fixHtml(editor.editable().getHtml()),
        "HTML after 1st wrapElement()"
      );
      assert.isTrue(
        wrapper.hasClass("cke_widget_block"),
        "has cke_widget_block class"
      );
    ...
    "test widgets.wrapElement - custom widget name": function () {
      ...
      assert.isMatching(
        new RegExp(
          "^<p>foo<span " +
            widgetWrapperAttributes +
            '><span data-cke-widget-keep-attr="0" data-widget="test">foo</span></span>bar(<br />)?</p>$'
        ),
        fixHtml(editor.editable().getHtml())
      );
    },
    ...
    "test widgets.wrapElement - inline on htmlParser.element": function () {
      var frag = new CKEDITOR.htmlParser.fragment.fromHtml(
          '<p>foo<em data-widget="test">foo</em>bar</p>'
        ),
      ...
      assert.isMatching(
        new RegExp(
          "^<p>foo<span " +
            widgetWrapperAttributes +
            '><em data-cke-widget-keep-attr="1" data-widget="test">foo</em></span>bar</p>$'
        ),
        writeFrag(frag)
      );
      assert.isTrue(
    ...
    "test widgets.wrapElement - block on htmlParser.element": function () {
      var frag = new CKEDITOR.htmlParser.fragment.fromHtml(
          '<p>foo</p><div data-widget="test">foo</div><p>bar</p>'
        ),
        el = frag.children[1];
      ...
      assert.isMatching(
        new RegExp(
          "^<p>foo</p><div " +
            widgetWrapperAttributes +
            '><div data-cke-widget-keep-attr="1" data-widget="test">foo</div></div><p>bar</p>$'
        ),
        writeFrag(frag),
        "HTML after 1st wrapElement()"
      );
    ...
    "test widgets.wrapElement - custom widget name on htmlParser.element":
      function () {
        var frag = new CKEDITOR.htmlParser.fragment.fromHtml(
            "<p>foo<span>foo</span>bar</p>"
          ),
          el = frag.children[0].children[1];
        ...
        assert.isMatching(
          new RegExp(
            "^<p>foo<span " +
              widgetWrapperAttributes +
              '><span data-cke-widget-keep-attr="0" data-widget="test">foo</span></span>bar</p>$'
          ),
          writeFrag(frag)
        );
      },
    ...
    "test widgets.wrapElement - force block mode on htmlParser.element":
      function () {
        var frag = new CKEDITOR.htmlParser.fragment.fromHtml(
            "<span>foo</span>"
          ),
    ...
    "test widgets.wrapElement - fix DOM": function () {
      ...
      assert.isMatching(
        new RegExp(
          "^<p>X</p><div " +
            widgetWrapperAttributes +
            '><em data-cke-widget-keep-attr="1" data-widget="testblock">foo</em></div><p>Y</p>$'
        ),
        fixHtml(dataP.toHtml('<p>X<em data-widget="testblock">foo</em>Y</p>')),
        "case 1"
      );
      ...
      assert.isMatching(
        ...
        fixHtml(
          dataP.toHtml('<p>X</p><p><em data-widget="testblock">foo</em>Y</p>')
        ),
        "case 2"
      );
      ...
      assert.isMatching(
        ...
        fixHtml(
          dataP.toHtml('<p>X<em data-widget="testblock">foo</em></p><p>Y</p>')
        ),
        "case 3"
      );
      ...
      assert.isMatching(
        ...
        fixHtml(
          dataP.toHtml(
            '<p><b class="red">X<em data-widget="testblock">foo</em>Y</b></p>'
          )
        ),
        "case 4"
      );
      ...
      assert.isMatching(
        new RegExp(
          "^<p>X<span " +
            widgetWrapperAttributes +
            '><em data-cke-widget-keep-attr="1" data-widget="testinline">foo</em></span>Y</p>$'
        ),
        fixHtml(dataP.toHtml('<p>X<em data-widget="testinline">foo</em>Y</p>')),
        "case 5"
      );
      ...
      assert.isMatching(
        new RegExp(
          "^<p>X</p><div " +
            widgetWrapperAttributes +
            '><h1 data-cke-widget-keep-attr="1" data-widget="testblock">foo</h1></div><p>Y</p>$'
        ),
        fixHtml(
          dataP.toHtml('<p>X</p><h1 data-widget="testblock">foo</h1><p>Y</p>')
        ),
        "case 6"
      );
    },
    ...
    "test widgets.wrapElement - detached node": function () {
      ...
      assert.isMatching(
        new RegExp(
          "^<span " +
            widgetWrapperAttributes +
            '><b data-cke-widget-keep-attr="0" data-widget="test">foo</b></span>$'
        ),
    ...
    "test widgets.wrapElement - detached node - htmlParser.element":
      function () {
    ...
    "test widgets.wrapElement - adds widget-data attribute - htmlParser.element":
      function () {
        var el = CKEDITOR.htmlParser.fragment.fromHtml("foo", "b");
    ...
    "test widgets.wrapElement - remembers that element had widget-data attribute":
      function () {
        var el = CKEDITOR.dom.element.createFromHtml(
          '<b data-widget="test">foo</b>'
        );
    ...
    "test widgets.wrapElement - remembers that element had widget-data attribute - htmlParser.element":
      function () {
    ...
    "test widgets.wrapElement - does not override data-cke-widget-keep-attr":
      function () {
        var el = CKEDITOR.dom.element.createFromHtml(
          '<b data-cke-widget-keep-attr="0" data-widget="test">foo</b>'
        );
    ...
    "test widgets.wrapElement - does not override data-cke-widget-keep-attr - htmlParser.element":
      function () {
        var el = CKEDITOR.htmlParser.fragment.fromHtml(
          '<b data-cke-widget-keep-attr="0" data-widget="test">foo</b>'
        ).children[0];
    ...
    "test widgets.initOnAll": function () {
      ...
      assert.areEqual(
        0,
        keysLength(editor.widgets.instances),
        "Widgets instances array is cleaned up on setData"
      );
      ...
      editor
        ...
        .setHtml(
          editor.dataProcessor.toHtml(
            '<p>foo<em data-widget="testinline">bar1</em>boo<em data-widget="testinline">bar2</em></p>' +
      ...
      assert.areEqual(
        3,
        editor.widgets.initOnAll().length,
        "3 new instances returned from 1st initOnAll"
      );
      assert.areEqual(
        3,
        keysLength(editor.widgets.instances),
        "3 instances after 1st initOnAll"
      );

      assert.areEqual(
        0,
        editor.widgets.initOnAll().length,
        "0 new instances returned from 2nd initOnAll"
      );
      assert.areEqual(
        3,
        keysLength(editor.widgets.instances),
        "3 instances after 2nd initOnAll"
      );

      var el = CKEDITOR.dom.element.createFromHtml(
        '<em data-widget="testinline">bar2</em>',
        editor.document
      );
      editor.insertElement(el);
      ...
      assert.areEqual(
        1,
        editor.widgets.initOnAll().length,
        "1 new instances returned from 3rd initOnAll"
      );
      assert.areEqual(
        4,
        keysLength(editor.widgets.instances),
        "4 instances after 3rd initOnAll"
      );

      var ids = [];

      for (var id in editor.widgets.instances) ids.push(id);
    ...
    "test widgets.initOnAll visits nested widgets (by nestedEditable.setData)":
      function () {
        var editor = this.editor;
        ...
        assert.areEqual(
          1,
          editor.widgets.initOnAll().length,
          "1 new instance returned from 1st initOnAll (only outer widget)"
        );
        assert.areEqual(
          2,
          keysLength(editor.widgets.instances),
          "2 instances after 1st initOnAll"
        );
        ...
        assert.areEqual(
          2,
          keysLength(editor.widgets.instances),
          "2 instances after 2nd initOnAll"
        );

        assert.areSame(
          "testinline",
          getWidgetById(editor, "w1").name,
          "nested widget has been initialized"
        );
      },
      ...
      this.editorBot.setData(
        ...
        function () {
          assert.areEqual(
            2,
            keysLength(editor.widgets.instances),
            "2 widgets have been initialized"
          );
          ...
          widget.on("destroy", function () {
            assert.isFalse(
              firedInstanceDestroyed,
              "widget#destroy is fired first"
            );
            firedDestroy = true;
          });
          ...
          assert.areEqual(
            1,
            keysLength(editor.widgets.instances),
            "1 widget remained after destroying 1st"
          );
          assert.isFalse(
            !!editor.widgets.instances[widget.id],
            "widget has been removed from instances"
          );
          assert.isTrue(
            editor.document.getBody().contains(widgetEl),
            "element is still present in DOM"
          );
          assert.isMatching(
            "<p>foo<span " +
              widgetInitedWrapperAttributes +
              ...
              data2Attr({ classes: null }) +
              '" data-cke-widget-keep-attr="1" data-widget="testblock" id="widget2">bam</div>' +
              widgetTestsTools.widgetDragHanlder +
              "</div>",
            fixHtml(editor.editable().getHtml()),
          ...
          assert.areEqual(
            0,
            keysLength(editor.widgets.instances),
            "0 widgets remained after destroying 2nd"
          );
          assert.isTrue(
            editor.document.getBody().contains(widgetEl),
            "element2 is still present in DOM"
          );
          assert.isMatching(
            "<p>foo<span " +
              widgetInitedWrapperAttributes +
              ...
              '<div data-widget="testblock" id="widget2">bam</div>',
            fixHtml(editor.editable().getHtml()),
            "data after destroying 2nd widget"
          );
    ...
    "test widgets.destroy - nested widgets are destroyed together with main widget":
      function () {
        var editor = this.editor;
        ...
        this.editorBot.setData(
          ...
          function () {
            ...
            assert.areSame(
              "wn1,wn2,wn3,wp1",
              destroyedIds.sort().join(","),
              "destroyedNames"
            );
            assert.isFalse(
              wn1.element.getParent().hasAttribute("data-cke-widget-wrapper"),
              "nested widgets were unwrapped too"
            );
    ...
    "test widgets.destroy - nested widget is destroyed before main widget":
      function () {
        var editor = this.editor;
        ...
        this.editorBot.setData(
          ...
          function () {
            ...
            assert.isTrue(
              w1Wrapper,
              "nested widget is destroyed before main one"
            );
          }
        );
      },

    "test widgets.destroy in offline mode - nested widget is not destroyed":
      function () {
        var editor = this.editor;
        ...
        this.editorBot.setData(
          ...
          function () {
            ...
            assert.isNotNull(
              w2.wrapper,
              "nested widgets wrapper was not reset"
            );
            assert.areSame(
              w2,
              getWidgetById(editor, "w2"),
              "nested widget still exists"
            );
          }
        );
      },
    ...
    "test widgets.destroyAll": function () {
      ...
      this.editorBot.setData(
        ...
        function () {
          ...
          assert.isMatching(
            new RegExp(
              '^<p>foo<em data-widget="testinline" id="widget1">bar1</em>boo(<br />)?</p>' +
                '<div data-widget="testblock" id="widget2">bam</div>$'
            ),
            fixHtml(editor.editable().getHtml()),
            "data after destroying widgets"
          );
          assert.areSame(2, destroyedIds.length, "destroyedIds");
          assert.areNotSame(
            destroyedIds[0] != destroyedIds[1],
            "two different widgets have been destroyed"
          );
          listener.removeListener();
        }
      );
    ...
    "test widgets.destroyAll - nested widget": function () {
      ...
      this.editorBot.setData(
        ...
        function () {
          ...
          assert.areSame(
            "testinline,testnested",
            destroyedNames.sort().join(","),
            "destroyedNames"
          );
          listener.removeListener();
        }
      ...
      this.editorBot.setData(
        ...
        function () {
          assert.areEqual(
            3,
            keysLength(editor.widgets.instances),
            "3 widgets have been initialized"
          );
          ...
          assert.isNotNull(
            getWidgetById(editor, "w1"),
            "widget outside specified container has not been destroyed"
          );
          assert.isNull(
            getWidgetById(editor, "w2", true),
            "w2 inside specified container has been destroyed"
          );
          assert.isNull(
            getWidgetById(editor, "w3", true),
            "w3 inside specified container has been destroyed"
          );
        }
      );
    },

    "test widgets.destroyAll within specified container destroys outer widget first":
      function () {
        var editor = this.editor;
        ...
        this.editorBot.setData(
          ...
          function () {
            ...
            assert.isTrue(
              w2Wrapper,
              "nested widget has been destroyed before its parent"
            );
          }
        );
      },

    "test widgets.destroyAll in offline mode ignores specified container":
      function () {
        var editor = this.editor;
        ...
        this.editorBot.setData(
          ...
          function () {
            ...
            assert.isTrue(
              w1.element.getParent().hasAttribute("data-cke-widget-wrapper"),
              "w1 has been destroyed in offline mode"
            );
            assert.isTrue(
              w2.element.getParent().hasAttribute("data-cke-widget-wrapper"),
              "w2 has been destroyed in offline mode"
            );
          }
        );
      },
    ...
    "test widgets.getByElement - simple widget": function () {
      ...
      this.editorBot.setData(
        ...
        function () {
          ...
          assert.areSame(
            widget,
            editor.widgets.getByElement(el.getParent()),
            "wrapper"
          );
          assert.areSame(
            widget,
            editor.widgets.getByElement(editor.document.getById("y")),
            "element inside widget"
          );

          assert.areSame(
            widget,
            editor.widgets.getByElement(el.getParent(), true),
            "wrapper in wrapperOnly"
          );

          assert.areSame(
            widget2,
            editor.widgets.getByElement(widget2.element),
            "second widget"
          );
          assert.areSame(
            widget2,
            editor.widgets.getByElement(widget2.wrapper, true),
            "second widget in wrapperOnly"
          );
        }
      );
    },

    "test widgets.getByElement - simple widget - false positive cases":
      function () {
        var editor = this.editor;
        ...
        this.editorBot.setData(
          ...
          function () {
            ...
            assert.isNull(
              editor.widgets.getByElement(editor.document.getBody().getLast()),
              "element outside widget"
            );
            assert.isNull(
              editor.widgets.getByElement(editor.document.getBody()),
              "body"
            );

            assert.isNull(
              editor.widgets.getByElement(el, true),
              "widget element in onlyWrapper mode"
            );
            assert.isNull(
              editor.widgets.getByElement(editor.document.getById("y"), true),
              "element inside widget in onlyWrapper mode"
            );
          }
        );
      },
    ...
    "test widgets.getByElement - nested editable": function () {
      ...
      this.editorBot.setData(
        ...
        function () {
          ...
          assert.areSame(
            widget,
            editor.widgets.getByElement(editor.document.getById("z")),
            "element inside nested editable widget"
          );

          assert.isNull(
            editor.widgets.getByElement(editor.document.getById("y"), true),
            "nested editable in wrapperOnly mode"
          );
        }
      );
    },
    ...
    "test widgets.getByElement - nested widget": function () {
      ...
      this.editorBot.setData(
        '<div data-widget="testnested" id="x">' +
          ...
          '<p><em data-widget="testinline">bar</em></p>',
        function () {
          var widgetInnerBlock = editor.widgets.getByElement(
              editor.document.getById("y")
            ),
            widgetInnerInline = editor.widgets.getByElement(
              editor.document.getById("z")
            );

          assert.areSame(
            "y",
            widgetInnerBlock.element.$.id,
            "inner block widget"
          );
          assert.areSame(
            "z",
            widgetInnerInline.element.$.id,
            "inner inner widget"
          );
          assert.areSame(
            widgetInnerInline,
            editor.widgets.getByElement(editor.document.getById("zi")),
            "element inside nested widget"
          );

          assert.areSame(
            widgetInnerBlock,
            editor.widgets.getByElement(widgetInnerBlock.wrapper, true),
            "inner block widget in wrapperOnly mode"
          );
          assert.isNull(
            editor.widgets.getByElement(widgetInnerBlock.element, true),
            "widget element in wrapperOnly mode"
          );
          assert.isNull(
            editor.widgets.getByElement(editor.document.getById("zi"), true),
    ...
    "test widgets.getByElement - edge case - widget id == 0": function () {
      ...
      this.editorBot.setData(
        '<p><em data-widget="testinline" id="x">bar</em></p>' +
          '<p><em data-widget="testinline" id="z">bar</em></p>',
        function () {
          var widgetWrapper = editor
              .editable()
              .findOne('[data-cke-widget-id="0"]'),
          ...
          assert.areSame(
            widget,
            editor.widgets.getByElement(widget.element),
            "element"
          );
          assert.areSame(
            widget,
            editor.widgets.getByElement(widget.wrapper, true),
            "wrapper in wrapperOnly mode"
          );
        }
      );
    },
    ...
    "test widgets.getNestedEditable": function () {
      ...
      assert.areSame(
        editable,
        f(el, el.findOne("#el3").getFirst()),
        "el3 text child"
      );
      assert.areSame(
        editable,
        f(el, el.findOne("#el4").getFirst()),
        "el4 text child"
      );
    },
    ...
    "test widgets.createEditableFilter": function () {
      ...
      var f1 = widgets._tests_createEditableFilter("w1", "e1", {
          allowedContent: "b",
        }),
        f2 = widgets._tests_createEditableFilter("w1", "e1", {
          allowedContent: "b",
        }),
        f3 = widgets._tests_createEditableFilter("w1", "e1", {
          allowedContent: "i",
        });
      ...
      var f4 = widgets._tests_createEditableFilter("w2", "e2", {
        allowedContent: "u",
      });
      ...
      editor.widgets.add("testfinalize1", {
        ...
        init: function () {
          this.on("edit", function (evt) {
            ...
            assert.isTrue(
              editor.widgets
                .getByElement(editor.editable().findOne("b"))
                .isReady(),
              "widget was marked as ready"
            );
    ...
    "test widgets.checkWidgets": function () {
      var editor = this.editor,
        editorBot = this.editorBot,
        data =
          '<p><span data-widget="test">A</span><span data-widget="test">B</span></p>';
      ...
      editorBot.setData(data, function () {
        ...
        assert.areSame(
          0,
          CKEDITOR.tools.object.keys(editor.widgets.instances).length,
    ...
    "test widgets.checkWidgets - do not remove widgets before finalize creation":
      function () {
        var editor = this.editor,
          editorBot = this.editorBot;
        ...
        editor.widgets.add("testCheckWidgets1", {
          ...
          init: function () {
            this.on("edit", function (evt) {
              ...
              assert.areSame(
                this,
                editor.widgets.instances[id],
                "widget was not removed from repository"
              );
              ...
              range.moveToPosition(
                editor.editable().findOne("p"),
                CKEDITOR.POSITION_AFTER_START
              );
              editor.getSelection().selectRanges([range]);

              editor.widgets.checkWidgets();
              objectAssert.ownsNoKeys(
                editor.widgets.instances,
                "widget was removed from repository"
              );
            });
          },
        });
    ...
    "test widgets.checkWidgets does not initialize widgets in temporary elements":
      function () {
        var editor = this.editor,
          editorBot = this.editorBot;

        editorBot.setData(
          '<p><span data-widget="test" id="w1">A</span></p>',
          function () {
            // Store widgets HTML.
            ...
            editor.editable().setHtml(
              "<p>" +
                ...
                "</p>" +
                '<p data-cke-temp="1"><i>' +
                widgetHtml.replace(/id="?w1"?/, 'id="w2"') +
                "</i></p>" + // Indirect descendant.
                '<p data-cke-temp="1">' +
                widgetHtml.replace(/id="?w1"?/, 'id="w3"') +
                "</p>" // Direct descendant.
            );
            ...
            assert.isNull(
              getWidgetById(editor, "w2"),
              "There should be no widget on #w2"
            );
            assert.isNull(
              getWidgetById(editor, "w3"),
              "There should be no widget on #w3"
            );
            assert.isNotNull(
              getWidgetById(editor, "w1"),
              "There should be a widget on #w1"
            );
          }
        );
      },

    "test widgets.checkWidgets - nested widgets - destroying a whole tree":
      function () {
        var editor = this.editor,
          editorBot = this.editorBot,
          data =
        ...
        editorBot.setData(data, function () {
          ...
          w1.editables.foo.setData(
            '<em data-widget="test">foo</em>foo<em data-widget="test">foo</em>'
          );

          assert.areSame(
            4,
            keysLength(editor.widgets.instances),
            "There should be 4 widgets in repo after init."
          );
          ...
          assert.areSame(
            1,
            keysLength(editor.widgets.instances),
            "There should be 1 widget in repo after checkWidgets."
          );
          assert.areSame("testblock", getWidgetById(editor, "w2").name);
        });
      },

    "test widgets.checkWidgets - nested widgets - destroying nested widget":
      function () {
        var editor = this.editor,
          editorBot = this.editorBot,
          data =
        ...
        editorBot.setData(data, function () {
          ...
          assert.areSame(
            3,
            keysLength(editor.widgets.instances),
            "There should be 3 widget in repo after checkWidgets."
          );
          assert.isNull(
            getWidgetById(editor, "wn1", true),
            "Widget wn1 was destroyed."
          );
        });
      },

    "test widgets.checkWidgets - nested widgets - initializing widget with nested widgets":
      function () {
        var editor = this.editor,
          editorBot = this.editorBot,
          data =
        ...
        editorBot.setData(data, function () {
          assert.areSame(
            2,
            keysLength(editor.widgets.instances),
            "There should be 2 widgets in repo after init."
          );
          ...
          assert.areSame(
            0,
            keysLength(editor.widgets.instances),
            "There should be 0 widgets in repo after DOM is overriden."
          );

          editor
            .editable()
            .setHtml(html.replace(/ data-cke-expando="?\d+"?/gi, ""));
          ...
          assert.areSame(
            2,
            keysLength(editor.widgets.instances),
            "There should be 2 widgets in repo after checkWidgets."
          );

          assert.areSame(
            "testnested",
            getWidgetById(editor, "w1").name,
            "Widget w1 was reinitialized."
          );
          assert.areSame(
            "test",
            getWidgetById(editor, "wn1", true).name,
            "Widget wn1 was reinitialized."
          );
        });
      },

    "test widgets.checkWidgets - nested widgets - initializing nested widgets":
      function () {
        var editor = this.editor,
          editorBot = this.editorBot,
          data =
    ...
    "test widgets.checkWidgets with initOnlyNew option": function () {
      ...
      editorBot.setData(
        ...
        function () {
          ...
          editor.editable().setHtml(
            '<p id="p1">' +
              ...
              widgetHtml
                .replace(
                  /cke_widget_wrapper/,
                  "cke_widget_wrapper cke_widget_new"
                )
                .replace(/id="?w1"?/, 'id="w3"') +
              "</p>"
          );
          ...
          assert.isNotNull(
            getWidgetById(editor, "w3"),
            "There should be a widget on #w3"
          );
        }
      );
    },
    ...
    "test widgets.checkWidgets with focusInited option": function () {
      ...
      editorBot.setData(
        ...
        function () {
          ...
          assert.areSame(
            getWidgetById(editor, "w1").wrapper,
            sel.getSelectedElement(),
            "Correct widget is selected"
          );
        }
      );
    },

    "test widgets.checkWidgets with focusInited option - two widgets":
      function () {
        var editor = this.editor,
          editorBot = this.editorBot;

        editorBot.setData(
          '<p><span data-widget="test" id="w1">A</span><span data-widget="test" id="w2">B</span></p>',
          function () {
            editor.editable().setHtml(editor.editable().getHtml());
    ...
    "test widgets.checkWidgets with focusInited and initOnlyNew options":
      function () {
        var editor = this.editor,
          editorBot = this.editorBot;
        ...
        editorBot.setData(
          ...
          function () {
            ...
            assert.isTrue(!!sel.isFake, "Selection is fake");
            assert.areSame(
              getWidgetById(editor, "w2").wrapper,
              sel.getSelectedElement(),
              "Correct widget is selected"
            );
          }
    ...
    "test widgets.checkWidgets can be canceled by canceling event":
      function () {
        var editor = this.editor,
          editorBot = this.editorBot;
        ...
        editorBot.setData(
          ...
          function () {
            ...
            var listener = editor.widgets.on(
              "checkWidgets",
              function (evt) {
                evt.cancel();
              },
    ...
    "test options of widgets.checkWidgets can be modified in event listener":
      function () {
        var editor = this.editor,
          editorBot = this.editorBot;
        ...
        editorBot.setData(
          ...
          function () {
            ...
            assert.isFalse(
              !!editor.getSelection().isFake,
              "Widget should not be focused"
            );
          }
        );
      },
    ...
    "test widgets.checkWidgets draghandler re usage": function () {
      ...
      this.editorBot.setData(data, function () {
        ...
        editable.setHtml(
          editable.getHtml().replace(/ data-cke-expando="?\d+"?/gi, "")
        );
        editor.widgets.checkWidgets();

        var dragHandlers = editor
          .editable()
        ...
        assert.areEqual(
          1,
          dragHandlers.count(),
          "There should be still only one drag handler"
        );
      });
    },

    "test widgets.checkWidgets draghandler re usage - nested widget":
      function () {
        var editor = this.editor,
          data =
        ...
        this.editorBot.setData(data, function () {
          ...
          assert.areEqual(
            2,
            dragHandlers.count(),
            "There should be two drag handlers"
          );

          var widget = getWidgetById(editor, "x");
          assert.areSame(
            widget.wrapper,
            widget.dragHandlerContainer.getParent(),
            "Main widget's drag handler is directly in the wrapper"
          );
          widget = getWidgetById(editor, "y");
          assert.areSame(
            widget.wrapper,
            widget.dragHandlerContainer.getParent(),
            "Nested widget's drag handler is directly in the wrapper"
          );
        });
      },
    ...
    "test widgets.checkWidgets mask re usage": function () {
      ...
      this.editorBot.setData(data, function () {
        ...
        assert.areEqual(
          1,
          masks.count(),
          "There should be still only one mask"
        );
      });
    },
    ...
    "test widgets.parseElementClasses": function () {
      ...
      assert.areSame(
        "foo",
        classes2Array(p("cke_bar foo")).join(","),
        "cke_* are ignored"
      );
    },
        ...
        function (bot) {
          ...
          bot.setData("<p>foo<span>x</span></p><p><b>y</b></p>", function () {
            assert.areSame(
              "p,span,p,b",
              callback1.join(","),
              "First callback executed on all elements"
            );
            assert.areSame(
              "p,span,p,b",
              callback2.join(","),
              "Second callback executed on all elements"
            );
          });
        }
      );
      ...
      bender.editorBot.create(
        ...
        function (bot) {
          ...
          bot.setData("<p>foo<b>x</b><i>y</i></p>", function () {
            assert.isNull(
              editor.widgets.getByElement(editor.editable().findOne("b")),
              "Element b was not upcasted"
            );
            assert.isNotNull(
              editor.widgets.getByElement(editor.editable().findOne("i")),
              "Element i was upcasted"
            );
            assert.areSame(
              "p,i",
              callback2.join(","),
              "Second callback was not executed on b element"
            );
          });
        }
      );
    ...
    "test Widget.isDomNestedEditable - <p data-cke-widget-editable>hello</p>":
      function () {
        var node = CKEDITOR.dom.element.createFromHtml(
          "<p data-cke-widget-editable>hello</p>"
        );
    ...
    'test Widget.isDomNestedEditable - <em data-cke-widget-wrapper="false" ></em>':
      function () {
        assert.isFalse(Widget.isDomNestedEditable(domEmDataWidgetWrapperFalse));
      },

    "test Widget.isDomNestedEditable - <em data-cke-widget-editable ></em>":
      function () {
    ...
    'test Widget.isParserWidgetElement - <em data-widget="test"></em>':
      function () {
        assert.isTrue(Widget.isParserWidgetElement(parserEmDataWidgetTest));
      },

    'test Widget.isParserWidgetElement - <em data-widget="false"></em>':
      function () {
    ...
    'test Widget.isDomWidgetElement - <em data-widget="test"></em>':
      function () {
        assert.isTrue(Widget.isDomWidgetElement(domEmDataWidgetTest));
      },

    'test Widget.isDomWidgetElement - <em data-widget="false"></em>':
      function () {
    ...
    'test Widget.isParserWidgetWrapper - <em data-cke-widget-wrapper="false"></em>':
      function () {
        assert.isTrue(
          Widget.isParserWidgetWrapper(parserElDataWidgetWrapperFalse)
        );
      },

    'test Widget.isParserWidgetWrapper - <em data-cke-widget-wrapper="true"></em>':
      function () {
        assert.isTrue(
          Widget.isParserWidgetWrapper(parserElDataWidgetWrapperTrue)
        );
      },
    ...
    'test Widget.isDomWidgetWrapper - <em data-cke-widget-wrapper="true" ></em>':
      function () {
        assert.isTrue(Widget.isDomWidgetWrapper(domEmDataWidgetWrapperTrue));
      },

    'test Widget.isDomDragHandler - <em class="cke_widget_drag_handler_container"></em>':
      function () {
        assert.isFalse(
          Widget.isDomDragHandler(domEmWidgetDragHandlerContainer)
        );
      },

    "test Widget.isDomDragHandler - <em data-cke-widget-drag-handler></em>":
      function () {
        assert.isTrue(Widget.isDomDragHandler(domEmWidgetDragHandler));
      },

    "test Widget.isDomDragHandlerContainer - <em data-cke-widget-drag-handler></em>":
      function () {
        assert.isFalse(
          Widget.isDomDragHandlerContainer(domEmWidgetDragHandler)
        );
      },

    'test Widget.isDomDragHandlerContainer - <em class="cke_widget_drag_handler_container"></em>':
      function () {
        assert.isTrue(
          Widget.isDomDragHandlerContainer(domEmWidgetDragHandlerContainer)
        );
      },
    ...
    "test Widget.isDomWidget - all": function () {
      ...
      assert.isTrue(
        Widget.isDomWidget(domEmDataWidgetTest),
        "domEmDataWidgetTest"
      );
      assert.isTrue(
        Widget.isDomWidget(domEmDataWidgetWrapperTrue),
        "domEmDataWidgetWrapperTrue"
      );
    },
  });
})();
