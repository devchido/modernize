...
(function () {
  ...
  var sampleWidget =
      '<figure data-widget="test" foo="Value1"><span>Value2</span></figure>',
  ...
  bender.test({
    ...
    "test modifier keystrokes upon widget focus": function () {
      ...
      this.editorBot.setData(
        ...
        function () {
          ...
          assert.areNotEqual(
            false,
            widget.fire("key", { keyCode: CKEDITOR.SHIFT + 121 }),
            "Shift should not be canceled"
          ); // SHIFT + F10

          widget.focus();
          assert.areNotEqual(
            false,
            widget.fire("key", { keyCode: CKEDITOR.CTRL + 121 }),
            "Ctrl should not be canceled"
          ); // CTRL + F10

          widget.focus();
          assert.areNotEqual(
            false,
            widget.fire("key", { keyCode: CKEDITOR.ALT + 121 }),
            "Alt should not be canceled"
          ); // ALT + F10
        }
      );
    },
      ...
      this.editorBot.setData(
        ...
        function () {
          ...
          assert.areEqual(
            3,
            instances.length,
            "Three widget instances are present."
          );
          arrayAssert.itemsAreEqual(
            ["test", "test2", "test2"],
            names,
            "Widgets are correctly initialized"
          );
          ...
          assert.areSame(
            instances[0].element,
            wrapper.getFirst(),
            "Wrapper contains widget element"
          );
          assert.areEqual(
            "1",
            wrapper.data("cke-widget-wrapper"),
            "Wrapper has data-cke-widget-wrapper attribute"
          );
          assert.isTrue(
          ...
          var widget = editor.widgets.initOn(
            el,
            editor.widgets.registered.test2
          );
          ...
          assert.areEqual(
            4,
            instances.length,
            "Four widget instances are present."
          );
          assert.areEqual(
            "test2",
            instances[3].name,
            "Widget4 is correctly initialized."
          );
          assert.isInstanceOf(
            CKEDITOR.plugins.widget,
            widget,
            "Widget4 is instance of widget"
          );
        }
      );
    },
        ...
        assert.isMatching(
          new RegExp(
            "^<div " +
              ...
              '><h1 data-cke-widget-keep-attr="1" data-widget="test2">TEST2</h1></div>' +
              "<p>foo</p>" +
              "<div " +
              widgetWrapperAttributes +
              '><h1 data-cke-widget-keep-attr="1" data-widget="test2">TEST2</h1></div>$'
          ...
          fixHtml(
            editor.dataProcessor.toHtml(
              sampleWidget2 + "<p>foo</p>" + sampleWidget2
            )
          )
        );
      });
      ...
      this.editorBot.setData("", function () {
        assert.isMatching(
          new RegExp(
            "^<p>X</p><div " +
              widgetWrapperAttributes +
              '><h1 data-cke-widget-keep-attr="1" data-widget="test2">TEST2</h1></div><p>X</p>$'
          ),
          fixHtml(
            editor.dataProcessor.toHtml(
              '<p>X</p><div class="cke_widget_wrapper" data-cke-widget-wrapper="1" data-cke-widget-id="66" id="oldWrapper" contenteditable="false">' +
                sampleWidget2 +
                "</div><p>X</p>"
            )
          )
    ...
    "test widget wrapper is skipped by data processor": function () {
      ...
      this.editorBot.setData(
        '<p>X</p><div><p data-widget="test" id="w1"><span>foo</span></p></div>',
        function () {
          ...
          assert.areSame(
            '<p foo="12">X</p><div foo="12"><p data-widget="test" id="w1"><span>foo</span></p></div>',
            data
          );
          assert.isFalse(
            getWidgetById(editor, "w1").wrapper.hasAttribute("foo")
          );
        }
      );
    },
      ...
      this.editorBot.setData(
        ...
        function () {
          ...
          assert.areEqual(
            3,
            instances.length,
            "Three widget instances are present at the beginning"
          );
          ...
          assert.areEqual(
            4,
            instances.length,
            "Four widget instances are present after initializing new one"
          );
          ...
          bot.setData(sampleWidget2, function () {
            ...
            assert.areEqual(
              1,
              instances.length,
              "After setData only one widget instance is registered"
            );
            ...
            if (!CKEDITOR.env.ie)
              assert.isTrue(
                el.getParent().hasAttribute("data-cke-widget-id"),
                "Widgets were destroyed in offline mode"
              );
    ...
    "test checkWidgets event on insertHtml": function () {
      ...
      this.editorBot.setData(
        '<p data-widget="test2" id="w1">A</p><p>x</p>',
        function () {
          var widget = getWidgetById(editor, "w1"),
          ...
          assert.areSame(
            '<p data-widget="test2" id="w1">A</p><p>x</p>',
            editorData,
            "event was fired after data was inserted"
          );
        }
      );
    },
    ...
    "test checkWidgets event on insertHtmlIntoRange": function () {
      ...
      this.editorBot.setData(
        '<p data-widget="test2" id="w1">A</p><p>xx</p>',
        function () {
          var widget = getWidgetById(editor, "w1"),
            html = widget.wrapper.getOuterHtml();
          ...
          assert.isTrue(eventData.initOnlyNew, "data.initOnlyNew was passed");
          assert.isUndefined(
            eventData.focusInited,
            "data.initOnlyNew was not passed"
          );
          assert.areSame(
            '<p>x</p><p data-widget="test2" id="w1">A</p><p>x</p>',
            editorData,
            "event was fired after data was inserted"
          );
        }
    ...
    "test widgets are correctly destroyed/initialzed on mode switch":
      function () {
        var editor = this.editor;
        ...
        this.editorBot.setData(
          ...
          function () {
            ...
            assert.areEqual(
              2,
              CKEDITOR.tools.object.keys(widgets.instances).length,
              "Two widgets instances are present at the beginning"
            );

            // Ensure async.
            wait(function () {
              editor.setMode("source", function () {
                var sourceWidgetsLength = CKEDITOR.tools.object.keys(
                    widgets.instances
                  ).length,
                ...
                editor.setMode("wysiwyg", function () {
                  resume(function () {
                    assert.areEqual(
                      0,
                      sourceWidgetsLength,
                      "There are no instances in source mode"
                    );
                    assert.areEqual(
                      sampleWidget2 + "<p>foo</p>" + sampleWidget2,
                      sourceData,
                    ...
                    assert.areEqual(
                      2,
                      CKEDITOR.tools.object.keys(editor.widgets.instances)
                        .length,
                      "Two instances has been initialized after switching back to wysiwyg"
                    );
                    assert.areEqual(
                      2,
                      editor.editable().find(".cke_widget_wrapper").count(),
    ...
    "test automatic data-cke-widget removing if was not present when upcasting":
      function () {
        var editor = this.editor,
          bot = this.editorBot;
          ...
          bot.setData(
            ...
            function () {
              assert.areSame(
                ...
                "4 widgets are upcasted"
              );
              assert.areSame(
                '<p><i class="autodata" data-widget="autodata1">A</i><i class="autodata">B</i>' +
                  '<b class="autodata" data-widget="autodata2" foo="1">C</b><b class="autodata" foo="1">D</b></p>',
                editor.getData()
              );
            }
          );
          ...
          editor.once("afterPaste", function () {
            resume(function () {
              assert.areEqual(
                4,
                CKEDITOR.tools.object.keys(editor.widgets.instances).length,
                "instances afterPaste"
              );

              assert.areEqual(
                4,
                editor.document.find(".cke_widget_wrapper").count(),
                "wrappers afterPaste"
              );
    ...
    "test pasting upcasted widgets": function () {
      ...
      this.editorBot.setData(
        '<p><i class="upcasted_pasting">foo</i></p>',
        function () {
          editor.focus();
          ...
          assert.areSame(
            1,
            CKEDITOR.tools.object.keys(editor.widgets.instances).length,
            "1 widget instance after setData"
          );
            ...
            editor.once("afterPaste", function () {
              resume(function () {
                assert.isMatching(
                  ...
                  "HTML after pasting element"
                );
                assert.areSame(
                  1,
                  CKEDITOR.tools.object.keys(editor.widgets.instances).length,
                  "1 widget instance after paste"
                );
              });
            });
      ...
      this.editorBot.setData(sampleWidget + "<p>X</p>", function () {
        ...
        editor.once("afterPaste", function () {
          resume(function () {
            assert.areSame(
              "bar",
              objToArray(editor.widgets.instances)[0].data.foo
            );
          });
        });
    ...
    "test single pasted widget is focused": function () {
      ...
      this.editorBot.setData(
        '<p id="w1" data-widget="test2">X</p>',
        function () {
          var html = editor.editable().getHtml();

          // https://bugzilla.mozilla.org/show_bug.cgi?id=911201
          if (CKEDITOR.env.gecko) html = html.replace(/^<br>/, "");
          ...
          editor.once("afterPaste", function () {
            resume(function () {
              ...
              assert.areSame(
                1,
                instances.length,
                "one widget initialized after paste"
              );
    ...
    "test no focused widget after pasting few": function () {
      ...
      this.editorBot.setData(
        '<p id="w1" data-widget="test2">A</p><p>X</p><p id="w1" data-widget="test2">B</p>',
        function () {
          var html = editor.editable().getHtml();
    ...
    "test copying single focused widget": function () {
      ...
      this.editorBot.setData(
        '<p>X</p><p id="w1" data-widget="test2">A</p>',
        function () {
          var widget = getWidgetById(editor, "w1"),
            selectionChanged = 0;
          ...
          assert.isTrue(
            copybin.contains(selContainer) || copybin.equals(selContainer),
            "selection was moved to the copybin"
          );
          ...
          wait(function () {
            ...
            assert.isTrue(
              ...
              "selection stayed faked"
            );
            assert.isFalse(
              !!editor.document.getById("cke_copybin"),
              "copybin was removed"
            );
    ...
    "test cutting single focused widget": function () {
      ...
      this.editorBot.setData(
        '<p>X</p><p id="w1" data-widget="test2">A</p><p>X</p>',
        function () {
          var widget = getWidgetById(editor, "w1"),
            selectionChanged = 0;
          ...
          editor
            ...
            .fire(
              "keydown",
              new CKEDITOR.dom.event({ keyCode: CKEDITOR.CTRL + 88 })
            );
    ...
    "test pasting single focused widget": function () {
      ...
      this.editorBot.setData(
        '<p data-widget="test2" id="w1">A</p><p id="p1">X</p>',
        function () {
          var widget = getWidgetById(editor, "w1"),
            html = widget.wrapper.getOuterHtml();
          ...
          editor.once("afterPaste", function () {
            resume(function () {
              ...
              assert.areSame(
                '<p id="p1">X</p><p data-widget="test2" id="w1">A</p>',
                editor.getData()
              );
              assert.isTrue(
                !!editor.getSelection().isFake,
    ...
    "test pasting a widget with lots of extra markup and mixed HTML case":
      function () {
        var editor = this.editor;

        this.editorBot.setData(
          '<p id="p1">A<span data-widget="test2" id="w1">A</span>B</p>',
          function () {
            var widget = getWidgetById(editor, "w1"),
              html = widget.wrapper.getOuterHtml();
            ...
            editor.once("afterPaste", function () {
              resume(function () {
                ...
                assert.isTrue(!!widget, "widget was pasted");
                assert.areSame(
                  '<p id="p1">AB<span data-widget="test2" id="w1">A</span></p>',
                  editor.getData()
                );
                assert.areSame(
                  widget,
    ...
    "test copying widget with context": function () {
      ...
      this.editorBot.setData(
        '<p>X<b><span id="w1" data-widget="test2">A</span></b>X</p>',
        function () {
          var widget = getWidgetById(editor, "w1"),
          ...
          wait(function () {
            ...
            assert.areSame(
              "b",
              range.startContainer.getName(),
              "startContainer"
            );
            assert.areSame("b", range.endContainer.getName(), "endContainer");
            assert.isTrue(
              range.startContainer.getChild(0).hasClass("cke_widget_wrapper")
            );
          }, 150);
        }
      );
    ...
    "test widget blocking/passing keystrokes": function () {
      ...
      this.editorBot.setData(
        '<p>foo</p><p id="w" data-widget="test2">X</p><p id="p2">bar</p>',
        function () {
    ...
    "leave focused widget by arrow keys": function () {
      ...
      this.editorBot.setData(
        '<p id="p1">foo</p><p id="w" data-widget="test2">X</p><p id="p2">bar</p>',
        function () {
          var editable = editor.editable(),
    ...
    "do not leave focused widget by arrow keys if there is not editing place by its side":
      function () {
        var editor = this.editor;

        this.editorBot.setData(
          '<p id="w" data-widget="test2">X</p>',
          function () {
            var editable = editor.editable(),
              widget = getWidgetById(editor, "w");
    ...
    "move to sibling widget by arrow keys": function () {
      ...
      this.editorBot.setData(
        '<p>X</p><p id="w1" data-widget="test2">X</p><p id="w2" data-widget="test2">X</p>',
        function () {
          var editable = editor.editable(),
    ...
    "forwarding keys to focused widget": function () {
      ...
      this.editorBot.setData(
        '<p id="w1" data-widget="test2">X</p><p id="w2" data-widget="test2">X</p><p id="x">foo</p>',
        function () {
          var editable = editor.editable(),
            widget1 = getWidgetById(editor, "w1"),
            widget2 = getWidgetById(editor, "w2"),
    ...
    "blocking forwarded keys by widget listener": function () {
      ...
      this.editorBot.setData(
        ...
        function () {
          ...
          widget1.focus();
          var success = editable.fire(
            "keydown",
            new CKEDITOR.dom.event({ keyCode: 77 })
          );
          listener.removeListener();
    ...
    "all not handled keys are blocked by default on focused widget":
      function () {
        var editor = this.editor;
    ...
    "forwarding double click to widget": function () {
      ...
      this.editorBot.setData(
        '<p id="w1" data-widget="test2"><span id="i1">X</span></p>',
        function () {
          ...
          editor.fire("doubleclick", {
            element: editor.document.getById("w1"),
          });

          assert.areSame(1, fired, "Widget#doubleclick was fired");
          assert.areSame(
            editor.document.getById("w1"),
            clicked,
            "Clicked element is w1"
          );

          editor.fire("doubleclick", {
            element: editor.document.getById("i1"),
          });

          assert.areSame(
            2,
            fired,
            "Widget#doubleclick was fired on dbclick on inner element"
          );
          assert.areSame(
            editor.document.getById("i1"),
            clicked,
            "Clicked element is i1"
          );
        }
      );
    },
    ...
    "blocking forwarded double click by widget listener": function () {
      ...
      this.editorBot.setData(
        ...
        function () {
          ...
          var success = editor.fire("doubleclick", {
            element: editor.document.getById("w1"),
          });
