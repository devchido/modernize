...
(function () {
  ...
  bender.test({
    ...
    // (excludding body).
    __testMockupWidgetPath: function (
      sourceTextareaId,
      selectElementId,
      expectedElementsPath
    ) {
      ...
      this.editorBot.setData(
        bender.tools.getValueAsHtml(sourceTextareaId),
        function () {
    ...
    "test widget path name overriding": function () {
      ...
      this.__testMockupWidgetPath(
        "editorContent",
        "headerspan",
        "customWIDGETname,h2,span"
      );
    },
    ...
    "test widget editable path name overriding": function () {
      ...
      this.mockupWidgetDefinition.editables.content.pathName =
        "customWIDGETname";
      this.__testMockupWidgetPath(
        "editorContent",
        "contentstrong",
        "div,customWIDGETname,strong"
      );
    },
    ...
    "test widgets wrapper default name": function () {
      ...
      this.__testMockupWidgetPath(
        "editorContent2",
        "dt_mockup_descr_span",
        "dl,dd,span"
      );

      if (dtdFixtureNeeded) delete CKEDITOR.dtd.$editable.dd;
    },
  });
})();
