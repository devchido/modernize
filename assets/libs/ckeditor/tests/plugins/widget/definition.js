  ...
  bender.test({
    "test basics": function () {
      ...
      assert.areNotSame(
        regWidgetDef,
        widgetDef,
        "registered widget def and passed widget def are not the same object"
      );
      assert.areSame(
        regWidgetDef,
        editor.widgets.registered.testbasics1,
    ...
    "test references are broken": function () {
      ...
      this.editorBot.setData(
        '<p>X<b data-widget="testrefs1" id="x">foo</b><b data-widget="testrefs1" id="y">bar</b>X</p>',
        function () {
          var widget1 = editor.widgets.getByElement(
      ...
      bender.editorBot.create(
        ...
        function (bot) {
          ...
          assert.isMatching(
            ...
            fixHtml(dataP.toHtml("<p>foo<b>bar</b></p>")),
            "upcast b"
          );
          ...
          assert.isMatching(
            ...
            fixHtml(
              dataP.toHtml('<p>foo<b data-widget="testup1" foo="1">bar</b></p>')
            ),
            "b was already upcasted"
          );
          ...
          assert.isMatching(
            ...
            fixHtml(dataP.toHtml('<p>foo<i foo="1">bar</i></p>')),
            "upcast i"
          );

          assert.isMatching(
            /^<p>foo<u foo="1">bar<\/u><\/p>$/,
            fixHtml(dataP.toHtml('<p>foo<u foo="1">bar</u></p>')),
            "do not upcast u"
          );

          assert.isMatching(
            /^<p>foo<span .*data-cke-widget-wrapper="1".*><u data-cke-widget-keep-attr="1" data-widget="testup1">bar<\/u><\/span><\/p>$/,
            fixHtml(dataP.toHtml('<p>foo<u data-widget="testup1">bar</u></p>')),
            "do not block upcasted u"
          );
          ...
          assert.isMatching(
            ...
            fixHtml(
              dataP.toHtml(
                '<p>foo<u data-widget="testup1">b<i><b>a</b>r</i></u></p>'
              )
            ),
            "do upcast b&i in widget"
          );
          ...
          assert.isMatching(
            ...
            fixHtml(dataP.toHtml("<p>foo<b><i>bar</i></b></p>")),
            "do upcast twice"
          );
      ...
      bender.editorBot.create(
        ...
        function (bot) {
          ...
          assert.isMatching(
            ...
            fixHtml(dataP.toHtml('<p>foo<u data-widget="testup2">bar</u></p>')),
            "pass upcasted u"
          );
      ...
      bender.editorBot.create(
        ...
        function (bot) {
          ...
          bot.setData("<p><b>A</b>X<b>B</b></p>", function () {
            assert.areSame(
              "bar1,bar2",
              dataValues.sort().join(","),
              "data.value were set"
            );
            assert.areSame(
              "1,1",
              dataValues2.sort().join(","),
              "data.value2 were used from defaults"
            );
          });
        }
      );
    ...
    "test which element are tested by upcast methods": function () {
      ...
      this.editorBot.setData("<p>x<b>y</b></p><div>z</div>", function () {
        assert.areSame(
          "p,b,div",
          elNames.join(","),
          "all editable's element ancestor"
        );
      });
    },
    ...
    "test no downcasts": function () {
      ...
      this.editorBot.setData(
        '<p>X<b data-widget="testtpl2" foo="1">bar</b>X</p>',
        function () {
          assert.areSame(
            '<p>X<b data-widget="testtpl2" foo="1">bar</b>X</p>',
            editor.getData()
    ...
    "test downcasting": function () {
      bender.editorBot.create(
        ...
        function (bot) {
          ...
          var widgetDef = {
            downcasts: {
              ...
              down2: function (el) {
                assert.areSame(
                  "testdown2",
                  el.attributes["data-widget"],
                  "element passed as 1st arg"
                );

                assert.areSame(
                  "u",
                  this.element.getName(),
                  "widget instance is a context"
                );
          ...
          bot.setData(
            '<p>X<u data-widget="testdown1">A</u>B<u data-widget="testdown2">C</u>D<u data-widget="testdown3">E</u>X</p>',
            function () {
              assert.areSame(
                '<p>X<u data-widget="testdown1">A</u>B<i>bar</i>D<b data-widget="testdown3" foo="1">E</b>X</p>',
                editor.getData()
              );
            }
          );
      ...
      bender.editorBot.create(
        ...
        function (bot) {
          ...
          bot.setData('<p>X<u data-widget="testdown5">A</u>X</p>', function () {
            assert.areSame(
              '<p>X<u data-widget="testdown5" foo="1">A</u>X</p>',
              editor.getData()
            );
          });
        }
    ...
    "test parts": function () {
      ...
      this.editorBot.setData(
        '<p data-widget="testparts1" id="x"><b>foo</b><i id="eli">bar</i></p>',
        function () {
          var elP = editor.document.getById("x"),
            widget = editor.widgets.getByElement(elP);

          assert.areSame(
            elP.getElementsByTag("b").getItem(0),
            widget.parts.foo,
            "foo"
          );
          assert.areSame(
            elP.getElementsByTag("i").getItem(0),
            widget.parts.bar,
            "bar"
          );
          ...
          assert.areSame(
            elP.getElementsByTag("b").getItem(0),
            fooInInit,
            "parts are already ready when init method is executed"
          );
        }
      );
    },
    ...
    "test defined dialog name": function () {
      ...
      this.editorBot.setData(
        '<p data-widget="testdialog1" id="x">foo</p>',
        function () {
    ...
    "test no dialogName": function () {
      ...
      this.editorBot.setData(
        '<p data-widget="testdialog2" id="x">foo</p>',
        function () {
          var widget = getWidgetById(editor, "x"),
            dialogName;
    ...
    "test insert method": function () {
      ...
      this.editorBot.setData("<p>foo</p>", function () {
        ...
        this.editorBot.setData(
          '<p>X</p><p data-widget="testcommand2" id="w1">foo</p>',
          function () {
            ...
            assert.areSame(
              1,
              widgetDef.insert.callCount,
              "Insert was not called this time"
            );
    ...
    "test automatic data listener": function () {
      ...
      this.editorBot.setData(
        '<p data-widget="testautodata" id="w">foo</p>',
        function () {
          ...
          assert.areSame(
            1,
            dataFired,
            "data listener was attached during initialization"
          );
          assert.isTypeOf(
            "object",
            widget.data,
            "data method has not been overriden"
          );
    ...
    "test automatic edit listener": function () {
      ...
      this.editorBot.setData(
        '<p data-widget="testautoedit" id="w">foo</p>',
        function () {
          var widget = getWidgetById(editor, "w");

          assert.areSame(
            widget.edit,
            CKEDITOR.plugins.widget.prototype.edit,
            "edit method was not overriden"
          );
          assert.areSame(
            editFn,
            widgetDef.edit,
            "widget definition was not modified"
          );
          ...
          assert.areSame(
            1,
            editFired,
            "edit listener was attached during initialization"
          );
        }
      );
    },
    ...
    "test editables": function () {
      ...
      editorBot.setData(
        ...
        function () {
          ...
          assert.isFalse(
            !!widget.editables.el5,
            "el5 was not found because it is not allowed editable element (span)"
          );
          ...
          assert.isTrue(
            widget.element.contains(widget.editables.el1),
            "widget contains editable el1"
          );

          editorBot.setData(
            '<div data-widget="testeditables1" id="w1" class="editable">X</div><div class="editable">Y</div>',
            function () {
              var widget = getWidgetById(editor, "w1");
              assert.areSame(
                editor.document.getById("w1"),
                widget.editables.el4,
                "el4 was found"
              );
            }
          );
    ...
    "test mask": function () {
      ...
      this.editorBot.setData(
        '<p>foo</p><p data-widget="testmask1" id="w1">bar</p>',
        function () {
          var widget = getWidgetById(editor, "w1");
          ...
          assert.areSame(
            widget.wrapper,
            widget.mask.getParent(),
            "mask is a wrapper's child"
          );
          assert.isTrue(
            widget.dragHandlerContainer.getIndex() > widget.mask.getIndex(),
            "drag handler is placed over mask"
          );
    ...
    "test inline property - block case": function () {
      ...
      this.editorBot.setData(
        '<p>foo</p><p data-widget="testautoinline1" id="w1">bar</p>',
        function () {
          var widget = getWidgetById(editor, "w1");
    ...
    "test inline property - inline case": function () {
      ...
      this.editorBot.setData(
        '<p>foo</p><p><em data-widget="testautoinline2" id="w1">bar</em></p>',
        function () {
          var widget = getWidgetById(editor, "w1");
    ...
    "test inline property - forced block case": function () {
      ...
      this.editorBot.setData(
        '<p>foo</p><p><em data-widget="testforcedinline1" id="w1">bar</em></p>',
        function () {
          var widget = getWidgetById(editor, "w1");
    ...
    "test draggable false": function () {
      ...
      this.editorBot.setData(
        '<p>foo</p><p><em data-widget="testdraggable1" id="w1">bar</em></p>',
        function () {
          var widget = getWidgetById(editor, "w1");

          assert.isNull(
            widget.wrapper.findOne(".cke_widget_drag_handler_container"),
            "no drag handler"
          );
    ...
    "test draggable - default value": function () {
      ...
      this.editorBot.setData(
        '<p>foo</p><p data-widget="testdraggable2" id="w1">bar</p>',
        function () {
          var widget = getWidgetById(editor, "w1");
    ...
    "test upcasting with DOM modification (split before upcasted element)":
      function () {
        var editor = this.editor,
          visited = 0;
        ...
        editor.widgets.add("testsplit", {
          upcast: function (el) {
            if (visited) assert.fail("Recurrent upcasting!");
