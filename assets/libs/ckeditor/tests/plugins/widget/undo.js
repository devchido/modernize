...
(function () {
  ...
  var widgetDefinition1 = {
    ...
    widgetData1 =
      '<p id="p1">X</p><div data-widget="test1" id="w1">Y<p class="e">Z</p></div>',
    widgetDefinition2 = {
      defaults: {
        value1: "x",
      },
  ...
  function assertCommands(editor, expectActiveUndo, expectActiveRedo, msg) {
    ...
    assert.areSame(
      expectActiveUndo ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED,
      editor.getCommand("undo").state,
      msg + "undo"
    );
    assert.areSame(
      expectActiveRedo ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED,
  ...
  bender.test({
      ...
      this.editorBot.setData("", function () {
        ...
        editor.once("dialogHide", function () {
          resume(function () {
            ...
            assert.areSame(
              "newfoo",
              getWidgetById(editor, "w1").data.value1,
              "set value"
            );
            assertCommands(editor, true, false, "after insert");
    ...
    "test widget pasting": function () {
      ...
      this.editorBot.setData(widgetData1, function () {
          ...
          function () {
            resume(function () {
              assert.areSame(
                2,
                objToArray(editor.widgets.instances).length,
                "widget was pasted and initialized"
              );
        ...
        wait(function () {
          editor.execCommand(
            "paste",
            getWidgetById(editor, "w1").wrapper.getOuterHtml()
          );
        });
      });
    },
    ...
    "test d&d inline widget": function () {
      ...
      this.editorBot.setData(
        '<p id="p1">x<span data-widget="test1" id="w1">Y</span>x</p>',
        function () {
          editor.resetUndo();
          editor.focus();
          ...
          editor.once("afterPaste", function () {
            resume(function () {
              ...
              assert.areSame(
                '<p id="p1"><span data-widget="test1" id="w1">Y</span>xx</p>',
                editor.getData()
              );
          ...
          wait(function () {
            ...
            evt.setTarget(
              editor.document.findOne("img.cke_widget_drag_handler")
            );
    ...
    "test d&d block widget": function () {
      ...
      this.editorBot.setData(
        '<p id="a">x</p><div data-widget="test1" id="w1">Y<p class="e">Z</p></div>',
        function () {
          var widget = getWidgetById(editor, "w1"),
          ...
          editor.once("afterPaste", function () {
            resume(function () {
              ...
              assert.areSame(
                '<div data-widget="test1" id="w1">Y<p class="e">Z</p></div><p id="a">x</p>',
                editor.getData()
              );
              assertCommands(editor, true, false, "after d&d");
    ...
    "test widget deleting": function () {
      ...
      this.editorBot.setData(widgetData1, function () {
        ...
        editor
          .editable()
          .fire("keydown", new CKEDITOR.dom.event({ keyCode: 46 }));
