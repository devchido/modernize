...
(function () {
  ...
  var Repository, Widget, onSpy, repo;
  ...
  bender.test({
    ...
    'test event listener added for element added to repo after calling "onWidget" method':
      function () {
        var cbMock = sinon.mock();
    ...
    "test event listener called with proper arguments": function () {
      ...
      assert.isTrue(
        onSpy.firstCall.calledWithExactly("action", cbMock, null, null, 5)
      );
    },
  });
})();
