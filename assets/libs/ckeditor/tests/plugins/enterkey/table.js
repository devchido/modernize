...
bender.test({
  ...
  "test enter key inside of table cell": function () {
    if (this.mode == CKEDITOR.ENTER_P) {
      ...
      assert.areSame(
        "<table><tbody><tr><td><p>foo</p><p>&nbsp;</p></td></tr></tbody></table>",
        this.enterKey("<table><tr><td>foo^</td></tr></table>")
      );
      assert.areSame(
        "<table><tbody><tr><td><p>&nbsp;</p><p>foo</p></td></tr></tbody></table>",
        this.enterKey("<table><tr><td>^foo</td></tr></table>")
      );
    } else if (this.mode == CKEDITOR.ENTER_BR) {
      assert.areSame(
        "<table><tbody><tr><td>foo<br />&nbsp;</td></tr></tbody></table>",
        this.enterKey("<table><tr><td>foo^</td></tr></table>")
      );
      assert.areSame(
        "<table><tbody><tr><td><br />foo</td></tr></tbody></table>",
        this.enterKey("<table><tr><td>^foo</td></tr></table>")
      );
    }
    ...
    assert.areSame(
      "<table><caption><p>foo</p><p>bar</p></caption><tbody><tr><td>bar</td></tr></tbody></table>",
      this.enterKey(
        "<table><caption>foo^bar</caption><tr><td>bar</td></tr></table>"
      )
    );
  },
});
