...
(function () {
  ...
  function assertEnter(name, data, expected, action, message, selMatters) {
    ...
    if (action === true) editor.execCommand("enter");
    else action(editor);
  ...
  bender.test({
    ...
    "test enterkey at the end of nested list item": function () {
      assertEnter(
        ...
        function (editor) {
          var i = 0;
          while (i++ < 3) editor.execCommand("enter");
        },
        true
      );
    },

    "test enterkey in first empty &lt;li&gt;, block-less: collapse list":
      function () {
        assertEnter(
          "enterP",
          "<ul>" +
          ...
          true,
          "List should collapse.",
          true
        );
      },

    "test enterkey in first empty &lt;li&gt;, block-less: collapse list (ENTER_BR)":
      function () {
        assertEnter(
          "enterBR",
          "<ul>" +
    ...
    "test enterkey in middle empty &lt;li&gt;, block-less: split list":
      function () {
        assertEnter(
          "enterP",
          "<ul>" +
    ...
    "test enterkey in middle empty &lt;li&gt;, block-less: split list (ENTER_BR)":
      function () {
        assertEnter(
          "enterBR",
          "<ul>" +
    ...
    "test enterkey in last empty &lt;li&gt;, block-less: collapse list":
      function () {
        assertEnter(
          "enterP",
          "<ul>" +
    ...
    "test enterkey in last empty &lt;li&gt;, block-less: collapse list (ENTER_BR)":
      function () {
        assertEnter(
          "enterBR",
          "<ul>" +
    ...
    "test enterkey in first empty &lt;li&gt;, block, extract contents":
      function () {
        assertEnter(
          "enterP",
          "<ul>" + "<li>^</li>" + "<li>x</li>" + "</ul>",
          ...
          true,
          "Paragraph should be extracted right before the list.",
          true
        );
      },

    "test enterkey in first empty &lt;li&gt;, block, extract contents (ENTER_BR)":
      function () {
        assertEnter(
          "enterBR",
          "<ul>" + "<li>^</li>" + "<li>x</li>" + "</ul>",

          new RegExp("\\^(<br />)?&nbsp;" + "<ul>" + "<li>x</li>" + "</ul>"),

          true,
          "New line should be extracted right before the list.",
          true
        );
      },
    ...
    "test enterkey in middle empty &lt;li&gt;, block, split list": function () {
      assertEnter(
        ...
        true,
        "List should be divided by a paragraph.",
        true
      );
    },

    "test enterkey in middle empty &lt;li&gt;, block, split list (ENTER_BR)":
      function () {
        ...
        assertEnter(
          ...
          true,
          "List should be divided.",
          true
        );
      },

    "test enterkey in last empty &lt;li&gt;, block, extract contents":
      function () {
        assertEnter(
          "enterP",
          "<ul>" + "<li>x</li>" + "<li>^</li>" + "</ul>" + "<p>y</p>",

          "<ul>" + "<li>x</li>" + "</ul>" + "<p>^&nbsp;</p>" + "<p>y</p>",

          true,
          "A paragraph should be extracted right after the list.",
          true
        );
      },

    "test enterkey in last empty &lt;li&gt;, block, extract contents (ENTER_BR)":
      function () {
        assertEnter(
          "enterBR",
          "<ul>" + "<li>x</li>" + "<li>^</li>" + "</ul>" + "<p>moo</p>",
          ...
          true,
          "A new line should be extracted right after the list.",
          true
        );
      },
    ...
    "test enterkey: preserve &lt;li&gt; styles": function () {
      assertEnter(
        "enterP",
        "<ul>" + "<li>x</li>" + '<li style="color:red;">^</li>' + "</ul>",

        "<ul>" + "<li>x</li>" + "</ul>" + '<p style="color:red;">^&nbsp;</p>',
    ...
    "test enterkey: preserve &lt;li&gt; classes": function () {
      assertEnter(
        "enterP",
        "<ul>" + "<li>x</li>" + '<li class="foo bar">^</li>' + "</ul>",

        "<ul>" + "<li>x</li>" + "</ul>" + '<p class="foo bar">^&nbsp;</p>',
    ...
    "test enterkey: preserve text direction": function () {
      assertEnter(
        ...
        true,
        "Direction should be preserved if different than cointainer's.",
        true
      );
    },
    ...
    "test enterkey: leaves empty list item with h1 format": function () {
      assertEnter(
        "enterP",
        "<ul>" + "<li>x</li>" + "<li><h1>^</h1></li>" + "<li>y</li>" + "</ul>",
        ...
        true,
        "List should be split and format preserved.",
        true
      );
    },
    ...
    "test enterkey: leaves empty list item with a paragraph": function () {
      assertEnter(
        "enterP",
        "<ul>" + "<li>x</li>" + "<li><p>^</p></li>" + "<li>y</li>" + "</ul>",
    ...
    "test enterkey: force block: class (ENTER_BR)": function () {
      assertEnter(
        "enterBR",
        "<ul>" + "<li>x</li>" + '<li class="foo">^</li>' + "</ul>",

        "<ul>" + "<li>x</li>" + "</ul>" + '<div class="foo">^&nbsp;</div>',
    ...
    "test enterkey: nested empty list": function () {
      assertEnter(
        ...
        true,
        "New item should be added to the list.",
        true
      );
    },
