  ...
  bender.test({
    ...
    "test enter key after invisible element": function () {
      ...
      bot.setHtmlWithSelection(
        '<p>foo<span style="display:none;">bar^</span></p>'
      );
      ...
      var expected = CKEDITOR.env.safari
    ...
    "test enter key at the end of block with inline styles": function () {
      ...
      assert.areSame(
        "<p><b><i>foo</i></b></p><p><b><i>bar</i></b></p>",
    ...
    "test enter key in the middle of contents with comments": function () {
      ...
      assert.areSame(
        "<p>foo</p><p>bar</p>",
        bot.getData(false, true).replace(/<![^>]+>/g, "")
      );
    },
    ...
    "test enter key in the middle of contents with comments (2)": function () {
      ...
      assert.areSame(
        "<p><b>foo</b>bar</p><p>baz<!-- --><b>qux</b></p>",
        bot.getData(false, true)
      );
    },
    ...
    "test enter key - start of block": e(
      "editor",
      '<p id="x">{}foo</p>',
      '<p>@@</p><p id="x">^foo@</p>'
    ),
    "test enter key - middle of block": e(
      "editor",
      '<p id="x">foo{}bar</p>',
      '<p id="x">foo@</p><p>^bar@</p>'
    ),
    "test enter key - end of block": e(
      "editor",
      '<p id="x">foo{}</p>',
      '<p id="x">foo@</p><p>^@</p>'
    ),

    "test enter key - inline with id": e(
      "editor",
      '<p>fo<b id="x">o{}b</b>ar</p>',
      '<p>fo<b id="x">o</b>@</p><p><b>^b</b>ar@</p>'
    ),
    "test enter key - block with id": e(
      "editor",
      '<div><p id="x">fo<b id="y">o{}b</b>ar</p></div>',
      '<div><p id="x">fo<b id="y">o</b>@</p><p><b>^b</b>ar@</p></div>'
    ),

    "test shift+enter key - middle of block": se(
      "editor",
      "<p>foo{}bar</p>",
      "<p>foo<br />^bar@</p>"
    ),
    "test shift+enter key - list item": se(
      "editor",
      "<ul><li>foo{}bar</li></ul>",
      "<ul><li>foo<br />^bar@</li></ul>"
    ),
    "test shift+enter key - start of block": se(
      "editor",
      "<p>{}foobar</p>",
      "<p><br />^foobar@</p>"
    ),
    "test shift+enter key - end of block": se(
      "editor",
      "<p>foobar{}</p>",
      "<p>foobar<br />^@</p>"
    ),
    "test shift+enter key - before br": se(
      "editor",
      "<p>foo{}<br />bar</p>",
      "<p>foo<br />^<br />bar@</p>"
    ),
    "test shift+enter key - after br": se(
      "editor",
      "<p>foo<br />{}bar</p>",
      "<p>foo<br /><br />^bar@</p>"
    ),
    ...
    "test shift+enter key - end of list item, inside inline element followed by bogus br":
      se(
        "editor",
        "<ul><li><em>foo{}</em><br /></li></ul>",
        "<ul><li><em>foo<br />^</em><br /></li></ul>"
      ),
  });
})();
