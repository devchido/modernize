...
bender.test({
  ...
  test_empty: function () {
    this.doTest(
      "<p>foo</p><blockquote><p>^</p></blockquote>",
      "<p>foo</p><p>^</p>"
    );
  },
  ...
  test_startWithText: function () {
    this.doTest(
      ...
      "<blockquote><p></p><p>^Some text</p></blockquote>"
    );
  },
  ...
  test_endWithText: function () {
    this.doTest(
      "<blockquote><p>Some text^</p></blockquote>",
      "<blockquote><p>Some text</p><p>^</p></blockquote>"
    );
  },

  test_emptyMiddle: function () {
    this.doTest(
      "<blockquote><p>Line1</p><p>^</p><p>Line 2</p></blockquote>",
      "<blockquote><p>Line1</p></blockquote><p>^</p><blockquote><p>Line 2</p></blockquote>"
    );
  },
  ...
  test_middleOfText: function () {
    this.doTest(
      "<blockquote><p>Some^text</p></blockquote>",
      "<blockquote><p>Some</p><p>^text</p></blockquote>"
    );
  },
  ...
  test_start: function () {
    this.doTest(
      "<blockquote><p>^</p><p>Some text</p></blockquote>",
      "<p>^</p><blockquote><p>Some text</p></blockquote>"
    );
  },
  ...
  test_startWithStyles: function () {
    this.doTest(
      "<blockquote><p><b><i>^</i></b></p><p>Some text</p></blockquote>",
      "<p><b><i>^</i></b></p><blockquote><p>Some text</p></blockquote>"
    );
  },

  test_endWithStyles: function () {
    this.doTest(
      "<blockquote><p>Some text</p><p><b><i>^</i></b></p></blockquote>",
      "<blockquote><p>Some text</p></blockquote><p><b><i>^</i></b></p>"
    );
  },
});
