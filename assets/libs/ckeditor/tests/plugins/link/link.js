...
(function () {
  ...
  bender.test({
    ...
    "test edit link (text selected)": function () {
      ...
      bot.setHtmlWithSelection(
        '<a href="http://cksource.com" name="test">[foo]</a>'
      );
      ...
      bot.dialog("link", function (dialog) {
        ...
        assert.areSame(
          '<a href="http://ckeditor.com" name="test">foo</a>',
          bot.getData(true)
        );
      });
    },
    ...
    "test unlink command states": function () {
      ...
      assert.isTrue(
        unlink.state == CKEDITOR.TRISTATE_DISABLED,
        "collapsed not in link"
      );
      bot.setHtmlWithSelection(
        '<a href="http://ckeditor.com" name="test">[<i contenteditable="false">bar</i>]</a>'
      );
      assert.isTrue(
        unlink.state == CKEDITOR.TRISTATE_OFF,
        "fake selection on non-editable element in link"
      );
    },
    ...
    "test getSelectedLink for selection inside read-only node": function () {
      ...
      bot.setHtmlWithSelection(
        'foo<span contenteditable="false">ba^r</span>bum'
      );
      assert.isNull(CKEDITOR.plugins.link.getSelectedLink(editor));
    },

    "test getSelectedLink for fake selection on non-editable element":
      function () {
        var bot = this.editorBots.noValidation,
          editor = bot.editor;

        bot.setHtmlWithSelection(
          'foo<a href="http://ckeditor.com">[<i contenteditable="false">bar</i>]</a>bum'
        );
        assert.areSame(
          "a",
          CKEDITOR.plugins.link.getSelectedLink(editor).getName()
        );
      },
    ...
    "test create link on a non-editable inline element": function () {
      ...
      bot.dialog("link", function (dialog) {
        ...
        assert.areSame(
          'foo<a href="http://ckeditor.com"><em contenteditable="false">bar</em></a>bum',
          bot.getData(true)
        );
    ...
    "test edit link on a non-editable inline element": function () {
      ...
      bot.dialog("link", function (dialog) {
        ...
        assert.areSame(
          'foo<a href="http://cksource.com"><em contenteditable="false">bar</em></a>bum',
          bot.getData(true)
        );
        assert.isTrue(!!editor.getSelection().isFake);
      });
    ...
    "test unlink on a non-editable inline element": function () {
      ...
      assert.areSame(
        'foo<em contenteditable="false">bar</em>bum',
        bot.getData(true)
      );
      assert.isTrue(!!editor.getSelection().isFake);
    },
    ...
    "test edit link which contents equals its href": function () {
      ...
      bot.setHtmlWithSelection(
        'foo<a href="http://ckeditor.com" data-cke-saved-href="http://ckeditor.com">http://ckedi^tor.com</a>bum'
      );
      bot.dialog("link", function (dialog) {
        dialog.setValueOf("info", "url", "http://cksource.com");
        dialog.getButton("ok").click();
        ...
        assert.areSame(
          'foo<a href="http://cksource.com">http://cksource.com</a>bum',
          bot.getData(true)
        );
        assert.areSame(
          "http://cksource.com",
          editor.getSelection().getSelectedText(),
          "content of a link was selected"
        );
      });
    },
    ...
    "test edit selected text": function () {
      ...
      bot.dialog("link", function (dialog) {
        var displayTextInput = dialog.getContentElement(
          "info",
          "linkDisplayText"
        );
        dialog.setValueOf("info", "url", "http://ckeditor.com");
        ...
        assert.isTrue(
          displayTextInput.isVisible(),
          "Display text input visibility"
        );
    ...
    "test edit existing link": function () {
      ...
      bot.dialog("link", function (dialog) {
        assert.areSame(
          dialog.getValueOf("info", "linkDisplayText"),
          "http://ckeditor.com"
        );
    ...
    "test changing inner text": function () {
      ...
      bot.setHtmlWithSelection(
        '<p>[testing <a href="http://ckeditor.com">http://ckeditor.<strong>com</strong></a>].</p>'
      );

      bot.dialog("link", function (dialog) {
        assert.areSame(
          dialog.getValueOf("info", "linkDisplayText"),
          "testing http://ckeditor.com"
        );
        dialog.setValueOf("info", "linkDisplayText", "foobar");
        dialog.setValueOf("info", "url", "http://example.dev");
        dialog.getButton("ok").click();
        assert.areSame(
          '<p><a href="http://example.dev">foobar</a>.</p>',
          bot.getData(true)
        );
      });
    },
    ...
    "test XSS protection": function () {
      var bot = this.editorBots.noValidation,
        expected =
          '<a href="http://ckeditor.com">&lt;img src="" onerror="alert( 1 );"&gt;</a>';
    ...
    "test overriding whole block": function () {
      ...
      bot.dialog("link", function (dialog) {
        ...
        dialog.getButton("ok").click();
        assert.areSame(
          '<p><a href="http://ckeditor.com">bbb</a></p>',
          bot.getData(true)
        );
      });
    },
    ...
    "test link with a nested strong without text change": function () {
      ...
      bot.setHtmlWithSelection(
        '[<a href="http://ckeditor.com">http://ckeditor.<strong>com</strong></a>].'
      );
      ...
      bot.dialog("link", function (dialog) {
        ...
        dialog.getButton("ok").click();
        assert.areSame(
          '<a href="http://example.dev">http://ckeditor.<strong>com</strong></a>.',
          bot.getData(true)
        );
      });
    },

    "test changing inner text of link with same href and inner text":
      function () {
        var bot = this.editorBots.noValidation;

        // Note it's crucial to include data-cke-saved-href attribute to reproduce this issue.
        bot.setHtmlWithSelection(
          '<p>aa [<a href="http://foobar" data-cke-saved-href="http://foobar">http://foobar</a>] bb</p>'
        );
        ...
        bot.dialog("link", function (dialog) {
          ...
          dialog.getButton("ok").click();
          assert.areSame(
            '<p>aa <a href="http://foobar">foo</a> bb</p>',
            bot.getData(true)
          );
        });
      },
    ...
    "test link with a nested anchors without text change": function () {
      ...
      bot.setHtmlWithSelection(
        '[<em>foo </em><a href="aaa">bbb</a> <span contenteditable="false"><a href="aaa">ccc</a></span>]'
      );
      ...
      bot.dialog("link", function (dialog) {
        ...
        dialog.getButton("ok").click();
        assert.areSame(
          '<a href="http://newlink"><em>foo </em>bbb <span contenteditable="false"><a href="aaa">ccc</a></span></a>',
          bot.getData(true)
        );
      });
    },
    ...
    "test multiline selection without changing display text": function () {
      ...
      bot.dialog("link", function (dialog) {
        ...
        assert.areSame(
          '<p>fo<a href="http://aaa">o</a></p><h2><a href="http://aaa">b</a>ar</h2>',
          bot.getData(true)
        );
      });
    },
    ...
    "test changing inner text block containing": function () {
      ...
      bot.dialog("link", function (dialog) {
        ...
        dialog.getButton("ok").click();
        assert.areSame(
          '<p>a<a href="http://bar">foo</a></p><p>cc</p>',
          bot.getData(true)
        );
      });
    },
    ...
    "test select link with descendants on double-click": function () {
      ...
      bot.setData(
        '<p>a<a href="http://bar"><span style="background:#f00;">b</span></a>c</p>',
        function () {
          editor.fire("doubleclick", {
    ...
    "test link target special chars": function () {
      ...
      bot.dialog("link", function (dialog) {
        ...
        assert.areSame(
          '<a href="http://ckeditor.com" target="' +
            funnyTargetValue +
            '">foo</a>',
          bot.getData(true)
        );
    ...
    "test link target keywords": function () {
      ...
      bot.dialog("link", function (dialog) {
        ...
        assert.areSame(
          '<a href="http://ckeditor.com" target="_self">foo</a>',
          bot.getData(true)
        );
      });
    },
    ...
    "test link target with space": function () {
      ...
      bot.dialog("link", function (dialog) {
        ...
        assert.areSame(
          '<a href="http://ckeditor.com" target="foobar">foo</a>',
          bot.getData(true)
        );
      });
    },
    ...
    "test CKEDITOR.link.showDisplayTextForElement": function () {
      var doc = CKEDITOR.document,
        ...
        showDisplayTextForElement =
          CKEDITOR.plugins.link.showDisplayTextForElement;

      assert.isFalse(
        showDisplayTextForElement(doc.findOne("input#blurTarget"), editor),
        "Input element"
      );
      assert.isTrue(
        showDisplayTextForElement(doc.findOne("span"), editor),
        "Span element"
      );
    ...
    "test unlink when cursor is right before the link": function () {
      ...
      bot.setHtmlWithSelection(
        '<p><a href="http://cksource.com">^Link</a></p>'
      );
    ...
    // https://dev.ckeditor.com/ticket/13062
    "test unlink when cursor is right before the link and there are more than one link in paragraph":
      function () {
        var bot = this.editorBots.noValidation,
          editor = bot.editor;

        bot.setHtmlWithSelection(
          '<p>I am<a href="http://foo"> an </a>in<a href="http://bar">sta</a>nce of <a href="http://ckeditor.com">^<s>CKEditor</s></a>.</p>'
        );

        editor.ui.get("Unlink").click(editor);

        assert.areSame(
          '<p>I am<a href="http://foo"> an </a>in<a href="http://bar">sta</a>nce of ^<s>CKEditor</s>.</p>',
    ...
    "test edit link with selection": function () {
      ...
      bot.setData(
        '<p><a class="linkClass" href="linkUrl"><img src="someUrl"/>some button text</a>some text</p>',
        function () {
  ...
  function assertCorrectLinks(bot, dialog, config) {
    ...
    bot.dialog("link", function (dialog) {
      assert.areEqual(
        "tel",
        dialog.getValueOf("info", "linkType"),
        "Link type should be 'tel' "
      );
      assert.areEqual(
        expected,
        dialog.getValueOf("info", "telNumber"),
