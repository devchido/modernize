  ...
  bender.test({
    ...
    "test paste html": function () {
      ...
      editor.on("afterPaste", function (evt) {
        ...
        tc.resume(function () {
          ...
          assert.isTrue(
            editor._.storedDialogs.paste._.committed,
            "Dialog committed state (after)"
          );
      ...
      editor.on("dialogShow", function (evt) {
        ...
        tc.resume(function () {
          ...
          var frameDoc = dialog
            .getContentElement("general", "editing_area")
            .getInputElement()
            .getFrameDocument();
    ...
    "test paste dialog focus": function () {
      ...
      editor.on("ariaWidget", function (event) {
        if (!event.data.is("iframe")) return;
        ...
        setTimeout(function () {
          resume(function () {
            ...
            assert.isTrue(
              ...
              "editor has focus on paste dialog opened."
            );
            assert.areSame(
              iframe,
              active,
              "paste area has focused on paste dialog opened"
            );
            dialog.hide();
          });
        });
