...
bender.test({
  ...
  "test setData/getData with predefined type - dataTransfer": function () {
    var nativeData = bender.tools.mockNativeDataTransfer(),
      ...
      dataTransfer =
        CKEDITOR.plugins.clipboard.initPasteDataTransfer(eventMock);
    ...
    assert.areSame(
      "<p>html text</p>",
      getDataNoCache(dataTransfer, "text/html")
    );

    this.assertDataTransferType(dataTransfer, "text/plain", "plain text");
    this.assertDataTransferType(dataTransfer, "text/html", "<p>html text</p>", {
      "cke/id": dataTransfer.id,
    });
  },

  "test setData/getData with predefined type - fallbackDataTransfer":
    function () {
      var nativeData = bender.tools.mockNativeDataTransfer(),
        dataTransferFallback = new CKEDITOR.plugins.clipboard.dataTransfer(
          nativeData
        )._.fallbackDataTransfer;
      ...
      assert.areSame(
        "<p>html text</p>",
        dataTransferFallback.getData("text/html")
      );
    },
  ...
  "test setData/getData with custom type - dataTransfer": function () {
    ...
    assert.areSame(
      "cke-custom data",
      getDataNoCache(dataTransfer, "cke/custom")
    );
    assert.areSame(
      "<p>custom html tag</p>",
      getDataNoCache(dataTransfer, "custom/tag")
    );
  ...
  "test setData/getData with custom type - fallbackDataTransfer": function () {
    ...
    assert.areSame(
      "cke-custom data",
      dataTransferFallback.getData("cke/custom")
    );
    assert.areSame(
      "<p>custom html tag</p>",
      dataTransferFallback.getData("custom/tag")
    );
  ...
  'test setData with custom type does not affect getData( "text/html" ) - dataTransfer':
    function () {
      var nativeData = bender.tools.mockNativeDataTransfer(),
        eventMock = {
          data: { $: { clipboardData: nativeData } },
          name: "copy",
        },
        dataTransfer =
          CKEDITOR.plugins.clipboard.initPasteDataTransfer(eventMock);
  ...
  'test setData with custom type does not affect getData( "text/html" ) - fallbackDataTransfer':
    function () {
      var nativeData = bender.tools.mockNativeDataTransfer(),
        dataTransferFallback = new CKEDITOR.plugins.clipboard.dataTransfer(
          nativeData
  ...
  'test setData( "text/html" ) does not overwrite custom data - dataTransfer':
    function () {
      var nativeData = bender.tools.mockNativeDataTransfer(),
        eventMock = {
          data: { $: { clipboardData: nativeData } },
  ...
  'test setData( "text/html" ) does not overwrite custom data - fallbackDataTransfer':
    function () {
      var nativeData = bender.tools.mockNativeDataTransfer(),
        dataTransferFallback = new CKEDITOR.plugins.clipboard.dataTransfer(
          nativeData
  ...
  'test setData( "text/html" ) called a few times does not overwrite custom data - dataTransfer':
    function () {
      var nativeData = bender.tools.mockNativeDataTransfer(),
        eventMock = {
          data: { $: { clipboardData: nativeData } },
  ...
  'test setData( "text/html" ) called a few times does not overwrite custom data - fallbackDataTransfer':
    function () {
      var nativeData = bender.tools.mockNativeDataTransfer(),
        dataTransferFallback = new CKEDITOR.plugins.clipboard.dataTransfer(
          nativeData
  ...
  "test setting same custom type overwrites the previous value and does not affect other types - dataTransfer":
    function () {
      var nativeData = bender.tools.mockNativeDataTransfer(),
        eventMock = {
          data: { $: { clipboardData: nativeData } },
  ...
  "test setting same custom type overwrites the previous value and does not affect other types - fallbackDataTransfer":
    function () {
      var nativeData = bender.tools.mockNativeDataTransfer(),
        dataTransferFallback = new CKEDITOR.plugins.clipboard.dataTransfer(
          nativeData
  ...
  "test setData returns value which was set - fallbackDataTransfer":
    function () {
      var nativeData = bender.tools.mockNativeDataTransfer(),
        dataTransferFallback = new CKEDITOR.plugins.clipboard.dataTransfer(
          nativeData
      ...
      assert.areSame(
        setValue,
        isEdge16
          ? getHtmlWithCustomData("", { "cke/custom": "custom data" })
          : "custom data",
        "return val 1"
      );
      ...
      assert.areSame(
        setValue,
        getHtmlWithCustomData(
          "<h1>Header1</h1>",
          isEdge16 ? { "cke/custom": "custom data" } : null
        ),
        "return val 2"
      );
  ...
  "test _applyDataComment case1": function () {
    var dataTransferFallback =
        new CKEDITOR.plugins.clipboard.fallbackDataTransfer({
          _: { data: {} },
        }),
      expected = document.querySelector("#case1").innerHTML;

    this.assertApplyDataComment(
      "<h1>Header1</h1><p>Test1</p>",
      { test: 1 },
      dataTransferFallback,
      expected
    );
  ...
  "test _applyDataComment case3": function () {
    var dataTransferFallback =
      ...
      expected = CKEDITOR.tools.trim(
        document.querySelector("#case3").innerHTML
      );

    this.assertApplyDataComment(
      "<!-- Start Comment --><h1>Header1</h1><p>Test1</p>",
      { test: 1 },
      dataTransferFallback,
      expected
    );
  ...
  "test _applyDataComment case4": function () {
    ...
    this.assertApplyDataComment(
      "<h1>Header1</h1><p>Test1</p><!-- End Comment -->",
      { test: 123 },
      dataTransferFallback,
      expected
    );
  ...
  "test _applyDataComment with empty data": function () {
    var dataTransferFallback =
      ...
      expected = CKEDITOR.tools.trim(
        document.querySelector("#empty-data").innerHTML
      );
  ...
  "test _extractDataComment case2": function () {
    ...
    objectAssert.areEqual(extracted.data, {
      test: 1,
      comment: "<!-- comment -->",
    });
    assert.isInnerHtmlMatching(
  ...
  "test _extractDataComment with falsy value": function () {
    ...
    assert.areSame(
      "",
      fallbackDataTransfer._extractDataComment(undefined).content
    );
    assert.areSame("", fallbackDataTransfer._extractDataComment(false).content);
  },

  "test if isRequired sets _isCustomMimeTypeSupported flag on the first run":
    function () {
      var fallbackDataTransfer =
        new CKEDITOR.plugins.clipboard.fallbackDataTransfer({
          $: bender.tools.mockNativeDataTransfer(),
          _: { data: {} },
        });
      ...
      assert.isTrue(
        flagValue !== null,
        "_isCustomMimeTypeSupported should be set"
      );
      assert.isTrue(
        flagValue === false || flagValue === true,
        "_isCustomMimeTypeSupported should be only true or false"
      );
      assert.isTrue(
        flagValue !== isRequiredValue,
        "isRequired should return value equal to !_isCustomMimeTypeSupported"
      );
    },
  ...
  "test if isRequired clears test MIME type": function () {
    ...
    assert.isTrue(
      nativeData.types.length === 0,
      "dataTransfer.types should be empty"
    );
    assert.isTrue(
      CKEDITOR.tools.object.keys(nativeData._data).length === 0,
      "dataTransfer should be empty"
    );
  },
  ...
  "test if isRequired does not remove other MIME types": function () {
    ...
    assert.areSame(
      1,
      nativeData.types.length,
      "dataTransfer.types should only contain one type"
    );
    assert.areSame(
      1,
      CKEDITOR.tools.object.keys(nativeData._data).length,
      "dataTransfer should only contain one type"
    );
    arrayAssert.itemsAreEqual(
      CKEDITOR.tools.object.keys(nativeData._data),
      ["text/html"],
      "dataTransfer should only contain text/html"
    );
  },
  ...
  "test getFallbackTypeContent prioritize cache": function () {
    ...
    dataTransfer._.data[dataTransferFallback._customDataFallbackType] =
      "cache value";
    nativeData.setData(
      dataTransferFallback._customDataFallbackType,
      "native value"
    );

    assert.areEqual(
      "cache value",
      dataTransferFallback._getFallbackTypeContent()
    );
  },
  ...
  "test getFallbackTypeContent for empty content in both cache and native data":
    function () {
      var nativeData = bender.tools.mockNativeDataTransfer(),
        dataTransferFallback = new CKEDITOR.plugins.clipboard.dataTransfer(
          nativeData
  ...
  "test getFallbackTypeData prioritize cache": function () {
    ...
    nativeData.setData(
      dataTransferFallback._customDataFallbackType,
      dataTransferFallback._applyDataComment("html", {
        "cke/id": "native value",
      })
    );
  ...
  "test getFallbackTypeData for empty content in both cache and native data":
    function () {
      var nativeData = bender.tools.mockNativeDataTransfer(),
        dataTransferFallback = new CKEDITOR.plugins.clipboard.dataTransfer(
          nativeData
  ...
  "test getFallbackTypeData for empty content in both cache and native data with `_customTypes` set":
    function () {
      var nativeData = bender.tools.mockNativeDataTransfer(),
        dataTransferFallback = new CKEDITOR.plugins.clipboard.dataTransfer(
          nativeData
  ...
  "test getData with getNative with custom type": function () {
    ...
    assert.areSame(
      "cke-custom data",
      dataTransfer.getData("cke/custom", true),
      "cke/custom value"
    );
    assert.areSame(
      "<p>custom html tag</p>",
      dataTransfer.getData("custom/tag", true),
      "custom/tag value"
    );
  ...
  assertApplyDataComment: function (
    content,
    data,
    dataTransferFallback,
    expected
    ...
    assert.isInnerHtmlMatching(
      expected.replace(/[\n\r\t]*/g, ""),
      dataTransferFallback._applyDataComment(content, data)
    );
  },
});
...
function getDataNoCache(dataTransfer, type) {
  ...
  return nativeDataTransferAvailableOnPaste
    ? dataTransfer._.fallbackDataTransfer.getData(type)
...
function getHtmlWithCustomData(htmlValue, customValue) {
  if (customValue) {
    return (
      "<!--cke-data:" +
      encodeURIComponent(JSON.stringify(customValue)) +
      "-->" +
      htmlValue
    );
  }
