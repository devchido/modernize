...
(function () {
  ...
  var trustySafari =
      CKEDITOR.env.safari && CKEDITOR.env.version >= 603 && !CKEDITOR.env.iOS,
  ...
  bender.test({
    ...
    tearDown: function () {
      ...
      for (name in { paste: 1, beforePaste: 1, afterPaste: 1 })
        this[name + "Callback"] &&
          editor.removeListener(name, this[name + "Callback"]);

      this.pasteCallback =
        this.beforePasteCallback =
        this.afterPasteCallback =
          null;
    },
      ...
      editor.on("paste", function (evt) {
        ...
        order.push(
          "b-" +
            data.type +
            "-" +
            (data.dataValue && data.dataValue.toLowerCase())
        );
      });
      ...
      editor.on("afterPaste", function (evt) {
        ...
        tc.resume(function () {
          assert.areEqual(
            "a-auto",
            order[0],
            "proper order and data for beforePaste"
          );
          assert.areEqual(
            "b-html-<b>foo</b>",
            order[1],
            "proper order and data for paste"
          );
        });
      });
    ...
    "pasting empty string with editor#paste command": function () {
      ...
      function callback() {
        ...
        assert.isFalse(
          wasAfterPaste,
          "afterPaste callback shouldn't be called"
        );
    ...
    "content type sniffing - htmlified text - Firefox & Opera": function () {
      if (!CKEDITOR.env.gecko) assert.ignore();
    ...
    "content type sniffing - htmlified text - Webkit": function () {
      if (!CKEDITOR.env.webkit) assert.ignore();
      ...
      assertPasteEvent(
        this.editor,
        { dataValue: "<div>a<div>b</div>c</div>" },
        { type: "html" },
        "html 6"
      );
    },
    ...
    "content type sniffing - htmlified text - IEs": function () {
      if (!CKEDITOR.env.ie) assert.ignore();
      ...
      assertPasteEvent(
        this.editor,
        { dataValue: "<p>a<br></p><p><br>b<br>c</p><P>d<BR></P>" },
        { type: "text" },
        "htmlified text 2"
      );
    ...
    "content type sniffing - htmlified text - other": function () {
      ...
      assertPasteEvent(
        ...
        { type: "html" },
        "for unrecognized browser always shout html"
      );
    },
    ...
    "content type sniffing - html": function () {
      ...
      assertPasteEvent(
        this.editor,
        { dataValue: 'a<p style="color: red">b</p>c' },
        { type: "html" },
        "styled html"
      );
      ...
      assertPasteEvent(
        this.editor,
        { dataValue: "a<div><p>b</p></div>c" },
        { type: "html" },
        "p & div only, but not created from plain text"
      );

      assertPasteEvent(
        this.editor,
        { dataValue: "a<div><div>b</div>c</div>d" },
        { type: "html" },
        "divs only, but not created from plain text"
      );

      assertPasteEvent(
        this.editor,
        { dataValue: "A<div>B<br>C</div>D" },
        { type: "html", dataValue: "A<div>B<br>C</div>D" },
        "case 1b"
      );

      assertPasteEvent(
        this.editor,
        { dataValue: "<p>A<br>B</p><p>C</p><div>D</div>" },
        { type: "html", dataValue: "<p>A<br>B</p><p>C</p><div>D</div>" },
        "case 2a"
      );
      assertPasteEvent(
        this.editor,
        { dataValue: "<div>A</div><p>B<br>C</p><p>D</p>" },
        { type: "html", dataValue: "<div>A</div><p>B<br>C</p><p>D</p>" },
        "case 2b"
      );

      assertPasteEvent(
        this.editor,
        { dataValue: "A<div>B</div>C<div>D</div>E" },
        { type: "html", dataValue: "A<div>B</div>C<div>D</div>E" },
        "case 3a"
      );
    },
    ...
    "content type sniffing - don't change type": function () {
      assertPasteEvent(
        this.editor,
        { dataValue: "a<b>b</b>c<hr>d", type: "text" },
        { type: "text" },
        "keep text"
      );
      ...
      assertPasteEvent(
        this.editor,
        { dataValue: "abc", type: "html" },
        { type: "html" },
        "keep html"
      );
    },

    "content type sniffing - default config.clipboard_defaultContentType":
      function () {
        testEditor(this, {}, function (editor) {
          ...
          if (CKEDITOR.env.webkit) {
            assertPasteEvent(
              editor,
              { dataValue: "<div>abc</div>" },
              { type: "html" },
              "case 2a"
            );
            assertPasteEvent(
              editor,
              { dataValue: "<div>abc</div>", type: "text" },
              { type: "text" },
              "case 2b"
            );
          } else {
    ...
    "htmlified text unification": function () {
      ...
      CKEDITOR.env.gecko &&
        assertPasteEvent(
          ...
          {
            dataValue:
              "1aaa<br>2bbb&nbsp;&nbsp; &nbsp;ccc<br><br>&nbsp; 3ddd<br>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;4eee" +
              "<br>&nbsp;&nbsp; &nbsp;5fff<br><br><br>6ggg&nbsp; hhh<br><br>",
          },
          {
            type: "text",
            dataValue:
              "<p>1aaa<br>2bbb&nbsp;&nbsp; &nbsp;ccc</p><p>&nbsp; 3ddd<br>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;" +
      ...
      CKEDITOR.env.webkit &&
        assertPasteEvent(
          ...
          {
            dataValue:
              '<div>1aaa</div><div>2bbb<span class="Apple-tab-span" style="white-space:pre">	</span>ccc</div><div><br></div>' +
          ...
          },
          {
            type: "text",
            dataValue:
              '<p>1aaa<br>2bbb&nbsp;&nbsp; &nbsp;ccc</p><p>&nbsp; 3ddd<br>&nbsp;&nbsp; &nbsp; 4eee<br> 5fff</p><p><br>6ggg &nbsp;hhh</p><br data-cke-eol="1">',
          },
    ...
    "htmlified text unification 2": function () {
      ...
      CKEDITOR.env.ie &&
        assertPasteEvent(
          ...
          {
            type: "text",
            dataValue: "<p>aa <br>&nbsp;&nbsp; </p><p>&nbsp;<br>bbb</p>",
          },
          "htmlified text 2 - ie"
        );
      CKEDITOR.env.webkit &&
        assertPasteEvent(
          ...
          {
            dataValue:
              '<div>aa&nbsp;</div><div>&nbsp; &nbsp;</div><div><br></div><div><span class="Apple-tab-span" style="white-space:pre">	</span></div><div>bbb</div>',
          },
          {
            type: "text",
            dataValue:
    ...
    "htmlified text unification 3 - other cases": function () {
      ...
      assertPasteEvent(
        this.editor,
        { dataValue: data },
        { type: "text", dataValue: result },
        "do not encode twice - treat as htmlifiedtext"
      );

      assertPasteEvent(
        this.editor,
        { dataValue: data, type: "text" },
        { type: "text", dataValue: result },
        "do not encode twice - treat as htmlifiedtext 2"
      );

      if (CKEDITOR.env.ie) {
        assertPasteEvent(
          this.editor,
          { dataValue: "<p>B<br>C</p>" },
          { type: "text", dataValue: "<p>B<br>C</p>" },
          "ie 1"
        );
        assertPasteEvent(
          this.editor,
          { dataValue: "<p>A<br></p>" },
          { type: "text", dataValue: "<p>A<br></p>" },
          "ie 2"
        );
        assertPasteEvent(
          this.editor,
          { dataValue: "<p>A<br></p><p>B<br></p>" },
          { type: "text", dataValue: "<p>A<br></p><p>B<br></p>" },
          "ie 3"
        );
        assertPasteEvent(
          this.editor,
          { dataValue: "<p>&nbsp;</p><p>aa</p><p>bb</p>" },
          { type: "text", dataValue: "<p>&nbsp;</p><p>aa</p><p>bb</p>" },
          "ie 4"
        );
        assertPasteEvent(
          this.editor,
        ...
        assertPasteEvent(
          ...
          {
            dataValue:
              "<div>A</div><div><br></div><div><br></div><div><br></div><div>B</div>",
          },
...
*/
        ...
        assertPasteEvent(
          ...
          {
            dataValue:
              "<div><br></div><div><br></div><div><br></div><div>aa</div>",
          },
      ...
      testEditor(
        ...
        function (editor) {
          if (CKEDITOR.env.gecko) {
            ...
            assertPasteEvent(
              editor,
              { dataValue: "aa<br><br>bb" },
              { type: "text", dataValue: "aa<br><br>bb" },
              "htmlified text 2 - fx"
            );
            assertPasteEvent(
              editor,
              { dataValue: "aa<br><br><br>bb" },
            ...
            assertPasteEvent(
              ...
              { type: "text", dataValue: "<br>aa<br><br>bb<br>cc<br>" },
              "htmlified text 4 - fx"
            );
          } else if (CKEDITOR.env.ie) {
            assertPasteEvent(
              editor,
              { dataValue: "<p>aa</p>" },
              { type: "text", dataValue: "aa" },
              "htmlified text 1 - ie"
            );
            assertPasteEvent(
              editor,
              { dataValue: "<p>aa</p><p>bb</p>" },
              { type: "text", dataValue: "aa<br><br>bb" },
              "htmlified text 2 - ie"
            );
            assertPasteEvent(
              editor,
              { dataValue: "<p>aa</p><p><br>bb</p>" },
              { type: "text", dataValue: "aa<br><br><br>bb" },
              "htmlified text 3 - ie"
            );
            ...
            assertPasteEvent(
              ...
              {
                dataValue:
                  "<div>aa</div><div><br></div><div><br></div><div>bb</div>",
              },
              { type: "text", dataValue: "aa<br><br><br>bb" },
              "htmlified text 5 - webkit"
            );
            assertPasteEvent(
              ...
              {
                dataValue:
                  "<div>aa</div><div><br></div><div><br></div><div><br></div><div>bb</div>",
              },
              { type: "text", dataValue: "aa<br><br><br><br>bb" },
              "htmlified text 6 - webkit"
            );
            ...
            assertPasteEvent(
              ...
              {
                dataValue:
                  "<div><br></div><div>aa</div><div><br></div><div>bb</div>",
              },
              { type: "text", dataValue: "<br>aa<br><br>bb" },
              "htmlified text 8 - webkit"
            );
            assertPasteEvent(
              ...
              {
                dataValue:
                  "<div><br></div><div><br></div><div>aa</div><div><br></div><div>bb</div>",
              },
              { type: "text", dataValue: "<br><br>aa<br><br>bb" },
              "htmlified text 9 - webkit"
            );
            assertPasteEvent(
              ...
              {
                dataValue:
                  "<div>aa</div><div><br></div><div>bb</div><div><br></div>",
              },
        ...
        function (editor) {
          if (CKEDITOR.env.gecko) {
            ...
            assertPasteEvent(
              ...
              {
                dataValue:
                  "<div>aa</div><div>bb</div><div><br></div><div>cc</div>",
              },
              { type: "text", dataValue: "<div>aa<br>bb</div><div>cc</div>" },
              "htmlified text 2 - webkit"
            );
    ...
    'html textification <p class="test" style="color:red">a<br style="display:none">b</p>':
      function () {
        assertPasteEvent(
          this.editor,
          {
            type: "text",
            dataValue:
              '<p class="test" style="color:red">a<br style="display:none">b</p>',
          },
    ...
    "html textification <ul> <li>A1</li> <li>A2 <ol> <li>B1</li> <li>B2</li> </ol></li> </ul> <ol> <li>C1</li> </ol>":
      function () {
        assertPasteEvent(
          this.editor,
          {
            type: "text",
            dataValue:
              "<ul> <li>A1</li> <li>A2 <ol> <li>B1</li> <li>B2</li> </ol></li> </ul> <ol> <li>C1</li> </ol>",
          },
          {
            type: "text",
            dataValue: "<p>A1</p><p>A2</p><p>B1</p><p>B2</p><p>C1</p>",
          },
          "lists"
        );
      },

    "html textification <dl> <dt>AT</dt> <dd>AD <dl> <dt>BT</dt> <dd>BD1</dd><dd>BD2</dd> </dl></dd> </dl>":
      function () {
        assertPasteEvent(
          this.editor,
          {
            type: "text",
            dataValue:
              "<dl> <dt>AT</dt> <dd>AD <dl> <dt>BT</dt> <dd>BD1</dd><dd>BD2</dd> </dl></dd> </dl>",
          },
          {
            type: "text",
            dataValue: "<p>AT</p><p>AD</p><p>BT</p><p>BD1</p><p>BD2</p>",
          },
          "def lists"
        );
      },

    'html textification a <div>b</div> <div title="1">c</div> d <div>e</div>':
      function () {
        ...
        assertPasteEvent(
          ...
          {
            type: "text",
            dataValue: 'a <div>b</div> <div title="1">c</div> d <div>e</div>',
          },
    ...
    "html textification <div> <p>a</p> b</div> <div>c <ul> <li>d</li> <li>e</li> </ul></div>":
      function () {
        assertPasteEvent(
          this.editor,
          {
            type: "text",
            dataValue:
              "<div> <p>a</p> b</div> <div>c <ul> <li>d</li> <li>e</li> </ul></div>",
          },
          {
            type: "text",
            dataValue: "<p>a</p><p>b</p><p>c</p><p>d</p><p>e</p>",
          },
          "divs 2"
        );
      },

    "html textification X<table> <caption>C</caption> <tr><th>A1</th><td>A2</td></tr> <tr><td>B1</td><th>B2</th></tr> </table>X":
      function () {
        ...
        assertPasteEvent(
          this.editor,
          {
            type: "text",
            dataValue:
              "X<table> <caption>C</caption> <tr><th>A1</th><td>A2</td></tr> <tr><td>B1</td><th>B2</th></tr> </table>X",
          },
    ...
    "html textification <table> <tr><td>A1</td> <td><table><tr><td>B1</td><td>B2</td></table></td></tr> <tr><td>C1</td></tr> </table>":
      function () {
        assertPasteEvent(
          this.editor,
          {
            type: "text",
            dataValue:
              "<table> <tr><td>A1</td> <td><table><tr><td>B1</td><td>B2</td></table></td></tr> <tr><td>C1</td></tr> </table>",
          },
    ...
    'html textification 2 <p title="1">a<br><br><br></p><p>b</p>': function () {
      assertPasteEvent(
        ...
        {
          type: "text",
          dataValue: '<p title="1">a<br><br><br></p><p>b</p>',
        },
    ...
    'html textification 2 <div title="1"><br><br></div><p>a</p>': function () {
      assertPasteEvent(
        ...
        {
          type: "text",
          dataValue: '<div title="1"><br><br></div><p>a</p>',
        },
        { type: "text", dataValue: "<p><br /><br /></p><p>a</p>" },
    ...
    'html textification 2 A<br>B<br><div title="1">C</div>D<br>E': function () {
      assertPasteEvent(
        ...
        {
          type: "text",
          dataValue: 'A<br>B<br><div title="1">C</div>D<br>E',
        },
        { type: "text", dataValue: "A<br />B<br /><p>C</p>D<br />E" },
    ...
    'html textification 2 A<br>B<div title="1">C</div><br>D<br>E': function () {
      assertPasteEvent(
        ...
        {
          type: "text",
          dataValue: 'A<br>B<div title="1">C</div><br>D<br>E',
        },
        { type: "text", dataValue: "A<br />B<p>C</p><br />D<br />E" },
        "correct order and new line before div"
      );
    },

    "html textification 2 A<div><div><p>B</p>C<ul><li>D</li></ul></div> <p>E</p></div>F":
      function () {
        assertPasteEvent(
          this.editor,
          {
            type: "text",
            dataValue:
              "A<div><div><p>B</p>C<ul><li>D</li></ul></div> <p>E</p></div>F",
          },
          { type: "text", dataValue: "A<p>B</p><p>C</p><p>D</p><p>E</p>F" },
          "transparent divs"
        );
      },

    "html textification 3 - ticket https://dev.ckeditor.com/ticket/8834":
      function () {
        ...
        assertPasteEvent(
          this.editor,
          {
            type: "text",
            dataValue:
              "<p><strong>Line</strong> 1<br>Line 2</p><p>Line 3</p><p>Line 4</p>",
          },
          {
            type: "text",
            dataValue: "<p>Line 1<br />Line 2</p><p>Line 3</p><p>Line 4</p>",
          },
    ...
    "html textification 4": function () {
      assertPasteEvent(
        ...
        {
          type: "text",
          dataValue: 'x<object>y</object>z <p>a<iframe src=".">b</iframe>c</p>',
        },
    ...
    "html textification 5 - complex cases #1": function () {
      assertPasteEvent(
        this.editor,
        {
          type: "text",
          dataValue:
            "<section><h1>HH</h1><p>1AAAA</p><p>2AAAA</p><p>3AAAA</p></section>" +
            "<table><tbody><tr><td><p>1AAAA</p><p>2AAAA</p><p>3AAAA</p></td></tr></tbody></table>",
        },
        {
          type: "text",
          dataValue:
            "<p>HH</p><p>1AAAA</p><p>2AAAA</p><p>3AAAA</p><p>1AAAA</p><p>2AAAA</p><p>3AAAA</p>",
        },
        "complex case 1"
      );
    },
    ...
    "html textification 5 - complex cases #2": function () {
      assertPasteEvent(
        this.editor,
        {
          type: "text",
          dataValue:
            "<section><div><p>1AAAA</p><p>2AAAA</p><p>3AAAA</p><aside><table><tr><td><p>4AAAA</p>" +
            "<ul><li>BBB</li><li>BBB</li></ul><p>5AAAA</p></td><td><p>6AAAA</p><p>7AAAA</p></td></tr></table></aside></div></section>",
        },
        {
          type: "text",
          dataValue:
            "<p>1AAAA</p><p>2AAAA</p><p>3AAAA</p><p>4AAAA</p><p>BBB</p><p>BBB</p><p>5AAAA</p><p>6AAAA</p><p>7AAAA</p>",
        },
        "complex case 2"
      );
    },
    ...
    'html textification 6 - tricks <p>A<img src="sth.jpg" alt="This is a title">B</p>':
      function () {
        assertPasteEvent(
          this.editor,
          {
            type: "text",
            dataValue: '<p>A<img src="sth.jpg" alt="This is a title">B</p>',
          },
          { type: "text", dataValue: "<p>AB</p>" },
          "img alt to text"
        );
      },

    'html textification 6 - tricks <p>A<img src="sth.jpg" alt="sth.jpg?1=2">B</p>':
      function () {
        ...
        assertPasteEvent(
          ...
          {
            type: "text",
            dataValue: '<p>A<img src="sth.jpg" alt="sth.jpg?1=2">B</p>',
          },
          { type: "text", dataValue: "<p>AB</p>" },
          "dumb alt"
        );
    ...
    'html textification 6 - tricks <p>A<img src="sth.jpg" alt="">B</p>':
      function () {
        // Popular too.
        assertPasteEvent(
          this.editor,
          {
            type: "text",
            dataValue: '<p>A<img src="sth.jpg" alt="">B</p>',
          },
          { type: "text", dataValue: "<p>AB</p>" },
          "dumb alt"
        );
    ...
    "html textification 6 - tricks <p>A</p> <h1>T1</h1> <h2>T2</h2> <h3>T3</h3> <p>C</p> <h4>T4</h4> D <h5>T5</h5>":
      function () {
        assertPasteEvent(
          this.editor,
          {
            type: "text",
            dataValue:
              "<p>A</p> <h1>T1</h1> <h2>T2</h2> <h3>T3</h3> <p>C</p> <h4>T4</h4> D <h5>T5</h5>",
          },
          {
            type: "text",
            dataValue:
              "<p>A</p><p>T1</p><p>T2</p><p>T3</p><p>C</p><p>T4</p>D<p>T5</p>",
          },
    ...
    "html textification 7 - enter mode br": function () {
      testEditor(this, { enterMode: CKEDITOR.ENTER_BR }, function (editor) {
        assertPasteEvent(
          editor,
          {
            type: "text",
    ...
    "html textification 8 - enter mode div": function () {
      testEditor(this, { enterMode: CKEDITOR.ENTER_DIV }, function (editor) {
        assertPasteEvent(
          editor,
          {
            type: "text",
          ...
          },
          {
            type: "text",
            dataValue:
              "<div><div>AT</div><div>AD<div><div>BT</div><div>BD1</div><div>BD2</div></div></div></div>",
          },
          "def lists"
        );
      });
    ...
    "filtering browser's crap": function () {
      assertPasteEvent(
        ...
        {
          dataValue:
            'a<span class="Apple-some-class" style="white-space:pre"> </span>b',
        },
        { dataValue: 'a<span style="white-space:pre"> </span>b' },
        "tab-span"
      );

      assertPasteEvent(
        this.editor,
        { dataValue: 'a<span class="Apple-converted-space">&nbsp;</span>b' },
        { dataValue: "a b" },
        "space"
      );
      ...
      CKEDITOR.env.webkit &&
        assertPasteEvent(
          ...
          {
            dataValue:
              'a<span class="Apple-tab-span" style="white-space:pre">		</span>b',
          },
          {
            priority: 4,
            dataValue: "a&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;b",
    ...
    "fixing block content": function () {
      if (CKEDITOR.env.ie) {
        ...
        assertPasteEvent(
          this.editor,
          { dataValue: "&nbsp; <b>ABC</b>" },
          { type: "html", dataValue: "&nbsp; <b>ABC</b>" },
          "eol 2"
        );
      } else if (CKEDITOR.env.webkit) {
        assertPasteEvent(
          this.editor,
          { dataValue: '<br class="Apple-interchange-newline">ABC' },
          { type: "html", dataValue: '<br data-cke-eol="1">ABC' },
          "eol 1"
        );
        ...
        assertPasteEvent(
          ...
          {
            dataValue:
              '<br class="Apple-interchange-newline"><p>A<b>B</b>C</p>',
            type: "text",
          },
          { type: "text", dataValue: '<br data-cke-eol="1"><p>ABC</p>' },
          "eol 1 - keep for forced text"
        );

        assertPasteEvent(
          this.editor,
          { dataValue: "<p>A<b>B</b>C</p><div><br></div>" },
          { type: "html", dataValue: '<p>A<b>B</b>C</p><br data-cke-eol="1">' },
          "eol 2"
        );

        assertPasteEvent(
          this.editor,
          { dataValue: "<p>A<b>B</b>C</p><div><br></div>", type: "text" },
          { type: "text", dataValue: '<p>ABC</p><br data-cke-eol="1">' },
          "eol 2 - keep for forced text"
        );

        assertPasteEvent(
          this.editor,
          { dataValue: "A<b>BC</b><div><br></div>" },
          { type: "html", dataValue: "A<b>BC</b><div><br></div>" },
          "eol 3"
        );
        ...
        assertPasteEvent(
          ...
          {
            dataValue:
              '<p><br class="Apple-interchange-newline">A</p><p>B</p><p>C</p>',
            type: "text",
          },
          {
            type: "text",
    ...
    "dataTranfer and method in paste - emulatePaste": function () {
      ...
      this.on("paste", function (evt) {
        ...
        dataTransferInPaste =
          evt.data.dataTransfer instanceof
      ...
      assertAfterPasteContent(this, "<p>foobambar</p>", function () {
        ...
        assert.isTrue(
          dataTransferInPaste,
          "Paste event should contain dataTranfer"
        );
      });
    ...
    "paste with HTML in clipboardData": function () {
      ...
      assertAfterPasteContent(this, "<p>foobambar</p>", function () {
        assert.areSame(
          "",
          dataValueOnPaste,
          "Data value on paste (priority 0) should be empty."
        );
        assert.areSame(
          "<p>bam</p>",
          htmlDataOnPaste,
          "dataTransfer html data should be set."
        );
      });
      this.wait();
    },
    ...
    "paste with HTML in clipboardData - cancel on before paste": function () {
      ...
      tc.wait(function () {
        assert.areSame(
          1,
          beforePasteCount,
          "There should be 1 before paste event."
        );
    ...
    "test cut": function () {
      if (!CKEDITOR.plugins.clipboard.isCustomCopyCutSupported) assert.ignore();
      ...
      if (CKEDITOR.env.edge) {
        ...
        assert.areSame(
          ...
          dataTransfer._.fallbackDataTransfer._extractDataComment(
            pasteEventMock.$.clipboardData.getData("text/html")
          ).content,
          "HTML text"
        );
      } else {
      ...
      assert.areSame(
        "bar",
        pasteEventMock.$.clipboardData.getData("Text"),
        "Plain text"
      );
      ...
      assert.areSame(
        pasteEventMock.$.clipboardData,
        CKEDITOR.plugins.clipboard.copyCutData.$,
        "copyCutData should be initialized"
      );
    },
    ...
    "test paste if dataTransfer is not empty": function () {
      ...
      this.on("paste", function (evt) {
        resume(function () {
          ...
          assert.areSame(
            "foo",
            evt.data.dataTransfer.getData(customType),
            "cke/custom data"
          );
    ...
    "test canClipboardApiBeTrusted internal": function () {
      var canClipboardApiBeTrusted =
        CKEDITOR.plugins.clipboard.canClipboardApiBeTrusted;
      ...
      assert.isTrue(
        canClipboardApiBeTrusted(dataTransfer, editor),
        "Clipboard API should be used for internal operations."
      );
    },
    ...
    "test canClipboardApiBeTrusted in Chrome": function () {
      ...
      assert.isTrue(
        canClipboardApiBeTrusted(dataTransfer),
        "Clipboard API should be used in Chrome."
      );
    },
    ...
    "test canClipboardApiBeTrusted in Safari": function () {
      ...
      assert.isTrue(
        canClipboardApiBeTrusted(dataTransfer),
        "Clipboard API should be marked as trusted."
      );
    },
    ...
    "test canClipboardApiBeTrusted in Android Chrome (no dataTransfer support)":
      function () {
        if (!CKEDITOR.env.chrome) {
          assert.ignore();
        }
    ...
    "test canClipboardApiBeTrusted in Firefox with HTML": function () {
      ...
      assert.isTrue(
        canClipboardApiBeTrusted(dataTransfer),
        "Clipboard API should be used in Firefox with HTML."
      );
    },
    ...
    "test canClipboardApiBeTrusted in Firefox with files": function () {
      ...
      assert.isTrue(
        canClipboardApiBeTrusted(dataTransfer),
        "Clipboard API should be used in Firefox with files."
      );
    },

    "test canClipboardApiBeTrusted in Firefox without files and HTML":
      function () {
        if (!CKEDITOR.env.gecko) {
          assert.ignore();
        }
    ...
    "test canClipboardApiBeTrusted on other browser": function () {
      ...
      assert.isFalse(
        canClipboardApiBeTrusted(dataTransfer),
        "Clipboard API should not be used in other browsers."
      );
    },
    ...
    "#131 - trailing spaces - default config.clipboard_defaultContentType":
      function () {
    ...
    "strip editable when about to paste the entire inline editor": function () {
      ...
      assertPasteEvent(
        this.editor,
        { dataValue: '<h1 class="cke_editable">Foo<br>Bar</h1>' },
        { dataValue: "Foo<br>Bar" },
        "stripped .cke_editable"
      );

      assertPasteEvent(
        this.editor,
        { dataValue: '<div class="cke_contents">Bar<br></div>' },
        { dataValue: "Bar" },
        "stripped .cke_contents & bogus br removed"
      );
      ...
      assertPasteEvent(
        ...
        {
          dataValue:
            '<div id="cke_1_contents" class="cke_contents"><div class="cke_editable" contenteditable="true"><p>aaa</p></div></div>',
        },
        { dataValue: "<p>aaa</p>" },
