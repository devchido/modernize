...
(function () {
    ...
    FileReaderMock.prototype.readAsDataURL = function () {
      CKEDITOR.tools.setTimeout(
        function () {
          this.result =
            readResultMock == "load"
              ? "data:" + fileMockType + fileMockBase64
              : null;
  ...
  bender.test({
    ...
    "test unsupported file type": function () {
      ...
      this.assertPaste("application/pdf", "<p>Paste image here: ^@</p>");
    },
    ...
    "test aborted paste": function () {
      ...
      this.assertPaste("image/png", "<p>Paste image here: ^@</p>");
    },
        ...
        function () {
          resume(function () {
            assert.isInnerHtmlMatching(
              expected,
              bender.tools.selection.getWithHtml(this.editor),
              {
                noTempElements: true,
                fixStyles: true,
