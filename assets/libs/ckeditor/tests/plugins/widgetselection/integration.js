  ...
  bender.test({
    ...
    "test content with non-editable at the beginning": function () {
      ...
      bender.tools.selection.setWithHtml(
        editor,
        '<p contenteditable="false">NE</p><p>This {}is text</p>'
      );
      this.fireSelectAll(editor);
    ...
    "test content with non-editable at the end": function () {
      ...
      bender.tools.selection.setWithHtml(
        editor,
        '<p>This {}is text</p><p contenteditable="false">NE</p>'
      );
      this.fireSelectAll(editor);
    ...
    "test content with non-editable at the beginning and end": function () {
      ...
      bender.tools.selection.setWithHtml(
        editor,
        '<p contenteditable="false">NE1</p><p>This {}is text</p><p contenteditable="false">NE2</p>'
      );
      this.fireSelectAll(editor);
    ...
    "test content with two non-editables": function () {
      ...
      bender.tools.selection.setWithHtml(
        editor,
        '<p contenteditable="false">NE1</p><p contenteditable="false">NE2</p>'
      );
      this.fireSelectAll(editor);
    ...
    "tests updating filler references on undo flow": function () {
      ...
      bender.tools.selection.setWithHtml(
        editor,
        '<p contenteditable="false">NE</p><p>Text1</p>'
      );
      this.fireSelectAll(editor);
      ...
      wait(function () {
        ...
        var filler = editor
          .editable()
          .findOne("div[data-cke-filler-webkit=start]");
        ...
        wait(function () {
          assert.isTrue(
            newFiller.equals(this.widgetselection.startFiller),
            "Filler reference was updated."
          );
        }, 5);
      }, 5);
    },
    ...
    fireSelectionCheck: function (editor, moveSelectionToElement) {
      if (moveSelectionToElement != null) {
        ...
        range.setStartAt(
          editor.editable().getChild(moveSelectionToElement),
