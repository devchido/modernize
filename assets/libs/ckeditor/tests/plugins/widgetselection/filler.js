...
(function () {
  ...
  bender.test({
    ...
    "test createFiller": function () {
      assert.isTrue(
        !!this.widgetselection.createFiller,
        "createFiller function exists"
      );
      ...
      assert.isTrue(
        startFiller.getAttribute("data-cke-filler-webkit") == "start"
      );
    ...
    "test hasFiller": function () {
      assert.isTrue(
        !!this.widgetselection.hasFiller,
        "hasFiller function exists"
      );
      ...
      bender.tools.selection.setWithHtml(
        editor,
        '<div data-cke-filler-webkit="start">&nbsp;</div><p>This is text</p>'
      );
      assert.isTrue(this.widgetselection.hasFiller(editor.editable()));

      bender.tools.selection.setWithHtml(
        editor,
        '<p>This is text</p><div data-cke-filler-webkit="end">&nbsp;</div>'
      );
      assert.isTrue(this.widgetselection.hasFiller(editor.editable()));
    },
    ...
    "test removeFiller": function () {
      assert.isTrue(
        !!this.widgetselection.removeFiller,
        "removeFiller function exists"
      );
      ...
      this.widgetselection.removeFiller(
        editable.findOne("div[data-cke-filler-webkit]"),
        editable
      );

      assert.isInnerHtmlMatching(
        '<p contenteditable="false">Non-editable</p><p>^This is text</p>',
      ...
      assert.isInnerHtmlMatching(
        '<p>This is text</p><p contenteditable="false">Non-editable</p><p>Filler text^</p>',
        bender.tools.selection.getWithHtml(editor),
        this.compareOptions
      );
    },
