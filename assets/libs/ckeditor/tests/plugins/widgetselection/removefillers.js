...
(function () {
  ...
  bender.test({
    ...
    "test content with helper at the end": function () {
      ...
      this.widgetselection.endFiller = editable.findOne(
        "div[data-cke-filler-webkit=end]"
      );
      this.widgetselection.removeFillers(editor.editable());

      assert.isInnerHtmlMatching(
        '^<p>This is text</p><p contenteditable="false">Non-editable</p>',
    ...
    "test content with helper at the beginning": function () {
      ...
      this.widgetselection.startFiller = editable.findOne(
