...
(function () {
  ...
  bender.test({
    ...
    "test paste normal content": function () {
      ...
      this.assertAfterPasteContent(
        "<p>Plain text</p>",
        "Content pasted without changes."
      );
      this.wait();
    },
    ...
    "test paste content with filler on the beginning": function () {
      ...
      bender.tools.emulatePaste(
        this.editor,
        '<div data-cke-filler-webkit="start" data-cke-temp="1" style="">&nbsp;</div><p>Plain text</p>'
      );

      this.assertAfterPasteContent(
        "<p>Plain text</p>",
        "Filler removed on paste."
      );
      this.wait();
    },
    ...
    "test paste content with filler on the end": function () {
      ...
      bender.tools.emulatePaste(
        this.editor,
        '<p>Plain text</p><div data-cke-filler-webkit="end" data-cke-temp="1" style="">&nbsp;</div>'
      );
