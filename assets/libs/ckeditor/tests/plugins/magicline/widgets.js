...
(function () {
  ...
  var tools = widgetTestsTools,
    /*nestedTplAc = new CKEDITOR.template( '<div id="{id}" class="u">' +
			...
			'</div>' +
		'</div>' ),*/
    nonEditTpl = new CKEDITOR.template(
      '<div id="{id}" class="w">' +
        '<div class="wa">wa</div>' +
        '<div class="wb">wb</div>' +
        "</div>"
    ...
    nestedTpl = new CKEDITOR.template(
      '<div id="{id}" class="z">' +
        '<div class="nested">' +
        '<div class="za">za</div>' +
        '<div class="zb">zb</div>' +
    ...
    nestedTpl2 = new CKEDITOR.template(
      '<div id="{id}" class="z">' +
        '<div class="nested">' +
        "<p>foo</p>" +
        "</div>" +
  ...
  function t(html, cfg) {
    return function () {
      ...
      this.editorBot.setData(html, function () {
        if (cfg.that.element) cfg.that.element = cfg.that.element();
        ...
        if (
          typeof cfg.trigger.upper != "undefined" &&
          typeof cfg.trigger.lower != "undefined"
        ) {
          assert.isObject(trigger, "Trigger should be returned");

          if (cfg.trigger.upper)
            assert.isTrue(
              cfg.trigger.upper().equals(trigger.upper),
              "Upper element matches."
            );
          else assert.isNull(trigger.upper, "Upper element doesn't exist");

          if (cfg.trigger.lower)
            assert.isTrue(
              cfg.trigger.lower().equals(trigger.lower),
              "Lower element matches"
            );
          else assert.isNull(trigger.lower, "Lower element doesn't exist");
        } else {
  ...
  function c(html, cfg) {
    return function () {
      ...
      this.editorBot.setData(html, function () {
        ...
        assert.isTrue(
          cfg.hotNode(widget).equals(backdoor.that.hotNode),
          "A correct space must be accessed."
        );
      });
    };
  }
  ...
  bender.test({
    ...
    "test block, editable[top] - widget as first child": t(
      blockTpl.output({ id: "x" }),
      {
        that: {
          mouse: { x: 10, y: 10 },
        },
    ...
    "test block, editable[bottom] - widget as last child": t(
      blockTpl.output({ id: "x" }),
      {
        that: {
          mouse: { x: 10, y: 150 },
    ...
    "test block, edge[top] - widget as first child": t(
      blockTpl.output({ id: "x" }),
      {
        that: {
          mouse: { x: 10, y: 10 },
    ...
    "test block, edge[bottom] - widget as last child": t(
      blockTpl.output({ id: "x" }),
      {
        that: {
          mouse: { x: 10, y: 90 },
    ...
    "test block, edge[top] - block before widget": t(
      '<div id="y">y</div>' + blockTpl.output({ id: "x" }),
      {
        that: {
          mouse: { x: 10, y: 10 },
          element: function () {
    ...
    "test block, edge[bottom] - block after widget": t(
      blockTpl.output({ id: "x" }) + '<div id="y">y</div>',
      {
        that: {
          mouse: { x: 10, y: 90 },
          element: function () {
    ...
    "test block, edge[top] - inline before widget": t(
      "<strong>y</strong>" + blockTpl.output({ id: "x" }),
      {
        that: {
          mouse: { x: 10, y: 10 },
          element: function () {
    ...
    "test block, edge[bottom] - inline after widget": t(
      blockTpl.output({ id: "x" }) + "<strong>y</strong>",
      {
        that: {
          mouse: { x: 10, y: 90 },
          element: function () {
    ...
    "test block, edge[bottom] - two widgets": t(
      blockTpl.output({ id: "x" }) + blockTpl.output({ id: "y" }),
      {
        that: {
          mouse: { x: 10, y: 90 },
          element: function () {
    ...
    "test block, expand - two widgets": t(
      blockTpl.output({ id: "x" }) + blockTpl.output({ id: "y" }),
      {
        that: {
          mouse: { x: 100, y: 120 },
    ...
    "test inline, editable[top] - widget as first child": t(
      inlineTpl.output({ id: "y" }),
      {
        that: {
          mouse: { x: 20, y: 20 },
        },
    ...
    "test inline, editable[bottom] - widget as last child": t(
      inlineTpl.output({ id: "y" }),
      {
        that: {
          mouse: { x: 20, y: 120 },
    ...
    "test inline, edge[top] - widget as first child": t(
      inlineTpl.output({ id: "y" }),
      {
        that: {
          mouse: { x: 10, y: 10 },
    ...
    "test inline, edge[bottom] - widget as last child": t(
      inlineTpl.output({ id: "y" }),
      {
        that: {
          mouse: { x: 10, y: 90 },
    ...
    "test inline, edge[top] - block before widget": t(
      "<div>x</div>" + inlineTpl.output({ id: "y" }),
      {
        that: {
          mouse: { x: 10, y: 10 },
          element: function () {
    ...
    "test inline, edge[bottom] - block after widget": t(
      inlineTpl.output({ id: "y" }) + "<div>x</div>",
      {
        that: {
          mouse: { x: 10, y: 90 },
          element: function () {
    ...
    "test inline, edge[top] - inline before widget": t(
      "<strong>x</strong>" + inlineTpl.output({ id: "y" }),
      {
        that: {
          mouse: { x: 10, y: 10 },
          element: function () {
    ...
    "test inline, edge[bottom] - inline after widget": t(
      inlineTpl.output({ id: "y" }) + "<strong>x</strong>",
      {
        that: {
          mouse: { x: 10, y: 90 },
          element: function () {
    ...
    "test inline, edge[bottom] - two widgets": t(
      inlineTpl.output({ id: "x" }) + inlineTpl.output({ id: "y" }),
      {
        that: {
          mouse: { x: 10, y: 90 },
          element: function () {
    ...
    "test inline, expand - two widgets": t(
      inlineTpl.output({ id: "x" }) + inlineTpl.output({ id: "y" }),
      {
        that: {
          mouse: { x: 10, y: 120 },
    ...
    "test nested, edge[bottom] - nested editable as a last child": t(
      nestedTpl2.output({ id: "z" }),
      {
        that: {
          mouse: { x: 10, y: 90 },
          element: function () {
    ...
    "test nested, expand - two blocks in nested": t(
      nestedTpl.output({ id: "z" }),
      {
        that: {
          mouse: { x: 10, y: 50 },
          element: function () {
    ...
    "test non-editable, edge[top] - first child": t(
      nonEditTpl.output({ id: "w" }),
      {
        that: {
          mouse: { x: 10, y: 10 },
          element: function () {
    ...
    "test non-editable, edge[bottom] - block after block": t(
      nonEditTpl.output({ id: "w" }),
      {
        that: {
          mouse: { x: 10, y: 40 },
    ...
    "test non-editable, edge[top] - block before block": t(
      nonEditTpl.output({ id: "w" }),
      {
        that: {
          mouse: { x: 10, y: 60 },
    ...
    "test non-editable, edge[bottom] - last child": t(
      nonEditTpl.output({ id: "w" }),
      {
        that: {
          mouse: { x: 10, y: 90 },
    ...
    "test non-editable, expand[bottom] - block after block": t(
      nonEditTpl.output({ id: "w" }),
      {
        that: {
          mouse: { x: 10, y: 40 },
    ...
    "test non-editable, expand[top] - block before block": t(
      nonEditTpl.output({ id: "w" }),
      {
        that: {
          mouse: { x: 10, y: 60 },
    ...
    "test commands[previous], first block in nested": CKEDITOR.env.gecko
      ? ignoreIt
      : c(nestedTpl.output({ id: "z" }), {
          widget: function () {
            return w("z");
          },
    ...
    "test commands[next], block after block in nested": CKEDITOR.env.gecko
      ? ignoreIt
      : c(nestedTpl.output({ id: "z" }), {
          widget: function () {
            return w("z");
    ...
    "test commands[previous], block before block in nested": CKEDITOR.env.gecko
      ? CKEDITOR.ignoreIt
      : c(nestedTpl.output({ id: "z" }), {
          widget: function () {
            return w("z");
    ...
    "test commands[next], last block in nested": CKEDITOR.env.gecko
      ? ignoreIt
      : c(nestedTpl.output({ id: "z" }), {
          widget: function () {
            return w("z");
    ...
    "test commands[previous], access before widget": c(
      "<div>q</div>" + nestedTpl.output({ id: "z" }),
      {
        widget: function () {
          return w("z");
        },
    ...
    "test commands[next], access after widget": c(
      nestedTpl.output({ id: "z" }),
      {
        widget: function () {
          return w("z");
