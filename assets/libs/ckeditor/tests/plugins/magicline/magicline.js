...
(function () {
  ...
  bender.test({
    ...
    "synthetic triggerEditable": function () {
      testEditor(
        ...
        function (editor, editable, backdoor) {
          var that = CKEDITOR.tools.extend(
              backdoor.that,
              {
                mouse: {
                  x: 20,
    ...
    "synthetic triggerExpand: Direct siblings with pointer in outer space":
      function () {
        testEditor(
          this,
          {},
    ...
    "getData box clearing": function () {
      ...
      testEditor(this, {}, "", function (editor, editable, backdoor) {
        ...
        backdoor.that.trigger = new backdoor.boxTrigger([
          dummy1,
          dummy2,
          EDGE_MIDDLE,
          TYPE_EXPAND,
    ...
    "get size": function () {
      testEditor(this, {}, "", function (editor, editable, backdoor) {
        var div = CKEDITOR.dom.element.createFromHtml(
          ...
          stretcher = CKEDITOR.dom.element.createFromHtml(
            '<div style="height: 1000px;' +
              'width: 100px; background: violet;">Foo</div>',
            editor.document
          );
    ...
    "box trigger": function () {
      testEditor(this, {}, "", function (editor, editable, backdoor) {
        var trigger = new backdoor.boxTrigger([
          null,
          null,
          EDGE_MIDDLE,
          TYPE_EXPAND,
    ...
    "get ascendant trigger": function () {
      testEditor(
        ...
        function (editor, editable, backdoor) {
          ...
          assert.isTrue(
            backdoor.getAscendantTrigger(backdoor.that).is("table")
          );
        }
      );
    },
    ...
    "get non empty neighbour": function () {
      testEditor(this, {}, "", function (editor, editable, backdoor) {
        bender.tools.setHtmlWithSelection(
          editor,
          "<u>Any</u> <b>CKSource previous</b>Foo" +
        ...
        assert.isNull(
          backdoor.getNonEmptyNeighbour(backdoor.that, startU, true)
        ); // first U previous
        assert.isTrue(
          backdoor.getNonEmptyNeighbour(backdoor.that, startB, true).is("u")
        ); // first B previous

        assert.areEqual(
          "bar",
          backdoor.getNonEmptyNeighbour(backdoor.that, span).getText()
        ); // Span next
        assert.areEqual(
          "foo",
          backdoor.getNonEmptyNeighbour(backdoor.that, span, true).getText()
        ); // Span previous

        assert.isTrue(
          backdoor.getNonEmptyNeighbour(backdoor.that, endI).is("u")
        ); // Last I next
      });
    },
    ...
    "line has data-cke-magic-line attribute": function () {
      testEditor(this, {}, "", function (editor, editable, backdoor) {
        var dummy1 = CKEDITOR.dom.element.createFromHtml(
            "<div>CK</div>",
            editor.document
          ),
          dummy2 = CKEDITOR.dom.element.createFromHtml(
            "<div>Editor</div>",
            editor.document
          );
    ...
    "is line": function () {
      testEditor(this, {}, "", function (editor, editable, backdoor) {
        ...
        assert.isTrue(
          backdoor.isLine(backdoor.that, editable.getChild([0, 0]))
        ); // The "line"
        assert.isTrue(
          backdoor.isLine(backdoor.that, editable.getChild([0, 0, 2]))
        ); // The triangle
      });
    },

    "magicline removes itself on editor#getData without superfluous operations":
      function () {
        testEditor(this, {}, "", function (editor, editable, backdoor) {
          var called = 0;
    ...
    "magicline with editor.config.enterMode set to ENTER_P": function () {
      testEditor(
        ...
        "<p>Foo</p>",
        function (editor, editable, backdoor) {
          var hr = CKEDITOR.dom.element.createFromHtml(
            "<hr>",
            backdoor.that.doc
          );
          ...
          assert.areEqual(
            "<p>Foo</p><p>&nbsp;</p><hr />",
            bender.tools.compatHtml(convertNbsp(editor.getData()))
          );
        }
      );
    },
    ...
    "command: access space - neighbour trigger is first-child (accessible)":
      function () {
        testEditor(this, {}, "", function (editor) {
          bender.tools.setHtmlWithSelection(
            editor,
            " <div>Foo</div> <p>Ba^r</p> <div>Foo</div> "
          );
    ...
    "command: access space - neighbour trigger is first-child (inaccessible)":
      function () {
        testEditor(this, {}, "", function (editor) {
    ...
    "command: access space - neighbour trigger has a sibling trigger (accessible)":
      function () {
        testEditor(this, {}, "", function (editor) {
          bender.tools.setHtmlWithSelection(
            editor,
            "<div>A</div><!-- Comment --> <div>B</div> <p>Ba^r</p><div>C</div><!-- Comment --> <div>D</div> "
          );
    ...
    "command: access space - neighbour trigger has a sibling trigger (inaccessible)":
      function () {
        testEditor(this, {}, "", function (editor) {
          bender.tools.setHtmlWithSelection(
            editor,
            "<hr /><!-- Comment --> <hr /> <p>Ba^r</p>"
          );

          editor.execCommand("accessPreviousSpace");

          assert.areEqual(
            "<hr /><!-- Comment --><p>^&nbsp;</p><hr /><p>Bar</p>",
            htmlWithSelection(editor)
          );

          bender.tools.setHtmlWithSelection(
            editor,
            "<p>Ba^r</p> <hr /><!-- Comment --> <hr /> "
          );

          editor.execCommand("accessNextSpace");

          assert.areEqual(
            "<p>Bar</p><hr /><p>^&nbsp;</p><!-- Comment --><hr />",
            htmlWithSelection(editor)
          );
        });
      },

    "command: access space - go down inline elements when looking for neighbour":
      function () {
        testEditor(this, {}, "", function (editor) {
          bender.tools.setHtmlWithSelection(
            editor,
            '<hr /><!-- Comment --> <hr /> <p><a href="#foo"><span><em>Ba^r</em></span></a></p>'
          );

          editor.execCommand("accessPreviousSpace");

          assert.areEqual(
            '<hr /><!-- Comment --><p>^&nbsp;</p><hr /><p><a href="#foo"><span><em>Bar</em></span></a></p>',
            htmlWithSelection(editor)
          );
        });
      },
    ...
    "command: access space before - towards DOM root": function () {
      testEditor(this, {}, "", function (editor) {
        bender.tools.setHtmlWithSelection(
          editor,
          "<div><p><span>Ba^r</span></p></div>"
        );

        editor.execCommand("accessPreviousSpace");

        assert.areEqual(
          "<p>^&nbsp;</p><div><p><span>Bar</span></p></div>",
          htmlWithSelection(editor)
        );
      });
    },
    ...
    "command: access space before list": function () {
      testEditor(this, {}, "", function (editor) {
        bender.tools.setHtmlWithSelection(
          editor,
          "<!-- Comment goes here --><ul><li>Foo</li><li>B^ar</li></ul>"
        );

        editor.execCommand("accessPreviousSpace");

        assert.areEqual(
          "<!-- Comment goes here --><p>^&nbsp;</p><ul><li>Foo</li><li>Bar</li></ul>",
          htmlWithSelection(editor)
        );
      });
    },
    ...
    "command: access space after list": function () {
      testEditor(this, {}, "", function (editor) {
        bender.tools.setHtmlWithSelection(
          editor,
          "<ul><li>Foo</li><li>B^ar</li></ul><!-- Comment goes here -->"
        );

        editor.execCommand("accessNextSpace");

        assert.areEqual(
          "<ul><li>Foo</li><li>Bar</li></ul><p>^&nbsp;</p><!-- Comment goes here -->",
          htmlWithSelection(editor)
        );
      });
    },
    ...
    "command: access space before table": function () {
      testEditor(this, {}, "", function (editor) {
        ...
        assert.areEqual(
          "<!-- Comment goes here --><p>^&nbsp;</p><table><tbody><tr><td>CKEditor</td></tr></tbody></table>",
          htmlWithSelection(editor)
        );
      });
    },
    ...
    "command: access space after table": function () {
      testEditor(this, {}, "", function (editor) {
        ...
        assert.areEqual(
          "<table><tbody><tr><td>CKEditor</td></tr></tbody></table><p>^&nbsp;</p><!-- Comment goes here -->",
          htmlWithSelection(editor)
        );
      });
    },
    ...
    "command: access space before/after - check sibling": function () {
      testEditor(this, {}, "", function (editor) {
        bender.tools.setHtmlWithSelection(
          editor,
          "a<div><p><span>Ba^r</span></p></div>b"
        );
    ...
    "command: access space before/after - check sibling 2": function () {
      testEditor(this, {}, "", function (editor) {
        bender.tools.setHtmlWithSelection(
          editor,
          "<hr />x<hr /><p>Ba^r</p><div>Foo</div>x"
        );
    ...
    "command: deep space access - multiple commands in the same direction with undo":
      function () {
        testEditor(this, {}, "", function (editor) {
          bender.tools.setHtmlWithSelection(
            editor,
            "<table><tbody><tr><td><table><tbody><tr><td>Fo^o</td></tr></tbody></table></td></tr></tbody></table>"
          );

          editor.execCommand("accessPreviousSpace");

          assert.areEqual(
            "<table><tbody><tr><td><p>^&nbsp;</p><table><tbody><tr><td>Foo</td></tr></tbody></table></td></tr></tbody></table>",
            htmlWithSelection(editor)
          );
          ...
          assert.areEqual(
            "<p>^&nbsp;</p><table><tbody><tr><td><table><tbody><tr><td>Foo</td></tr></tbody></table></td></tr></tbody></table>",
            htmlWithSelection(editor)
          );
          ...
          assert.areEqual(
            "<table><tbody><tr><td><p>&nbsp;</p><table><tbody><tr><td>Foo</td></tr></tbody></table></td></tr></tbody></table><p>^&nbsp;</p>",
            htmlWithSelection(editor)
          );
    ...
    "command: deep space access - with changes": function () {
      testEditor(this, {}, "", function (editor) {
        ...
        assert.areEqual(
          "<table><tbody><tr><td><p>Inserted^&nbsp;</p><table><tbody><tr><td>Foo</td></tr></tbody></table></td></tr></tbody></table>",
          htmlWithSelection(editor)
        );
        ...
        assert.areEqual(
          "<p>^&nbsp;</p><table><tbody><tr><td><p>Inserted&nbsp;</p><table><tbody><tr><td>Foo</td></tr></tbody></table></td></tr></tbody></table>",
          htmlWithSelection(editor)
        );
      });
    },
