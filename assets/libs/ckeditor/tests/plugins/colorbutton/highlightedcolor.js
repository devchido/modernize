  ...
  bender.test({
    "test highlighted color with background color button": function () {
      ...
      bender.tools.selection.setWithHtml(
        editor,
        '<h1 style="background: #999999">{Moo}</h1>'
      );
    ...
    "test highlighted color with background and text color button":
      function () {
        var editor = this.editor,
          txtColorBtn = editor.ui.get("TextColor"),
          bgColorBtn = editor.ui.get("BGColor");
        ...
        bender.tools.selection.setWithHtml(
          editor,
          '<h1 style="color: #ffffff; background: #dddddd">{Moo}</h1>'
        );
        bgColorBtn.click(editor);
    ...
    "test highlighted various color with background and text color button":
      function () {
        var editor = this.editor,
          txtColorBtn = editor.ui.get("TextColor"),
          bgColorBtn = editor.ui.get("BGColor");
        ...
        bender.tools.selection.setWithHtml(
          editor,
          '<h1 style="color: #0000FF; background: #a1a1a1">{Moo}</h1>'
        );
        bgColorBtn.click(editor);
