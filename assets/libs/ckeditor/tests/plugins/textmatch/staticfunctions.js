...
(function () {
  ...
  function createRange(root, position) {
    ...
    if (position.ec) range.setEnd(findNode(root, position.ec), position.eo);
  ...
  function findNode(container, query) {
    // Special case.
    if (query == "root") return container;
  ...
  function addTestCases(readyTCs, tcs) {
    ...
    for (tcType in tcs) {
      for (tcName in tcs[tcType]) {
        readyTCs["test " + tcType + " - " + tcName] = tcGenerators[
          tcType
        ].apply(null, tcs[tcType][tcName].concat(tcName));
      }
    }
  }
    ...
    getRangeInText: function (
      ...
      return function () {
        var inputPlayground = setupPlayground(input),
          ...
          ret = CKEDITOR.plugins.textMatch.getRangeInText(
            inputRange,
            start,
            end
          );
        ...
        assert.areSame(
          outputRange.startContainer.getText(),
          ret.startContainer.getText()
        );
        assert.areSame(
          outputRange.endContainer.getText(),
          ret.endContainer.getText()
        );
  ...
  tcs["test textMatch with filling char sequence"] = function () {
    var html =
        "<p>" + CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE + "Hel{}lo</p>",
  ...
  addTestCases(tcs, {
    ...
    getTextAndRange: {
      ...
      "collapsed in text j offset 1": [
        "i.j<i>k</i>l.m",
        { sc: "#j", so: 1 },
        "ij",
        2,
      ],
      "collapsed in text k offset 0": [
        "i.j<i>k</i>l.m",
        { sc: "#k", so: 0 },
        "k",
        0,
      ],
      "collapsed in text l offset 0": [
        "i.j<i>k</i>l.m",
        { sc: "#l", so: 0 },
        "lm",
        0,
      ],
      "collapsed in text m offset 1": [
        "i.j<i>k</i>l.m",
        { sc: "#m", so: 1 },
        "lm",
        2,
      ...
      "single paragraph index 0": [
        "<p>{}Hello</p>",
        { sc: "#Hello", so: 0 },
        "Hello",
        0,
      ],
      "single paragraph index 3": [
        "<p>Hel{}lo</p>",
        { sc: "#Hello", so: 3 },
        "Hello",
        3,
      ],
      "single paragraph index 5": [
        "<p>Hello{}</p>",
        { sc: "#Hello", so: 5 },
        "Hello",
        5,
      ...
      sophisticated: [
        "<p><strong>Foo</strong>Hell{}o<br />You</p>",
        { sc: "#Hello", so: 4 },
        "Hello",
        4,
      ],

      "collapsed in text bc offset 1 #1": [
        "<p>a.bc</p>",
        { sc: "#bc", so: 1 },
        "abc",
        2,
      ],
      "collapsed in text bc offset 1 #2": [
        "<p><i>foo</i>a.bc</p>",
        { sc: "#bc", so: 1 },
        "abc",
        2,
      ],
      "collapsed in text bs offset 1 #3": [
        "<p><i>fo.o</i>a.bc</p>",
        { sc: "#bc", so: 1 },
        "abc",
        2,
      ...
      "collapsed in element a root offset 0": [
        "a",
        { sc: "root", so: 0 },
        "a",
        0,
      ],
      "collapsed in element a root offset 1": [
        "a",
        { sc: "root", so: 1 },
        "a",
        1,
      ...
      "collapsed in element bcde offset 0": [
        "b.cd.e",
        { sc: "root", so: 0 },
        "bcde",
        0,
      ],
      "collapsed in element bcde offset 1": [
        "b.cd.e",
        { sc: "root", so: 1 },
        "bcde",
        1,
      ],
      "collapsed in element bcde offset 2": [
        "b.cd.e",
        { sc: "root", so: 2 },
        "bcde",
        3,
      ],
      "collapsed in element bcde offset 3": [
        "b.cd.e",
        { sc: "root", so: 3 },
        "bcde",
        4,
      ...
      "collapsed in element fghijkl offset 0": [
        "f.g<i>h</i>ij.k<u>l</u>",
        { sc: "root", so: 0 },
        "fg",
        0,
      ],
      "collapsed in element fghijkl offset 1": [
        "f.g<i>h</i>ij.k<u>l</u>",
        { sc: "root", so: 1 },
        "fg",
        1,
      ],
      "collapsed in element fghijkl offset 2": [
        "f.g<i>h</i>ij.k<u>l</u>",
        { sc: "root", so: 2 },
        "fg",
        2,
      ],
      "collapsed in element fghijkl offset 3": [
        "f.g<i>h</i>ij.k<u>l</u>",
        { sc: "root", so: 3 },
        "ijk",
        0,
      ],
      "collapsed in element fghijkl offset 4": [
        "f.g<i>h</i>ij.k<u>l</u>",
        { sc: "root", so: 4 },
        "ijk",
        2,
      ],
      "collapsed in element fghijkl offset 5": [
        "f.g<i>h</i>ij.k<u>l</u>",
        { sc: "root", so: 5 },
        "ijk",
        3,
      ],
      "collapsed in element fghijkl offset 6": [
        "f.g<i>h</i>ij.k<u>l</u>",
        { sc: "root", so: 6 },
        "",
        0,
      ...
      "collapsed in element pqrs offset 0": [
        "m.no<i>pq.rs</i>",
        { sc: "i", so: 0 },
        "pqrs",
        0,
      ],
      "collapsed in element pqrs offset 1": [
        "m.no<i>pq.rs</i>",
        { sc: "i", so: 1 },
        "pqrs",
        2,
      ],
      "collapsed in element pqrs offset 2": [
        "m.no<i>pq.rs</i>",
        { sc: "i", so: 2 },
        "pqrs",
        4,
      ...
      "collapsed in element tu offset 1": [
        "<i>t</i><i>u</i>",
        { sc: "root", so: 1 },
        "",
        0,
      ],
      "collapsed in element tu offset 2": [
        "<i>t</i><i>u</i>",
        { sc: "root", so: 2 },
        "",
        0,
      ...
      "collapsed in element wxyz offset 0": [
        "<i>w</i>xy.z",
        { sc: "root", so: 0 },
        "",
        0,
      ],
      "collapsed in element wxyz offset 1": [
        "<i>w</i>xy.z",
        { sc: "root", so: 1 },
        "xyz",
        0,
      ],
      "collapsed in element wxyz offset 2": [
        "<i>w</i>xy.z",
        { sc: "root", so: 2 },
        "xyz",
        2,
      ],
      "collapsed in element wxyz offset 3": [
        "<i>w</i>xy.z",
        { sc: "root", so: 3 },
        "xyz",
        3,
    ...
    getRangeInText: {
      "two text nodes - range at first": [
        "<p>foo.bar</p>",
        { sc: "#foo", so: 2, ec: "#foo", eo: 2 },
        1,
        3,
        "foo",
        { sc: "#foo", so: 1, ec: "#foo", eo: 3 },
      ],
      "two text nodes - range at second": [
        "<p>foo.bar</p>",
        { sc: "#foo", so: 0, ec: "#foo", eo: 0 },
        3,
        5,
        "foo.bar",
        { sc: "#foo", so: 3, ec: "#bar", eo: 2 },
      ],
      "two text nodes - range at both": [
        "<p>foo.bar</p>",
        { sc: "#foo", so: 2, ec: "#foo", eo: 2 },
        1,
        5,
        "foo.bar",
        { sc: "#foo", so: 1, ec: "#bar", eo: 2 },
      ],
      "begin to middle": [
        "<p>Hello</p>",
        { sc: "#Hello", so: 0, ec: "#Hello", eo: 0 },
        0,
        1,
        "<p>Hello</p>",
        { sc: "#Hello", so: 0, ec: "#Hello", eo: 1 },
      ],
      "middle to middle": [
        "<p>Hello</p>",
        { sc: "#Hello", so: 0, ec: "#Hello", eo: 0 },
