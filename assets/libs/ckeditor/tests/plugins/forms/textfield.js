...
bender.test({
  "test fill fields (text) ": function () {
    ...
    bot.setData("", function () {
      bot.dialog("textfield", function (dialog) {
        ...
        assert.areSame(
          '<input name="name" required="required" type="text" value="value" />',
          bot.getData(true)
        );
      });
    });
  ...
  "test fill fields (password)": function () {
    ...
    bot.setData("", function () {
      bot.dialog("textfield", function (dialog) {
        ...
        assert.areSame(
          '<input name="name" required="required" type="password" value="value" />',
          bot.getData(true)
        );
      });
    });
  ...
  "test empty fields": function () {
    ...
    bot.setHtmlWithSelection(
      '[<input name="name" type="text" value="value" required="required" />]'
    );
  ...
  "test read attributes (email)": function () {
    ...
    bot.setHtmlWithSelection(
      '[<input name="name" type="email" value="test@host.com" />]'
    );
    ...
    bot.dialog("textfield", function (dialog) {
      ...
      assert.areSame(
        '<input name="name" type="text" value="test@host.com" />',
        bot.getData(true)
      );
    });
  },
