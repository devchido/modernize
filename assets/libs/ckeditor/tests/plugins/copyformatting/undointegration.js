...
(function () {
  ...
  bender.test({
    ...
    "test basic undo integration": function () {
      ...
      assert.areSame(
        1,
        editor.undoManager.index,
        "There shouldn't be new undo steps and editor should remain on the 1st step."
      );
      assert.isTrue(
        editor.undoManager.undoable(),
        "Editor should have a possibility to undo."
      );
    },
    // (#2780)
    "test basic redo integration": function () {
      ...
      assert.isTrue(
        editor.undoManager.redoable(),
        "Editor should has possibility to redo."
      );
    },
  });
