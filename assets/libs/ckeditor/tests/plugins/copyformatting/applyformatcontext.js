...
(function () {
  ...
  bender.test({
    ...
    "test editor.copyFormatting._isContextAllowed": function () {
      ...
      assert.isTrue(
        instance._isContextAllowed("text"),
        "text with disabled tables"
      );
      assert.isTrue(
        instance._isContextAllowed("list"),
        "list with disabled tables"
      );
      assert.isFalse(
        instance._isContextAllowed("table"),
        "table with disabled tables"
      );
    ...
    "test context - text only": function () {
      ...
      testApplyingFormat(
        this.editor,
        "<table><tr><td>Apply her{}e</td></tr></table>",
        "here",
        styles,
        [],
        []
    ...
    "test context - text and table only": function () {
      ...
      testApplyingFormat(
        this.editor,
        "<table><tr><td>Apply {here}</td></tr></table>",
        "here",
        styles
      );
    },
