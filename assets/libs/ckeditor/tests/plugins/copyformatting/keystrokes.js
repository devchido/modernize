...
(function () {
  ...
  bender.test({
    "test default paste keystroke set on editor init": function () {
      assert.areEqual(
        defaultKeystrokeCommand,
        this.editors.editor1.keystrokeHandler.keystrokes[defaultKeystroke]
      );
    },
    ...
    "test copy keystroke set on editor init": function () {
      assert.areEqual(
        "copyFormatting",
        this.editors.editor1.keystrokeHandler.keystrokes[
          CKEDITOR.config.copyFormatting_keystrokeCopy
        ]
      );
    },

    "test keystroke detached when copied format canceled (normal)":
      function () {
        var editor = this.editors.editor1;

        bender.tools.selection.setWithHtml(
          editor,
          "<p>Copy <em>for{}mat</em></p>"
        );
        ...
        assert.areEqual(
          "applyFormatting",
          editor.keystrokeHandler.keystrokes[defaultKeystroke]
        );
    ...
    "test keystroke detached when copied format canceled (sticky)":
      function () {
        var editor = this.editors.editor1;
    ...
    "test keystroke attached on format copy (normal) and detached on format apply":
      function () {
        var editor = this.editors.editor1;
    ...
    "test keystroke attached on format copy (sticky) and not detached on format apply":
      function () {
        var editor = this.editors.editor1;
    ...
    "test keystroke attached on format copy (normal) and detached on format apply with custom keystroke":
      function () {
        ...
        assert.areEqual(
          "applyFormatting",
          editor.keystrokeHandler.keystrokes[customKeystroke]
        );
