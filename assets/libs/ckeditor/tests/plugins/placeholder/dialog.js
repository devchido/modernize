...
(function () {
  ...
  bender.test({
    "test dialog": function () {
      var initialEditorHtml =
          "This is sample text [[language]], having around [[count_of]] placeholders.",
        dialogAssertConfig = {
          name: "language",
        };
    ...
    "test multiple items dialog value": function () {
      var initialEditorHtml =
          "This is sample text [[language]], [[yet]] having around [[count_of]] placeholders [[foo]] bar.",
        dialogAssertConfig = {
          name: "count_of",
        };
    ...
    "test widget name change with dialog": function () {
      ...
      var initialEditorHtml = "foo [[bar]] baz.",
        ...
        onResume = function (dialog) {
          var widget = bender.tools.objToArray(
          ...
          assert.areSame(
            "boo_faa",
            widget.data.name,
            "After accepting dialog, name was not changed."
          );
        };
