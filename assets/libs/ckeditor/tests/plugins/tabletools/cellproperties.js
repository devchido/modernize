...
(function () {
  ...
  bender.test({
    "test cell properties dialog (text selection)": doTest(
      "table-1",
      function (dialog) {
    ...
    "test load and update field values (#1)": doTest(
      "table-2",
      function (dialog) {
    ...
    // https://dev.ckeditor.com/ticket/11439
    "test load and update field values (#2)": doTest(
      "table-3",
      function (dialog) {
        assert.areSame("", dialog.getValueOf("info", "rowSpan"));
      }
    ...
    // https://dev.ckeditor.com/ticket/11439
    "test load and update field values (#3)": doTest(
      "table-4",
      function (dialog) {
    ...
    // https://dev.ckeditor.com/ticket/11439
    "test load and update field values (#4)": doTest(
      "table-5",
      function (dialog) {
        assert.areSame("", dialog.getValueOf("info", "colSpan"));
      }
    ...
    // https://dev.ckeditor.com/ticket/11439
    "test load and update field values (#5)": doTest(
      "table-6",
      function (dialog) {
    ...
    // https://dev.ckeditor.com/ticket/11439
    "test load and update field values (#6)": doTest(
      "table-7",
      function (dialog) {
    ...
    // https://dev.ckeditor.com/ticket/11439
    "test load and update field values (#7)": doTest(
      "table-8",
      function (dialog) {
        assert.areSame("50", dialog.getValueOf("info", "width"));
    ...
    // https://dev.ckeditor.com/ticket/11439
    "test load and update field values (#8)": doTest(
      "table-9",
      function (dialog) {
    ...
    // https://dev.ckeditor.com/ticket/11439
    "test load and update field values (#9)": doTest(
      "table-10",
      function (dialog) {
    ...
    // https://dev.ckeditor.com/ticket/11439
    "test load and update field values (#10)": doTest(
      "table-11",
      function (dialog) {
        assert.areSame("", dialog.getValueOf("info", "width"));
        assert.areSame("", dialog.getValueOf("info", "widthType"));
    ...
    // (#2084)
    "test load and update field values - same unit and value, change value (#11)":
      doTest("table-12", function (dialog) {
    ...
    // (#2084)
    "test load and update field values - different unit, same value, change value (#12)":
      doTest("table-13", function (dialog) {
        assert.areSame("60", dialog.getValueOf("info", "height"));
        assert.areSame("", dialog.getValueOf("info", "heightType"));
    ...
    // (#2084)
    "test load and update field values - different unit and value, change value (#13)":
      doTest("table-14", function (dialog) {
        assert.areSame("", dialog.getValueOf("info", "height"));
        assert.areSame("", dialog.getValueOf("info", "heightType"));
    ...
    // (#2084)
    "test load and update field values - different unit and value, change unit and value (#14)":
      doTest("table-15", function (dialog) {
        assert.areSame("", dialog.getValueOf("info", "height"));
        assert.areSame("", dialog.getValueOf("info", "heightType"));
    ...
    "test disallowedContent rule": function () {
      bender.editorBot.create(
        ...
        function (bot) {
          ...
          bot.dialog("cellProperties", function (dialog) {
            assert.isTrue(
              dialog.getContentElement("info", "width").isVisible()
            );
            assert.isTrue(
              dialog.getContentElement("info", "height").isVisible()
            );
            assert.isTrue(
              dialog.getContentElement("info", "heightType").isVisible()
            );
          });
        }
      );
        ...
        function (bot) {
          ...
          CKEDITOR.once(
            ...
            function (evt) {
              resume(function () {
                assertChildren(
                  evt.data.definition.contents[0].elements[0].children
                );
              });
            },
            null,
