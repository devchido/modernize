  ...
  bender.test({
    "test undo snapshot while highlighting (async)": function () {
        ...
        setTimeout(function () {
          resume(function () {
            ...
            assert.areSame(
              "<p>foo</p>",
              editor.getData(),
              "Undo does not record highlighting step"
            );
          });
        }, 50);
      };
      ...
      assert.areSame(
        ...
        "A single widget instance created"
      );

      wait();
    },

    "test undo after editing sinppet with dialog and synchronous highlighter":
      function () {
        var bot = this.editorBots.asyncHighlighter,
          editor = bot.editor;
    ...
    "test undo after editing sinppet with dialog and asynchronous highlighter":
      function () {
        var bot = this.editorBots.asyncHighlighter,
          editor = bot.editor;
