...
(function () {
  ...
  bender.test({
    ...
    _getWrappedText: function (codeToWrap, lang, textDirection) {
      ...
      if (textDirection) ret += ' dir="' + textDirection + '"';
    ...
    "test sample selection": function () {
      var bot = this.editorBot,
        ...
        expectedHtml =
          "<p>foo " + this._getWrappedText("bar baz", "es", "ltr") + "!</p>";
    ...
    "test sample selection with rtl language": function () {
      var bot = this.editorBot,
        ...
        expectedHtml =
          "<p>yet another" +
          this._getWrappedText("very test text", "ar", "rtl") +
          " sample.</p>";
    ...
    "test multiline selection": function () {
      var bot = this.editorBot,
        ed = this.editor,
        inputHtml =
          "<p>foo [bar</p><p>baz</p><p>and the third] line</p><p>fourth line</p>", // input html + selection
        usedLang = "es",
        usedLangDir = "ltr",
        expectedHtml =
          "<p>foo " +
          this._getWrappedText("bar", usedLang, usedLangDir) +
          "</p><p>" +
          this._getWrappedText("baz", usedLang, usedLangDir) +
          "</p><p>" +
          this._getWrappedText("and the third", usedLang, usedLangDir) +
          " line</p><p>" +
          "fourth line</p>";
      ...
      bender.editorBot.create(
        ...
        function (bot) {
          var inputHtml = "<p>foo [bar baz]!</p>",
            expectedHtml =
              "<p>foo " +
              that._getWrappedText("bar baz", "es", "ltr") +
              "!</p>";
          ...
          assert.areSame(
            expectedHtml,
            bender.tools.compatHtml(bot.getData(), 0, 1),
            "One of default languages was not applied"
          );
        }
      );
    },
    ...
    "test remove format for language element": function () {
      ...
      assert.beautified.html(
        '<p><span dir="ltr" lang="fr">Lorem ipsum dolor somit</span></p>',
        this.editor.getData(),
        "Span element with atrributes should not be removed."
      );
    },
  });
})();
