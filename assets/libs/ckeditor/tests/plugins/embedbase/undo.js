...
bender.test({
  _should: {
    ignore: {
      "test undo and redo after creation":
  ...
  "test undo and redo after creation": function () {
    ...
    editor.once("dialogHide", function () {
      resume(function () {
        ...
        assert.areSame(
          '<p>foo</p><div data-oembed-url="//after/creation"><p>url:%2F%2Fafter%2Fcreation</p></div><p>&nbsp;</p>',
          editor.getData(),
          "data after redo"
        );
      });
  ...
  "test undo and redo after edition": function () {
    ...
    editor.once("dialogHide", function () {
      resume(function () {
        assert.areSame(
          "//after/edition",
          objToArray(editor.widgets.instances)[0].data.url,
          "widget url after edition"
        );
        ...
        assertCommands(editor, false, true, "after undo");
        assert.areSame(
          '<p>foo</p><div data-oembed-url="//before/edition"><p>url:%2F%2Fbefore%2Fedition</p></div><p>&nbsp;</p>',
          editor.getData(),
          "data after undo"
        );
        ...
        assertCommands(editor, true, false, "after redo");
        assert.areSame(
          '<p>foo</p><div data-oembed-url="//after/edition"><p>url:%2F%2Fafter%2Fedition</p></div><p>&nbsp;</p>',
          editor.getData(),
          "data after redo"
        );
      });
      ...
      editor.on("dialogHide", function () {
        ...
        resume(function () {
          assert.areSame(
            1,
            objToArray(editor.widgets.instances).length,
            "1 widget after creation and edition"
          );
          assert.areSame(
            urls[1],
            objToArray(editor.widgets.instances)[0].data.url,
          ...
          assert.areSame(
            1,
            objToArray(editor.widgets.instances).length,
            "1 widget after 1st undo"
          );
          assert.areSame(
            urls[0],
            objToArray(editor.widgets.instances)[0].data.url,
            "widget url after 1st undo"
          );
          ...
          assert.areSame(
            1,
            objToArray(editor.widgets.instances).length,
            "1 widget after 1st redo"
          );
          assert.areSame(
            urls[0],
            objToArray(editor.widgets.instances)[0].data.url,
            "widget url after 1st redo"
          );
          ...
          assert.areSame(
            1,
            objToArray(editor.widgets.instances).length,
            "1 widget after 2nd redo"
          );
          assert.areSame(
            urls[1],
            objToArray(editor.widgets.instances)[0].data.url,
            "widget url after 2nd redo"
          );
