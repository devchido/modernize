...
bender.test({
  "test create iframe": function () {
    ...
    bot.dialog("iframe", function (dialog) {
      ...
      assert.areEqual(
        '<iframe frameborder="0" height="500" scrolling="no" src="http://ckeditor.com" ' +
          'style="height:100px;width:100px;" width="100%"></iframe>',
        bot.getData(true)
      );
    });
  },
  ...
  "test update iframe": function () {
    ...
    bot.setHtmlWithSelection(
      editor.dataProcessor.toHtml(
        '[<iframe frameborder="0" scrolling="no" src="http://ckeditor.com" width="100%"></iframe>]'
      )
    );
    ...
    bot.dialog("iframe", function (dialog) {
      ...
      assert.areEqual(
        '<iframe frameborder="0" scrolling="no" src="http://cksource.com" width="400"></iframe>',
        bot.getData(true)
      );
    });
  },
