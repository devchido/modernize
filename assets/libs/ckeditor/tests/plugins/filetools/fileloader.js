...
(function () {
  ...
  function observeEvents(loader) {
    ...
    function stdObserver(evt) {
      ...
      if (data.length > 21) data = data.substring(0, 21);
  ...
  bender.test({
    ...
    "test constructor string, no name, default file name provided":
      function () {
        var loader = new FileLoader(editorMockDefaultFileName, pngBase64);

        assert.areSame(
          editorMockDefaultFileName.config.fileTools_defaultFileName + ".png",
          loader.fileName
        );
        assert.areSame(pngBase64, loader.data);
        assert.isObject(loader.file);
    ...
    "test constructor file, no filename in file, default file name provided":
      function () {
        var testFileWithoutName = bender.tools.getTestPngFile();
        testFileWithoutName.name = undefined;
    ...
    "test upload with custom field name (https://dev.ckeditor.com/ticket/13518)":
      function () {
        var loader = new FileLoader(editorMock, pngBase64, "name.png");
        ...
        resumeAfter(
          ...
          function () {
            ...
            objectAssert.areEqual(
              new Blob([lastFormData.get("myFile")], {}),
              loader.file
            );
          },
          3
    ...
    "test upload with additional request parameters provided (https://dev.ckeditor.com/ticket/13518)":
      function () {
        var loader = new FileLoader(editorMock, pngBase64, "name.png");
    ...
    "test if name of file is correctly attached (https://dev.ckeditor.com/ticket/13518)":
      function () {
    ...
    "test upload response not encoded (https://dev.ckeditor.com/ticket/13030)":
      function () {
        ...
        createXMLHttpRequestMock(["progress", "load"], {
          responseText:
            '{"fileName":"na me2.png","uploaded":1,"url":"http://url/na me2.png"}',
        });
    ...
    "test additional data passed to xhr via fileUploadRequest listener (https://dev.ckeditor.com/ticket/13518)":
      function () {
        var loader = new FileLoader(editorMock, testFile),
          file = new File([], "a");
    ...
    "test additional data in fileUploadResponse (https://dev.ckeditor.com/ticket/13519)":
      function () {
        var data,
    ...
    "test custom XHR headers": function () {
      ...
      resumeAfter(loader, "uploaded", function (evt) {
        ...
        assert.areSame(
          2,
          setRequestHeaderStub.callCount,
          "setRequestHeader call count"
        );
      });
      wait();
    },
