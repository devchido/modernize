...
(function () {
  ...
  bender.test({
    "test style non-captioned, right-aligned widget": function () {
      ...
      bot.setData(
        '<img src="_assets/foo.png" alt="rick" class="ar" id="x" />',
        function () {
          ...
          assert.areSame(
            fixHtml(
              '<img src="_assets/foo.png" alt="rick" class="give gonna never up you ar" id="x" />'
            ),
            fixHtml(editor.getData()),
            "Styles in output data"
          );
          ...
          assert.areSame(
            fixHtml(
              '<img src="_assets/foo.png" alt="rick" class="give gonna up you ar" id="x" />'
            ),
            fixHtml(editor.getData()),
            "Styles in output data after removeStyle"
          );
        }
      );
    },
    ...
    "test style captioned widget": function () {
      var bot = this.editorBots.editor,
        ...
        style = new CKEDITOR.style(styleDef),
        html =
          '<figure class="cap al" id="x">' +
          '<img src="_assets/bar.png" alt="rick" />' +
          "<figcaption>boo</figcaption>" +
          "</figure>",
        expected =
          '<figure class="cap up you give gonna never al" id="x">' +
          '<img src="_assets/bar.png" alt="rick" />' +
          "<figcaption>boo</figcaption>" +
          "</figure>",
        expectedRemoveStyle =
          '<figure class="cap up you give gonna al" id="x">' +
          '<img src="_assets/bar.png" alt="rick" />' +
          "<figcaption>boo</figcaption>" +
          "</figure>";
    ...
    "test transition: add caption to non-captioned, right-aligned, styled widget":
      function () {
        var bot = this.editorBots.editor,
          editor = bot.editor,
          style = new CKEDITOR.style(styleDef),
          expected =
            '<figure class="cap up you give gonna never ar">' +
        ...
        bot.setData(
          ...
          function () {
            ...
            assert.isFalse(
              widget.parts.image.hasAttribute("class"),
              "Image has no classes left"
            );

            for (var c in widget.data.classes)
              assert.isTrue(
                widget.element.hasClass(c),
                "." + c + " class transferred from img"
              );
    ...
    "test transition: center non-captioned, right-aligned, styled widget":
      function () {
        var bot = this.editorBots.editor,
          editor = bot.editor,
          style = new CKEDITOR.style(styleDef),
        ...
        bot.setData(
          ...
          function () {
            ...
            for (var c in widget.data.classes)
              assert.isTrue(
                widget.parts.image.hasClass(c),
                "." + c + " class of img is set"
              );
    ...
    "test transition: center captioned, right-aligned, styled widget":
      function () {
        var bot = this.editorBots.editor,
          editor = bot.editor,
          style = new CKEDITOR.style(styleDef),
    ...
    "test ACF integration - widget using classes": function () {
      var bot = this.editorBots.editorACFClasses,
        editor = bot.editor,
        html =
          '<figure class="cap gonna never ar xxx">' +
          '<img alt="rick" src="_assets/foo.png" />' +
          "<figcaption>caption</figcaption>" +
          "</figure>" +
          '<p><img alt="rick" class="give up you ar xxx" src="_assets/foo.png" /></p>',
        expected =
          '<figure class="cap gonna never ar">' +
          '<img alt="rick" src="_assets/foo.png" />' +
          "<figcaption>caption</figcaption>" +
          "</figure>" +
