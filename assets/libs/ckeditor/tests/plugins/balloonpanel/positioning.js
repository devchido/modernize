    ...
    tests = {
      ...
      setUp: function () {
        ...
        if (!this._getFrameMethodReplaced) {
          ...
          sinon
            .stub(CKEDITOR.env.safari ? container : frame, "getClientRect")
            .returns(rect);
      ...
      "test classic - out of view - right - attached to an element":
        function () {
      ...
      "test classic - out of view - bottom center - attached to an element":
        function () {
      ...
      "test classic - out of view - left vcenter - attached to an element":
        function () {
      ...
      "test classic - out of view - hcenter top - attached to an element":
        function () {
      ...
      "test classic - inside viewport - left top - attached to an element":
        function () {
      ...
      "test classic - inside viewport - right bottom - attached to an element":
        function () {
      ...
      "test classic - top center - attached to a selection - single rect":
        function () {
          // Tested scheme:
          //
          //           +-------+
      ...
      "test classic - top center - attached to a selection - many rects not aligned":
        function () {
          // Tested scheme:
          //
          //           +-------+
      ...
      "test classic - top center - attached to a selection - many rects aligned":
        function () {
          // Tested scheme:
          //
          //           +-------+
      ...
      "test classic - top center - attached to a selection - many ranges and rects":
        function () {
          // Tested scheme:
          //
          //           +-------+
      ...
      _testBalloonPanelPosition: function (
        input,
        expectedX,
        expectedY,
        testSelection
        ...
        var moveSpy = spy(this.balloon, "move"),
          target = testSelection
            ? this._createSelectionForTests(input)
            : this.markerElement;
