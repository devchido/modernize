...
(function () {
  ...
  bender.test({
      ...
      bender.editorBot.create(
        {
          ...
          creator: "inline",
          startupData:
            '<p><iframe frameborder="0" scrolling="no" src="error404"></iframe></p>',
          config: {
        ...
        function (bot) {
          ...
          editor.on("afterPaste", function () {
            resume(function () {
              ...
              assert.areSame(
                '<p>x<iframe frameborder="0" scrolling="no" src="error404"></iframe>x</p>',
    ...
    "test fakeobjects plugin registers ACF rules needed for its upcasted version":
      function () {
        bender.editorBot.create(
          {
          ...
          function (bot) {
            ...
            editor.on("afterPaste", function () {
              resume(function () {
                ...
                assert.isTrue(
                  img.hasAttribute("data-cke-realelement"),
                  "data-cke-realelement"
                );
                assert.areSame(
                  "<p>xx</p>",
                  editor.dataProcessor.toHtml('<p>x<img src="x">x</p>'),
