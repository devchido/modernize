...
(function () {
  ...
  var compat = bender.tools.compatHtml,
    engineName = CKEDITOR.env.webkit
      ? "webkit"
      : CKEDITOR.env.ie
        ? "ie"
        : CKEDITOR.env.gecko
  ...
  bender.test({
    "test tc1 - word2003": function () {
      if (!engineName) assert.ignore();

      bender.tools.testExternalInputOutput(
        "_assets/tc1_word2010_" + engineName + ".html",
        testWordFilter(this.editor)
      );
    },
  });
})();
