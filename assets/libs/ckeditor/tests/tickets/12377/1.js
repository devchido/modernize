...
(function () {
  ...
  bender.test({
    "test image dialog with removed preview and basic panel - image loaded":
      function () {
    ...
    "test image dialog with removed preview and basic panel - image load error":
      function () {
        var bot = this.editorBot,
          src = "img404.gif",
