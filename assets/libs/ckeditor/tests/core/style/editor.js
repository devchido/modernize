...
bender.test({
  ...
  assertApplyStyleOnFake: function (source, expection, style, isRemoval) {
    ...
    bot.setData(expandShortcuts(source), function () {
      ...
      assert.areSame(
        expection,
        makeShortcuts(bender.tools.compatHtml(editor.getData(), 0, 1)),
        "data"
      );
      assert.isTrue(!!sel.isFake, "sel.isFake");
      assert.areSame(
        editor.document.getById("fake"),
  ...
  "test apply/remove style on editor - basic": function () {
    ...
    // ranged
    this.assertApplyStyle(
      "<p>[foo]</p>",
      '<p><span class="foo" style="font-weight:bold;">[foo]</span></p>',
      inline
    );
    this.assertRemoveStyle(
      '<p><span class="foo" style="font-weight:bold;">[foo]</span></p>',
      "<p>[foo]</p>",
      inline
    );
    ...
    this.assertApplyStyle(
      "<p>foo^</p>",
      '<p>foo<span class="foo" style="font-weight:bold;">^</span></p>',
      inline
    );
    this.assertApplyStyle(
      "<p>^</p>",
      '<p><span class="foo" style="font-weight:bold;">^</span></p>',
      inline
    );
    ...
    this.assertApplyStyle(
      "<p>foo^</p>",
      '<h1 class="foo" style="text-align:right;">foo^</h1>',
      block
    );
    this.assertRemoveStyle(
      '<h1 class="foo" style="text-align:right;">foo^</h1>',
    ...
    this.assertApplyStyle(
      "<p>[<img />]</p>",
      '<p>[<img class="foo" style="float:left;" />]</p>',
      obj
    );
    this.assertRemoveStyle(
      '<p>[<img class="foo" style="float:left;" />]</p>',
  ...
  "test apply inline style on non-editable inline element - at non-editable inline boundary":
    function () {
      ...
      this.assertApplyStyle(
        "<p>a[<i @c=f>a</i>x<u @c=f>a</u>]b</p>",
        "<p>a<b>[<i @c=f>a</i>x<u @c=f>a</u>]</b>b</p>",
        style
      );
    },

  "test remove inline style from non-editable inline element - at non-editable inline boundary":
    function () {
      // https://dev.ckeditor.com/ticket/11242
      if (CKEDITOR.env.ie && CKEDITOR.env.version == 8) {
        assert.ignore();
  ...
  "test apply inline style on inline element with non-editable element inside":
    function () {
      var style = new CKEDITOR.style({ element: "b", includeReadonly: true });

      this.assertApplyStyle(
        "<p>a[<s><i @c=f>a</i></s>]b</p>",
        "<p>a<b><s>[<i @c=f>a</i>]</s></b>b</p>",
        style
      );
    },

  "test remove inline style from inline element with non-editable element inside":
    function () {
      var style = new CKEDITOR.style({ element: "b", includeReadonly: true });
  ...
  "test apply block style in block with non-editable inline element":
    function () {
      var style = new CKEDITOR.style({ element: "h1" });

      this.assertApplyStyle(
        "<p>a<i @c=f>b</i>c^d</p>",
        "<h1>a<i @c=f>b</i>c^d</h1>",
        style
      );
    },
  ...
  "test apply inline style on non-editable inline element": function () {
    ...
    this.assertApplyStyleOnFake(
      '<p>a<i @c=f id="fake">a</i>b</p>',
      '<p>a<b><i @c=f id="fake">a</i></b>b</p>',
      style
    );
  },
  ...
  "test remove inline style from non-editable inline element": function () {
    ...
    this.assertRemoveStyleFromFake(
      '<p>a<b><i @c=f id="fake">a</i></b>b</p>',
      '<p>a<i @c=f id="fake">a</i>b</p>',
      style
    );
  ...
  "test apply inline style on non-editable block element": function () {
    ...
    this.assertApplyStyleOnFake(
      '<p>x</p><div @c=f id="fake">a</div><p>x</p>',
      '<p>x</p><div @c=f id="fake">a</div><p>x</p>',
      style
    );
  },
  ...
  "test apply inline style on non-editable block element with nested editable":
    function () {
      var style = new CKEDITOR.style({ element: "b", includeReadonly: true });

      this.assertApplyStyleOnFake(
        '<p>x</p><div @c=f id="fake">a<div @c=t>b</div></div><p>x</p>',
        '<p>x</p><div @c=f id="fake">a<div @c=t><b>b</b></div></div><p>x</p>',
        style
      );
    },

  "test remove inline style from non-editable block element with nested editable":
    function () {
      var style = new CKEDITOR.style({ element: "b", includeReadonly: true });
  ...
  "test apply block style on non-editable block element with nested editable":
    function () {
      var style = new CKEDITOR.style({ element: "h1" });

      this.assertApplyStyleOnFake(
        '<p>x</p><div @c=f id="fake">a<div @c=t>b</div></div><p>x</p>',
        '<p>x</p><div @c=f id="fake">a<div @c=t><h1>b</h1></div></div><p>x</p>',
        style
      );
    },

  "test remove block style from non-editable block element with nested editable":
    function () {
      var style = new CKEDITOR.style({ element: "h1" });
      style._.enterMode = CKEDITOR.ENTER_P; // We're forced to do here what format plugin does internally. This is bad!
      ...
      this.assertRemoveStyleFromFake(
        '<p>x</p><div @c=f id="fake">a<div @c=t><h1>b</h1></div></div><p>x</p>',
        '<p>x</p><div @c=f id="fake">a<div @c=t><p>b</p></div></div><p>x</p>',
        style
      );
    },
  ...
  "test remove block style in blockless nested editable": function () {
    ...
    this.assertRemoveStyle(
      "<p>x</p><div @c=f><h1 @c=t>a^b</h1></div>",
      "<p>x</p><div @c=f><h1 @c=t>a^b</h1></div>",
      style
    );
  },
  ...
  "test br filler is preserved when applying block style": function () {
    ...
    assert.areSame(
      "<h1><br /></h1>",
      bender.tools.compatHtml(this.editor.editable().getHtml())
    );
  },
  ...
  "test editor#removeStyle with custom style._.enterMode": function () {
    ...
    assert.areSame(
      CKEDITOR.ENTER_DIV,
      styleObj._.enterMode,
      "styleObj._.enterMode should not be changed"
    );
  },
    ...
    bender.editorBot.create(
      ...
      function (bot) {
        ...
        assert.areEqual(
          "<div>foobar</div>",
          bot.editor.getData(),
          "Invalid editor#getData() result for DIV enterMode"
        );
        ...
        assert.areEqual(
          "<p>foobar</p>",
          bot.editor.getData(),
          "Invalid editor#getData() result for style with hardcoded P enterMode"
        );
      }
    );
  },
    ...
    bender.editorBot.create(
      ...
      function (bot) {
        ...
        assert.areEqual(
          "foobar",
          bot.editor.getData(),
          "Invalid editor#getData() result for BR enterMode"
        );
      }
    );
  },

  "test editor#removeStyle, editor#applyStyle not changing styles _.enterMode value":
    function () {
      ...
      assert.areSame(
        undefined,
        styleObj._.enterMode,
        "Invalid value for styleObj._.enterMode after editor#removeStyle()"
      );
      ...
      assert.areSame(
        undefined,
        styleObj._.enterMode,
        "Invalid value for styleObj._.enterMode after editor#applyStyle()"
      );
    },
});
