...
(function () {
  ...
  function addTests(cases, editor, removeEmptyBlock) {
    ...
    for (group in cases) {
      for (i = 0; i < cases[group].length; i++) {
        ...
        if (!removeEmptyBlock) {
          testsGet["test getHtmlFromRange: " + name] = assertGetHtmlFromRange(
            editor,
            tc[0],
            tc[1]
          );
        }
        testsExtract["test extractHtmlFromRange: " + name] =
          assertExtractHtmlFromRange(
            editor,
            tc[0],
            tc[1],
            tc[2],
  ...
  function assertGetHtmlFromRange(editor, html, expected) {
    return function () {
      ...
      assert.isInnerHtmlMatching(
        expected,
        docFragment.getHtml(),
        compareInnerHtmlOptions,
        "Selected HTML"
      );
      assert.isInnerHtmlMatching(
        html,
        getWithHtml(editable, range),
        compareInnerHtmlOptions,
        "HTML of editable, untouched once get"
      );
    };
  }

  function assertExtractHtmlFromRange(
    editor,
    html,
    htmlGet,
    htmlWithSelection,
    ...
    return function () {
      ...
      if (removeEmptyBlock) {
        ...
        assert.isInnerHtmlMatching(
          htmlWithSelection,
          editable.getHtml(),
          "HTML of editable, once extracted"
        );
      } else {
        assert.isInnerHtmlMatching(
          htmlWithSelection,
  ...
  tests = {
    ...
    "test node markers are cleared": function () {
      ...
      assert.isNull(
        editable.findOne("tr").getChild(0).getCustomData("visited_out"),
        "1st cell should not have a marker"
      );
      assert.isNull(
        editable.findOne("tr").getChild(1).getCustomData("visited_in"),
        "2nd cell should not have a marker"
      );
    },
  };
  ...
  addTests(
    {
      ...
      "cross-block": [
        ...
        [
          "<blockquote>a{b</blockquote><p>c}d</p>",
          "<blockquote>b</blockquote><p>c</p>",
          "<blockquote>a[]d</blockquote>",
        ],
        [
          "<blockquote>a{b</blockquote><div>c</div><p>d}e</p>",
          "<blockquote>b</blockquote><div>c</div><p>d</p>",
          "<blockquote>a[]e</blockquote>",
        ],
        [
          "<div>a<div>{b</div></div><div>c</div><p>d}e</p>",
          "<div><div>b</div></div><div>c</div><p>d</p>",
          "<div>a<div>[]e</div></div>",
        ] /*!*/,
        [
          "<p>a{b</p><p>}c</p>",
          '<p>b</p><br data-cke-eol="1" />',
          "<p>a[]c</p>",
        ],
        [
          "<p>a{</p><p>b}c</p>",
          '<br data-cke-eol="1" /><p>b</p>',
          "<p>a[]c</p>",
        ],
        [
          "<p>a{b</p><p>c</p><p>}d</p>",
          '<p>b</p><p>c</p><br data-cke-eol="1" />',
          "<p>a[]d</p>",
        ],
        [
          "<p>ab{</p><p>c</p><p>}de</p>",
          '<br data-cke-eol="1" /><p>c</p><br data-cke-eol="1" />',
          "<p>ab[]de</p>",
        ],
        [
          "<h1><b>{a</b></h1><p>b}</p>",
        ...
        [
          "<h1>{abc</h1><p><strong>de</strong>gh}<strong>jl</strong>mn</p>",
          "<h1>abc</h1><p><strong>de</strong>gh</p>",
          "<h1>[]<strong>jl</strong>mn</h1>",
        ],
      ],
      ...
      inline: [
        ...
        [
          '<p>a<a href="#">b{c}d</a>e</p>',
          '<a href="#">c</a>',
          '<p>a<a href="#">b[]d</a>e</p>',
        ],
        ...
        ["<p>a{<b>b}</b>c</p>", "<b>b</b>", "<p>a[]c</p>"],
        [
          '<p>a{<img src="' + img_src + '" />}b</p>',
          '<img src="' + img_src + '" />',
          "<p>a[]b</p>",
        ],
        [
          '<p>a{<a href="foo"><img src="' + img_src + '" /></a>}b</p>',
          '<a href="foo"><img src="' + img_src + '" /></a>',
          "<p>a[]b</p>",
        ],
      ],
      ...
      "cross-inline": [
        ...
        [
          '<p>a<b class="a">{b</b><b class="b">c}</b>d</p>',
          '<b class="a">b</b><b class="b">c</b>',
          "<p>a[]d</p>",
        ],
        [
          '<p>a<b class="a">{b</b>c<b class="b">d}</b>e</p>',
          '<b class="a">b</b>c<b class="b">d</b>',
          "<p>a[]e</p>",
        ],
      ],
      ...
      html5: [
        ...
        [
          "<div>[<div><figure>img<figcaption>cap</figcaption></figure></div>]</div>",
          "<div><figure>img<figcaption>cap</figcaption></figure></div>",
          "<div>[]@!</div>",
        ],
      ],
      ...
      tables: [
        ...
        [
          ...
          "b",
          "<table><tbody><tr><td>a[]c</td></tr></tbody></table>",
        ],
        // #4
        [
          "<table><tbody><tr><td>a{b</td><td>c}d</td></tr></tbody></table>",
      ...
      lists: [
        ...
        [
          "<ol><li>a{b</li><li>c}d</li></ol>",
          "<ol><li>b</li><li>c</li></ol>",
          "<ol><li>a[]d</li></ol>",
        ],
        [
          "<ol><li>a{b</li></ol><ol><li>c}d</li></ol>",
          "<ol><li>b</li></ol><ol><li>c</li></ol>",
          "<ol><li>a[]d</li></ol>",
        ],
        [
          "<ol><li>a{b</li></ol><ul><li>c}d</li></ul>",
          "<ol><li>b</li></ol><ul><li>c</li></ul>",
          "<ol><li>a[]d</li></ol>",
        ],
        [
          "<ol><li>a<ul><li>b{c</li></ul></li><li>d}e</li></ol>",
          "<ol><li><ul><li>c</li></ul></li><li>d</li></ol>",
          "<ol><li>a<ul><li>b[]e</li></ul></li></ol>",
        ],
        [
          "<ol><li>a{b<ul><li>c}d</li><li>e</li></ul></li><li>f</li></ol>",
          "<ol><li>b<ul><li>c</li></ul></li></ol>",
          "<ol><li>a[]d<ul><li>e</li></ul></li><li>f</li></ol>",
        ],
        [
          "<ol><li>a</li><li>b{c</li><li>d}e</li></ol>",
          "<ol><li>c</li><li>d</li></ol>",
          "<ol><li>a</li><li>b[]e</li></ol>",
        ],
        [
          "<ol><li>a{b</li><li><b>c}d</b></li></ol>",
          "<ol><li>b</li><li><b>c</b></li></ol>",
          "<ol><li>a[]<b>d</b></li></ol>",
        ],
        [
          "<ol><li><b>a{b</b></li><li><b>c}d</b></li></ol>",
          "<ol><li><b>b</b></li><li><b>c</b></li></ol>",
          "<ol><li><b>a[]d</b></li></ol>",
        ],
      ],
  ...
  addTests(
    {
      block: [
        ...
        // (https://dev.ckeditor.com/ticket/13465)
        [
          '<p>a</p><p><span class="foo">{b}</span></p><p>c</p>',
          '<span class="foo">b</span>',
          "<p>a</p><p>c</p>",
        ],
        // (https://dev.ckeditor.com/ticket/13465)
        [
          '<p>a</p><p><b>{b}</b><span class="foo"></span></p><p>c</p>',
          "<b>b</b>",
          "<p>a</p><p>c</p>",
        ],
      ],
