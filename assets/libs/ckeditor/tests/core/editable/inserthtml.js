  ...
  insertionDT.run(
    ...
    },
    {
      ...
      "G1. text into text": function () {
        ...
        var a = this.createAssertInsertionFunction(
          this.editablesNames,
          "bam",
          null,
          CKEDITOR.ENTER_BR
      ...
      "G2. text next to inline element": function () {
        ...
        a(
          "[foo<span><b>]bar</b></span>baz",
          "bam^<span><b>bar</b></span>baz",
          "before nested"
        );
        ...
        a(
          "[<b>]a</b>",
          { html: "bam^<b>a</b>", text: "<b>bam^a</b>" },
          "before b 2"
        );
        a(
          "<b>a[</b>]",
          { html: "<b>a</b>bam^", text: "<b>abam^</b>" },
          "after b 2"
        );
        a(
          '<a href="#">a[</a>]',
          { html: '<a href="#">a</a>bam^', text: '<a href="#">abam^</a>' },
          "after a 1"
        );
        a(
          "foo<span><b>bar[</b></span>baz]",
      ...
      "G2. text into inline element": function () {
        ...
        a(
          "foo<u>x[y]z</u>baz",
          { html: "foo<u>x</u>bam^<u>z</u>baz", text: "foo<u>xbam^z</u>baz" },
          "middle"
        );
        // See more tests for splitting in special TC.
        a(
          "foo<u>x<b>[y]</b>z</u>baz",
          {
        ...
        a(
          "x[<span>a]b</span>x",
          { html: "xbam^<span>b</span>x", text: "x<span>bam^b</span>x" },
          "beginning 2"
        );
        a(
          "x<span>a[b</span>]x",
          { html: "x<span>a</span>bam^x", text: "x<span>abam^</span>x" },
          "end 2"
        );
      },
      ...
      "G2. text into selection containing inline element (part of or entire) and text outside this element":
        function () {
          var a = this.createAssertInsertionFunction(
            this.editablesNames,
            "bam",
          ...
          // Rule 1. (+ note 1.)
          a(
            "foo[<span>xyz</span>baz]",
            { html: "foobam^", text: "foo<span>bam^</span>" },
            "inside 1"
          );
          a(
            "foo<span>xy[z</span>baz]",
            { html: "foo<span>xy</span>bam^", text: "foo<span>xybam^</span>" },
            "inside 2"
          );
        },
      ...
      "G2. text into selection containing entire inline elements": function () {
        ...
        // Rule 1. (+ note 1.)
        a(
          "foo<b>[bar</b><b>bom]</b>baz",
          { html: "foobam^baz", text: "foo<b>bam^</b>baz" },
          "inside 1"
        );
        a(
          "foo[<b>bar</b><b>bom</b>]baz",
        ...
        a(
          "foo<b>[bar</b> <span>cke</span><br />\n\t <b>bom]</b>baz",
          { html: "foobam^baz", text: "foo<b>bam^</b>baz" },
          "inside 3"
        );
        a(
          "foo[<b>bar</b><b>baz</b>bim]bom",
          { html: "foobam^bom", text: "foo<b>bam^</b>bom" },
          "inside 4"
        );

        // Different endings - only startContainer matters.
        a(
          "foo[<i><u>b</u>im</i><b>bar</b><b>bom]</b>baz",
          { html: "foobam^baz", text: "foo<i><u>bam^</u></i>baz" },
          "inside 5"
        );
      ...
      "G2. text into not entirely selected inline elements": function () {
        ...
        // Rule 1. (+ note 1.)
        a(
          "foo<u>b[ar</u> <u>baz]</u>baz",
          { html: "foo<u>b</u>bam^baz", text: "foo<u>bbam^</u>baz" },
          "inside 1"
        );
        a(
          "foo<u>b[ar</u> <i>ba]z</i>baz",
          {
        ...
        a(
          "foo<u>b[ar</u> <u>ba]z</u>baz",
          { html: "foo<u>b</u>bam^<u>z</u>baz", text: "foo<u>bbam^z</u>baz" },
          "inside 3"
        );
      },
      ...
      "G2. text between inline elements": function () {
        ...
        a(
          "x<b>a[</b>def]<b>c</b>y",
          { html: "x<b>a</b>bam^<b>c</b>y", text: "x<b>abam^c</b>y" },
          "between 6"
        );
      },
      ...
      "G3. text into block element": function () {
        ...
        a(
          "x<p>[<b>foo</b>]</p>x",
          { html: "x<p>bam^</p>x", text: "x<p><b>bam^</b></p>x" },
          "into 7"
        );
      },
      ...
      "G3. text into block element + line break": function () {
        ...
        a(
          "x<p>bar[<b>foo</b>a</p>]x",
          { html: "x<p>barbam^</p>x", text: "x<p>bar<b>bam^</b></p>x" },
          "case 4"
        );

        a("<p>x</p>[<p>a<b>f</b>]bar</p>", "<p>x</p>bam^<p>bar</p>", "case 5");
        a(
          "<p>bar[<b>f</b>a</p>]<p>x</p>",
          {
            html: "<p>barbam^</p><p>x</p>",
            text: "<p>bar<b>bam^</b></p><p>x</p>",
          },
          "case 6"
        );
      ...
      "G3. text into block elements": function () {
        ...
        a(
          "<p>AA[A</p><div>B]BB</div>",
          "<p>AAbam^</p><div>BB</div>",
          "don't merge 1"
        );
        a(
          "<p>AA[A</p><div><p>B]BB</p></div>",
          "<p>AAbam^</p><div><p>BB</p></div>",
          "don't merge 2"
        );
        // Hard to implement merging here - but this could be interesting feature.
        a(
          "<ul><li>A[A<ul><li>B]B</li></ul></li></ul>",
          "<ul><li>Abam^<ul><li>B</li></ul></li></ul>",
          "don't merge 3"
        );
        a(
          "<table><tbody><tr><td>A[A</td><td>B]B</td></tr></tbody></table>",
          "<table><tbody><tr><td>Abam^</td><td>B</td></tr></tbody></table>",
          "don't merge 4"
        );
        a(
          '<ul class="red"><li>A[A</li></ul> <ul><li>B]B</li><li>C</li></ul>',
          '<ul class="red"><li>Abam^</li></ul><ul><li>B</li><li>C</li></ul>',
          "don't merge 5"
        );
        ...
        a(
          "<p>AA[A</p><div>C</div><hr><p>B]BB</p>",
          "<p>AAbam^BB</p>",
          "merge 4"
        );

        a(
          "<p>A<b>A[A</b></p><p>B]BB</p>",
          { html: "<p>A<b>A</b>bam^BB</p>", text: "<p>A<b>Abam^</b>BB</p>" },
          "merge 5"
        );
        // Combo! Rule 2. + 4. + 5.
        a(
          "<p>A<b>A<u>[A</u></b></p><p><b><u>B]B</u></b>B</p>",
          {
        ...
        a(
          "<ul><li>A<b>C[D</b></li></ul> <ul><li>A<b>C]D</b></li></ul>",
          {
        ...
        a(
          "<ul><li>A[A</li><li>B]B</li><li>CC</li></ul>",
          "<ul><li>Abam^B</li><li>CC</li></ul>",
          "merge 7"
        );
        a(
          "<ul><li>A[A</li></ul> <ul><li>B]B</li><li>C</li></ul>",
          "<ul><li>Abam^B</li><li>C</li></ul>",
          "merge 8"
        );

        a(
          '<ul><li>A[A</li></ul> <ul><li class="red">B]B</li><li>C</li></ul>',
          '<ul><li>Abam^</li><li class="red">B</li><li>C</li></ul>',
          "partial merge 1"
        );
        ...
        a(
          "<div><p>foo[</p></div><h1>bar]</h1>",
          "<div><p>foo^</p></div>",
          "div+p/h1"
        );
        a(
          "<p>foo[</p><ul><li>bar]</li><li>baz</li></ul>",
          "<p>foo^</p><ul><li>baz</li></ul>",
          "p+2li"
        );
        ...
        a(
          "[foo]<p></p>",
          "^<p>&nbsp;</p>",
          "do not remove empty block that's not within the original range"
        );

        // Should NOT remove empty block if it's on the start path.
        a(
          "<p>baz</p><p>[foo</p><h1>bar]</h1>",
          "<p>baz</p><p>^&nbsp;</p>",
          "do not remove empty block if it's on the start path"
        );
      },
      ...
      "G5. inline element next to inline element (different name)":
        function () {
          var a = this.createAssertInsertionFunction(
            this.editablesNames,
            "<b>a</b>",
          ...
          a(
            '<u>c[<b style="color: red">a</b></u>foo]',
            "<u>c</u><b>a^</b>",
            "remove styled el"
          );
          a(
            '[foo<u><b style="color: red">a</b>]c</u>',
            "<b>a^</b><u>c</u>",
            "remove styled el"
          );
        },
      ...
      "G5. inline element into inline element": function () {
        ...
        a(
          "<u>c^</u>",
          { html: "<u>c</u>d<br />e^", text: "<u>cd<br />e^</u>" },
          "into b1"
        );
        a(
          "<u>^c</u>",
          { html: "d<br />e^<u>c</u>", text: "<u>d<br />e^c</u>" },
          "into b2"
        );
        a(
          "<u>a[b]c</u>",
          { html: "<u>a</u>d<br />e^<u>c</u>", text: "<u>ad<br />e^c</u>" },
          "into b3"
        );
      ...
      "G6. inline element into block elements": function () {
        ...
        a(
          "<ul><li><b>a[a</b></li><li>b]b</li></ul>",
          "<ul><li><b>abam^</b>b</li></ul>",
          "merge 2"
        );

        a(
          "<p>a[a</p><div>b]b</div>",
          "<p>a<b>bam^</b></p><div>b</div>",
          "don't merge 1"
        );
      ...
      "G7-8. splitting": function () {
        ...
        a("<p>a^b</p>", "<p>a</p><p>bam</p><p>bar^</p><p>b</p>", "case 1a");
        a(
          "<h1>a^b</h1>",
          "<h1>a</h1><p>bam</p><p>bar^</p><h1>b</h1>",
          "case 1b"
        );
        a("<p>ab^</p>", "<p>ab</p><p>bam</p><p>bar^</p>", "case 1c");
        a("<h1>^ab</h1>", "<p>bam</p><p>bar^</p><h1>ab</h1>", "case 1d");
        a(
          "<div><p>a^b</p></div>",
          "<div><p>a</p><p>bam</p><p>bar^</p><p>b</p></div>",
          "case 1e"
        );
        ...
        a(
          "<ul><li>a^b</li></ul>",
          "<ul><li>a<p>bam</p><p>bar^</p>b</li></ul>",
          "case 2b"
        );
        ...
        a(
          "<h1>a^b</h1>",
          "<h1>a</h1><p>bam</p><h1><b>c</b>d^b</h1>",
          "case 4e"
        );
        ...
        a(
          "<p>a^b</p>",
          "<p>a</p><p>bam</p><b>x</b>y<p>bom^</p><p>b</p>",
          "case 5a"
        );
        a(
          "<h1>a^b</h1>",
          "<h1>a</h1><p>bam</p><b>x</b>y<p>bom^</p><h1>b</h1>",
          "case 5b"
        );
        a(
          "<div>a^b</div>",
          "<div>a<p>bam</p><b>x</b>y<p>bom^</p>b</div>",
          "case 5c"
        );
        ...
        a(
          "<p><b>a^b</b></p>",
          "<p><b>abom</b>x</p><p>bam</p><p>y<b>bim^b</b></p>",
          "case 6a"
        );

        a(
          "<p><b>a[b</b></p><p><b>c]d</b></p>",
          "<p><b>abom</b>x</p><p>bam</p><p>y<b>bim^d</b></p>",
          "case 6b"
        );
      ...
      "G7-8. splitting - reuse element": function () {
        ...
        a(
          '<p title="2">a^b</p>',
          '<p title="2">ax</p><p title="1">bam</p><p title="2">y^b</p>',
          "case 1a"
        );
      },
      ...
      "G7-8. splitting - multi selection": function () {
        ...
        a("<p>a[b</p><p>c]d</p>", "<p>ax</p><p>bam</p><p>y^d</p>", "case 1a");

        a(
          '<p title="1">a[b</p><p title="2">c]d</p>',
          '<p title="1">ax</p><p>bam</p><p title="2">y^d</p>',
          "case 2a"
        );

        a(
          '<p title="1">a[b</p><div>c]d</div>',
          '<p title="1">ax</p><p>bam</p><div>y^d</div>',
          "case 2b"
        );

        a(
          "<p>a[b</p><ul><li>c]d</li></ul>",
          "<p>ax</p><p>bam</p><ul><li>y^d</li></ul>",
          "case 2c"
        );
        ...
        a(
          "<p>a[b</p><div>c]d</div>",
          "<p>ax</p><p>bam</p><p>bom</p><div>y^d</div>",
          "case 3a"
        );
        ...
        a(
          "<p>a^b</p>",
          "<p>aa<b>b</b></p><p>bam</p><p>bam</p><p>c<b>d</b>e^b</p>",
          "case 4a"
        );
      },
      ...
      "G7-8. filtering content": function () {
        ...
        a(
          "<span><b>a^b</b></span>",
          "<span><b>a</b></span>bam^<span><b>b</b></span>",
          "case 1b"
        );
        ...
        a.insertion =
          "x<div>bam</div>y<table><tr><td>u</td><td>w</td></tr></table>z";
        a("a^b", "ax bam y u w z^b", "case 3a");
        a.insertion =
          "<ul><li>x</li><li>y<ul><li>X</li><li>Y</li></ul></li><li>z</li></ul>";
      ...
      "G9. non-editable block element with nested editable": function () {
        var div =
            '<div contenteditable="false">xx<p contenteditable="true">yy</p></div>',
          a = this.createAssertInsertionFunction("body,div", div, "html");
      ...
      "GS. merging adjacent inline elements": function () {
        ...
        a(
          "x[<b>a</b>def]<b>c</b>y",
          { html: "xbam^<b>c</b>y", text: "x<b>bam^c</b>y" },
          "merge 1a"
        );
        a(
          "x<u>b[ar</u><br /><u>ba]z</u>y",
          { html: "x<u>b</u>bam^<u>z</u>y", text: "x<u>bbam^z</u>y" },
          "merge 1b"
        );
        a(
          "x<u>b[<b>a</b>r</u> <u>ba]<b>z</b></u>y",
          {
        ...
        a(
          "x<b>a[b</b>cde]<b>f</b>y",
          { html: "x<b>a</b>bam^<b>f</b>y", text: "x<b>abam^f</b>y" },
          "merge 1e"
        );
        a(
          "x<b>ab[</b>cde<b>f]e</b>y",
          { html: "x<b>ab</b>bam^<b>e</b>y", text: "x<b>abbam^e</b>y" },
          "merge 1f"
        );
        a(
          "x<b><u>a[a</u>b</b>cde]<b>f</b>y",
          {
        ...
        a(
          "x^<b><u>a</u></b>y",
          "x<b><u>b</u>a<i>m^</i><u>a</u></b>y",
          "merge 3b"
        );
        a("x<b>a[b]<i>c</i></b>y", "x<b>a<u>b</u>a<i>m^c</i></b>y", "merge 3c");
        a(
          "x<b><u>a</u></b>[b]<b><i>c</i></b>y",
          "x<b><u>ab</u>a<i>m^c</i></b>y",
          "merge 3d"
        );
...
*/
      ...
      // Rule 3.
      "GS. moving caret to the element which is at the very end of insertion":
        function () {
          var a = this.createAssertInsertionFunction(
            this.editablesNames,
            "",
          ...
          a(
            '<i><a href="#">a&nbsp;[</a></i>b]',
            '<i><a href="#">a&nbsp;</a></i>^',
            "dont move into inline link end with &nbsp;"
          );
      ...
      "GS. cleanup empty blocks": function () {
        ...
        a(
          ...
          "<p>bam^</p>",
          "remove empty DIV>P at the end"
        );
        a(
          "<p>[foo</p><ul><li>bar]</li></div>",
          "<p>bam^</p>",
          "remove empty UL>LI at the end"
        );
        a(
          "<p>[foo</p><ul><li>bar]</li><li>baz</li></ul></div>",
          "<p>bam^</p><ul><li>baz</li></ul>",
          "Not remove UL>LIs at the end"
        );
        a(
          "<p>[foo</p><table><tr><td>bar]</td></tr></table></div>",
          "<p>bam^</p>",
          "remove empty TABLE>TR>TD at the end"
        );
        a(
          "<p>[foo</p><table><caption>baz</caption><tr><td>bar]</td></tr></table></div>",
          "<p>bam^</p>",
          "remove emtpy TABLE>TR>TD at the end (with caption)"
        );
        a(
          "<p>[foo</p><table><tr><td>bar]</td><td>baz</td></tr></table></div>",
          "<p>bam^</p><table><tbody><tr><td>baz</td></tr></tbody></table>",
          "NOT remove TABLE>TR>TD at the end"
        );
      ...
      "GS. block bogus": function () {
        ...
        if (CKEDITOR.env.needsBrFiller) {
          ...
          a(
            "<p>^<br /></p>",
            "<p>bam<br />^&nbsp;</p>",
            "line break inserted before bogus"
          );
          a.insertion = "<br />bam";
          a(
            "<p><br />^</p>",
            "<p><br />bam^</p>",
            "line break inserted after bogus"
          );
      ...
      "GS. blocks inheriting inline styles in text mode": function () {
        ...
        a(
          "<p><b>^xy</b></p>",
          "<p><b>abc</b></p><p><b>def^</b></p><p><b>xy</b></p>",
          "case 2a"
        );
        a(
          "<p><b>xy^</b></p>",
          "<p><b>xy</b></p><p><b>abc</b></p><p><b>def^</b></p>",
          "case 2b"
        );
        // Caret outside - no styles applied.
        a(
          "<p>x^<b>yz</b></p>",
          "<p>x</p><p>abc</p><p>def^</p><p><b>yz</b></p>",
          "case 2c"
        );
        a(
          "<p><b>x<i>y^z<u>w</u></i></p>",
          "<p><b>x<i>y</i></b></p><p><b><i>abc</i></b></p><p><b><i>def^</i></b></p><p><b><i>z<u>w</u></i></b></p>",
          "case 2d"
        );

        a(
          '<p><span title="text">x^y</span></p>',
        ...
        a(
          "<p><b>x^y</b></p>",
          "<p><b>x</b></p><p><b>def</b></p><p><b>abc^y</b></p>",
          "case 4a"
        );
        ...
        if (
          !(
            CKEDITOR.env.ie &&
            (document.documentMode || CKEDITOR.env.version) < 9
          )
        ) {
          a.insertion = "abc<p>def</p>";
          a(
            "<p><b>x^y</b></p>",
            "<p><b>xabc</b></p><p><b>def^</b></p><p><b>y</b></p>",
            "case 4b"
          );
        }
        ...
        a(
          "<p>[<b>x]y</b></p>",
          "<p><b>abc</b></p><p><b>def^</b></p><p><b>y</b></p>",
          "case 6a"
        );
        a(
          "<p><b>x[y</b>]</p>",
          "<p><b>x</b></p><p><b>abc</b></p><p><b>def^</b></p>",
          "case 6b"
        );
        a(
          "<p><b>y[x</b></p><p><b>x]z</b></p>",
          "<p><b>y</b></p><p><b>abc</b></p><p><b>def^</b></p><p><b>z</b></p>",
          "case 6c"
        );

        a(
          "<table><tbody><tr><td><b>x[y</b></td><td><u>y]z</u></td></tr></tbody></table>",
        ...
        a.insertion = "<p>abc</p>";
        a("<p><b>x^y</b></p>", "<p><b>xabc^y</b></p>", "case 7a");

        // TODO Small bug - caret should end in <b>^y.
        a.insertion = '<p>abc</p><p>def</p><br data-cke-eol="1" />';
        a(
          "<p><b>x^y</b></p>",
          "<p><b>x</b></p><p><b>abc</b></p><p><b>def</b></p><p>^<b>y</b></p>",
          "case 8a"
        );
        a.insertion = '<br data-cke-eol="1" />abc';
        a("<p><b>x^y</b></p>", "<p><b>x</b></p><p><b>abc^y</b></p>", "case 8b");
