      ...
      editor.setMode("source", function () {
        ...
        editor.setMode("wysiwyg", function () {
          resume(function () {
            assert.areSame(
              "detached",
              statuses.editableWysiwygAfterSetMode,
      ...
      editor.setMode("source", function () {
        ...
        editor.setMode("wysiwyg", function () {
          ...
          resume(function () {
            ...
            assert.areSame(
              "ready",
              statuses.editableWysiwygAfterModeReady,
              "wysiwyg editable status after wysiwyg mode is ready"
            );

            assert.areSame(
              "unloaded",
              statuses.setData.join(","),
              "statuses on setData"
            );

            assert.areSame(
              "ready",
              statuses.contentDom.join(","),
