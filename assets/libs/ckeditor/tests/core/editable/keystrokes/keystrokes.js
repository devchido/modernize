...
bender.test({
  assertKeystroke: function (key, keyModifiers, input, output, msg) {
    ...
    assert[notHandled ? "isFalse" : "isTrue"](
      ...
      msg +
        " - " +
        (notHandled
          ? "keystroke should be left unhandled"
          : "keystroke should be handled")
    );
  ...
  "test handle del/backspace at the boundary of table cell": function () {
    this.assertKeystroke(
      DEL,
      0,
      "<table><tbody><tr><td>foo^</td><td>bar</td></tr></tbody></table>",
      "<table><tbody><tr><td>foo^</td><td>bar</td></tr></tbody></table>",
      "del doesn't change the selection"
    );
    ...
    this.assertKeystroke(
      ...
      "<table><tbody><tr><td>foo</td><td>bar</td></tr></tbody></table>^text",
      "del moves selection after the table"
    );
    ...
    this.assertKeystroke(
      ...
      "<table><tbody><tr><td>foo</td><td>^bar</td></tr></tbody></table>",
      "<table><tbody><tr><td>foo</td><td>^bar</td></tr></tbody></table>",
      "backspace del doesn't change the selection"
    );
    ...
    this.assertKeystroke(
      ...
      "<table><tbody><tr><td>foo^</td><td>bar</td></tr></tbody></table>",
      "<table><tbody><tr><td>foo^</td><td>bar</td></tr></tbody></table>",
      "del doesn't change the selection - SHIFT"
    );
    ...
    this.assertKeystroke(
      ...
      "<table><tbody><tr><td>foo</td><td>^bar</td></tr></tbody></table>",
      "<table><tbody><tr><td>foo</td><td>^bar</td></tr></tbody></table>",
      "backspace del doesn't change the selection - CTRL"
    );
  },
  ...
  "test handle del with full nested table content selected": function () {
    ...
    this.assertKeystroke(
      DEL,
      0,
      "<table><tbody><tr><td>x<table><tbody><tr><td>[foo]</td></tr></tbody></table></td></tr></tbody></table>",
    ...
    this.assertKeystroke(
      DEL,
      0,
      "<table><tbody><tr><td><table><tbody><tr><td>[foo]</td></tr></tbody></table>x</td></tr></tbody></table>",
      "<table><tbody><tr><td>^x</td></tr></tbody></table>",
      "table 2"
    );
    ...
    this.assertKeystroke(
      DEL,
      0,
      "<table><tbody><tr><td><table><tbody><tr><td>[foo]</td></tr></tbody></table></td></tr></tbody></table>",
      "^",
      "table 3"
    );
  },
  ...
  // https://dev.ckeditor.com/ticket/10646
  "test handle del with full nested table content selected within a list":
    function () {
      // A content in a parent list: before selected.
      this.assertKeystroke(
        DEL,
        0,
        "<ul><li>x<table><tbody><tr><td>[foo]</td></tr></tbody></table></li></ul>",
        "<ul><li>x^</li></ul>",
        "table 1"
      );
      ...
      this.assertKeystroke(
        DEL,
        0,
        "<ul><li><table><tbody><tr><td>[foo]</td></tr></tbody></table>x</li></ul>",
        "<ul><li>^x</li></ul>",
        "table 2"
      );
      ...
      this.assertKeystroke(
        DEL,
        0,
        "<ul><li><table><tbody><tr><td>[foo]</td></tr></tbody></table></li></ul>",
        "^",
        "table 3"
      );
    },
