    ...
    },
    {
      "insert list into the start/end of list item": function () {
        ...
        a(
          ...
          "<ol><li>foo</li><li>bar^</li><li>foo</li><li>bar</li></ol>"
        );

        a.insertion = "<ol><li>baz</li><li>quz</li></ol>";
        a(
          "<ol><li>foo^</li><li>bar</li></ol>",
          "<ol><li>foo</li><li>baz</li><li>quz^</li><li>bar</li></ol>"
        );
      },
      ...
      "insert list into the start/end of list item with block": function () {
        ...
        a(
          ...
          "<ol><li>baz^</li><li><p>foo</p></li><li>bar</li></ol>"
        );

        a.insertion = "<ol><li>baz</li></ol>";
        a(
          "<ol><li><p>foo^</p></li><li>bar</li></ol>",
          "<ol><li><p>foo</p></li><li>baz^</li><li>bar</li></ol>"
        );
      },
      ...
      "insert list with sublist into the start/end of list item": function () {
        ...
        a(
          "<ol><li>foo^</li></ol>",
          "<ol><li>foo</li><li>baz<ol><li>quz^</li></ol></li></ol>"
        );

        a.insertion = "<ol><li>baz<ol><li>quz</li></ol></li></ol>";
        a(
          "<ol><li>^foo</li></ol>",
          "<ol><li>baz<ol><li>quz^</li></ol></li><li>foo</li></ol>"
        );
      },
      ...
      "insert into middle of list item": function () {
        ...
        a(
          "<ol><li>foo^bar</li></ol>",
          "<ol><li>foo</li><li>quz^</li><li>bar</li></ol>",
          "list block"
        );
        a(
          "<ol><li><p>foo^bar</p></li></ol>",
          "<ol><li><p>foo</p></li><li>quz^</li><li><p>bar</p></li></ol>",
          "text block"
        );
      },
      ...
      "insert list items": function () {
        ...
        a(
          "<ul><li>bom^</li></ul>",
          "<ul><li>bom</li><li>foo</li><li>bar^</li></ul>"
        );
