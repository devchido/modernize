...
(function () {
  ...
  bender.test({
    ...
    "test BACKSPACE in read-only mode: framed config.readOnly=true":
      function () {
    ...
    "test BACKSPACE in read-only mode: inline config.readOnly=true":
      function () {
    ...
    "test BACKSPACE in read-only mode: inline no contenteditable attribute":
      function () {
