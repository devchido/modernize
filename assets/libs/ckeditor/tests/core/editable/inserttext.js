  ...
  insertionDT.run(
    ...
    },
    {
      "plain text htmlification": function () {
        ...
        a(
          "<p>foo^bar</p>",
          "<p>foo</p><p>abc</p><p>def<br />ghi</p><p>jkl^</p><p>bar</p>",
          "2 LFs - wrapped blocks"
        );
        a.insertion = "\n\n\n\nfoo";
        ...
        a(
          "^",
          "foo&nbsp;&nbsp; &nbsp; &nbsp;<br />&nbsp;bar^",
          "whitespaces between tab and LF"
        );
        a.insertion = "foo  \n\n  bar";
        a(
          "^",
      ...
      "empty and spaces insertions": function () {
        ...
        a(
          "<p>a ^b</p>",
          "<p>a &nbsp;^b</p>",
          "space into paragraph after space"
        );
