...
bender.test({
  ...
  "test click on image selects it": function () {
    ...
    bot.setData(
      '<p>foo<img src="../../_assets/img.gif" alt="" />foo</p>',
      function () {
  ...
  "test click on a non-editable image does not select it": function () {
    ...
    bot.setData(
      '<p>foo</p><div contenteditable="false"><img src="../../_assets/img.gif" alt="" /></div><p>foo</p>',
      function () {
        var editor = bot.editor,
          img = editor.editable().findOne("img");
  ...
  // https://dev.ckeditor.com/ticket/11727.
  "test click on deeply nested non-editable image does not select it":
    function () {
      var bot = this.editorBots.editor;

      bot.setData(
        '<p>foo</p><div contenteditable="false"><p><span><img src="../../_assets/img.gif" alt="" /></span></p></div><p>foo</p>',
        function () {
          var editor = bot.editor,
            img = editor.editable().findOne("img");
