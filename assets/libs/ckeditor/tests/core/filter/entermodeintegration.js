...
(function () {
  ...
  bender.test({
    "test default configuration": function () {
      bender.editorBot.create(
        ...
        function (bot) {
          ...
          assert.areSame(
            0,
            editor._activeEnterModeChanged,
            "no enter mode changes before ready"
          );
          assert.areSame(
            ENTER_P,
      ...
      bender.editorBot.create(
        ...
        function (bot) {
          ...
          assert.areSame(
            ENTER_P,
            editor.activeEnterMode,
            "back to initial activeEnterMode"
          );
          assert.areSame(
            ENTER_BR,
            editor.activeShiftEnterMode,
            "back to initial activeShiftEnterMode"
          );
        }
      );
    },
    ...
    "test changing enter modes by active filter in blockless editor":
      function () {
        bender.editorBot.create(
          {
          ...
          function (bot) {
            ...
            assert.areSame(
              0,
              editor._activeEnterModeChanged,
              "enter mode has not been changed"
            );
            assert.areSame(
              ENTER_BR,
              editor.activeEnterMode,
