...
(function () {
  ...
  function ruleSortCompare(ruleA, ruleB) {
    ...
    return elementsA == elementsB ? 0 : elementsA > elementsB ? 1 : -1;
  }
  ...
  bender.test({
    ...
    "test addFeature() - config.disallowedContent - conflicting rule":
      function () {
    ...
    "test addFeature() - config.disallowedContent - not conflicting rule":
      function () {
        var editor = this.editors.editorDisallowedContent,
          filter = editor.filter,
          allowedContentLength = filter.allowedContent.length;
    ...
    "test addFeature() - config.allowedContent && config.disallowedContent - conflicting rule":
      function () {
    ...
    "test addFeature() - config.allowedContent && config.disallowedContent - not conflicting rule":
      function () {
        var editor = this.editors.editorBothContents,
          filter = editor.filter,
          allowedContentLength = filter.allowedContent.length;
    ...
    "test filtering - attributes": function () {
      ...
      filter(
        '<p><i bar="1" foo="1">A</i> <b>B</b></p>',
        '<p><i bar="1" foo="1">A</i> <b>B</b></p>'
      );
      filter('<p><i xxx="1">A</i></p>', "<p><i>A</i></p>");
      filter(
        '<p><b bar="1" barxxx="1" foo="1">A</b></p>',
        '<p><b bar="1">A</b></p>'
      );
    },
    ...
    "test filtering - attributes - no conflict with classes and styles":
      function () {
        ...
        filter(
          '<p><b bar="1" foo="1" xxx="1">A</b></p>',
          '<p><b bar="1" foo="1">A</b></p>'
        );
      },
    ...
    "test filtering - attributes - allow&disallow all": function () {
      ...
      filter(
        '<p><b class="foo" style="bar:1">A</b></p>',
        '<p><b class="foo" style="bar:1">A</b></p>'
      );
    },
    ...
    "test filtering - classes": function () {
      ...
      filter(
        '<p><i class="bar foo">A</i> <b>B</b></p>',
        '<p><i class="bar foo">A</i> <b>B</b></p>'
      );
      filter('<p><i class="xxx">A</i></p>', "<p><i>A</i></p>");
      filter(
        '<p><b class="bar barxxx foo">A</b></p>',
        '<p><b class="bar">A</b></p>'
      );
    },
    ...
    "test filtering - classes with wildcards": function () {
      ...
      filter(
        '<p><i class="a b bonb">A</i></p>',
        '<p><i class="a b bonb">A</i></p>'
      );
      filter('<p><i class="on ona onfoo">A</i></p>', "<p><i>A</i></p>");
      filter(
        '<p><b class="foo-a foo-b foo-xxx">A</b></p>',
        '<p><b class="foo-b">A</b></p>'
      );
      filter('<p><b class="bar-a bar-bar">A</b></p>', "<p><b>A</b></p>");
      // https://dev.ckeditor.com/ticket/11780
      filter(
        '<p><i class="onx data-x">A</i></p>',
        '<p><i class="data-x">A</i></p>'
      );
    },
    ...
    "test filtering - styles": function () {
      ...
      filter(
        '<p><i style="bar:1; foo:1">A</i> <b>B</b></p>',
        '<p><i style="bar:1; foo:1">A</i> <b>B</b></p>'
      );
      filter('<p><i style="xxx:1">A</i></p>', "<p><i>A</i></p>");
      filter(
        '<p><b style="bar:1; barxxx:1; foo:1">A</b></p>',
        '<p><b style="bar:1">A</b></p>'
      );
    },
    ...
    "test filtering - styles with wildcards": function () {
      ...
      filter(
        '<p><i style="a:1; b:1; bonb:1">A</i></p>',
        '<p><i style="a:1; b:1; bonb:1">A</i></p>'
      );
      filter('<p><i style="on:1; ona:1; onfoo:1">A</i></p>', "<p><i>A</i></p>");
      filter(
        '<p><b style="foo-a:1; foo-b:1; foo-xxx:1">A</b></p>',
        '<p><b style="foo-b:1">A</b></p>'
      );
      filter('<p><b style="bar-a:1; bar-bar:1">A</b></p>', "<p><b>A</b></p>");
      // https://dev.ckeditor.com/ticket/11780
      filter(
        '<p><i style="onx:1; data-x:1">A</i></p>',
        '<p><i style="data-x:1">A</i></p>'
      );
    },
    ...
    "test check() - diallowing entire elements": function () {
      var filter = new CKEDITOR.filter(
        "p b; i[foo]; b[bar]; u[foo]; *[bom]; u[!foo]"
      );
    ...
    "test transformations - attributes": function () {
      ...
      bot.setData(
        '<p><img alt="" src="../../_assets/img.gif" style="height:100px; width:50px" /></p>',
        function () {
          assert.areSame(
            '<p><img alt="" height="100" src="../../_assets/img.gif" width="50" /></p>',
            bot.getData(true)
          );
        }
      );
