...
(function () {
  ...
  bender.test({
    "test standalone filter": function () {
      ...
      assert.isTrue(
        filter.allow("b", null, true),
        "Rule added in overwriteCustom mode"
      );
    ...
    "test elements filter - string": function () {
      ...
      filter(
        "<p><b>foo</b> <i>bar</i> <u>bum</u></p>",
        "<p><b>foo</b> <i>bar</i> bum</p>"
      );
      filter(
    ...
    'test elements "*" filter 2 - string': function () {
      ...
      filter(
        '<h1 class="red">foo <b class="red">bar</b></h1>',
        '<h1 class="red">foo <b class="red">bar</b></h1>'
      );
    },
    ...
    "test elements propertiesOnly filter - object": function () {
      ...
      filter(
        '<p><b foo="1" bar="2">A</b> <i foo="1" bar="2">B</i></p>',
    ...
    "test attributes filter - string": function () {
      ...
      filter(
        '<p title="a" id="b" data-custom="c">foo</p>',
        '<p data-custom="c" title="a">foo</p>'
      );
      filter(
        '<h1 title="a" id="b" lang="pl">foo</h1>',
        '<h1 lang="pl">foo</h1>'
      );
    },
    ...
    "test attributes filter - string with wildcards": function () {
      ...
      filter(
        '<p data-foo="b" data-x="a" boo="b">foo</p>',
        '<p data-foo="b" data-x="a">foo</p>'
      );
      filter(
        '<p foobar="a" fooxbar="b" foo="c">foo</p>',
        '<p foobar="a" fooxbar="b">foo</p>'
      );
      filter(
        '<h1 lang="pl" language="pl">foo</h1>',
        '<h1 lang="pl" language="pl">foo</h1>'
      );
    },
    ...
    "test attributes filter - style": function () {
      var filter = createFilter([
        st({
          element: "p",
          attributes: { title: "foo", "data-custom": "bar" },
        }),
    ...
    "test classes filter - string": function () {
      ...
      filter(
        '<h1 class="a B b">foo</h1><p class="a c">bar</p>',
        '<h1 class="B a">foo</h1><p class="a">bar</p>'
      );
    ...
    "test classes filter - string with wildcards": function () {
      ...
      filter(
        '<h1 class="axy cb dB dx">foo</h1><p class="a c">bar</p>',
    ...
    "test styles filter - string": function () {
      ...
      filter(
        '<h1 style="height:0; width:0">foo</h1>',
        '<h1 style="height:0; width:0">foo</h1>'
      );
      filter(
        '<h2 style="height:0; width:0">foo</h2>',
        '<h2 style="width:0">foo</h2>'
      );
      filter(
        '<p style="height:0; color:red">foo</p>',
        '<p style="height:0">foo</p>'
      );
    },
    ...
    "test styles filter - string with wildcards": function () {
      ...
      filter(
        '<h1 style="font-size:11px; height:0">foo</h1>',
        '<h1 style="font-size:11px">foo</h1>'
      );
      filter(
        '<h2 style="border:solid">foo</h2>',
        '<h2 style="border:solid">foo</h2>'
      );
      filter(
        '<h2 style="border-style:solid">foo</h2>',
        '<h2 style="border-style:solid">foo</h2>'
      );
      filter(
    ...
    "test styles filter - style": function () {
      ...
      filter(
        '<p><span style="font-size:10px; color:red">A</span></p>',
    ...
    "test combined and spacey filter - string": function () {
      var filter = createFilter(
        " p h1 ( c1, c2 ) [ attr1, attr2 ] { color, width } ;\n h2(c3) "
      );
    ...
    "test required properties": function () {
      ...
      filter(
        '<p><img alt="2" src="1" />X<img alt="2"></p>',
        '<p><img alt="2" src="1" />X</p>'
      );
      filter(
        '<p><b class="foo bar">A</b><b>B</b></p>',
        '<p><b class="foo">A</b>B</p>'
      );
    },
    ...
    "test required properties with wildcards": function () {
      ...
      filter(
        '<p><b foo-x="1" foo-y="1">x</b></p>',
        '<p><b foo-x="1" foo-y="1">x</b></p>'
      );
      filter('<p><i class="bar-x">x</i></p>', '<p><i class="bar-x">x</i></p>');
      filter(
        '<p><i class="bar-x bar-y" foo-x="1">x</i></p>',
        '<p><i class="bar-x bar-y" foo-x="1">x</i></p>'
      );
    },

    "test dynamic rules adding after filter rule was added to htmlParser.filter":
      function () {
        var filter = createFilter("h1");

        filter(
          '<h1 class="red"><i>foo</i> <b>bar</b></h1>',
          "<h1>foo bar</h1>"
        );
    ...
    "test match rule": function () {
      ...
      filter(
        '<p><b class="bar">A</b><b foo="1" class="bar">B</b></p>',
        '<p>A<b class="bar">B</b></p>'
      );
    ...
    "test validate all rules - string": function () {
      ...
      filter(
        '<p><u class="x y" foo="1" style="color:red">A</u></p>',
        '<p><u foo="1">A</u></p>'
      );
      filter(
        '<p><i class="x y" foo="1" style="color:red">A</i></p>',
        '<p><i class="x y">A</i></p>'
      );
      filter(
        '<p><s class="x y" foo="1" style="color:red">A</s></p>',
    ...
    "test strip divs": function () {
      ...
      t(
        "<div><h1>A</h1><div>B</div></div>",
        "<h1>A</h1><p>B</p>",
        "strip div>h1+div"
      );
      t(
        "<div><b>A</b>B<br />C<div>D</div>E</div>",
        "<p><b>A</b>B<br />C</p><p>D</p><p>E</p>",
        "strip div>various"
      );
      t(
        "<div>A</div><blockquote><div>B</div><div>C</div></blockquote><div>D</div>",
        "<p>A</p><blockquote><p>B</p><p>C</p></blockquote><p>D</p>",
        "replace div in blockquote"
      );
    },
    ...
    "test strip list": function () {
      var t = createFilterTester(this.editors.themed);
      t(
        "<p>X</p><ul><li>A</li><li>B</li></ul><p>X</p>",
        "<p>X</p><p>A</p><p>B</p><p>X</p>",
        "strip ul>li+li"
      );
      t(
        "<ul><li><b>A</b><ol><li>B</li><li>C</li></ol></li><li>D</li></ul>",
        "<p><b>A</b></p><p>B</p><p>C</p><p>D</p>",
        "strip ul>li>ol>li"
      );
    },
    ...
    "test strip table": function () {
      var t = createFilterTester(this.editors.themed);
      t(
        "<table><tr><td>A</td><td><b>B</b></td></tr><tr><th>C</th><th>D</th></tr></table>",
        "<p>A<b>B</b></p><p>CD</p>",
        "strip table"
      );
    },
    ...
    "test strip table 2": function () {
      ...
      t(
        "<table><thead><tr><td>A</td><td>B</td></tr></thead><tbody><tr><td>C</td><td>D</td></tr></tbody></table>",
    ...
    "test strip elements and clean up props": function () {
      var t = createFilterTester(this.editors.themed);
      t(
        '<h2 foo="1">A <i style="color:red">B</i></h2>',
        "<p>A B</p>",
        "strip h2 and attribute"
      );
      t(
        '<table><tbody><tr style="color:red"><td>C</td><td foo="1">D</td></tr></tbody></table>',
        "<p>CD</p>",
        "strip table and attributes"
      );
      t(
        '<div class="Y">A <p foo="1">B</p> <div class="X">C</div></div>',
        "<p>A</p><p>B</p><p>C</p>",
        "strip divs and attributes"
      );
      t(
        '<ul align="right"><li foo="1">A</li><li bar="2">B <ol class="X"><li class="Y">C</li></ol></ul>',
        "<p>A</p><p>B</p><p>C</p>",
        "strip list and attributes"
      );
    },
    ...
    "test strip in br mode": function () {
      ...
      t(
        "<strong>A</strong><br />B<em>C</em>D",
        "<strong>A</strong><br />B<em>C</em>D",
        "leave"
      );

      t(
        "<span>A</span>B<kbd>C</kbd>D<hr />E",
        "ABCD<br />E",
        "strip inlines and hr"
      );
      t(
        "<h1>A</h1><p>B</p><p><em>C</em></p>",
        "A<br />B<br /><em>C</em>",
        "strip paragraphs and header"
      );
      t("<ul><li>A</li><li>B</li></ul>", "A<br />B", "strip list");
      t(
        "A<table><tbody><tr><td>X</td><td>Y</td></tr><tr><td>W</td><td>Z</td></tr></tbody></table>C<br />D",
        "A<br />XY<br />WZ<br />C<br />D",
        "strip table"
      );
      t(
        "<p>A</p><blockquote><p>B</p><p>C</p></blockquote><p>D</p>",
        "A<blockquote>B<br />C</blockquote>D",
        "strip paragraphs from blockquote"
      );
      t(
        "<p>X</p><div><div>A</div><div>B</div></div><p>X<p>",
        "X<br />A<br />B<br />X",
        "strip div>div+div"
      );
    },
    ...
    "test strip in div mode": function () {
      ...
      t(
        "<p>X</p><div><div>A</div><div>B</div></div><p>X<p>",
        "<div>X</div><div><div>A</div><div>B</div></div><div>X</div>",
        "leave div>div+div, replace p"
      );

      t(
        "<h1>A</h1><p>B</p><p><em>C</em></p>",
        "<div>A</div><div>B</div><div><em>C</em></div>",
        "replace paragraphs and header"
      );
      t(
        "<ul><li>A</li><li>B</li></ul>",
        "<div><div>A</div><div>B</div></div>",
      ...
      t(
        "<p>A</p><table><tbody><tr><td>X</td><td>Y</td></tr><tr><td>W</td><td>Z</td></tr></tbody></table><p>C<br />D</p>",
        "<div>A</div><div><div>XY</div><div>WZ</div></div><div>C<br />D</div>",
        "strip table"
      );
      t(
        "<p>A</p><blockquote><p>B</p><p>C</p></blockquote><p>D</p>",
        "<div>A</div><blockquote><div>B</div><div>C</div></blockquote><div>D</div>",
        "replace paragraphs in blockquote"
      );
    },
    ...
    "test strip in blockless editor": function () {
      ...
      t(
        "<p>A</p><blockquote><p>B</p><p>C</p></blockquote><p>D</p>",
        "A<br />B<br />C<br />D",
        "strip paragraphs and blockquote"
      );
      t(
        "<p>X</p><div><div>A</div><div>B</div></div><p>X<p>",
    ...
    "test clean up invalid link/anchor": function () {
      ...
      filter(
        '<p>X<a name="x"><img src="x" /></a>X</p>',
        '<p>X<a name="x"></a>X</p>'
      );
      filter(
        '<p>X<a href="x" name="x">A</a>X</p>',
        '<p>X<a name="x">A</a>X</p>'
      );
      ...
      filter(
        '<p>X<a id="x" name="x">foo</a>X</p>',
        '<p>X<a id="x">foo</a>X</p>'
      );
      ...
      t(
        '<p>X<a href="x">A</a>X</p>',
        "<p>X<a>A</a>X</p>",
        "remove href, but not link"
      );
      t(
        '<p>X<a name="x">A</a>X</p>',
        '<p>X<a data-cke-saved-name="x" name="x">A</a>X</p>',
        "do not remove a[name]"
      );
      t(
        '<p>X<a name="x"></a>X</p>',
        '<p>X<a data-cke-saved-name="x" name="x"></a>X</p>',
        "do not remove empty a[name]"
      );
    },
    ...
    "test clean up invalid img": function () {
      ...
      t(
        '<p><a href="a"><img src="x" /></a></p>',
        "<p>@</p>",
        "remove a>img and add bogus"
      );
    },
    ...
    "test clean up empty elements from dtd.$removeEmpty": function () {
      ...
      t(
        '<p><b><img src="x" /></b></p>',
        "<p>@</p>",
        "remove empty b>img and add bogus"
      );
      t(
        '<p><b><i><img src="x" /></i></b></p>',
        "<p>@</p>",
        "remove empty b>i>img and add bogus"
      );
    },
    ...
    "test clean up data-cke-saved attributes": function () {
      ...
      filter('<p data-cke-saved-foo="1">A</p>', "<p>A</p>");
      filter(
        '<p data-cke-saved-foo="1" foo="1">A</p>',
        '<p data-cke-saved-foo="1" foo="1">A</p>'
      );
      filter('<p data-cke-custom="1">A</p>', '<p data-cke-custom="1">A</p>');
    },
    ...
    "test strip table after its content have been rejected": function () {
      ...
      filter(
        "<p>X</p><table><caption>C</caption><tbody><tr><td>1A</td><td>1B</td></tr><tr><td>2A</td><td>2B</td></tr></tbody></table><p>X</p>",
    ...
    "test strip protected elements": function () {
      ...
      t(
        "<p>X<script>alert(1);</scr" + "ipt>Y</p>",
        "<p>XY</p>",
        "strip entire script"
      );
      t(
        "<p>X<script>alert(1);</scr" +
          "ipt><script>alert(1);</scr" +
          "ipt>Y</p>",
        "<p>XY</p>",
        "strip entire scripts"
      );
      t(
        "<p>X<noscript>foo</noscr" + "ipt>Y</p>",
        "<p>XY</p>",
        "strip entire noscript"
      );
      t(
        '<p>X<script>alert("<? echo 1; ?>");</scr' + "ipt>Y</p>",
        "<p>XY</p>",
        "strip entire script with protected like fragment"
      );
      t(
        "<p>X<!--foo-->Y</p>",
        "<p>X<!--{cke_protected}{C}%3C!%2D%2Dfoo%2D%2D%3E-->Y</p>",
        "leave real comment"
      );
      t(
        "<p>X<? echo 1; ?>Y</p>",
        "<p>X<!--{cke_protected}%3C%3F%20echo%201%3B%20%3F%3E-->Y</p>",
        "leave entire PHP code"
      );
      t("<script>alert(1);", "@", "strip entire script (no closing)");
      t(
        '<script><iframe src="foo"></iframe>',
        "@",
        "strip entire script (no closing, iframe inside)"
      );
    },
    ...
    "test leave protected elements": function () {
      ...
      t(
        "<p>X<script>alert(1);</scr" + "ipt>Y</p>",
        "<p>X<!--{cke_protected}%3Cscript%3Ealert(1)%3B%3C%2Fscript%3E-->Y</p>",
        "leave entire script"
      );
      t(
        "<p>X<noscript>foo</noscr" + "ipt>Y</p>",
        "<p>X<!--{cke_protected}%3Cnoscript%3Efoo%3C%2Fnoscript%3E-->Y</p>",
        "leave entire noscript"
      );
      t(
        "<p>X<!--foo-->Y</p>",
        "<p>X<!--{cke_protected}{C}%3C!%2D%2Dfoo%2D%2D%3E-->Y</p>",
    ...
    "test script removed completely when its body is not encoded": function () {
      ...
      filter(
        "<p>X<script>alert(1);</scr" + "ipt>X</p>",
        "<p>XX</p>",
        "strip whole element"
      );
    },
    ...
    "test strip entire elements which may contain cdata": function () {
      ...
      t(
        "<p>X</p><style>#d{color:red}</style><p>Y</p>",
        "<p>X</p><p>Y</p>",
        "strip entire style"
      );
    },
    ...
    "test no filtering on output": function () {
      ...
      t(
        '<h2>X</h2><p><i>A</i> <img alt="y" src="x" /></p><div foo="1">C</div>',
        '<h2>X</h2><p><i>A</i> <img alt="y" src="x" /></p><div foo="1">C</div>',
        "leave all"
      );
    },
    ...
    "test no filtering with dontFilter argument": function () {
      ...
      t(
        '<h2>X</h2><p><i>A</i></p><div foo="1">C</div>',
        '<h2>X</h2><p><i>A</i></p><div foo="1">C</div>',
        "leave all"
      );
    },

    "test leave data-cke-* spans like markers and bookmarks - toHtml":
      function () {
        var t = createFilterTester(this.editors.themed);

        t(
          'X<span data-cke-marker="1">&nbsp;</span>X',
          'X<span data-cke-marker="1">&nbsp;</span>X',
          "leave markers"
        );

        t(
          'X<span data-cke-bookmark="1">&nbsp;</span>X',
          'X<span data-cke-bookmark="1">&nbsp;</span>X',
          "leave bookmarks"
        );

        t(
          'X<span data-cke-moo="1">Y</span>X',
          'X<span data-cke-moo="1">Y</span>X',
          "leave data-cke-* spans"
        );

        // B is allowed.
        t(
          'X<b data-cke-marker="1" foo="2">Y</b>X',
          'X<b data-cke-marker="1">Y</b>X',
          "leave b, but strip foo attribute"
        );

        t(
          'X<span data-="1" cke-="1" data-cke="1">Y</span>X',
          "XYX",
          "strip tricky spans"
        );
    ...
    "test leave data-cke-* spans like markers and bookmarks - toDataFormat":
      function () {
        ...
        filter(
          'X<i data-cke-marker="1">Y</i>X',
          "XYX",
          "strip other elements - i"
        );
      },
    ...
    'test disabling filter with data-cke-filter="off" attribute': function () {
      ...
      filter(
        '<p><i data-cke-filter="off">X</i><i>Y</i></p>',
        '<p><i data-cke-filter="off">X</i>Y</p>',
        "protect marked i"
      );

      filter(
        '<p class="xyz" data-cke-filter="off" foo="1" style="color: red"><i bar="2">X</i></p>',
        '<p class="xyz" data-cke-filter="off" foo="1" style="color: red"><i bar="2">X</i></p>',
        "protect attributes and descendants"
      );

      filter(
        '<div><div data-cke-filter="off">Y</div></div>',
        '<div data-cke-filter="off">Y</div>',
        "strip wrapper"
      );

      filter(
        '<h6><i data-cke-filter="off">Y</i></h6>',
        '<p><i data-cke-filter="off">Y</i></p>',
        "strip wrapper 2"
      );
      ...
      t(
        '<p><span data-cke-filter="off"><i foo="1">x</i></span></p>',
        '<p><span data-cke-filter="off"><i foo="1">x</i></span></p>',
        "protect span with data-cke-* and its contents"
      );
    },
    ...
    "test forcing enter mode": function () {
      ...
      filter(
        "<div>A</div><div>B</div>",
        "A<br />B",
        "br was inserted between blocks"
      );
    },
    ...
    "test enter mode defaults to editor.enterMode": function () {
      ...
      filter(
        "<div>A</div><div>B</div>",
        "<p>A</p><p>B</p>",
        "divs were replaced with p when active mode equals defailt"
      );
      ...
      try {
        filter(
          "<div>A</div><div>B</div>",
          "<p>A</p><p>B</p>",
          "divs were replaced with p when active mode is br"
        );
      } catch (e) {
        throw e;
      } finally {
    ...
    "test filter styles validation with none or empty styles": function () {
      ...
      assert.isTrue(
        filter.check(new CKEDITOR.style({ element: "a", styles: {} }))
      );
      assert.isTrue(
        filter.check(
          new CKEDITOR.style({ element: "a", styles: { color: "red" } })
        )
      );
    },
