  ...
  bender.test({
    "test editor.setActiveFilter": function () {
      ...
      assert.areSame(
        1,
        activeFilterChanged,
        "activeFilterChange was fired once"
      );
      ...
      assert.areSame(
        1,
        activeFilterChanged,
        "activeFilterChange was not fired"
      );
      ...
      assert.areSame(
        editor.filter,
        editor.activeFilter,
        "default filter is active again"
      );
      assert.areSame(
        2,
        activeFilterChanged,
        "activeFilterChange was fired once - 2"
      );
      ...
      assert.areSame(
        editor.filter,
        editor.activeFilter,
        "default filter is still active"
      );
      assert.areSame(
        2,
        activeFilterChanged,
        "activeFilterChange was not fired - 2"
      );
    },
    ...
    "test commands' states are updated on filter change": function () {
      ...
      assert.areSame(
        ...
        cBold.state,
        "default filter - bold is enabled"
      );
      assert.areSame(
        CKEDITOR.TRISTATE_OFF,
        cItalic.state,
        "default filter - italic is enabled"
      );
      assert.areSame(
        CKEDITOR.TRISTATE_DISABLED,
        cUnderline.state,
        "default filter - underline is disabled"
      );
      ...
      assert.areSame(
        CKEDITOR.TRISTATE_DISABLED,
        cBold.state,
        "custom filter - bold is disabled"
      );
      assert.areSame(
        CKEDITOR.TRISTATE_OFF,
        cItalic.state,
        "custom filter - italic is enabled"
      );
      assert.areSame(
        CKEDITOR.TRISTATE_OFF,
        cUnderline.state,
        "custom filter - underline is enabled"
      );
      ...
      assert.areSame(
        CKEDITOR.TRISTATE_DISABLED,
        cBold.state,
        "bold cannot be enabled by setState"
      );
      ...
      assert.areSame(
        CKEDITOR.TRISTATE_OFF,
        cBold.state,
        "back to default filter - bold is enabled"
      );
      assert.areSame(
        CKEDITOR.TRISTATE_OFF,
        cItalic.state,
        "back to default filter - italic is enabled"
      );
      assert.areSame(
        CKEDITOR.TRISTATE_DISABLED,
        cUnderline.state,
        "back to default filter - underline is disabled"
      );
    },
    ...
    "test active filter change when selection is empty": function () {
      ...
      editor
        .addCommand("testChangeWhenEmptySelection", {
      ...
      assert.areSame(
        0,
        refreshed,
        "command was not refreshed when selection was undefined"
      );
    },
  });
})();
