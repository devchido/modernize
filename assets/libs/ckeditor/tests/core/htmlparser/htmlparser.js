...
(function () {
  ...
  bender.test({
    ...
    test_parse_inline_3: function () {
      assert.areSame(
        '<span class="outer"><b>text</b></span>',
    ...
    test_parse_inline_4: function () {
      assert.areSame(
        '<span class="outer"><span><b>some</b></span>text</span>',
    ...
    test_survive_1: function () {
      assert.areSame(
        '<span class="outer"><span data-cke-survive="true"></span></span>',
        htmlParse(
          '<span class="outer"><span data-cke-survive="true"></span><span></span></span>'
        )
      );
    },
    ...
    test_survive_2: function () {
      assert.areSame(
        '<span class="outer"><span class="cls" data-cke-survive="true"></span>text</span>',
        htmlParse(
          '<span class="outer"><span class="cls" data-cke-survive="true"><span></span></span>text<span><span class="cls"></span></span></span>'
        )
      );
    },
    ...
    test_survive_3: function () {
      assert.areSame(
        '<span class="outer"><span data-cke-survive="true">text</span>text</span>',
        htmlParse(
          '<span class="outer"><span data-cke-survive="true">text</span>text</span>'
        )
      );
    ...
    test_fromHtml_attribute_name: function () {
      var html =
        '<p attr-name="value" attr_name="value" attr.name="value" attr:name="value">text</p>';
      assert.areSame(html, htmlParse(html), "Attributes doesn't match.");
    },
    ...
    test_trim_whitespaces: function () {
      assert.areSame(
        "<div>some <strong>bold</strong> text<p>paragraph</p></div>",
        htmlParse(
          "<div>some <strong>bold</strong> text <p>\nparagraph</p></div>"
        ),
    ...
    test_onTagOpen: function () {
      ...
      parser.onTagOpen = function (tagName, attributes, selfClosing) {
        ...
        assert.isTrue(
          selfClosing,
          "Should be recognized as a self closing tag"
        );
    ...
    test_onCDATA: function () {
      ...
      parser.onTagOpen = parser.onTagClose = function (tagName) {
        if (tagName !== "style") nodes_counter += 1;
      };
      ...
      parser.parse(
        style_html.replace("%s", "/*<![CDATA[<p></p><br /><!--abc<p>-->]]>*/")
      );
    ...
    test_6946_2: function () {
      assert.areSame("<ul><li><ol></ol></li></ul>", htmlParse("<ul><ol></ul>"));
    },
    ...
    test_6975: function () {
      assert.areSame(
        "<dl><dt>foo</dt><dd>bar</dd><dt>baz</dt><dd>quz</dd></dl>",
    ...
    test_7494: function () {
      assert.areSame(
        "<ol><li>1<ol><li>2</li></ol></li><li>3</li></ol>",
    ...
    test_7497: function () {
      assert.areSame(
        "<p>1</p><ul><li>2</li></ul><p>3</p>",
        htmlParse("<p>1</p><li>2</li><p>3</p>")
      );
    },

    "test attributes are decoded": function () {
      var elP = CKEDITOR.htmlParser.fragment.fromHtml(
        '<p foo="&lt;&quot;&gt;">bar</p>'
      ).children[0];
        ...
        parser.onTagOpen = function (tagName, attributes) {
          ...
          if (barValue)
            assert.areSame(
              barValue,
              attributes.bar,
              "attributes.bar's value is correct - " + msg
            );
          else
            assert.isFalse(
              "bar" in attributes,
              "attributes.bar should not exist - " + msg
            );
        };
    ...
    "test anchor with name and id": function () {
      assert.areSame(
        '<a id="foo" name="bom">bar</a>',
        htmlParse('<a id="foo" name="bom">bar</a>')
      );
    },
