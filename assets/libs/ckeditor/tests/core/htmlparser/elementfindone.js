...
(function () {
  ...
  bender.test({
    "test findOne by tag name": function () {
      assert.areSame(
        testElement.children[0],
        testElement.findOne("div"),
        "testElement.children[ 0 ]"
      );
      assert.areSame(
        testElement.children[0].children[1],
        testElement.findOne("p", true),
        "testElement.children[ 0 ].children[ 1 ]"
      );
    },
    ...
    "test findOne deep nested child": function () {
      assert.areSame(
        testElement.children[0].children[1].children[2].children[0],
        testElement.findOne("strong", true),
