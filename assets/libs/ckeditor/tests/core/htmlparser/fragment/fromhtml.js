...
bender.test({
  test_parser_1: function () {
    assert.areSame(
      ...
      parseHtml(
        "<table><tr><td>1</td><p><b>2</b> Test</p><td>3</td></tr></table>"
      )
    );
  },
  ...
  test_parser_3_1: function () {
    assert.areSame(
      ...
      parseHtml(
        "<b><i>Table:<table><tr><td>1</td><td>2</td></tr></table></i></b>"
      )
    );
  },
  ...
  test_parser_3_2: function () {
    assert.areSame(
      ...
      parseHtml(
        "<b><i><table><tr><td>1</td><td>2</td></tr></table>Table</i></b>"
      )
    );
  },

  test_parser_4: function () {
    assert.areSame("<p><b><i>Test</i></b></p>", parseHtml("<b><i>Test"));
  },
  ...
  test_parser_6: function () {
    assert.areSame("<p><b>A</b><i>B</i></p>", parseHtml("<b>A</b><i>B</i>"));
  },
  ...
  test_parser_8: function () {
    assert.areSame("<p>text</p>", parseHtml("<p><b></b>text</p>"));
  },
  ...
  test_parser_8_2: function () {
    assert.areSame("<p>text</p>", parseHtml("<p><b><i></b></i>text</p>"));
  },
  ...
  test_parser_8_4: function () {
    assert.areSame(
      '<p>test<a name="foo"></a><a name="bar"></a></p>',
  ...
  test_parser_12: function () {
    assert.areSame(
      "<p>p1</p><p>p2</p><table><tr><td>c1</td></tr></table>",
  ...
  test_parser_13: function () {
    ...
    assert.areSame(
      ...
      parseHtml(
        "<ul><li>level1</li><ul><li>level2</li><ul><li>level3</li></ul></ul></ul>"
      )
    );
  },
  ...
  test_parser_14b: function () {
    assert.areSame(
      "<dl><dt><p>foo</p></dt><dd><p>bar</p></dd></dl>",
      parseHtml("<dt><p>foo</p></dt><dd><p>bar</p></dd>")
    );
    assert.areSame(
      "<dl><dt>foo</dt></dl><td>bar</td>",
      parseHtml("<dt><td>bar</td>foo</dt>")
    );
  },
  ...
  "test auto paragraphing": function () {
    var editables = ["body", "div", "h1", "table"],
      ct,
      dtd,
      msg;
    for (var i = 0; i < editables.length; i++) {
      ...
      if (dtd.p) assert.areSame("<p>foo</p>", parseHtml("foo", ct), msg);
      else if (ct == "table")
        assert.areSame(
      ...
      else assert.areSame("foo", parseHtml("foo", ct), msg);
    }
  },
  ...
  "test whitespaces handling": function () {
    ...
    assert.areSame(
      output,
      parseHtml(source, "body"),
      "body context - block edges"
    );
    assert.areSame(
      output,
      parseHtml(source, "div"),
      "div context - block edges"
    );
    assert.areSame(
      output,
      parseHtml(source, "figcaption"),
      "figcaption context - block edges"
    );
    ...
    assert.areSame(
      output,
      parseHtml(source),
      "default context - between blocks"
    );
    assert.areSame(
      output,
      parseHtml(source, "body"),
      "body context - between blocks"
    );
    assert.areSame(
      output,
      parseHtml(source, "div"),
      "div context - between blocks"
    );
    assert.areSame(
      output,
      parseHtml(source, "figcaption"),
      "figcaption context - between blocks"
    );
  },
  ...
  "parse list and table contents (with context)": function () {
    ...
    assert.areSame(
      source,
      parseHtml("<tr><td>foo</td><td>bar</td></tr>", "table")
    );

    source = "<tbody><tr><td>foo</td><td>bar</td></tr></tbody>";
    assert.areSame(
      source,
      parseHtml("<tbody><tr><td>foo</td><td>bar</td></tr></tbody>", "table")
    );
  ...
  "parser orphan text in list/table.": function () {
    assert.areSame(
      "<ul><li><strong>foo</strong>bar</li></ul>",
    ...
    assert.areSame(
      "<table><tbody><tr><td><strong>foo</strong>bar</td></tr></tbody></table>",
      parseHtml("<table><strong>foo</strong>bar</table>")
    );
    assert.areSame(
      "<table><tbody><tr><td><strong>foo</strong></td><td>bar</td></tr></tbody></table>",
      parseHtml("<table><strong>foo</strong><td>bar</td></table>")
    );
    assert.areSame(
      "<table><tbody><tr><td><strong>foo</strong></td></tr><tr><td>bar</td></tr></tbody></table>",
    ...
    assert.areSame(
      "<table><tbody><tr><td>1</td></tr><tr><td>Issue2</td></tr><tr><td>3</td></tr></tbody></table>",
      parseHtml(
        "<table><tbody><tr><td>1</td></tr>Issue2<tr><td>3</td></tr></tbody></table>"
      )
    );
  },
  ...
  "test parser fix inline outside of block element": function () {
    assert.areSame(
      "<p>Line 1</p><p><b>Line 2</b></p><p><b>Line 3</b></p><p><b>Line 4</b></p><p>Line 5</p>",
      parseHtml(
        "<p>Line 1</p><b><p>Line 2</p><p>Line 3</p><p>Line 4</p></b><p>Line 5</p>"
      )
    );
  },
  ...
  test_ticket_5788: function () {
    assert.areSame(
      ...
      parseHtml("<p>test<br /> whitespace</p>")
    );
    assert.areSame(
      "<div><p>paragraph</p>pseudo</div>",
      parseHtml("<div><p>paragraph</p> pseudo</div>")
    );
    assert.areSame(
      "<div>pseudo<p>paragraph</p></div>",
      parseHtml("<div>pseudo <p>paragraph</p></div>")
    );
  },
  ...
  "test parser *NOT* fixing orphan table cells": function () {
    assert.areSame("<td>td1</td><p>text</p>", parseHtml("<td>td1</td>text"));
    assert.areSame(
      "<tr><td>td1</td></tr><ul><li>li1</li></ul>",
  ...
  "test parser fix malformed link": function () {
    assert.areSame(
      '<p>foo<a href="#2">bar</a></p><p>foo bar</p>',
      parseHtml(
        '<p>foo<a href="#1"><a href="#2">bar</a></p> <p>foo</a> bar</p>'
      )
    );
  },
  ...
  "test *NOT* removing empty inline when comment enclosed": function () {
    assert.areSame(
      ...
      parseHtml("<p><span><!--comment--></span></p>")
    );
  },
  ...
  "test fragment#writeChildrenHtml": function () {
    ...
    assert.areSame(
      '<p x="1">A<b x="1">B<i x="1">C</i></b></p><div x="1">X</div>',
      writer.getHtml(true)
    );
  },
});
