...
function assertFilter(expectedOutput, input, filter, msg, method) {
  ...
  if (method == "write") fragment.writeHtml(writer, filter);
  else {
...
function addNormalAndNonEditableRules(filter) {
  filter.addRules({
    root: function (el) {
      if (el.type == CKEDITOR.NODE_ELEMENT) el.attributes.roote = "1";
    },
    elements: {
      $: function (el) {
        el.attributes.ax = "1";
  ...
  filter.addRules(
    {
      root: function (el) {
        if (el.type == CKEDITOR.NODE_ELEMENT) el.attributes.rootn = "1";
      },
      elements: {
        $: function (el) {
          el.attributes.bx = "1";
...
bender.test({
  "test addRules with priorieties": function () {
    ...
    assertFilter(
      "<p>foo-1-default1-default2-100</p>",
      "<p>foo</p>",
      filter,
      "Rules were applied in correct order"
    );
    assertFilter(
      "<p>foo-1-default1-default2-100</p>",
      "<p>foo</p>",
  ...
  "test attributeNames rules": function () {
    ...
    assertFilter(
      '<p bar="1">A</p><p><b barbar="foo">B</b></p>',
      '<p foo="1">A</p><p><b foofoo="foo">B</b></p>',
      filter
    );

    assertFilter(
      '<p data-onmouse="foo" data-onkey="bar">A</p>',
      '<p onmouse="foo" onkey="bar">A</p>',
      filter
    );
  ...
  "test elementNames rules": function () {
    ...
    assertFilter(
      "<bar>A</bar><barbar>B</barbar>",
      "<foo>A</foo><foofoo>B</foofoo>",
      filter
    );
    assertFilter(
      "<bar>A</bar><barbar>B</barbar>",
    ...
    assertFilter(
      "<bar>A</bar><bar>C</bar>",
      "<cke:bar>A</cke:bar><cke>B</cke><cke:foo>C</cke:foo>",
      filter
    );
    ...
    assertFilter(
      ...
      "<a>A</a><b>B</b>",
      filter,
      "All modifiers creating chain are applied."
    );
  },
      ...
      attributes: {
        foo: function (value) {
          assert.areSame(
            "bum",
            value,
            "Updated value was passed to the next filter"
          );
  ...
  "test attributes - return false or undefined": function () {
      ...
      attributes: {
        foo: function (value) {
          assert.areSame(
            "bum",
            value,
            'Attribute "bom" was removed, so don\'t pass it to next filters'
          );
          return value;
        },
      },
    ...
    assertFilter(
      ...
      '<p foo="bum">A</p>',
      filter,
      "Returning undefined should not change the attribute"
    );
    assertFilter(
      "<p>A</p>",
      '<p foo="bom">A</p>',
      filter,
      "Returning false should remove attribute completely"
    );
  },
  ...
  "test elements": function () {
    ...
    assertFilter(
      '<div foo="bum" class="red">A</div>',
      '<p foo="bar" id="true">A</p>',
      filter
    );
    assertFilter(
      '<div foo="bum" class="red">A</div>',
  ...
  "test comments 2": function () {
    ...
    assertFilter(
      '<p x="1">A</p><div x="1">foo</div><p x="1">B</p>',
      "<p>A</p><!--foo--><p>B</p>",
      filter
    );
  },
  ...
  "test filter rules same name": function () {
    ...
    assertFilter(
      '<span class="class2">some other text</span>',
  ...
  "test element filters - wildcard": function () {
    ...
    assertFilter(
      '<p data-^="1" data-p="2" data-$="3"><span data-^="4" data-$="5">foo</span></p>',
      "<p><span>foo</span></p>",
      filter,
  ...
  "test root filter": function () {
    ...
    filter.addRules({
      root: function (el) {
        els.push(
          el.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT ? "#frag" : el.name
        );
    ...
    assert.areEqual(1, els.length);
    assert.areEqual(
      '<div data-filtered="1"><p><span>foo</span></p></div>',
      writer.getHtml(true)
    );
  ...
  "test bottom-up filtering": function () {
    ...
    assertFilter(
      '<div o="1"><p o="5"><b o="2">A</b><i o="3">B<u o="4">C</u></i></p></div>',
      "<div><p><b>A</b><i>B<u>C</u></i></p></div>",
      filter
    );
  ...
  "test multiple filters": function () {
    ...
    filter2.addRules({
      ...
      elements: {
        b: function () {
          assert.fail(
            "Element <b> should have been removed by previous filter."
          );
        },
        i: function () {
          assert.fail(
            "Element <i> should have been removed by previous filter."
          );
        },
        u: function () {
          // Returns <s> element.
          return new CKEDITOR.htmlParser.fragment.fromHtml('<s f2="1">X</s>')
            .children[0];
        },
      },
    });
    ...
    filter3.addRules({
      ...
      elements: {
        u: function () {
          assert.fail(
            "Element <u> should have been removed by previous filter."
          );
        },
        s: function (element) {
    ...
    fragment.writeHtml(writer);
    assert.areSame(
      '<p a1="1">Af1f2Bf1f2<s a2="1">Xf2</s>Ef1f2</p>',
      writer.getHtml(true)
    );
    ...
    fragment.writeHtml(writer);
    assert.areSame(
      '<p a1="1">Af1f2f3Bf1f2f3<s a2="1" a3="1">Xf2f3</s>Ef1f2f3</p>',
      writer.getHtml(true)
    );
  },
  ...
  "test applyToAll option - root filtering": function () {
    ...
    var el = CKEDITOR.htmlParser.fragment.fromHtml(
      '<p a="1" b="1" contenteditable="false">foo</p>'
    ).children[0];
  ...
  "test applyToAll with excludeNestedEditable option": function () {
    ...
    filter.addRules(
      {
        root: function (el) {
          if (el.type == CKEDITOR.NODE_ELEMENT) el.attributes.roota = "1";
        },
        elements: {
          $: function (el) {
            el.attributes.ax = "1";
