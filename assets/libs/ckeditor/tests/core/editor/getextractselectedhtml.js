...
bender.test({
  ...
  "test getSelectedHtml in source mode (https://dev.ckeditor.com/ticket/13118)":
    function () {
  ...
  "test getSelectedHtml with no ranges": function () {
    ...
    assert.isNull(
      selectedHtml,
      "There should be no error but null should be returns if selection contains no ranges"
    );
  },
  ...
  "test extractSelectedHtml": function () {
    ...
    var frag = editor.extractSelectedHtml(),
      selectionWasSetOnce =
        CKEDITOR.dom.selection.prototype.selectRanges.calledOnce;
  ...
  "test getSelectedHtml with multiple ranges": function () {
    ...
    assert.isInnerHtmlMatching(
      "<table><tbody><tr><td>11@</td><td>22</td></tr></tbody></table>",
      editor.getSelectedHtml(true)
    );
  },
  ...
  "test getSelectedHtml with partial table selection": function () {
    ...
    assert.isInnerHtmlMatching(
      "<table><tbody><tr><td>11@</td></tr><tr><td>44</td></tr></tbody></table>",
      editor.getSelectedHtml(true)
    );
  },
  ...
  "test getSelectedHtml with [colspan] and [rowspan]": function () {
    ...
    assert.isInnerHtmlMatching(
      '<table><tbody><tr><td colspan="2">11@</td><td rowspan="2">22</td><td>33</td></tr><tr><td>44</td><td>55</td><td>66</td></tr></tbody></table>',
      editor.getSelectedHtml(true)
    );
  },
  ...
  "test extractSelectedHtml should not fail when editor is blurred":
    function () {
      bender.editorBot.create({ name: "nofocus" }, function (bot) {
        ...
        assert.isTrue(
          html == null || html === "",
          "returned value should be null if selection does not exist or should be an empty string"
        );
      });
    },
});
