...
bender.test({
  ...
  test_dataManipulation: function () {
    ...
    assert.areSame(
      "Test4",
      testObject.fire("someEvent", "Test1"),
      'fire must return "Test4"'
    );
  ...
  test_fireOnce: function () {
    ...
    assert.areSame(
      true,
      testObject.fireOnce("someEvent"),
      'fireOnce must return "false"'
    );
  ...
  test_nestedCancel: function () {
    ...
    var isCanceledA, isCanceledB, isCanceledC;
