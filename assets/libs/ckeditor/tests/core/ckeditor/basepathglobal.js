  ...
  bender.test({
    "test default BASEPATH": function () {
      ...
      iframe.on("load", function () {
        resume(function () {
          ...
          assert.areSame(
            defaultPath + "ckeditor.js" + query,
            iCKEDITOR.getUrl("ckeditor.js")
          );
          assert.areSame(
            defaultPath + "skins/default/editor.css" + query,
            iCKEDITOR.getUrl("skins/default/editor.css")
          );
          assert.areSame(
            "/skins/default/editor.css" + query,
            iCKEDITOR.getUrl("/skins/default/editor.css")
          );
          assert.areSame(
            "http://www.otherdomain.com/skins/default/editor.css" + query,
            iCKEDITOR.getUrl(
              "http://www.otherdomain.com/skins/default/editor.css"
            )
          );
        });
      });
    ...
    "test full BASEPATH": function () {
      ...
      iframe.on("load", function () {
        resume(function () {
          ...
          assert.areSame(
            "http://" + secondDomainName + expectedEditorPath,
            iCKEDITOR.basePath
          );
          assert.areSame(
            "http://" +
      ...
      doc.$.open();
      doc.$.write(
        '<script>CKEDITOR_BASEPATH = "http://' +
          secondDomainName +
          expectedEditorPath +
          '";</scr' +
          "ipt>" +
          '<script src="' +
          CKEDITOR.getUrl("ckeditor.js") +
          '"></scr' +
          "ipt>"
      );
      doc.$.close();
    ...
    "test absolute BASEPATH": function () {
      ...
      iframe.on("load", function () {
        resume(function () {
          ...
          assert.areSame(
            path + expectedEditorPath + "ckeditor.js" + query,
            iCKEDITOR.getUrl("ckeditor.js")
          );
          assert.areSame(
            path + expectedEditorPath + "skins/default/editor.css" + query,
            iCKEDITOR.getUrl("skins/default/editor.css")
          );
          assert.areSame(
            "/skins/default/editor.css" + query,
    ...
    "test relative BASEPATH": function () {
      var iframe = CKEDITOR.document.getById("iframe-relative"),
        ...
        relativeEditorPath =
          testDir.replace(/[^\/]+/g, "..").slice(1, -1) + expectedEditorPath;
      ...
      iframe.on("load", function () {
        resume(function () {
          ...
          assert.areSame(
            path + testDir + relativeEditorPath,
            iCKEDITOR.basePath
          );
          assert.areSame(
            folderPath + "/" + relativeEditorPath + "ckeditor.js" + query,
            iCKEDITOR.getUrl("ckeditor.js")
          );
          assert.areSame(
            folderPath +
    ...
    "test protocol relative BASEPATH": function () {
      ...
      iframe.on("load", function () {
        resume(function () {
          ...
          assert.areSame(
            "//" + secondDomainName + expectedEditorPath,
            iCKEDITOR.basePath
          );
          assert.areSame(
            "//" +
