...
bender.test({
  ...
  "test constructor - div[editable]>div[noneditable]>figure>figcaption[editable]>p":
    function () {
      ...
      assert.areSame(
        this.$("e5_2"),
        path.blockLimit,
        "figcaption is a block limit"
      );
      assert.areSame(5, path.elements.length);
      assert.areSame(this.$("e5_2_1"), path.lastElement);
    },

  "test constructor - div[editable]>div[noneditable]>blockquote[editable]>p":
    function () {
      // Nested editable case.
  ...
  "test isContextFor - div[editable]>div[noneditable]>p[editable]":
    function () {
      // Blockless nested editable case.
      var path = this.elPath("e5_1", "e5");
