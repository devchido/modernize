    ...
    },
    {
      ...
      test_createFromHtml: function () {
        ...
        assert.areEqual(
          "My test",
          element.$.innerHTML,
          "the innerHTML doesn't match"
        );
      },

      test_createFromHtml2: function () {
        var element = CKEDITOR.dom.element.createFromHtml(
          "<div><x:x><p>Test</p></div>"
        );
      ...
      "test getChild - array selector": function () {
        var element = CKEDITOR.dom.element.createFromHtml(
          "<div><ul><li>zero</li><li>one</li></ul></div>"
        );
      ...
      test_append1: function () {
        ...
        assert.areEqual(
          "b",
          document.getElementById("append").firstChild.nodeName.toLowerCase()
        );
      },
      ...
      test_append2: function () {
        ...
        assert.areEqual(
          "i",
          document.getElementById("append").lastChild.nodeName.toLowerCase()
        );
      },
      ...
      test_setHtml: function () {
        ...
        assert.areEqual(
          "<b>test</b>",
          document.getElementById("append").innerHTML.toLowerCase(),
          "First call doesn't match"
        );
        element.setHtml("Another test");
        assert.areEqual(
          "Another test",
          document.getElementById("append").innerHTML,
          "Second call doesn't match"
        );
      },
      ...
      test_setAttribute2: function () {
        ...
        assert.areEqual(
          "position: absolute;",
          bender.tools.getAttribute(element, "style")
        );
      },
      ...
      test_setAttributes: function () {
        ...
        assert.areSame(
          "Test",
          document.getElementById("test1").className,
          "class is wrong"
        );
        assert.areEqual(
          "position: absolute;",
        ...
        assert.areEqual(
          "TestName",
          document.getElementById("test1").name,
          "name is wrong"
        );
        assert.areEqual(
          5,
          document.getElementById("test1").rows,
          "rows is wrong"
        );
      },
      ...
      test_setStyle1: function () {
        ...
        assert.areEqual(
          "absolute",
          document.getElementById("setStyle").style.position
        );
      },
      ...
      test_setStyle2: function () {
        ...
        assert.areSame(
          "float",
          div.getAttribute("style").split(":")[0].toLowerCase()
        );
      },
      ...
      "test removeClass - multiple classes": function () {
        ...
        element.removeClass("classA");
        assert.areSame(
          '<div class="classb classc classd"></div>',
          getInnerHtml("removeClass")
        );
        element.removeClass("classC");
        assert.areSame(
          '<div class="classb classd"></div>',
          getInnerHtml("removeClass")
        );
      ...
      test_getAttribute_checked: function () {
        var unchecked1 = new CKEDITOR.dom.element.createFromHtml(
            '<input type="checkbox" />'
          ),
          checked1 = new CKEDITOR.dom.element.createFromHtml(
      ...
      test_getAttribute_contenteditable: function () {
        ...
        element = body.append(
          CKEDITOR.dom.element.createFromHtml("<div></div>")
        );
      ...
      test_getText2: function () {
        var element = newElement(
          document.getElementById("getText2").getElementsByTagName("b")[0]
        );
      ...
      test_hasAttribute_input: function () {
        var inputWithAttrs = newElement(
            document.getElementById("inputWithAttrs")
          ),
          inputWithoutAttrs = newElement(
            document.getElementById("inputWithoutAttrs")
          ),
          checkboxWithAttrs = newElement(
            document.getElementById("checkboxWithAttrs")
          ),
          checkboxWithoutAttrs = newElement(
            document.getElementById("checkboxWithoutAttrs")
          );

        assert.isTrue(
          inputWithAttrs.hasAttribute("value"),
          "inputWithValue value"
        );
        assert.isTrue(
          inputWithAttrs.hasAttribute("class"),
          "inputWithValue class"
        );

        assert.isFalse(
          inputWithoutAttrs.hasAttribute("value"),
          "inputWithNoValue value"
        );
        assert.isFalse(
          inputWithoutAttrs.hasAttribute("class"),
          "inputWithNoValue class"
        );

        assert.isTrue(
          checkboxWithAttrs.hasAttribute("value"),
          "checkboxWithAttrs value"
        );
        assert.isTrue(
          checkboxWithAttrs.hasAttribute("class"),
          "checkboxWithAttrs class"
        );
        assert.isTrue(
          checkboxWithAttrs.hasAttribute("checked"),
          "checkboxWithAttrs checked"
        );

        assert.isFalse(
          checkboxWithoutAttrs.hasAttribute("value"),
          "checkboxWithoutAttrs value"
        );
        assert.isFalse(
          checkboxWithoutAttrs.hasAttribute("class"),
          "checkboxWithoutAttrs class"
        );
        assert.isFalse(
          checkboxWithoutAttrs.hasAttribute("checked"),
          "checkboxWithoutAttrs checked"
        );
      },

      test_getDocumentPosition: function () {
        var pos = CKEDITOR.document
            .getById("DocPositionTarget")
            .getDocumentPosition(),
          x = Math.round(pos.x),
          y = Math.round(pos.y),
          delta = 1,
        ...
        assert.isNumberInRange(
          ...
          expectedX - delta,
          expectedX + delta,
          "Position relative to document doesn't match " +
            x +
            " with offset " +
            delta +
            "."
      ...
      "test getDocumentPosition with document scrolled": function () {
        ...
        assert.isNumberInRange(
          scrolledElementPosition.x,
          3498,
          3502,
          "Horizontal position read correctly."
        );
        assert.isNumberInRange(
          scrolledElementPosition.y,
          2998,
          3002,
      ...
      test_appendHtml: function () {
        ...
        assert.areEqual(
          '<div id="appendhtml"><i>text</i>test</div>',
      ...
      test_breakParent: function () {
        ...
        assert.areEqual(
          '<i id="a">text1</i><b id="b">text2</b><i>text3</i>',
          getInnerHtml("breakParent")
        );
      },
      ...
      test_getComputedStyle: function () {
        ...
        assert.areEqual(
          "inline",
          element.getFirst().getComputedStyle("display")
        );
      },
      ...
      test_isIdentical: function () {
        ...
        assert.isTrue(
          element2.isIdentical(element1),
          "different attrs order 2"
        );
        assert.isFalse(element1.isIdentical(element3), 'more attrs in "this"');
        assert.isFalse(
          element3.isIdentical(element1),
          "more attrs in passed element"
        );
        assert.isFalse(element4.isIdentical(element1), 'no attrs in "this"');
        assert.isFalse(
          element1.isIdentical(element4),
          "no attrs in passed element"
        );
      ...
      "test isIdentical ignore child nodes": function () {
        var el1 = CKEDITOR.dom.element.createFromHtml(
            '<b class="foo" style="color: red; width: 10px">foo</b>'
          ),
          el2 = el1.clone();
      ...
      test_mergeSiblings: function () {
        ...
        assert.areEqual(
          "<b>text1text2</b>",
          bender.tools.fixHtml(doc.getById("mergeSiblings").getHtml())
        );
      },
      ...
      test_getFrameDocument: function () {
        ...
        assert.isTrue(
          frame.getFrameDocument() instanceof CKEDITOR.dom.document
        );
      },
      ...
      test_copyAttributes_checked: function () {
        var original1 = new CKEDITOR.dom.element.createFromHtml(
            '<input type="checkbox" checked="checked" />'
          ),
      ...
      test_element_identical: function () {
        var element1 = CKEDITOR.dom.element.createFromHtml(
            '<span class="foo"></span>'
          ),
          element2 = CKEDITOR.dom.element.createFromHtml(
            '<span class="foo"></span>'
          );
      ...
      "test find": function () {
        ...
        assert.areSame(
          3,
          els.count(),
          "Element <i>Y</i> should not be returned"
        );
        for (var i = 0; i < els.count(); ++i)
          assert.areSame(
            "X",
            els.getItem(i).getHtml(),
            "Element <i>Y</i> should not be returned"
          );
        ...
        assert.isFalse(
          el.hasAttribute("id"),
          "Element#find cleans after itself"
        );
      ...
      recordNodes: function (callback) {
        ...
        return {
          tokens: tokens,
          fn: function (node) {
            if (node.type == CKEDITOR.NODE_ELEMENT) tokens.push(node.getName());
      ...
      "test forEach": function () {
        ...
        assert.areSame(
          "div,p,#a,i,#b,#c,div,h1,#d,h2,#e,b,#f",
      ...
      "test forEach - stop condition": function () {
        var el = doc.getById("forEach_1"),
          recorder = this.recordNodes(function (node) {
            ...
            return !(
              node.type == CKEDITOR.NODE_ELEMENT && node.is({ i: 1, h2: 1 })
            );
          });
      ...
      "test disableContextMenu - element with cke_enable_context_menu class":
        function () {
      ...
      "test disableContextMenu - ancestor with cke_enable_context_menu class":
        function () {
      ...
      "test setSize": function () {
        ...
        var elem = CKEDITOR.dom.element.createFromHtml(
            '<div style="height: 50px; border: 0.9px solid black"></div>'
          ),
          realBorderWidth,
          expectedWidth;
        ...
        realBorderWidth = parseFloat(
          elem.getComputedStyle("border-left-width")
        );
        ...
        assert.areSame(
          expectedWidth,
          round(parseFloat(elem.$.style.width)),
          "Computed width"
        );
      },
    }
