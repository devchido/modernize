  ...
  var tests = {
    ...
    test__constructor: function () {
      ...
      assert.areSame(
        container.$,
        range.root.$,
        "range boundary element must match."
      );
    },
    ...
    test_enclosed_node4: function () {
      ...
      assert.areSame(
        doc.getById("_enclosed_i").getFirst(),
    ...
    "test checkReadOnly when both range boundaries are inside of read-only element":
      function () {
        var source =
            'some <strong contenteditable="false"> sample [text</strong> and a <a href="javascript:void(0)" contenteditable="false">link]</a>',
          range = bender.tools.setHtmlWithRange(
            doc.getById("editable_playground"),
            source
          )[0];
        assert.isTrue(range.checkReadOnly());
      },

    "test checkReadOnly when only one range boundary is inside of read-only element":
      function () {
        var source =
            '<strong contenteditable="false"> some [sample</strong> text]',
          range = bender.tools.setHtmlWithRange(
            doc.getById("editable_playground"),
            source
          )[0];
    ...
    "test checkReadOnly when entire range is inside of read-only element":
      function () {
        var source =
            'some <strong contenteditable="false"> [sample text ]</strong>',
          range = bender.tools.setHtmlWithRange(
            doc.getById("editable_playground"),
            source
          )[0];
    ...
    "test checkReadOnly when read-only element is enclosed within the range":
      function () {
        var source =
            '[some <strong contenteditable="false"> sample text </strong> and ]',
          range = bender.tools.setHtmlWithRange(
            doc.getById("editable_playground"),
            source
          )[0];
    ...
    "test checkReadOnly when entire range is enclosed in an editable element which is contained by another read-only element":
      function () {
        var source =
            'some <strong contenteditable="false"> sample text and <a href="javascript:void(0)" contenteditable="true">a [link].</a></strong>',
          range = bender.tools.setHtmlWithRange(
            doc.getById("editable_playground"),
            source
          )[0];
    ...
    "test _getTableElement": function () {
      ...
      assert.isTrue(
        range._getTableElement().equals(doc.getById("_td1")),
        "collapsed td"
      );
      ...
      assert.isTrue(
        range._getTableElement().equals(doc.getById("_th1")),
        "collapsed th"
      );
      ...
      assert.isTrue(
        range._getTableElement().equals(doc.getById("_thead")),
        "selected thead"
      );
      ...
      assert.isTrue(
        range._getTableElement().equals(doc.getById("_tbody")),
        "selected tbody"
      );
      ...
      assert.isTrue(
        range._getTableElement().equals(doc.getById("_tfoot")),
        "selected tfoot"
      );
      ...
      assert.isTrue(
        range._getTableElement().equals(doc.getById("_table1")),
        "selected table1"
      );
      ...
      assert.isTrue(
        range._getTableElement().equals(doc.getById("_tr2")),
        "selected 2 tds"
      );
      ...
      assert.isNull(
        ...
        "selected 2 tds from different tables"
      );
      ...
      assert.isTrue(
        range._getTableElement().equals(doc.getById("_td3")),
        "selected td in one-cell table"
      );
      ...
      assert.isTrue(
        range._getTableElement("tbody").equals(doc.getById("_tbody")),
        "filtering elements"
      );
    },
  };
