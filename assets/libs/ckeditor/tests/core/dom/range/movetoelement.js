...
(function () {
  ...
  var tests = {
    rangeMoveToElementEditablePosition: function (html, isMoveToEnd, retValue) {
      ...
      assert.areSame(
        retValue,
        !!range.moveToElementEditablePosition(ct, isMoveToEnd),
    ...
    test_moveToElementEditStart: function () {
      assert.areSame(
        "<table><thead><tr><th>^editable</th></tr></thead><tbody></tbody></table>",
        this.rangeMoveToElementEditablePosition(
          "<table><thead><tr><th>editable</th></tr></thead><tbody></tbody></table>"
        )
      );
    },
    ...
    test_moveToElementEditStart3: function () {
      assert.areSame(
        '<table><tbody><tr><td><ul><li><a href="javascript:void(0)"><strong>^editable</strong></a></li></ul></td></tr></tbody></table>',
        this.rangeMoveToElementEditablePosition(
          '<table><tbody><tr><td><ul><li><a href="javascript:void(0)"><strong>editable</strong></a></li></ul></td></tr></tbody></table>'
        )
      );
    ...
    test_moveToElementEditStart5: function () {
      assert.areSame(
        "^<textarea>non editable</textarea>editable",
        this.rangeMoveToElementEditablePosition(
          "<textarea>non editable</textarea>editable"
        )
      );
    ...
    test_moveToElementEditStart6: function () {
      assert.areSame(
        '<span data-cke-bookmark="1" style="display:none;">&nbsp;</span>^foo',
        this.rangeMoveToElementEditablePosition(
          '<span data-cke-bookmark="1" style="display:none;">&nbsp;</span>foo'
        )
      );
    ...
    test_moveToElementEditStart8a: function () {
      assert.areSame(
        '<span data-cke-temp="1">bar</span><span data-cke-temp="1">bar</span>^foo',
        this.rangeMoveToElementEditablePosition(
          '<span data-cke-temp="1">bar</span><span data-cke-temp="1">bar</span>foo'
        )
      );
    ...
    test_moveToElementEditStart8: function () {
      assert.areSame(
        '<span data-cke-temp="1">bar</span>^foo<span data-cke-temp="1">bar</span>',
        this.rangeMoveToElementEditablePosition(
          '<span data-cke-temp="1">bar</span>foo<span data-cke-temp="1">bar</span>'
        )
      );
    ...
    test_moveToElementEditStart13a: function () {
      assert.areSame(
        '[<div contenteditable="false">x</div>]<div contenteditable="false">y</div><p>foo</p>',
        this.rangeMoveToElementEditablePosition(
          '<div contenteditable="false">x</div><div contenteditable="false">y</div><p>foo</p>'
        )
      );
    ...
    test_moveToElementEditStart13b: function () {
      assert.areSame(
        '<div contenteditable="false">x</div><p>foo</p>[<div contenteditable="false">y</div>]',
        this.rangeMoveToElementEditablePosition(
          '<div contenteditable="false">x</div><p>foo</p><div contenteditable="false">y</div>',
          true
        )
    ...
    test_moveToElementEditStart13c: function () {
      assert.areSame(
        '<div>[<div contenteditable="false">x</div>]<p>foo</p></div>',
        this.rangeMoveToElementEditablePosition(
          '<div><div contenteditable="false">x</div><p>foo</p></div>'
        )
      );
    ...
    test_moveToElementEditStart14d: function () {
      assert.areSame(
        '<div>bar<span contenteditable="false">foo</span>^</div>',
        this.rangeMoveToElementEditablePosition(
          '<div>bar<span contenteditable="false">foo</span></div>',
          true
        )
    ...
    test_moveToElementEditStart16c: function () {
      assert.areSame(
        '<div>[<div contenteditable="false">x</div>]</div>',
        this.rangeMoveToElementEditablePosition(
          '<div><div contenteditable="false">x</div></div>'
        )
      );
    ...
    test_moveToElementEditStart16e: function () {
      assert.areSame(
        '[<ul contenteditable="false"><li>x</li></ul>]',
        this.rangeMoveToElementEditablePosition(
          '<ul contenteditable="false"><li>x</li></ul>'
        )
      );
    ...
    test_moveToElementEditStart16f: function () {
      assert.areSame(
        '[<table contenteditable="false"><tbody><tr><td>x</td></tr></tbody></table>]',
        this.rangeMoveToElementEditablePosition(
          '<table contenteditable="false"><tbody><tr><td>x</td></tr></tbody></table>'
        )
      );
    ...
    test_moveToElementEditStart17b: function () {
      assert.areSame(
        '<div>[<div contenteditable="false">x</div>]</div>',
        this.rangeMoveToElementEditablePosition(
          '<div>  \t <div contenteditable="false">x</div>\n\n</div>'
        )
      );
    },
