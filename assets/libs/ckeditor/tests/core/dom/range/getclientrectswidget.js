...
(function () {
  ...
  function assertWidgetsRects(editor, bot, config) {
    ...
    if (!captioned && !inline) {
      ...
      widgetText =
        '<figure class="image"><img alt="x" id="x" src="../../../_assets/lena.jpg" /><figcaption>caption</figcaption></figure>';
    } else if (captioned && inline) {
      widgetText =
        '<figure class="image"><img alt="x" id="x" src="../../../_assets/lena.jpg" /><figcaption>caption[[inline]]</figcaption></figure>';
    } else {
      widgetText = "[[inline]]";
    }
            ...
            if (inline) {
              assert.isTrue(
                CKEDITOR.tools.objectCompare(
                  caption
                    .findOne(".cke_widget_element")
                    .getClientRect(absolute),
