...
(function () {
  ...
  var tests = {
    ...
    assertRangeContainers: function (
      range,
      startOffset,
      endOffset,
      startContainer,
      ...
      assert.isInstanceOf(
        CKEDITOR.dom.range,
        range,
        "assertRangeContainers: range parameter has invalid type, should be instance of CKEDITOR.dom.range"
      );

      if (typeof endContainer == "undefined") endContainer = startContainer;
    ...
    "test enlarge element (HTML comments)": function () {
      ...
      if (CKEDITOR.env.ie && CKEDITOR.env.version < 9) assert.ignore();

      var ct = CKEDITOR.document.getById("_EnlargeP19"),
        ranges = bender.tools.setHtmlWithRange(
          ct,
          "<!-- foo --><p><strong>foo</strong></p><p>[bar]</p><!--bar-->"
        );
    ...
    "test enlarge element 16": function () {
      ...
      assert.areSame(
        source,
        bender.tools.getHtmlWithRanges(ct, new CKEDITOR.dom.rangeList([range]))
      );
    },
    ...
    test_enlarge_block1: function () {
      ...
      assert.areSame(
        document.getElementById("_EnlargeP11"),
        range.startContainer.$,
        "range.startContainer"
      );
    ...
    test_enlarge_element9: function () {
      ...
      assert.areSame(
        document.getElementById("_EnlargeI3").firstChild,
        range.startContainer.$,
        "range.startContainer"
      );
      assert.areSame(1, range.startOffset, "range.startOffset");
      assert.areSame(
        document.getElementById("_EnlargeP3"),
        range.endContainer.$,
        "range.endContainer"
      );
    ...
    test_enlarge_element10: CKEDITOR.env.ie
      ? function () {
          ...
          assert.areSame(
            document.getElementById("_EnlargeP4"),
            range.startContainer.$,
            "range.startContainer"
          );
          assert.areSame(1, range.startOffset, "range.startOffset");
    ...
    test_enlarge_element11: function () {
      ...
      assert.areSame(
        document.getElementById("_EnlargeP5"),
        range.startContainer.$,
        "range.startContainer"
      );
      assert.areSame(1, range.startOffset, "range.startOffset");
    ...
    test_enlarge_element12: function () {
      ...
      assert.areSame(
        document.getElementById("_EnlargeP6"),
        range.startContainer.$,
        "range.startContainer"
      );
      assert.areSame(1, range.startOffset, "range.startOffset");
    ...
    test_enlarge_element13: function () {
      ...
      assert.areSame(
        document.getElementById("_EnlargeP"),
        range.startContainer.$,
        "range.startContainer"
      );
      assert.areSame(0, range.startOffset, "range.startOffset");
      assert.areSame(
        document.getElementById("_EnlargeP").childNodes[1],
        range.endContainer.$,
        "range.endContainer"
      );
    ...
    test_enlarge_element15: function () {
      ...
      assert.areSame(
        document.getElementById("_EnlargeP18"),
        range.startContainer.$
      );
      assert.areSame(0, range.startOffset, "range.startOffset");
      assert.areSame(
    ...
    "test enlarge with _empty_ contenteditable as preceding item": function () {
      ...
      if (CKEDITOR.env.ie && CKEDITOR.env.version == 8)
        this.assertRangeContainers(
          range,
          1,
          2,
          doc.getById("_EnlargeP22").$,
          expectedSelectContainer
        );
      else
        this.assertRangeContainers(
          range,
    ...
    "test enlarge with whitespaced contenteditable as preceding item":
      function () {
        // <p><span contenteditable="false">  </span><i>[foobar]</i></p>
        // [<p><span contenteditable="false">  </span><i>foobar</i></p>]
    ...
    test_enlarge_list1: function () {
      ...
      assert.areSame(
        document.getElementById("_EnlargeP7"),
        range.startContainer.$,
        "range.startContainer"
      );
      assert.areSame(0, range.startOffset, "range.startOffset");
    ...
    test_enlarge_list2: function () {
      ...
      assert.areSame(
        document.getElementById("_EnlargeP8"),
        range.startContainer.$,
        "range.startContainer"
      );
      assert.areSame(0, range.startOffset, "range.startOffset");
    ...
    test_enlarge_list3: function () {
      ...
      assert.areSame(
        document.getElementById("_EnlargeP9"),
        range.startContainer.$,
        "range.startContainer"
      );
    ...
    test_enlarge_list4: function () {
      ...
      assert.areSame(
        document.getElementById("_EnlargeP10"),
        range.startContainer.$,
        "range.startContainer"
      );
    ...
    test_enlarge_list5: function () {
      ...
      assert.areSame(
        document.getElementById("_EnlargeP15"),
        range.startContainer.$,
        "range.startContainer"
      );
      assert.areSame(0, range.startOffset, "range.startOffset");
    ...
    test_enlarge_block2: function () {
      ...
      assert.areSame(
        document.getElementById("_EnlargeP16"),
        range.startContainer.$,
        "range.startContainer"
      );
      assert.areSame(0, range.startOffset, "range.startOffset");
    ...
    test_enlarge_block3: function () {
      ...
      assert.areSame(
        document.getElementById("_EnlargeP12"),
        range.startContainer.$,
        "range.startContainer"
      );
      assert.areSame(0, range.startOffset, "range.startOffset");
    ...
    test_enlarge_block4: function () {
      ...
      assert.areSame(
        document.getElementById("_EnlargeP13"),
        range.startContainer.$,
        "range.startContainer"
      );
      assert.areSame(0, range.startOffset, "range.startOffset");
    ...
    test_enlarge_block5: function () {
      ...
      assert.areSame(
        document.getElementById("_EnlargeP14"),
        range.startContainer.$,
        "range.startContainer"
      );
      assert.areSame(0, range.startOffset, "range.startOffset");
    ...
    test_enlarge_block6: function () {
      ...
      assert.areSame(
        document.getElementById("_EnlargeP17"),
        range.startContainer.$,
        "range.startContainer"
      );
      assert.areSame(0, range.startOffset, "range.startOffset");
    ...
    "test enlarge does not stop on positioned or floated inline elements":
      function () {
    ...
    "test enlarge stops on block boundaries": function () {
      ...
      assert.isTrue(
        range.startOffset > 0,
        "range.startOffset - range has not been moved to the start"
      );
      assert.isTrue(
        range.endOffset < target.getChildCount(),
        "range.endOffset - range has not been moved to the end"
      );
    },

    "test enlarge does not check contents of non-editable elements - ENLARGE_BLOCK_CONTENTS":
      function () {
        ...
        assert.areSame(
          CKEDITOR.document.getById("P26S").getIndex() + 1,
          range.startOffset,
          "range.startOffset"
        );
        // Ends right before <p#P26E>.
        assert.areSame(
          CKEDITOR.document.getById("P26E").getIndex(),
          range.endOffset,
          "range.endOffset"
        );
      },

    "test enlarge does not check contents of non-editable elements - ENLARGE_LIST_ITEM_CONTENTS":
      function () {
        var target = CKEDITOR.document.getById("_EnlargeP26"),
          range = getRange("S26", null);
    ...
    "test enlarge stops on non-editable blocks": function () {
      ...
      assert.areSame(
        CKEDITOR.document.getById("P27S").getIndex() + 1,
        range.startOffset,
        "range.startOffset"
      );
      // Ends right before <p#P27E>.
      assert.areSame(
        CKEDITOR.document.getById("P27E").getIndex(),
        range.endOffset,
        "range.endOffset"
      );
    },
    ...
    "test enlarge between non-editable block and block limit boundary":
      function () {
  ...
  // IE only tests.
  CKEDITOR.env.ie &&
    YUITest.Util.mix(tests, {
      test_enlarge_element1:
        CKEDITOR.env.version > 8
          ? function () {
              ...
              assert.areSame(
                document.getElementById("_EnlargeB"),
                range.startContainer.$,
                "range.startContainer"
              );
              assert.areSame(1, range.startOffset, "range.startOffset");
      ...
      test_enlarge_element3:
        CKEDITOR.env.version > 8
          ? function () {
              ...
              assert.areSame(
                document.getElementById("_EnlargeP").firstChild,
                range.startContainer.$,
                "range.startContainer"
              );
              assert.areSame(1, range.startOffset, "range.startOffset");
      ...
      test_enlarge_element4:
        CKEDITOR.env.version > 8
          ? function () {
              ...
              assert.areSame(
                document.getElementById("_EnlargeP").parentNode,
                range.startContainer.$,
                "range.startContainer"
              );
              assert.areSame(
                doc.getById("_EnlargeP").getIndex(),
                range.startOffset,
                "range.startOffset"
              );
              assert.areSame(
              ...
              assert.areSame(
                doc.getById("_EnlargeP").getIndex() + 1,
                range.endOffset,
                "range.endOffset"
              );
              assert.isFalse(range.collapsed, "range.collapsed");
      ...
      test_enlarge_element5: function () {
        ...
        assert.areSame(
          document.getElementById("_EnlargeB1"),
          range.startContainer.$,
          "range.startContainer"
        );
        assert.areSame(1, range.startOffset, "range.startOffset");
        assert.areSame(
          document.getElementById("_EnlargeB1").childNodes[2],
          range.endContainer.$,
          "range.endContainer"
        );
        assert.areSame(5, range.endOffset, "range.endOffset");
      ...
      test_enlarge_element6:
        CKEDITOR.env.version > 8
          ? function () {
              ...
              assert.areSame(
                document.getElementById("_EnlargeB2"),
                range.startContainer.$,
                "range.startContainer"
              );
              assert.areSame(1, range.startOffset, "range.startOffset");
      ...
      test_enlarge_element7:
        CKEDITOR.env.version > 8
          ? function () {
              ...
              assert.areSame(
                document.getElementById("_EnlargeP2").parentNode,
                range.startContainer.$,
                "range.startContainer"
              );
              assert.areSame(
                doc.getById("_EnlargeP2").getIndex(),
                range.startOffset,
                "range.startOffset"
              );
              assert.areSame(
              ...
              assert.areSame(
                doc.getById("_EnlargeP2").getIndex() + 1,
                range.endOffset,
                "range.endOffset"
              );
              assert.isFalse(range.collapsed, "range.collapsed");
