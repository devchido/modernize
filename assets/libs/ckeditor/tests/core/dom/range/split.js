  ...
  var tests = {
    ...
    "test range#splitElement (cloneId=false)": function () {
      ...
      assert.isInnerHtmlMatching(
        '<p id="SE1">Test split <b id="SE1B1"><i id="SE1I1">ele</i></b></p><p><b><i>ment</i></b>.</p>',
        playground.getHtml(),
        "DOM after split"
      );
      assert.isInnerHtmlMatching(
        "<p><b><i>ment</i></b>.</p>",
        splitElement.getOuterHtml(),
        "Split element returned"
      );
    },
    ...
    "test range#splitElement (cloneId=true)": function () {
      ...
      assert.isInnerHtmlMatching(
        '<p id="SE1">Test split <b id="SE1B1"><i id="SE1I1">ele</i></b></p><p id="SE1"><b id="SE1B1"><i id="SE1I1">ment</i></b>.</p>',
        playground.getHtml(),
        "DOM after split"
      );
      assert.isInnerHtmlMatching(
        '<p id="SE1"><b id="SE1B1"><i id="SE1I1">ment</i></b>.</p>',
        splitElement.getOuterHtml(),
        "Split element returned"
      );
    },
    ...
    "test range#splitBlock (cloneId=false)": function () {
      ...
      assert.isInnerHtmlMatching(
        '<p id="SE1">Test@</p><p><b id="SE1B1"><i id="SE1I1">ment</i></b>.</p>',
        playground.getHtml(),
        "DOM after split"
      );
      ...
      assert.isInnerHtmlMatching(
        '<p id="SE1">Test@</p>',
        splitInfo.previousBlock.getOuterHtml(),
        "Previous block"
      );
      assert.isInnerHtmlMatching(
        '<p><b id="SE1B1"><i id="SE1I1">ment</i></b>.</p>',
        splitInfo.nextBlock.getOuterHtml(),
        "Next block"
      );
    },
    ...
    "test range#splitBlock (cloneId=true)": function () {
      ...
      assert.isInnerHtmlMatching(
        '<p id="SE1">Test@</p><p id="SE1"><b id="SE1B1"><i id="SE1I1">ment</i></b>.</p>',
        playground.getHtml(),
        "DOM after split"
      );
