...
(function () {
  ...
  var tests = {
    ...
    test_shrink_text2: function () {
      ...
      // <p>Test <b>[shrink <i>te]xt</i></b>.</p>
      assert.areSame(
        doc.getById("_ShrinkB2").$,
        range.startContainer.$,
        "range.startContainer"
      );
      assert.areSame(0, range.startOffset, "range.startOffset");
      assert.areSame(
        doc.getById("_ShrinkI2").getFirst().$,
        range.endContainer.$,
        "range.endContainer"
      );
    ...
    test_shrink_element2: function () {
      ...
      // <p> Test <b>sh[rink <i><img /></i>el]ement</b>.</p>
      assert.areSame(
        doc.getById("_ShrinkB4").getFirst().$,
        range.startContainer.$,
        "range.startContainer"
      );
      assert.areSame(2, range.startOffset, "range.startOffset");
      assert.areSame(
        doc.getById("_ShrinkI4").getNext().$,
        range.endContainer.$,
        "range.endContainer"
      );
      assert.areSame(2, range.endOffset, "range.endOffset");
    ...
    "test shrink does stop on block boundary end - SHRINK_ELEMENT":
      function () {
    ...
    "test shrink does stop on block boundary start - SHRINK_ELEMENT":
      function () {
        var ct = doc.getById("editable_playground"),
          source = "<p>[para1</p><p>]para2</p>",
          result = "<p>[para1]</p><p>para2</p>";
    ...
    "test shrink does stop on block boundary end - SHRINK_ELEMENT, no shrink on block boundary":
      function () {
        var ct = doc.getById("editable_playground"),
          source = "<p>para1[</p><p>para2]</p>";
    ...
    "test shrink does stop on block boundary start - SHRINK_ELEMENT, no shrink on block boundary":
      function () {
        var ct = doc.getById("editable_playground"),
          source = "<p>[para1</p><p>]para2</p>";
    ...
    "test shrink does not stop on inline boundary end - SHRINK_ELEMENT":
      function () {
        var ct = doc.getById("editable_playground"),
    ...
    "test shrink does not stop on inline boundary start - SHRINK_ELEMENT":
      function () {
        var ct = doc.getById("editable_playground"),
    ...
    "test shrink should stop on a non-editable block - SHRINK_ELEMENT":
      function () {
        var ct = doc.getById("editable_playground"),
    ...
    "test shrink should stop on a non-editable block with block contents - SHRINK_ELEMENT":
      function () {
        var ct = doc.getById("editable_playground"),
    ...
    "test shrink should stop on a non-editable inline element - SHRINK_ELEMENT":
      function () {
        var ct = doc.getById("editable_playground"),
    ...
    "test shrink should stop on a non-editable inline element with contents - SHRINK_ELEMENT":
      function () {
        var ct = doc.getById("editable_playground"),
    ...
    "test shrink should stop on a non-editable inline element but get inside editable element - SHRINK_ELEMENT":
      function () {
        var ct = doc.getById("editable_playground"),
    ...
    "test shrink should stop on a non-editable block - SHRINK_TEXT":
      function () {
        var ct = doc.getById("editable_playground"),
          source = '[<p contenteditable="false">x</p>]';
    ...
    "test shrink should stop on a non-editable block with block contents - SHRINK_TEXT":
      function () {
        var ct = doc.getById("editable_playground"),
          source = '[<div contenteditable="false"><p>x</p></div>]';
    ...
    "test shrink should stop on a non-editable inline element - SHRINK_TEXT":
      function () {
        var ct = doc.getById("editable_playground"),
          source = '<p>foo[<i contenteditable="false">x</i>]bar</p>';
    ...
    "test shrink should stop on a non-editable inline element with contents - SHRINK_TEXT":
      function () {
        var ct = doc.getById("editable_playground"),
          source = '<p>foo[<i contenteditable="false"><b>x</b></i>]bar</p>';
