  ...
  bender.test({
    ...
    "test wrapping contents stops at block limit": function () {
      ...
      this.assertFixBlock(
        ...
        true,
        "p",
        "x<table><tbody><tr><td><p>foo</p></td></tr></tbody></table>x"
      );
    },
    ...
    "test wrapping contents stops at block and block limit": function () {
      ...
      this.assertFixBlock(
        ...
        true,
        "p",
        "x<table><tbody><tr><td><p>foo</p><p>&nbsp;</p></td></tr></tbody></table>x"
      );
    },

    // https://dev.ckeditor.com/ticket/11798
    "test wrapping contents stops at non-editable block and block limit":
      function () {
        var editable = this.editor.editable(),
          range = this.editor.createRange();

        editable.setHtml(
          'x<table><tbody><tr><td><p contenteditable="false">foo</p></td></tr></tbody></table>x'
        );
        range.moveToPosition(
          editable.findOne("p"),
        ...
        this.assertFixBlock(
          ...
          true,
          "p",
          'x<table><tbody><tr><td><p contenteditable="false">foo</p><p>&nbsp;</p></td></tr></tbody></table>x'
        );
      },
    ...
    "test fixing empty, focused editable": function () {
      ...
      assert.isInnerHtmlMatching(
        "<p>[]@!</p>",
        bender.tools.range.getWithHtml(editable, range)
      );
    },
  });
})();
