  ...
  bender.test({
    "test keystrokeToString": function () {
      var tests = [
        ...
        [
          CKEDITOR.CTRL + CKEDITOR.ALT + 68 /*D*/,
          "Ctrl+Alt+D",
          "⌘+⌥+D",
          "Ctrl+Alt+D",
          "Command+Alt+D",
        ...
        [
          CKEDITOR.CTRL + CKEDITOR.SHIFT + 69 /*E*/,
          "Ctrl+Shift+E",
          "⌘+⇧+E",
          "Ctrl+Shift+E",
          "Command+Shift+E",
        ...
        [
          CKEDITOR.ALT + CKEDITOR.SHIFT + 70 /*F*/,
          "Alt+Shift+F",
          "⌥+⇧+F",
          "Alt+Shift+F",
          "Alt+Shift+F",
        ...
        [
          CKEDITOR.CTRL + CKEDITOR.ALT + CKEDITOR.SHIFT + 71 /*G*/,
          "Ctrl+Alt+Shift+G",
          "⌘+⌥+⇧+G",
          "Ctrl+Alt+Shift+G",
          "Command+Alt+Shift+G",
    ...
    _assertKeyboardMatrix: function (methodName, tests, compareAsArray) {
      var assertValue = compareAsArray
      ...
      for (var i = 0, l = tests.length; i < l; i++) {
        ...
        assertValue(
          test[expIndex],
          CKEDITOR.tools[methodName](lang, test[0]).display,
          "Keystroke display string representation is invalid."
        );
        assertValue(
          test[expIndex + 2],
          CKEDITOR.tools[methodName](lang, test[0]).aria,
