...
(function () {
  ...
  bender.test({
    ...
    "test array.map": function () {
      arrayAssert.itemsAreSame(
        [2, 4, 6],
        this.array.map([1, 2, 3], function (a) {
          return a * 2;
        })
      );
    ...
    "test array.every array": function () {
      ...
      assert.isTrue(
        this.array.every([11, 12, 34, 35, 546546], function (item) {
          return item > 10;
        })
      );
      assert.isFalse(
        this.array.every([10, 12, 34, 35, 546546], function (item) {
          return item > 10;
        })
      );

      assert.isTrue(
        this.array.every(["a", "asdas", "asdas", "adsadas"], function (item) {
          return item.charAt(0) === "a";
        })
      );
      assert.isFalse(
        this.array.every(["a", "asdas", "asdas", "cdsadas"], function (item) {
          return item.charAt(0) === "a";
        })
      );
    ...
    "test array.find no match": function () {
        ...
        ret = this.array.find(
          ...
          function (item, index) {
            ...
            arrayAssert.indexOf(
              ...
              arr,
              index,
              "Index argument should match item index"
            );
      ...
      arrayAssert.itemsAreSame(
        arr,
        results,
        "Each array item should be iterated"
      );
    },
        ...
        ret = this.array.find(
          ...
          function (item, index, array) {
            assert.areSame(
              arr,
              array,
              "Array argument should match given array"
            );
