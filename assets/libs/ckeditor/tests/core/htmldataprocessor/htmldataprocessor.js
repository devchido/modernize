...
(function () {
  ...
  function addXssTC(tcs, name, input, output) {
    name = "test xss - " + name;
    if (tcs[name]) throw 'Test called "' + name + '" already exists.';
  ...
  function getDataString(code, protocol) {
    ...
    return (
      proto +
      ": text/html,<html><head><title>Test</title></head><body><script>" +
      code +
      ";</script></body></html>"
    );
  }
  ...
  function isBrowserDisplayingAlert() {
    ...
    return (
      (CKEDITOR.env.ie &&
        (CKEDITOR.env.version == 8 || CKEDITOR.env.version == 11)) ||
      CKEDITOR.env.edge ||
  ...
  var tcs = {
    ...
    createProcessorAssertion: function (type) {
      ...
      return function (expected, source, msg) {
        assert.areSame(
          processBogus(expected),
          ed.dataProcessor[isToHtml ? "toHtml" : "toDataFormat"](
            processBogus(source)
          ),
          msg
        );
    ...
    assertHtml: function (expected, actual, msg) {
      assert.areEqual(
        ...
        bender.tools.fixHtml(actual),
        msg
      );
    },

    createBogus: function (toHtml) {
      return CKEDITOR.env.needsNbspFiller
        ? toHtml
          ? "\u00a0"
          : "&nbsp;"
        : "<br />";
    ...
    test_toDataFormat_ticket_2886_1: function () {
      assert.areSame(
        "<p>&nbsp;</p>",
        this.editor.dataProcessor.toDataFormat("<p></p>")
      );
    },

    test_toDataFormat_1a: function () {
      var element = new CKEDITOR.dom.element.createFromHtml(
        "<div><p>Test</p></div>"
      );

      assert.areSame(
        "<p>Test</p>",
        this.editor.dataProcessor.toDataFormat(element.getHtml())
      );
    },

    test_toDataFormat_1b: function () {
      var element = new CKEDITOR.dom.element.createFromHtml(
        "<div><x:x>Test</x:x></div>"
      );
    ...
    "test bogus nodes output in pseudo block": function () {
      ...
      o(
        "<div>foo<br />&nbsp;<p>bar</p></div>",
        "<div>foo<br />@<p>bar</p></div>",
        "Converted filler (2)"
      );
      o("<hr /><br />&nbsp;", "<hr /><br />@", "Converted filler (3)");
      o(
        "<ul><li>&nbsp;<ol><li>foo</li></ol></li></ul>",
        "<ul><li>@<ol><li>foo</li></ol></li></ul>",
        "Converted filler (4)"
      );
      o(
    ...
    test_toDataFormat_3: function () {
      assert.areSame(
        "<div><x:x><p>Test</p></x:x></div>",
        this.editor.dataProcessor.toDataFormat("<div><x:x><p>Test</p></div>")
      );
    },

    test_toDataFormat_ticket_2774: function () {
      var element = new CKEDITOR.dom.element.createFromHtml(
        "<div><P class=MsoNormal><B><I><SPAN lang=EN-US><o:p>Test</o:p></SPAN></I></B></P></div>"
      );

      assert.areSame(
        '<p class="MsoNormal"><b><i><span lang="EN-US"><o:p>Test</o:p></span></i></b></p>',
        this.editor.dataProcessor.toDataFormat(element.getHtml())
      );
    },
    ...
    test_toDataFormat_ticket_3036_2: function () {
      assert.areSame(
        '<input autocomplete="off" type="checkbox" unknown="" />',
        this.editor.dataProcessor.toDataFormat(
          '<INPUT type="checkbox" UNKNOWN  autocomplete=off>'
        )
      );
    },
    ...
    test_toDataFormat_ticket_2886_2: function () {
      ...
      if (CKEDITOR.env.needsNbspFiller) source = "<p>Some text<br><br></p>";
      assert.areSame(
        "<p>Some text<br /><br />&nbsp;</p>",
    ...
    test_toDataFormat_ticket_2886_6: function () {
      ...
      if (CKEDITOR.env.needsNbspFiller) source = "<p><br></p>";

      assert.areSame("<p><br />&nbsp;</p>", dataProcessor.toDataFormat(source));
    },
    ...
    test_toHtml_ticket_2886_2: function () {
      ...
      assert.areSame(
        expected,
        dataProcessor.toHtml("<p>Some text<br>Some other text</p>")
      );
    },
    ...
    test_toHtml_ticket_2886_3: function () {
      ...
      assert.areSame(
        expected,
        dataProcessor.toHtml("<p>Some text<br>&nbsp;</p>")
      );
    },
    ...
    test_toHtml_ticket_7243: function () {
      ...
      var input =
          '<p><img onmouseout="this.src=\'out.png\'" onmouseover="this.src=\'over.png\'" src="http://t/image.png" /></p>',
        output =
    ...
    "test link with empty href": function () {
      ...
      assert.areSame(
        ...
        dataProcessor.toDataFormat(
          dataProcessor.toHtml('<p><a href="" name="">emptylink</a></p>')
        )
      );
    },
    ...
    "test empty link": function () {
      ...
      assert.areSame(
        "<p>xx</p>",
        dataProcessor.toDataFormat('<p>x<a href="foo"></a>x</p>'),
        "toDF"
      );

      assert.areSame(
        "<p>xx</p>",
        dataProcessor.toHtml('<p>x<a href="foo"></a>x</p>'),
        "toHtml"
      );
    },
    ...
    "test empty anchor with name": function () {
      ...
      assert.areSame(
        '<p>x<a name="foo"></a>x</p>',
        dataProcessor.toDataFormat(
          '<p>x<a data-cke-saved-name="foo" name="foo"></a>x</p>'
        ),
        "toDF"
      );
      ...
      assert.areSame(
        '<p>x<a data-cke-saved-name="foo" name="foo"></a>x</p>',
        fixHtml(dataProcessor.toHtml('<p>x<a name="foo"></a>x</p>')),
        "toHtml"
      );
    },
    ...
    "test empty anchor with id": function () {
      ...
      assert.areSame(
        '<p>x<a id="foo"></a>x</p>',
        dataProcessor.toDataFormat('<p>x<a id="foo"></a>x</p>'),
        "toDF"
      );

      assert.areSame(
        '<p>x<a id="foo"></a>x</p>',
        dataProcessor.toHtml('<p>x<a id="foo"></a>x</p>'),
        "toHtml"
      );
    },
    ...
    "test empty anchor with name and id": function () {
      ...
      assert.areSame(
        '<p>x<a id="bar" name="foo"></a>x</p>',
        dataProcessor.toDataFormat(
          '<p>x<a data-cke-saved-name="foo" id="bar" name="foo"></a>x</p>'
        ),
        "toDF"
      );
      ...
      assert.areSame(
        ...
        bender.tools.fixHtml(
          dataProcessor.toHtml('<p>x<a id="bar" name="foo"></a>x</p>')
        ),
        "toHtml"
      );
    },
    ...
    test_innerHtmlComments_ticket_3801: function () {
      ...
      for (var i = 1; i <= 7; i++) {
        ...
        assert.areSame(
          getTextAreaValue("_TEXTAREA_3801_" + i),
    ...
    test_pre_leading_whitespaces_toHtml: function () {
      ...
      assert.areSame(
        source,
        bender.tools.fixHtml(dataProcessor.toHtml(source), false, false)
      );
    },
    ...
    "test bogus node output in nested list": function () {
      ...
      assert.areSame(
        "<ol><li>level1</li><li>&nbsp;<ol><li>level2</li></ol></li></ol>",
        bender.tools.fixHtml(processor.toDataFormat(source), true, true)
      );

      // Bogus removed.
      source =
        "<ol><li>level1</li><li>foo" +
        this.createBogus() +
        "<ol><li>level2</li></ol></li></ol>";
      assert.areSame(
        "<ol><li>level1</li><li>foo<ol><li>level2</li></ol></li></ol>",
        bender.tools.fixHtml(processor.toDataFormat(source), true, true)
      );

      // Real BR preserved.
      source =
        "<ol><li>level1</li><li>foo<br />" +
        this.createBogus() +
        "<ol><li>level2</li></ol></li></ol>";
      assert.areSame(
        "<ol><li>level1</li><li>foo<br />&nbsp;<ol><li>level2</li></ol></li></ol>",
        bender.tools.fixHtml(processor.toDataFormat(source), true, true)
      );
    },
    ...
    "test output embedded/object element": function () {
      assert.areSame(
        '<div>some<object classid="id1"><param /><param /><embed /></object>text</div>',
        this.editor.dataProcessor.toDataFormat(
          '<div>some<object classid="id1"><param><param><embed /></object>text</div>'
        )
      );
    ...
    'test protect "href" attributes': function () {
      assert.areSame(
        ...
        bender.tools.fixHtml(
          this.editor.dataProcessor.toHtml(
    ...
    "test don't search for protected in attribute value": function () {
      ...
      for (var i = escaped.length; i--; ) {
        ...
        assert.areSame(
          html,
          bender.tools.fixHtml(this.editor.dataProcessor.toHtml(html)),
          "Escaped text is not processed."
        );
    ...
    "test don't protect foo:href attributes": function () {
      assert.areSame(
        '<a foo:href="http://ckeditor.com">foo</a>',
        bender.tools.fixHtml(
          this.editor.dataProcessor.toHtml(
            '<a foo:href="http://ckeditor.com">foo</a>'
          )
    ...
    "test protect source does not break real comments next to \"' characters":
      function () {
        var sources = [
        ...
        for (
          var i = 0, processor = this.editor.dataProcessor;
          i < sources.length;
          ++i
        ) {
          assert.areSame(
            results[i],
            bender.tools
              .compatHtml(processor.toHtml(sources[i]), false, true)
              // IE encodes \n in attributes.
              .replace(/&#10;/g, "\n"),
            "tc " + i
          );
    ...
    "test protected source in attribute in self-closing tag": function () {
      var processor = this.editors.editor3.dataProcessor,
        ...
        expectedHtml =
          '<p><img data-cke-saved-src="{cke_protected_1}" src="{cke_protected_1}" /></p>',
    ...
    "test protected source in title": addProtectedSourceTC(
      "<p>[[mytag]]</p>",
      "[[mytag]]"
    ),
    "test protected source in iframe": addProtectedSourceTC(
      '<p><iframe name="aa">[[mytag]]</iframe></p>'
    ),
    "test protected source in textarea": addProtectedSourceTC(
      '<p><textarea name="aa">[[mytag]]</textarea></p>'
    ),
    "test protected source in textarea multiline": addProtectedSourceTC(
      '<p><textarea name="aa">[[aa]]\n[[bb]]</textarea></p>'
    ),
    // Meta tags should be allowed in any element. (https://dev.ckeditor.com/ticket/8117)
    "test meta tag in paragraph": addProtectedSourceTC(
      '<p><meta itemprop="best" content="10" /></p>'
    ),
    "test meta tag directly in body": addProtectedSourceTC(
      '<meta itemprop="familyName" content="McFoobar" /><p>x</p>'
    ),
    ...
    "test values of attributes are not protected": function () {
      ...
      assert.areSame(
        ...
        bender.tools.compatHtml(
          toHtml('<p bar="' + script + script + '" foo="' + script + '">x</p>'),
          false,
          true
        ),
        "tc3"
    ...
    "test browser does not hang up when processing malformed attributes list":
      function () {
        var processor = this.editor.dataProcessor;
        processor.toHtml(
          "<table border=0 cellspacing=0 cellpadding=0 style='border-collapse:collapse;></table>"
    ...
    "test protect inline event handlers": function () {
      var source =
        '<img onmouseout="this.src=\'out.png\'" onmouseover="this.src=\'over.png\'" src="http://t/image.png" />';
      var processor = this.editor.dataProcessor;
      assert.areSame(source, processor.toDataFormat(processor.toHtml(source)));
    },
    ...
    "test process table with multiple tbody keeps order": function () {
      var processor = this.editor.dataProcessor;
      bender.tools.testInputOut(
        "table-multi-tbody",
        function (source, expected) {
          assert.areSame(
            bender.tools.compatHtml(expected),
            processor.toDataFormat(source)
          );
        }
      );
    },
    ...
    "test process textarea": function () {
      var p = this.editor.dataProcessor,
        ...
        se = "</textarea><p>X</p>",
        os =
          '<p>X</p><textarea cols="20" contenteditable="false" data-cke-editable="1" rows="10">',
        oe = "</textarea><p>X</p>";
      ...
      assert.areSame(
        os + "&lt;p&gt;foo&lt;/p&gt;" + oe,
        toHtml(ss + "<p>foo</p>" + se),
        "t2"
      );
      assert.areSame(
        os + '&lt;img src="a" alt="b" /&gt;' + oe,
        toHtml(ss + '<img src="a" alt="b" />' + se),
        "t3"
      );
      assert.areSame(
        os + "a&lt;!--b--&gt;c" + oe,
      ...
      assert.areSame(
        os + 'a&lt;a href="b"&gt;c&lt;/a&gt;d' + oe,
        toHtml(ss + 'a<a href="b">c</a>d' + se),
        "t5"
      );

      assert.areSame(
        os + "&lt;!--a--&gt;" + oe + os + "&lt;!--b--&gt;" + oe,
        toHtml(ss + "<!--a-->" + se + ss + "<!--b-->" + se),
        "t6"
      );

      assert.areSame(
        '<textarea contenteditable="false" data-cke-editable="1">a&lt;!--b--&gt;c</textarea>',
        toHtml("<textarea>a<!--b-->c</textarea>"),
        "t7"
      );

      assert.areSame(
        os + "a&lt;?php echo(1); ?&gt;b" + oe,
        toHtml(ss + "a<?php echo(1); ?>b" + se),
        "t8"
      );
    ...
    "test process style": function () {
      ...
      assert.areSame(
        ss +
          'a{}</style><p><img data-cke-saved-src="http://t/image.png" src="http://t/image.png" /></p><style>b{}' +
          se,
        toHtml(
          ss +
            'a{}</style><p><img src="http://t/image.png" /></p><style>b{}' +
            se
        ),
        "s2"
      );
    ...
    "test removing apple style span": function () {
      assert.areSame(
        "<p>abc</p>",
        this.editor.dataProcessor.toDataFormat(
          '<p>a<span class="Apple-style-span">b</span>c</p>'
        )
      );
      // Test that it does not happen because of all spans stripping.
      assert.areSame(
        "<p>a<span>b</span>c</p>",
        this.editor.dataProcessor.toDataFormat("<p>a<span>b</span>c</p>")
      );
    },
    ...
    "test process attributes containing protected parts": function () {
      ...
      assert.areSame(
        ...
        bender.tools.fixHtml(
          dataP.toHtml('<p><a data-href="x" href="#" src-foo="y">a</a></p>')
        )
      );
    },
    ...
    "test process malformed script": function () {
      ...
      assert.areSame(
        "<p>x</p><!--{cke_protected}%3Cscript%3E%3Ciframe%20src%3D%22foo%22%3E%3C%2Fiframe%3E-->",
        dataP.toHtml('<p>x</p><script><iframe src="foo"></iframe>')
      );
      assert.areSame(
        "<p>x</p><!--{cke_protected}%3Cscript%3Ealert(1)%3B%3Cp%3Efoo%3C%2Fp%3E%3Cp%3Ebar%3C%2Fp%3E-->",
      ...
      assert.areSame(
        ...
        dataP.toHtml(
          "<p>x</p><script>alert(1);</scr" +
            "ipt><p>foo</p><script>alert(2);</scr" +
            "ipt><p>bar</p>"
        )
      );
    },
    ...
    "test toHtml event": function () {
      ...
      var lst2 = editor.on(
        ...
        function (evt) {
          assert.areSame(
            "1",
            evt.data.dataValue.children[0].attributes.onclick
          );
      ...
      var lst4 = editor.on(
        ...
        function (evt) {
          assert.areSame(
            '<p data-cke-pa-onclick="1">A</p><p>B</p>',
            evt.data.dataValue
          );
          calls++;
        },
      ...
      assert.areSame(
        '<p data-cke-pa-onclick="1">A</p><p>B</p>',
        editor.dataProcessor.toHtml('<p onclick="1">A</p>')
      );
    ...
    "test toHtml - options.filter": function () {
      ...
      html = editor.dataProcessor.toHtml(
        '<p><i class="options-filter">A</i><b>B</b></p>',
        {
    ...
    "test toHtml - options.filter - defaults to": function () {
      ...
      assert.areSame(
        editor.filter,
        filters[2],
        "defaults to the main filter instead of active filter"
      );
    ...
    "test toDataFormat - options.context": function () {
      bender.editorBot.create(
        ...
        function (bot) {
          ...
          assert.areSame(
            "<p>foo</p>",
            dataProcessor.toDataFormat("foo"),
            "data was processed in body context"
          );
          assert.areSame(
            "body",
            context,
            "context defaults to editor.editable"
          );
          ...
          assert.areSame(
            "foo",
            dataProcessor.toDataFormat("foo", { context: "p" }),
            "data was processed in p context"
          );
      ...
      bender.editorBot.create(
        ...
        function (bot) {
          ...
          assert.areSame(
            "<p>foo</p>",
            html,
            "dynamic mode was used instead of active mode"
          );
      ...
      bender.editorBot.create(
        ...
        function (bot) {
          ...
          assert.areSame(
            "<p>foo</p>",
            html,
            "default mode was used instead of active mode"
          );
    ...
    "test toHtml passes enterMode to ACF so elements are stripped correctly":
      function () {
        var data = "<div>foo</div><div>bar</div>";

        assert.areSame(
          "<p>foo</p><p>bar</p>",
          this.editor.dataProcessor.toHtml(data, {
    ...
    "test leading br is removed by toDataFormat in ENTER_P and ENTER_DIV":
      function () {
        ...
        assert.areSame(
          "",
          htmlDP.toDataFormat("<br />", opts),
          "single <br />"
        );

        assert.areSame(
          "<p>foo</p>",
          htmlDP.toDataFormat("<br><p>foo</p>", opts),
          "<br> followed by a block"
        );
        assert.areSame(
          "<p><b>foo</b></p>",
          htmlDP.toDataFormat("<br><b>foo</b>", opts),
          "<br> followed by an inline element"
        );
        assert.areSame(
          "<p>foo</p>",
          htmlDP.toDataFormat("<br>foo", opts),
          "<br> followed by a text"
        );

        assert.areSame(
          "<div>foo</div>",
          htmlDP.toDataFormat("<br>foo", { enterMode: CKEDITOR.ENTER_DIV }),
          "<br> followed by a block - ENTER_DIV"
        );

        assert.areSame(
          "<br />foo",
          htmlDP.toDataFormat("<br>foo", { enterMode: CKEDITOR.ENTER_BR }),
          "<br> is not removed in ENTER_BR"
        );
      },
    ...
    "test data-cke-expando is always stripped": function () {
      ...
      assert.areSame(
        "<p>foo</p>",
        htmlDP.toHtml('<p data-cke-expando="1">foo</p>'),
        "toHtml"
      );
      assert.areSame(
        "<p>foo</p>",
        htmlDP.toDataFormat('<p data-cke-expando="1">foo</p>'),
        "toDF"
      );
      assert.areSame(
        '<p contenteditable="false">foo</p>',
        htmlDP.toHtml(
          '<p contenteditable="false" data-cke-expando="1">foo</p>'
        ),
        "toHtml - non editable"
      );
      assert.areSame(
    ...
    "test config.fillEmptyBlocks - default": function () {
      ...
      assert.areSame(
        "<p>" + bogus + "</p>",
        htmlDP.toDataFormat("<p></p>"),
        "toDF 1"
      );
      assert.areSame(
        "<div><h1>" + bogus + "</h1></div>",
        htmlDP.toDataFormat("<div><h1></h1></div>"),
        "toDF 2"
      );
    },
    ...
    // (#988)
    "test protected element names regex": testProcessedHtmlUnchanged(
  ...
  addXssTC(
    tcs,
    "img onerror with white spaces",
    '<p><img \nonerror\n =\n "%xss%" src="produce404" /></p>',
    '<p><img onerror="%xss%" src="produce404" /></p>'
  );
  addXssTC(
    tcs,
    "img onerror without quotes and with white spaces",
    '<p><img onerror =\n  \t%xss% src="produce404" /></p>',
    '<p><img onerror="%xss%" src="produce404" /></p>'
  );
  ...
  addXssTC(
    tcs,
    "video with source onerror",
    '<p><video><source onerror="%xss%" /></video></p>'
  );
  addXssTC(
    tcs,
    "video with source onerror 2",
  ...
  addXssTC(
    tcs,
    "video with incorrect source onerror 1",
    '<p><video><source onerror.="%xss%" src="produce404" /></video></p>',
    false
  );
  addXssTC(
    tcs,
    "video with incorrect source onerror 2",
    '<p><video><source onerror&="%xss%" src="produce404" /></video></p>',
    false
  );
  addXssTC(
    tcs,
    "video with incorrect source onerror 3",
    '<p><video><source onerror%3D"%xss%" src="produce404" /></video></p>',
    false
  );
  addXssTC(
    tcs,
    "video with incorrect source onerror 4",
    '<p><video><source on error="%xss%" src="produce404" /></video></p>',
    false
  );
  addXssTC(
    tcs,
    "video with incorrect source onerror 5",
    '<p><video><source on\nerror="%xss%" src="produce404" /></video></p>',
    false
  );
  addXssTC(
    tcs,
    "video with incorrect source onerror 6",
    '<p><video><source o\rnerror="%xss%" src="produce404" /></video></p>',
    false
  );
  addXssTC(
    tcs,
    "video with incorrect source onerror 7a",
    '<p><video><source o\x00nerror="%xss%" src="produce404" /></video></p>',
    false
  );
  addXssTC(
    tcs,
    "video with incorrect source onerror 7b",
    '<p><video><source onerror\x00="%xss%" src="produce404" /></video></p>',
    false
  );
  addXssTC(
    tcs,
    "video with incorrect source onerror 7c",
    '<p><video><source onerror\x02="%xss%" src="produce404" /></video></p>',
    false
  );
  addXssTC(
    tcs,
    "video with incorrect source onerror 8",
    '<p><video><source o\u0000nerror="%xss%" src="produce404" /></video></p>',
    false
  );
  addXssTC(
    tcs,
    "video with incorrect source onerror 9",
    '<p><video><source o\u0009nerror="%xss%" src="produce404" /></video></p>',
    false
  );
  addXssTC(
    tcs,
    "video with incorrect source onerror 10",
    '<p><video><source o\u0008onerror="%xss%" src="produce404" /></video></p>',
    false
  );
  addXssTC(
    tcs,
    "video with incorrect source onerror 11",
    '<p><video><source onerror %xss% src="produce404" /></video></p>',
    false
  );
  addXssTC(
    tcs,
    "video with incorrect source onerror 12",
    '<p><video><source onerror "%xss%" src="produce404" /></video></p>',
    false
  );
  addXssTC(
    tcs,
    "video with incorrect source onerror 13",
    '<p><video><source onerror=="%xss%" src="produce404" /></video></p>',
    false
  );
  addXssTC(
    tcs,
    "video with incorrect source onerror 14",
    '<p><video><source onerror= ="%xss%" src="produce404" /></video></p>',
    false
  );
  addXssTC(
    tcs,
    "video with incorrect source onerror 15",
    '<p><video><source onerror ==="%xss%" src="produce404" /></video></p>',
    false
  );
  addXssTC(
    tcs,
    "video with incorrect source onerror 16",
    '<p><video><source foo=1onerror="%xss%" src="produce404" /></video></p>',
    false
  );
  // Important to have src first, because Chrome timeouts if it cannot be found.
  addXssTC(
    tcs,
    "video with incorrect source onerror 17",
    '<p><video><source src="produce404" foo="1\n onerror="%xss%" /></video></p>',
    false
  );
  addXssTC(
    tcs,
    "video with incorrect source onerror 18",
    '<p><video><source <onerror="%xss%" src="produce404" /></video></p>',
    false
  );
  addXssTC(
    tcs,
    "video with incorrect source onerror 19",
    '<p><video><source _onerror="%xss%" src="produce404" /></video></p>',
    false
  );
  addXssTC(
    tcs,
    "video with incorrect source onerror 20",
    '<p><video><source /onerror="%xss%" src="produce404" /></video></p>',
    false
  );
  addXssTC(
    tcs,
    "video with spacy source onerror 1",
    '<p><video><source onerror = "%xss%" src="produce404" /></video></p>',
    '<p><video><source onerror="%xss%" src="produce404" /></video></p>'
  );
  addXssTC(
    tcs,
    "video with spacy source onerror 2",
    '<p><video><source onerror\r\n \t="%xss%" src="produce404" /></video></p>',
    '<p><video><source onerror="%xss%" src="produce404" /></video></p>'
  );
  addXssTC(
    tcs,
    "video with spacy source onerror 3",
    '<p><video><source onerror=\n\r \t"%xss%" src="produce404" /></video></p>',
    '<p><video><source onerror="%xss%" src="produce404" /></video></p>'
  );
  addXssTC(
    tcs,
    "video with spacy source onerror 4",
  ...
  addXssTC(
    tcs,
    "iframe with src=javascript 1",
    '<p><iframe src="javascript:window.parent.%xss%;"></iframe></p>',
    '<p><iframe src="javascript:window.parent.%xss%;"></iframe></p>'
  );
  addXssTC(
    tcs,
    "iframe with src=javascript 2",
  ...
  addXssTC(
    tcs,
    "iframe with src=data 1",
    '<p><iframe src="' +
      getDataString("window.parent.parent.%xss%") +
      '"></iframe></p>',
    false
  );
  addXssTC(
    tcs,
    "iframe with src=data 2",
    '<p><iframe src="' +
      getDataString("window.top.%xss%", "   dAtA") +
      '"></iframe></p>',
    false
  );
  addXssTC(
    tcs,
    "iframe with src=data 3",
    '<p><iframe src="' +
      getDataString("window.top.%xss%", "d     ata") +
      '"></iframe></p>',
    false
  );
