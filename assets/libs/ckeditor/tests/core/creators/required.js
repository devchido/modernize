      ...
      bender.editorBot.create(
        ...
        function (bot) {
          ...
          assert.isFalse(
            ...
            "does not have textarea[required] when editor is initialized"
          );
          ...
          assert.isTrue(
            textarea.hasAttribute("required"),
            "has textarea[required] after destroying editor"
          );
          assert.areSame(
            "required",
            textarea.getAttribute("required"),
            "value of textarea[required] after destroying editor"
          );
    ...
    "test no required attribute": function () {
      bender.editorBot.create(
        ...
        function (bot) {
          ...
          assert.isFalse(
            textarea.hasAttribute("required"),
            "does not have textarea[required] after destroying editor"
          );
