...
(function () {
  ...
  bender.tools.compatHtml = function (
    html,
    noInterWS,
    sortAttributes,
    fixZWS,
    ...
    return originalCompatHtml.call(
      bender.tools,
      html,
      noInterWS,
      sortAttributes,
  ...
  function t(ret, expected, actual, options, expectedCompatHtmlArgs) {
    return function () {
      ...
      assert.areSame(
        ret,
        htmlTools.compareInnerHtml(expected, actual, options),
        "returned value"
      );
  ...
  function th(expected, innerHtmlToPrepare, options) {
    return function () {
      assert.areSame(
        expected,
        htmlTools.prepareInnerHtmlForComparison(innerHtmlToPrepare, options)
      );
    };
  }
  ...
  function tp(expected, patternSource) {
    return function () {
      var actual = htmlTools
        .prepareInnerHtmlPattern(patternSource)
        .toString()
  ...
  bender.test({
    ...
    "opts.noInterWS defaults to false": t(true, "", "", null, {
      noInterWS: false,
    }),
    "opts.noInterWS defaults to false 2": t(
      true,
      "",
      "",
      {},
    ...
    "opts.fixStyles defaults to false": t(true, "", "", null, {
      fixStyles: false,
    }),
    "opts.fixStyles is passed": t(
      true,
      "",
      "",
      { fixStyles: true },
    ...
    "opts.sortAttributes defaults to true": t(true, "", "", null, {
      sortAttributes: true,
    }),
    "opts.fixZWS defaults to true": t(true, "", "", null, { fixZWS: true }),
    "opts.fixNbsp defaults to true": t(true, "", "", null, { fixNbsp: true }),
    "opts.noTempElements defaults to false": t(true, "", "", null, {
      noTempElements: false,
    }),
    ...
    "multiple opts": t(
      ...
      "",
      "",
      { fixNbsp: false, fixStyles: true },
      { fixZWS: true, fixNbsp: false, fixStyles: true }
    ),
    ...
    "multiple boguses": t(
      true,
      "<p>a@</p><p>b@</p><p>c@</p>",
      "<p>a" + fillerBr + "</p><p>b</p><p>c" + fillerBr + "</p>"
    ),
    ...
    "markers 3 - no opts.compareSelection": t(
      true,
      "<ul><li>[</li><li>a</li></ul>",
      "<ul>[<li>a</li></ul>"
    ),

    "markers 1 - opts.compareSelection": t(true, "ba[r}", "ba[r}", {
      compareSelection: true,
    }),
    "markers 2 - opts.compareSelection": t(true, "ba{}r", "ba{}r", {
      compareSelection: true,
    }),
    "markers 3 - opts.compareSelection": t(true, "ba[]r", "ba[]r", {
      compareSelection: true,
    }),
    "markers 4 - opts.compareSelection": t(
      true,
      "<ul>[<li>a</li>]</ul>",
      "<ul>[<li>a</li>]</ul>",
      {
    ...
    "markers 4 - opts.compare&normalizeSelection": t(
      true,
      "<ul>[<li>a</li>]</ul>",
      "<ul>[<li>a</li>]</ul>",
    ...
    "br/nbsp bogus expected, nbsp/br given": t(
      false,
      "a@@",
      "a" + CKEDITOR.env.needsBrFiller ? "&nbsp;" : "<br />"
    ),
    ...
    "markers - opts.compareSelection - fail": t(false, "ba{}r", "ba[]r", {
      compareSelection: true,
    }),
    "markers - opts.compare&normalizeSelection - fail": t(
      false,
      "ba[]r",
      "ba[]r",
      {
    ...
    "prep inner HTML - attributes sorting": th(
      '<b bar="2" foo="1">foo</b>',
      '<b foo="1" bar="2">foo</b>'
    ),
    "prep inner HTML - no attributes sorting": th(
      '<b foo="1" bar="2">foo</b>',
      '<b foo="1" bar="2">foo</b>',
      { sortAttributes: false }
    ),
    "prep inner HTML - no interws default": th(
      '<b>foo <img src="x" /></b> bar',
      '<b>foo <img src="x" /></b> bar'
    ),
    "prep inner HTML - no interws": th(
      '<b>foo<img src="x" /></b>bar',
      '<b>foo <img src="x" /></b> bar',
      { noInterWS: true }
    ),
    "prep inner HTML - no compare sel": th(
      "<ul><li>[</li><li>a</li><li>]</li></ul>",
      "<ul>[<li>a</li>]</ul>"
    ),
    "prep inner HTML - compare sel": th(
      "<ul>[<li>a</li>]</ul>",
      "<ul>[<li>a</li>]</ul>",
      {
        compareSelection: true,
    ...
    "prep inner HTML - no normalize sel": th(
      "<p>[]a{b}c</p>",
      "<p>[]a{b}c</p>"
    ),
    ...
    "prep inner HTML - no strip temp": th(
      'a<i data-cke-temp="1">b</i>',
      'a<i data-cke-temp="1">b</i>'
    ),
    "prep inner HTML - strip temp": th("a", 'a<i data-cke-temp="1">b</i>', {
      noTempElements: true,
    }),
    ...
    "prep pattern - boguses": tp(
      "/^f" + fillerBrPattern + "oo" + fillerBrPattern + "$/",
      "f@oo@"
    ),
    ...
    "test does not modify options object": function () {
      ...
      assert.areSame(
        strOpts,
        JSON.stringify(opts),
        "options object has not been modified"
      );
    },
