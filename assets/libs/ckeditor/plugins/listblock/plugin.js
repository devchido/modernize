...
CKEDITOR.plugins.add("listblock", {
  ...
  onLoad: function () {
    var list = CKEDITOR.addTemplate(
      ...
      listGroup = CKEDITOR.addTemplate(
        "panel-list-group",
        '<h1 id="{id}" draggable="false" ondragstart="return false;" class="cke_panel_grouptitle" role="presentation" >{label}</h1>'
      ),
      reSingleQuote = /\'/g,
    ...
    CKEDITOR.ui.panel.prototype.addListBlock = function (name, definition) {
      return this.addBlock(
        name,
        new CKEDITOR.ui.listBlock(this.getHolderElement(), definition)
      );
    };
    ...
    CKEDITOR.ui.listBlock = CKEDITOR.tools.createClass({
      ...
      $: function (blockHolder, blockDefinition) {
        ...
        var attribs =
          blockDefinition.attributes || (blockDefinition.attributes = {});
      ...
      proto: {
        ...
        hideGroup: function (groupTitle) {
          var group = this.element
              .getDocument()
              .getById(this._.groups[groupTitle]),
