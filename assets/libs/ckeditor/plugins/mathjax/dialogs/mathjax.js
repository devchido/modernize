        ...
        elements: [
          ...
          !(CKEDITOR.env.ie && CKEDITOR.env.version == 8) && {
            ...
            html:
              ...
              '<iframe style="border:0;width:0;height:0;font-size:20px" scrolling="no" frameborder="0" allowTransparency="true" src="' +
            ...
            onLoad: function () {
              ...
              preview = new CKEDITOR.plugins.mathjax.frameWrapper(
                iFrame,
                editor
              );
            },
