  ...
  init: function (editor) {
          ...
          [
            {
              ...
              left: function (element) {
                ...
                return (
                  background.color && tools.object.keys(background).length === 1
                );
              },
              right: function (element) {
      ...
      editor.ui.add(name, CKEDITOR.UI_PANELBUTTON, {
        ...
        onBlock: function (panel, block) {
          ...
          block.element.setHtml(
            renderColors(panel, type, colorBoxId, colorData)
          );
        ...
        onOpen: function () {
            ...
            automaticColor =
              (block &&
                block.getComputedStyle(
                  type == "back" ? "background-color" : "color"
                )) ||
              "transparent";
          } while (
            type == "back" &&
          ...
          if (range) {
            ...
            if (type == "fore") {
              colorData.automaticTextColor =
                "#" + normalizeColor(automaticColor);
            }
    ...
    function renderColors(panel, type, colorBoxId, colorData) {
      var output = [],
        ...
        moreColorsEnabled =
          editor.plugins.colordialog && config.colorButton_enableMore !== false,
      ...
      var clickFn = CKEDITOR.tools.addFunction(
        function applyColorStyle(color, type) {
          editor.focus();
          ...
          function setColor(color) {
            ...
            editor.removeStyle(
              new CKEDITOR.style(colorStyle, { color: "inherit" })
            );
