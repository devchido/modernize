  ...
  return {
    ...
    onLoad: function () {
      ...
      this.foreach(function (field) {
        ...
        field.commit = CKEDITOR.tools.override(
          field.commit,
          function (orgCommit) {
            return function () {
      ...
      children: [
        {
          ...
          validate: validate.number(
            langCell["invalid" + CKEDITOR.tools.capitalize(fieldName)]
          ),

          // Extra labelling of unit type.
          onLoad: function () {
            var unitType = this.getDialog().getContentElement(
                "info",
                fieldName + "Type"
              ),
          ...
          commit: function (element) {
            var value = parseFloat(this.getValue(), 10),
              ...
              unit =
                this.getDialog().getValueOf("info", fieldName + "Type") ||
                getCellSizeUnitType(element, fieldName);
