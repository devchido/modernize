  ...
  View.prototype = {
    ...
    setPosition: function (rect) {
      ...
      if (CKEDITOR.env.iOS && !editable.isInline()) {
        ...
        editorViewportRect = editable.isInline()
      ...
      // +---------------------------------------------+
      top =
        rect.top < editorViewportRect.top
          ? editorViewportRect.top
          : Math.min(editorViewportRect.bottom, rect.bottom);
      ...
      if (editorViewportRect.bottom < rect.bottom) {
        top = Math.min(
          rect.top - viewHeight,
          editorViewportRect.bottom - viewHeight
        );
      }
