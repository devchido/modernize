    ...
    init: function (editor) {
        ...
        function (evt) {
          ...
          if (element && !element.isReadOnly()) {
            if (element.is("a")) {
              ...
              CKEDITOR.plugins.link.tryRestoreFakeAnchor(editor, element)
            ) {
      ...
      if (editor.contextMenu) {
        editor.contextMenu.addListener(function (element) {
          ...
          var anchor = CKEDITOR.plugins.link.tryRestoreFakeAnchor(
            editor,
            element
          );
          ...
          if (
            !anchor &&
            !(anchor = CKEDITOR.plugins.link.getSelectedLink(editor))
          )
            return null;
  ...
  CKEDITOR.plugins.link = {
    ...
    getEditorAnchors: function (editor) {
      var editable = editor.editable(),
        ...
        scope =
          editable.isInline() && !editor.plugins.divarea
            ? editor.document
            : editable,
    ...
    parseLinkAttributes: function (editor, element) {
      var href =
          ...
          "",
        compiledProtectionFunction =
          editor.plugins.link.compiledProtectionFunction,
            ...
            function (match, funcName, funcArgs) {
              if (funcName == compiledProtectionFunction.name) {
                ...
                for (var i = 0; i < paramsMatchLength; i++) {
                  ...
                  paramName =
                    compiledProtectionFunction.params[i].toLowerCase();
