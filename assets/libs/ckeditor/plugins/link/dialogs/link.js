...
(function () {
  CKEDITOR.dialog.add("link", function (editor) {
    ...
    return {
      ...
      minWidth:
        (CKEDITOR.skinName || editor.config.skin) == "moono-lisa" ? 450 : 350,
      minHeight: 240,
      contents: [
        {
          id: "info",
  ...
  function validateTelNumber() {
    var dialog = this.getDialog(),
      ...
      linkLang = editor.lang.link,
      messageWhenEmpty = CKEDITOR.dialog.validate
        .notEmpty(linkLang.noTel)
        .apply(this);

    if (
      !dialog.getContentElement("info", "linkType") ||
      dialog.getValueOf("info", "linkType") != "tel"
    ) {
      return true;
    }
