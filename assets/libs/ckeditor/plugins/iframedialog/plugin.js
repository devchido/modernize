...
CKEDITOR.plugins.add("iframedialog", {
  ...
  onLoad: function () {
     ...
     */
    CKEDITOR.dialog.addIframe = function (
      name,
      title,
      src,
      minWidth,
      ...
      for (var i in userDefinition) definition[i] = userDefinition[i];
    ...
    (function () {
      ...
      var iframeElement = function (dialog, elementDefinition, htmlList) {
        ...
        var _ = this._ || (this._ = {}),
          contentLoad =
            elementDefinition.onContentLoad &&
            CKEDITOR.tools.bind(elementDefinition.onContentLoad, this),
        ...
        dialog.on("show", function () {
          var iframe = CKEDITOR.document.getById(_.frameId),
            ...
            html = myHtml
              .replace("%1", callIndex)
              .replace("%2", CKEDITOR.tools.htmlEncode(elementDefinition.src));
