...
(function () {
  ...
  CKEDITOR.plugins.add("undo", {
    ...
    init: function (editor) {
      var undoManager = (editor.undoManager = new UndoManager(editor)),
        editingHandler = (undoManager.editingHandler = new NativeEditingHandler(
          undoManager
        ));
  ...
  UndoManager.ieFunctionalKeysBug = function (keyCode) {
    return (
      CKEDITOR.env.ie &&
      UndoManager.getKeyGroup(keyCode) == UndoManager.keyGroups.FUNCTIONAL
    );
  };
   ...
   */
  var NativeEditingHandler = (CKEDITOR.plugins.undo.NativeEditingHandler =
  ...
  NativeEditingHandler.prototype = {
    ...
    onKeydown: function (evt) {
      ...
      if (
        UndoManager.isNavigationKey(keyCode) ||
        this.undoManager.keyGroupChanged(keyCode)
      ) {
    ...
    onKeyup: function (evt) {
      ...
      if (
        UndoManager.ieFunctionalKeysBug(keyCode) &&
