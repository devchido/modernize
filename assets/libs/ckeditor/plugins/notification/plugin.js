...
(function () {
  ...
  Notification.prototype = {
    ...
    show: function () {
      if (
        this.editor.fire("notificationShow", { notification: this }) === false
      ) {
        return;
      }
    ...
    hide: function () {
      if (
        this.editor.fire("notificationHide", { notification: this }) === false
      ) {
        return;
      }
    ...
    _hideAfterTimeout: function () {
      ...
      if (typeof this.duration == "number") {
        ...
        duration =
          typeof this.editor.config.notification_duration == "number"
  ...
  Area.prototype = {
    ...
    _createElement: function () {
      ...
      notificationArea.setAttribute(
        "id",
        "cke_notifications_area_" + editor.name
      );
    ...
    _layout: function () {
      ...
      if (!notificationWidth || !notificationMargin) {
        ...
        notificationWidth = this._notificationWidth =
          notification.getClientRect().width;
        notificationMargin = this._notificationMargin =
      ...
      if (
        ...
        contentsPos.y + contentsRect.height - areaRect.height >
        scrollPos.y
      ) {
        setTopFixed();
      ...
      if (contentsRect.width < notificationWidth + notificationMargin) {
        ...
        // +------------------------------------------+
        if (
          contentsPos.x + notificationWidth + notificationMargin >
          scrollPos.x + viewRect.width
        ) {
          setRight();
        ...
        if (
          ...
          contentsRect.left + contentsRect.width / 2 - notificationWidth / 2 <
          0
        ) {
          setLeftFixed();
      ...
      function setLeftFixed() {
        area.setStyle(
          "left",
          cssLength(leftBase - contentsPos.x + scrollPos.x)
        );
      }
