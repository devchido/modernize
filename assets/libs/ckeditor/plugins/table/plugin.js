  ...
  init: function (editor) {
    ...
    editor.addCommand(
      ...
      new CKEDITOR.dialogCommand("table", {
        context: "table",
        allowedContent:
          "table{width,height,border-collapse}[align,border,cellpadding,cellspacing,summary];" +
              ...
              right: function (element) {
                if (element.styles) {
                  ...
                  if (element.styles.border) {
                    parsedStyle = CKEDITOR.tools.style.parse.border(
                    ...
                    if (
                      ...
                      styleData["border-left"] === styleData["border-right"] &&
                  ...
                  if (
                    parsedStyle &&
                    parsedStyle.style &&
                    parsedStyle.style === "solid" &&
                    parsedStyle.width &&
                    parseFloat(parsedStyle.width) !== 0
                  ) {
