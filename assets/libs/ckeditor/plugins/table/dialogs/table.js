  ...
  function validatorNum(msg) {
    return function () {
      var value = this.getValue(),
        pass = !!(
          CKEDITOR.dialog.validate.integer().call(this, value) && value > 0
        );
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      setup: function (selectedTable) {
                        ...
                        for (
                          ...
                          if (
                            headCell &&
                            headCell.nodeName.toLowerCase() != "th"
                          ) {
                        ...
                        if (selectedTable.$.tHead !== null)
                          this.setValue(
                            dialog.hasColumnHeaders ? "both" : "row"
                          );
                        else
                    ...
                    },
                    {
                      ...
                      validate: CKEDITOR.dialog.validate.number(
                        editor.lang.table.invalidBorder
                      ),
                      setup: function (selectedTable) {
                        this.setValue(
                          selectedTable.getAttribute("border") || ""
                        );
                      },
                    ...
                    },
                    {
                      ...
                      setup: function (selectedTable) {
                        this.setValue(
                          selectedTable.getAttribute("align") || ""
                        );
                      },
                      commit: function (data, selectedTable) {
                        if (this.getValue())
                ...
                },
                {
                  ...
                  children: [
                      ...
                      children: [
                        {
                          ...
                          onChange: function () {
                            ...
                            styles &&
                              styles.updateStyle("width", this.getValue());
                          },
                          setup: function (selectedTable) {
                      ...
                      children: [
                        {
                          ...
                          onChange: function () {
                            ...
                            styles &&
                              styles.updateStyle("height", this.getValue());
                          },
                    ...
                    },
                    {
                      ...
                      default: editor.filter.check("table[cellspacing]")
                        ? 1
                        : 0,
                      validate: CKEDITOR.dialog.validate.number(
                        editor.lang.table.invalidCellSpacing
                      ),
                      setup: function (selectedTable) {
                        this.setValue(
                          selectedTable.getAttribute("cellSpacing") || ""
                        );
                      },
                      commit: function (data, selectedTable) {
                        if (this.getValue())
                        ...
                        else selectedTable.removeAttribute("cellSpacing");
                      },
                    },
                    {
                      type: "text",
                      ...
                      default: editor.filter.check("table[cellpadding]")
                        ? 1
                        : 0,
                      validate: CKEDITOR.dialog.validate.number(
                        editor.lang.table.invalidCellPadding
                      ),
                      setup: function (selectedTable) {
                        this.setValue(
                          selectedTable.getAttribute("cellPadding") || ""
                        );
                      },
                      commit: function (data, selectedTable) {
                        if (this.getValue())
                        ...
                        else selectedTable.removeAttribute("cellPadding");
                      },
                    },
                  ],
                },
              ...
              children: [
                  ...
                  commit: function (data, table) {
                    ...
                    if (caption) {
                      if (captionElement.count() > 0) {
                        ...
                        captionElement = new CKEDITOR.dom.element(
                          "caption",
                          editor.document
                        );
                        table.append(captionElement, true);
                      }
                      captionElement.append(
                        new CKEDITOR.dom.text(caption, editor.document)
                      );
                ...
                },
                {
                  ...
                  commit: function (data, selectedTable) {
                    ...
                    else selectedTable.removeAttribute("summary");
                  },
                },
              ],
            },
