    ...
    proto: {
      render: function (menu, index, output) {
        ...
        if (this.command) {
          ...
          if (keystroke) {
            shortcut = CKEDITOR.tools.keystrokeToString(
        ...
        var params = {
          ...
          ariaShortcut: shortcut
            ? editor.lang.common.keyboardShortcut + " " + shortcut.aria
            : "",
          href:
            "javascript:void('" + (this.label || "").replace("'" + "") + "')", // jshint ignore:line
          ...
          shortcutHtml: shortcut
            ? menuShortcutTpl.output({ shortcut: shortcut.display })
            : "",
