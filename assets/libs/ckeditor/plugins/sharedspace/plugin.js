...
(function () {
  ...
  var containerTpl = CKEDITOR.addTemplate(
    "sharedcontainer",
    "<div" +
      ' id="cke_{name}"' +
  ...
  function create(editor, spaceName, target) {
    ...
    if (target) {
      ...
      if (innerHtml) {
        ...
        if (target.getCustomData("cke_hasshared")) space.hide();
        else target.setCustomData("cke_hasshared", 1);
        ...
        editor.on("focus", function () {
          for (
            var i = 0, sibling, children = target.getChildren();
