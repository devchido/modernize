  ...
  CKEDITOR.plugins.add("pastefromword", {
    ...
    init: function (editor) {
      ...
      var forceFromWord = 0,
        path = this.path,
        configInlineImages =
          editor.config.pasteFromWord_inlineImages === undefined
            ? true
      ...
      editor.addCommand("pastefromword", {
        ...
        exec: function (editor, data) {
          ...
          editor.execCommand("paste", {
            type: "html",
            notification:
              data && typeof data.notification !== "undefined"
                ? data.notification
                : true,
          });
        },
      ...
      editor.on(
        ...
        function (evt) {
          var data = evt.data,
            ...
            pfwEvtData = {
              dataValue: mswordHtml,
              dataTransfer: { "text/rtf": dataTransferRtf },
            },
            officeMetaRegexp =
            ...
            isOfficeContent =
              officeMetaRegexp.test(mswordHtml) || wordRegexp.test(mswordHtml);
          ...
          if (
            editor.fire("pasteFromWord", pfwEvtData) === false &&
            !forceFromWord
          ) {
            return;
          }
          ...
          var isLazyLoad = loadFilterRules(editor, path, function () {
            ...
            if (isLazyLoad) {
              ...
              pfwEvtData.dataValue = CKEDITOR.cleanWord(
                pfwEvtData.dataValue,
                editor
              );
          ...
          return img.type
            ? "data:" +
                ...
                CKEDITOR.tools.convertBytesToBase64(
                  CKEDITOR.tools.convertHexStringToBytes(img.hex)
                )
            : null;
        }
