...
(function () {
   ...
   */
  CKEDITOR.editor.prototype.createFakeElement = function (
    realElement,
    className,
    realElementType,
    isResizable
    ...
    if (!CKEDITOR.env.hc) attributes.src = CKEDITOR.tools.transparentImageData;
    ...
    if (fakeElement.data("cke-resizable")) {
      ...
      width &&
        element.setAttribute(
          "width",
          replaceCssLength(element.getAttribute("width"), width)
        );
      height &&
        element.setAttribute(
          "height",
