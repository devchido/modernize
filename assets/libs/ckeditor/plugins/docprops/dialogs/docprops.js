...
CKEDITOR.dialog.add("docProps", function (editor) {
  ...
  function commitMeta(name, isHttp, value) {
    return function (doc, html, head) {
      ...
      if (!val && name in hash) hash[name].remove();
      else if (val && name in hash) hash[name].setAttribute("content", val);
      else if (val) {
  ...
  function commitMargin(name) {
    return function (doc, html, head, body) {
      ...
      else body.removeStyle("margin-" + name);
    };
  }
  ...
  function createMetaHash(doc) {
    ...
    for (var i = 0; i < count; i++) {
      ...
      hash[
        meta
          .getAttribute(meta.hasAttribute("http-equiv") ? "http-equiv" : "name")
          .toLowerCase()
      ] = meta;
    }
    return hash;
        ...
        ),
        {
          ...
          onClick: function () {
            ...
            getDialogValue("colordialog", function (colorDialog) {
              ...
              dialog
                .getContentElement(dialog._.currentTabId, id)
                .setValue(
                  colorDialog
                    .getContentElement("picker", "selectedColor")
                    .getValue()
                );
            });
          },
        ...
        elements: [
          {
            ...
            setup: function (doc) {
              this.setValue(
                doc.getElementsByTag("title").getItem(0).data("cke-title")
              );
            },
            ...
            children: [
              {
                ...
                commit: function (doc, html, head, body) {
                  var val = this.getValue();
                  if (val) body.setAttribute("dir", val);
            ...
            children: [
              {
                ...
                onChange: function () {
                  this.getDialog().selectedCharset =
                    this.getValue() != "other" ? this.getValue() : "";
                ...
                setup: function () {
                  ...
                  if (val) {
                    ...
                    if (!this.getValue()) {
                      this.setValue("other");
                      var other = this.getDialog().getContentElement(
                        "general",
                        "charsetOther"
                      );
                ...
                commit: function (doc, html, head, body, isPreview) {
                  ...
                  var value = this.getValue(),
                    other = this.getDialog().getContentElement(
                      "general",
                      "charsetOther"
                    );
            ...
            children: [
              {
                ...
                commit: function (doc, html, head, body, isPreview) {
                  ...
                  editor.docType =
                    value == "other" ? (other ? other.getValue() : "") : value;
                },
              },
              {
                type: "text",
            ...
            children: [
              {
                ...
                children: [
                  colorField("txtColor", "txtColor", {
                    ...
                    commit: function (doc, html, head, body, isPreview) {
                      if (this.isChanged() || isPreview) {
                        ...
                        var val = this.getValue();
                        if (val) body.setStyle("color", val);
                        else body.removeStyle("color");
                      }
                    },
                  }),
                  colorField("bgColor", "bgColor", {
                    ...
                    commit: function (doc, html, head, body, isPreview) {
                      if (this.isChanged() || isPreview) {
                        ...
                        var val = this.getValue();
                        if (val) body.setStyle("background-color", val);
                        else
                    ...
                    children: [
                      {
                        ...
                        setup: function (doc, html, head, body) {
                          var val =
                            body.getComputedStyle("background-image") || "";
                          if (val == "none") val = "";
                          else {
                            val = val.replace(
                              /url\(\s*(["']?)\s*([^\)]*)\s*\1\s*\)/i,
                        ...
                        commit: function (doc, html, head, body) {
                          ...
                          else resetStyle(body, "background-image", "none");
                        },
                      },
                      {
                        type: "button",
                  ...
                  },
                  {
                    ...
                    setup: function (doc, html, head, body) {
                      this.setValue(
                        body.getComputedStyle("background-attachment") ==
                          "fixed"
                      );
                    },
                    commit: function (doc, html, head, body) {
                      ...
                      else resetStyle(body, "background-attachment", "scroll");
                    },
                  },
                ],
              },
                ...
                children: [
                  {
                    ...
                    id: "marginTitle",
                    html:
                      '<div style="text-align: center; margin: 0px auto; font-weight: bold">' +
                      lang.margin +
                      "</div>",
                  },
                  {
                    ...
                    setup: function (doc, html, head, body) {
                      this.setValue(
                        body.getStyle("margin-top") ||
                          body.getAttribute("margintop") ||
                          ""
                      );
                    },
                    ...
                    children: [
                      {
                        ...
                        setup: function (doc, html, head, body) {
                          this.setValue(
                            body.getStyle("margin-left") ||
                              body.getAttribute("marginleft") ||
                              ""
                          );
                        },
                      ...
                      },
                      {
                        ...
                        setup: function (doc, html, head, body) {
                          this.setValue(
                            body.getStyle("margin-right") ||
                              body.getAttribute("marginright") ||
                              ""
                          );
                        },
                  ...
                  },
                  {
                    ...
                    setup: function (doc, html, head, body) {
                      this.setValue(
                        body.getStyle("margin-bottom") ||
                          body.getAttribute("marginbottom") ||
                          ""
                      );
                    },
        ...
        elements: [
          {
            ...
            html:
              '<iframe src="' +
              previewSrc +
              '" style="width: 100%; height: 310px" hidefocus="true" frameborder="0"></iframe>',
            onLoad: function () {
