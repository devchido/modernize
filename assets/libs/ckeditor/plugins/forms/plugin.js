...
CKEDITOR.plugins.add("forms", {
  ...
  icons:
    "button,checkbox,form,hiddenfield,imagebutton,radio,select,select-rtl,textarea,textarea-rtl,textfield", // %REMOVE_LINE_CORE%
  ...
  init: function (editor) {
    ...
    if (editor.contextMenu) {
      ...
      editor.contextMenu.addListener(function (element) {
        if (element && !element.isReadOnly()) {
          ...
          if (name == "select") return { select: CKEDITOR.TRISTATE_OFF };

          if (name == "textarea") return { textarea: CKEDITOR.TRISTATE_OFF };
    ...
    editor.on("doubleclick", function (evt) {
      ...
      if (!editor.blockless && element.is("form")) evt.data.dialog = "form";
