...
(function () {
  ...
  Context.prototype = {
    ...
    _matchElement: function (elem) {
      ...
      return this.options.cssSelector &&
        ...
        !!elem.$[matchingFunctionName](this.options.cssSelector)
        ? elem
        : null;
    },
  ...
  ContextManager.prototype = {
    ...
    create: function (options) {
      var context = new CKEDITOR.plugins.balloontoolbar.context(
        this.editor,
        options
      );
    ...
    check: function (selection) {
      ...
      function matchEachContext(contexts, matchingFunction, matchingArg1) {
        forEach(contexts, function (curContext) {
          ...
          if (
            !contextMatched ||
            contextMatched.options.priority > curContext.options.priority
          ) {
  ...
  CKEDITOR.plugins.add("balloontoolbar", {
    ...
    beforeInit: function (editor) {
      ...
      editor.balloonToolbars =
        new CKEDITOR.plugins.balloontoolbar.contextManager(editor);
    },
    ...
    init: function (editor) {
      ...
      CKEDITOR.ui.balloonToolbarView.prototype.show = function () {
        ...
        this._listeners.push(
          CKEDITOR.document.getWindow().on("resize", attachListener, this)
        );
        this._listeners.push(
      ...
      CKEDITOR.ui.balloonToolbarView.prototype._getAlignments = function (
        ...
        var alignments = CKEDITOR.ui.balloonPanel.prototype._getAlignments.call(
          this,
          elementRect,
          panelWidth,
          panelHeight
        ...
        CKEDITOR.tools.array.forEach(
          ...
          function (itemKey) {
            ...
            if (
              ...
              items[itemKey] instanceof CKEDITOR.ui.richCombo &&
              groupStarted
            ) {
              groupStarted = false;
              output.push("</span>");
