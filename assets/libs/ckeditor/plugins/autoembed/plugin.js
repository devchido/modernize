...
(function () {
    ...
    init: function (editor) {
      ...
      editor.on(
        ...
        function (evt) {
          ...
          embedCandidatePasted =
            match != null && decodeURI(match[1]) == decodeURI(match[2]);
          ...
          if (embedCandidatePasted) {
            evt.data.dataValue =
              ...
              ++currentId +
              '"' +
              evt.data.dataValue.substr(2);
          }
        },
        null,
        null,
        20
      ); // Execute after autolink.
  ...
  function autoEmbedLink(editor, id) {
    var anchor = editor
        .editable()
        .findOne('a[data-cke-autoembed="' + id + '"]'),
      ...
      callback: function () {
        ...
        if (anchor) {
          ...
          if (
            ...
            !bookmark.endNode &&
            startNode.equals(anchor.getNext())
          ) {
