...
(function () {
          ...
          20: {
            refresh: function (editor, path) {
              ...
              if (!firstBlock.is($listItem)) {
                ...
                firstBlock =
                  (ascendant && path.contains(ascendant)) || firstBlock;
              }
              ...
              if (!this.enterBr && !this.getContext(path))
                ...
                if (this.isIndent) return TRISTATE_OFF;
                //	[+] Context in the path or ENTER_BR
                //	[-] IndentClasses
                //	[-] Indenting
                //	[-] Block in the path
  ...
  function indentElement(element, classes, dir) {
    ...
    if (classes) {
      ...
      element.$.className = CKEDITOR.tools.ltrim(
        element.$.className.replace(this.classNameRegex, "")
      );
  ...
  function getIndentCss(element, dir) {
    return (dir || element.getComputedStyle("direction")) == "ltr"
      ? "margin-left"
      : "margin-right";
  }
