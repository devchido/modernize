...
(function () {
  ...
  CKEDITOR.style = function (styleDefinition, variablesValues) {
    if (typeof styleDefinition.type == "string")
      return new CKEDITOR.style.customHandlers[styleDefinition.type](
        styleDefinition
      );
  ...
  function applyInlineStyle(range) {
    ...
    while (currentNode) {
      ...
      if (currentNode.equals(lastNode)) {
        ...
        if (
          (nodeName && currentNode.data("cke-bookmark")) ||
          currentNode.type === CKEDITOR.NODE_COMMENT
        ) {
  ...
  function compareCssText(source, target) {
    ...
    for (var name in source) {
      ...
      if (
        !(
          filter(target[name], name) == filter(source[name], name) ||
          source[name] == "inherit" ||
          target[name] == "inherit"
        )
      ) {
