...
(function () {
  ...
  CKEDITOR.editor.prototype.resize = function (
    ...
    var contentsOuterDelta =
        (outer.$.offsetHeight || 0) - (contents.$.clientHeight || 0),
      // If we're setting the content area's height, then we don't need the delta.
      resultContentsHeight = Math.max(
        height - (isContentHeight ? 0 : contentsOuterDelta),
        0
      ),
      resultOuterHeight = isContentHeight
        ? height + contentsOuterDelta
        : height;
