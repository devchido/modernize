...
(function () {
    ...
    proto: {
      ...
      addRules: function (rules, options) {
        ...
        if (rules.attributeNames)
          this.attributeNameRules.addMany(
      ...
      onElement: function (context, element) {
        ...
        var rulesGroups = [
            this.elementsRules["^"],
            this.elementsRules[element.name],
            this.elementsRules.$,
          ],
          rulesGroup,
          ret;
        ...
        return type == CKEDITOR.NODE_ELEMENT
          ...
          : type == CKEDITOR.NODE_TEXT
            ...
            : type == CKEDITOR.NODE_COMMENT
              ? new CKEDITOR.htmlParser.comment(
                  this.onComment(context, node.value)
                )
              : null;
      },
  ...
  filterRulesGroup.prototype = {
    ...
    exec: function (context, currentValue) {
      var isNode =
          currentValue instanceof CKEDITOR.htmlParser.node ||
          currentValue instanceof CKEDITOR.htmlParser.fragment,
