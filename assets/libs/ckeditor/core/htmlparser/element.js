...
CKEDITOR.htmlParser.element = function (name, attributes) {
  ...
  var isBlockLike = !!(
    CKEDITOR.dtd.$nonBodyContent[realName] ||
...
CKEDITOR.htmlParser.cssStyle = function () {
  ...
  styleText =
    arg instanceof CKEDITOR.htmlParser.element ? arg.attributes.style : arg;
  ...
  CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(
    new CKEDITOR.htmlParser.node(),
    {
      ...
      setHtml: function (html) {
        var children = (this.children =
          CKEDITOR.htmlParser.fragment.fromHtml(html).children);
      ...
      split: function (index) {
        var cloneChildren = this.children.splice(
            index,
      ...
      removeClass: function (className) {
        ...
        if (classes) this.attributes["class"] = classes;
