!function(t) {
    ...
    function j(t, f, o) {
        var l, u, a, c, i, s, e, p, d = window.navigator.pointerEnabled ? {
            ...
            return t
        }(), y = t, E = f.spectrum, m = [], g = [], v = [], b = 0, S = {}, x = t.ownerDocument, w = f.documentElement || x.documentElement, C = x.body, N = -1, U = 0, M = 1, k = 2, A = "rtl" === x.dir || 1 === f.ort ? 0 : 100;
        function P(t, e) {
            ...
            Object.keys(e).forEach(function(t) {
                !function(t, e, r) {
                    if ((r = i ? i(e, r) : r) !== N) {
                        ...
                        n.style[f.style] = t + "%",
                        U < r && ((n = P(a, !1)).className = p(r, f.cssClasses.value),
        ...
        function q(n, i, o, a) {
            var e = function(t) {
                return !!(t = function(t, e, r) {
                    ...
                    t.cursor = a || s,
                    t
                }(t, a.pageOffset, a.target || i)) && (!(O() && !a.doNotReject) && (e = y,
                r = f.cssClasses.tap,
        ...
        function n(t) {
            t.stopPropagation();
            var i, o, a, e = B(t.calcPoint), r = (i = e,
            a = !(o = 100),
        ...
        $("update", function(t, e, a, r, s) {
            v.forEach(function(t) {
                ...
                f.ariaLabel && f.ariaLabel.length && e.children[0].setAttribute("title", f.ariaLabel[t])
            })
        }),
        s = {
            destroy: function() {
