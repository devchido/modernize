...
(function ($, window, document, undefined) {
  ...
  DatePaginator.prototype = {
    ...
    _normalizeOptions: function () {
      ...
      if (typeof this.options.startDate === "string") {
        this.options.startDate = {
          d: moment(this.options.startDate, this.options.startDateFormat)
            .clone()
            .startOf("day"),
      ...
      if (typeof this.options.endDate === "string") {
        this.options.endDate = {
          d: moment(this.options.endDate, this.options.endDateFormat)
            .clone()
            .startOf("day"),
      ...
      if (typeof this.options.startOfWeek === "string") {
        this.options.startOfWeek = {
          ...
          f: this.options.startOfWeekFormat
    ...
    _isValidDate: function (m) {
      if (
        (m.isSame(this.options.startDate.d) ||
          m.isAfter(this.options.startDate.d)) &&
