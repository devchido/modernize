...
QUnit.test(
  "valid() should ignore elements that belong to other/nested forms",
  function (assert) {
    var form = $("#testForm28");
...
QUnit.test(
  "form() should ignore elements that belong to other/nested forms",
  function (assert) {
    var form = $("#testForm28");
    var v = form.validate();
...
QUnit.test(
  "elements() should ignore elements that belong to other/nested forms",
  function (assert) {
    var form = $("#testForm28");
    var v = form.validate();
    ...
    try {
      assert.equal(
        v.elements().length,
        1,
        "There should be only one element to validate"
      );
    } catch (err) {
      assert.ok(false, "Shouldn't throw an error");
    }
...
QUnit.test(
  "Ignore elements that have form attribute set to other forms",
  function (assert) {
...
QUnit.test(
  "Required rule should not take precedence over number & digits rules",
  function (assert) {
    var v = $("#userForm").validate(),
      // A fake number input
      numberInput = {
...
QUnit.test("destroy()", function (assert) {
  ...
  assert.equal(
    $("#y1", form).hasClass("validate-greaterThan-blur"),
    true,
    "The blur event should be bound to this element"
  );
  assert.equal(
    $("#y2", form).hasClass("validate-lessThan-blur"),
    true,
    "The blur event should be bound to this element"
  );
  assert.equal(
    $("#z1", form).hasClass("validate-greaterThanEqual-blur"),
    true,
    "The blur event should be bound to this element"
  );
  assert.equal(
    $("#z2", form).hasClass("validate-lessThanEqual-blur"),
    true,
    "The blur event should be bound to this element"
  );
  ...
  assert.equal(
    $("#y1", form).hasClass("validate-lessThan-blur"),
    false,
    "The blur event should be unbound from this element"
  );
  assert.equal(
    $("#y2", form).hasClass("validate-greaterThan-blur"),
    false,
    "The blur event should be unbound from this element"
  );
  assert.equal(
    $("#z1", form).hasClass("validate-equalTo-blur"),
    false,
    "The blur event should be unbound from this element"
  );
  assert.equal(
    $("#z2", form).hasClass("validate-greaterThan-blur"),
    false,
    "The blur event should be unbound from this element"
  );
});
...
QUnit.test(
  "stopRequest() should submit the form once pendingRequests === 0",
  function (assert) {
    var $form = $("#userForm");
    var button = $(":submit", $form)[0];
    var done = assert.async();
